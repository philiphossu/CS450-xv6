...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
       9:	c7 44 24 04 76 51 00 	movl   $0x5176,0x4(%esp)
      10:	00 
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      24:	00 
      25:	c7 04 24 8a 51 00 00 	movl   $0x518a,(%esp)
      2c:	e8 b1 3c 00 00       	call   3ce2 <open>
      31:	85 c0                	test   %eax,%eax
      33:	78 19                	js     4e <main+0x4e>
    printf(1, "already ran user tests -- rebuild fs.img\n");
      35:	c7 44 24 04 f4 58 00 	movl   $0x58f4,0x4(%esp)
      3c:	00 
  ...
  close(open("usertests.ran", O_CREATE));
      ...
      55:	00 
      56:	c7 04 24 8a 51 00 00 	movl   $0x518a,(%esp)
...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
     136:	a1 04 62 00 00       	mov    0x6204,%eax
     13b:	c7 44 24 04 1c 42 00 	movl   $0x421c,0x4(%esp)
     142:	00 
     143:	89 04 24             	mov    %eax,(%esp)
     146:	e8 d5 3c 00 00       	call   3e20 <printf>

  if(mkdir("iputdir") < 0){
     14b:	c7 04 24 af 41 00 00 	movl   $0x41af,(%esp)
  ...
  if(chdir("iputdir") < 0){
     15b:	c7 04 24 af 41 00 00 	movl   $0x41af,(%esp)
  ...
  if(unlink("../iputdir") < 0){
     16f:	c7 04 24 ac 41 00 00 	movl   $0x41ac,(%esp)
  ...
  if(chdir("/") < 0){
     17f:	c7 04 24 d1 41 00 00 	movl   $0x41d1,(%esp)
  ...
  printf(stdout, "iput test ok\n");
     18f:	a1 04 62 00 00       	mov    0x6204,%eax
     194:	c7 44 24 04 54 42 00 	movl   $0x4254,0x4(%esp)
     19b:	00 
...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
    printf(stdout, "mkdir failed\n");
     1a6:	a1 04 62 00 00       	mov    0x6204,%eax
     1ab:	c7 44 24 04 88 41 00 	movl   $0x4188,0x4(%esp)
     1b2:	00 
  ...
  if(chdir("/") < 0){
    printf(stdout, "chdir / failed\n");
     1c0:	a1 04 62 00 00       	mov    0x6204,%eax
     1c5:	c7 44 24 04 d3 41 00 	movl   $0x41d3,0x4(%esp)
     1cc:	00 
  ...
  if(unlink("../iputdir") < 0){
    printf(stdout, "unlink ../iputdir failed\n");
     1da:	a1 04 62 00 00       	mov    0x6204,%eax
     1df:	c7 44 24 04 b7 41 00 	movl   $0x41b7,0x4(%esp)
     1e6:	00 
  ...
  if(chdir("iputdir") < 0){
    printf(stdout, "chdir iputdir failed\n");
     1f4:	a1 04 62 00 00       	mov    0x6204,%eax
     1f9:	c7 44 24 04 96 41 00 	movl   $0x4196,0x4(%esp)
     200:	00 
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
     216:	a1 04 62 00 00       	mov    0x6204,%eax
     21b:	c7 44 24 04 e3 41 00 	movl   $0x41e3,0x4(%esp)
     222:	00 
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     236:	c7 04 24 af 41 00 00 	movl   $0x41af,(%esp)
    ...
    if(chdir("iputdir") < 0){
     24a:	c7 04 24 af 41 00 00 	movl   $0x41af,(%esp)
    ...
    if(unlink("../iputdir") < 0){
     25a:	c7 04 24 ac 41 00 00 	movl   $0x41ac,(%esp)
  ...
  printf(stdout, "exitiput test ok\n");
     275:	a1 04 62 00 00       	mov    0x6204,%eax
     27a:	c7 44 24 04 06 42 00 	movl   $0x4206,0x4(%esp)
     281:	00 
    ...
    if(unlink("../iputdir") < 0){
      printf(stdout, "unlink ../iputdir failed\n");
     290:	a1 04 62 00 00       	mov    0x6204,%eax
     295:	c7 44 24 04 b7 41 00 	movl   $0x41b7,0x4(%esp)
     29c:	00 
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     2aa:	a1 04 62 00 00       	mov    0x6204,%eax
     2af:	c7 44 24 04 c9 50 00 	movl   $0x50c9,0x4(%esp)
     2b6:	00 
    ...
    if(chdir("iputdir") < 0){
      printf(stdout, "child chdir failed\n");
     2c4:	a1 04 62 00 00       	mov    0x6204,%eax
     2c9:	c7 44 24 04 f2 41 00 	movl   $0x41f2,0x4(%esp)
     2d0:	00 
  ...
  if(pid == 0){
    if(mkdir("iputdir") < 0){
      printf(stdout, "mkdir failed\n");
     2de:	a1 04 62 00 00       	mov    0x6204,%eax
     2e3:	c7 44 24 04 88 41 00 	movl   $0x4188,0x4(%esp)
     2ea:	00 
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     306:	a1 04 62 00 00       	mov    0x6204,%eax
     30b:	c7 44 24 04 18 42 00 	movl   $0x4218,0x4(%esp)
     312:	00 
     313:	89 04 24             	mov    %eax,(%esp)
     316:	e8 05 3b 00 00       	call   3e20 <printf>
  if(mkdir("oidir") < 0){
     31b:	c7 04 24 27 42 00 00 	movl   $0x4227,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     349:	00 
     34a:	c7 04 24 27 42 00 00 	movl   $0x4227,(%esp)
     351:	e8 8c 39 00 00       	call   3ce2 <open>
    if(fd >= 0){
     356:	85 c0                	test   %eax,%eax
     358:	78 6e                	js     3c8 <openiputtest+0xc8>
      printf(stdout, "open directory for write succeeded\n");
     35a:	a1 04 62 00 00       	mov    0x6204,%eax
     35f:	c7 44 24 04 ac 51 00 	movl   $0x51ac,0x4(%esp)
     366:	00 
  ...
  if(unlink("oidir") != 0){
     384:	c7 04 24 27 42 00 00 	movl   $0x4227,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     399:	a1 04 62 00 00       	mov    0x6204,%eax
     39e:	c7 44 24 04 50 42 00 	movl   $0x4250,0x4(%esp)
     3a5:	00 
  ...
  if(unlink("oidir") != 0){
    printf(stdout, "unlink failed\n");
     3b0:	a1 04 62 00 00       	mov    0x6204,%eax
     3b5:	c7 44 24 04 41 42 00 	movl   $0x4241,0x4(%esp)
     3bc:	00 
     ...
     3c8:	e8 d5 38 00 00       	call   3ca2 <exit>
{
  ...
  if(mkdir("oidir") < 0){
    printf(stdout, "mkdir oidir failed\n");
     3cd:	a1 04 62 00 00       	mov    0x6204,%eax
     3d2:	c7 44 24 04 2d 42 00 	movl   $0x422d,0x4(%esp)
     3d9:	00 
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     3e7:	a1 04 62 00 00       	mov    0x6204,%eax
     3ec:	c7 44 24 04 c9 50 00 	movl   $0x50c9,0x4(%esp)
     3f3:	00 
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     416:	a1 04 62 00 00       	mov    0x6204,%eax
     41b:	c7 44 24 04 62 42 00 	movl   $0x4262,0x4(%esp)
     422:	00 
  ...
  fd = open("echo", 0);
     ...
     432:	00 
     433:	c7 04 24 6d 42 00 00 	movl   $0x426d,(%esp)
  ...
  fd = open("doesnotexist", 0);
     ...
     452:	00 
     453:	c7 04 24 85 42 00 00 	movl   $0x4285,(%esp)
  ...
  printf(stdout, "open test ok\n");
     463:	a1 04 62 00 00       	mov    0x6204,%eax
     468:	c7 44 24 04 b0 42 00 	movl   $0x42b0,0x4(%esp)
     46f:	00 
  ...
  if(fd < 0){
    printf(stdout, "open echo failed!\n");
     47a:	a1 04 62 00 00       	mov    0x6204,%eax
     47f:	c7 44 24 04 72 42 00 	movl   $0x4272,0x4(%esp)
     486:	00 
  ...
  if(fd >= 0){
    printf(stdout, "open doesnotexist succeeded!\n");
     494:	a1 04 62 00 00       	mov    0x6204,%eax
     499:	c7 44 24 04 92 42 00 	movl   $0x4292,0x4(%esp)
     4a0:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     4b8:	a1 04 62 00 00       	mov    0x6204,%eax
     4bd:	c7 44 24 04 be 42 00 	movl   $0x42be,0x4(%esp)
     4c4:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4d4:	00 
     4d5:	c7 04 24 cf 42 00 00 	movl   $0x42cf,(%esp)
     ...
     4e1:	85 c0                	test   %eax,%eax
{
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4eb:	a1 04 62 00 00       	mov    0x6204,%eax
  } else {
  ...
  if(fd >= 0){
    printf(stdout, "creat small succeeded; ok\n");
     4f2:	c7 44 24 04 d5 42 00 	movl   $0x42d5,0x4(%esp)
     4f9:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     50f:	00 
     510:	c7 44 24 04 0c 43 00 	movl   $0x430c,0x4(%esp)
     517:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     530:	00 
     531:	c7 44 24 04 17 43 00 	movl   $0x4317,0x4(%esp)
     538:	00 
  ...
  printf(stdout, "writes ok\n");
     552:	a1 04 62 00 00       	mov    0x6204,%eax
     557:	c7 44 24 04 22 43 00 	movl   $0x4322,0x4(%esp)
     55e:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     576:	00 
     577:	c7 04 24 cf 42 00 00 	movl   $0x42cf,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     58d:	a1 04 62 00 00       	mov    0x6204,%eax
     592:	c7 44 24 04 2d 43 00 	movl   $0x432d,0x4(%esp)
     599:	00 
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     5c5:	a1 04 62 00 00       	mov    0x6204,%eax
     5ca:	c7 44 24 04 61 43 00 	movl   $0x4361,0x4(%esp)
     5d1:	00 
  ...
  if(unlink("small") < 0){
     5e2:	c7 04 24 cf 42 00 00 	movl   $0x42cf,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     5f6:	a1 04 62 00 00       	mov    0x6204,%eax
     5fb:	c7 44 24 04 89 43 00 	movl   $0x4389,0x4(%esp)
     602:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
      printf(stdout, "error: write aa %d new file failed\n", i);
     612:	a1 04 62 00 00       	mov    0x6204,%eax
     617:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     61b:	c7 44 24 04 d0 51 00 	movl   $0x51d0,0x4(%esp)
     622:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
      printf(stdout, "error: write bb %d new file failed\n", i);
     630:	a1 04 62 00 00       	mov    0x6204,%eax
     635:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     639:	c7 44 24 04 f4 51 00 	movl   $0x51f4,0x4(%esp)
     640:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     64e:	a1 04 62 00 00       	mov    0x6204,%eax
     653:	c7 44 24 04 46 43 00 	movl   $0x4346,0x4(%esp)
     65a:	00 
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     668:	a1 04 62 00 00       	mov    0x6204,%eax
     66d:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
     674:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     682:	a1 04 62 00 00       	mov    0x6204,%eax
     687:	c7 44 24 04 74 43 00 	movl   $0x4374,0x4(%esp)
     68e:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     69c:	a1 04 62 00 00       	mov    0x6204,%eax
     6a1:	c7 44 24 04 f0 42 00 	movl   $0x42f0,0x4(%esp)
     6a8:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     6c8:	a1 04 62 00 00       	mov    0x6204,%eax
     6cd:	c7 44 24 04 9d 43 00 	movl   $0x439d,0x4(%esp)
     6d4:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     6e4:	00 
     6e5:	c7 04 24 17 44 00 00 	movl   $0x4417,(%esp)
     ...
     6f1:	85 c0                	test   %eax,%eax
{
  ...
  fd = open("big", O_RDONLY);
     ...
     743:	00 
     744:	c7 04 24 17 44 00 00 	movl   $0x4417,(%esp)
  ...
  if(unlink("big") < 0){
     7ab:	c7 04 24 17 44 00 00 	movl   $0x4417,(%esp)
  ...
  printf(stdout, "big files ok\n");
     7bf:	a1 04 62 00 00       	mov    0x6204,%eax
     7c4:	c7 44 24 04 3e 44 00 	movl   $0x443e,0x4(%esp)
     7cb:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
      printf(stdout, "error: write big file failed\n", i);
     7db:	a1 04 62 00 00       	mov    0x6204,%eax
     7e0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     7e4:	c7 44 24 04 c7 43 00 	movl   $0x43c7,0x4(%esp)
     7eb:	00 
    ...
    if(((int*)buf)[0] != n){
     ...
     7fd:	a1 04 62 00 00       	mov    0x6204,%eax
     802:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     806:	c7 44 24 04 18 52 00 	movl   $0x5218,0x4(%esp)
     80d:	00 
     ...
     81f:	a1 04 62 00 00       	mov    0x6204,%eax
     824:	c7 44 24 04 1b 44 00 	movl   $0x441b,0x4(%esp)
     82b:	00 
  ...
  for(;;){
    ...
    if(i == 0){
      if(n == MAXFILE - 1){
        printf(stdout, "read only %d blocks from big", n);
     839:	a1 04 62 00 00       	mov    0x6204,%eax
     83e:	c7 44 24 08 8b 00 00 	movl   $0x8b,0x8(%esp)
     845:	00 
     846:	c7 44 24 04 fe 43 00 	movl   $0x43fe,0x4(%esp)
     84d:	00 
  ...
  if(fd < 0){
    printf(stdout, "error: open big failed!\n");
     85b:	a1 04 62 00 00       	mov    0x6204,%eax
     860:	c7 44 24 04 e5 43 00 	movl   $0x43e5,0x4(%esp)
     867:	00 
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
     875:	a1 04 62 00 00       	mov    0x6204,%eax
     87a:	c7 44 24 04 ad 43 00 	movl   $0x43ad,0x4(%esp)
     881:	00 
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     88f:	a1 04 62 00 00       	mov    0x6204,%eax
     894:	c7 44 24 04 2b 44 00 	movl   $0x442b,0x4(%esp)
     89b:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     8bc:	a1 04 62 00 00       	mov    0x6204,%eax
     8c1:	c7 44 24 04 38 52 00 	movl   $0x5238,0x4(%esp)
     8c8:	00 
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     93a:	a1 04 62 00 00       	mov    0x6204,%eax
     93f:	c7 44 24 04 60 52 00 	movl   $0x5260,0x4(%esp)
     946:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     966:	a1 04 62 00 00       	mov    0x6204,%eax
     96b:	c7 44 24 04 4c 44 00 	movl   $0x444c,0x4(%esp)
     972:	00 
     973:	89 04 24             	mov    %eax,(%esp)
     976:	e8 a5 34 00 00       	call   3e20 <printf>

  if(mkdir("dir0") < 0){
     97b:	c7 04 24 58 44 00 00 	movl   $0x4458,(%esp)
  ...
  if(chdir("dir0") < 0){
     98b:	c7 04 24 58 44 00 00 	movl   $0x4458,(%esp)
  ...
  if(chdir("..") < 0){
     99f:	c7 04 24 fd 49 00 00 	movl   $0x49fd,(%esp)
  ...
  if(unlink("dir0") < 0){
     9af:	c7 04 24 58 44 00 00 	movl   $0x4458,(%esp)
  ...
  printf(stdout, "mkdir test ok\n");
     9bf:	a1 04 62 00 00       	mov    0x6204,%eax
     9c4:	c7 44 24 04 95 44 00 	movl   $0x4495,0x4(%esp)
     9cb:	00 
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    printf(stdout, "mkdir failed\n");
     9d6:	a1 04 62 00 00       	mov    0x6204,%eax
     9db:	c7 44 24 04 88 41 00 	movl   $0x4188,0x4(%esp)
     9e2:	00 
  ...
  if(unlink("dir0") < 0){
    printf(stdout, "unlink dir0 failed\n");
     9f0:	a1 04 62 00 00       	mov    0x6204,%eax
     9f5:	c7 44 24 04 81 44 00 	movl   $0x4481,0x4(%esp)
     9fc:	00 
  ...
  if(chdir("..") < 0){
    printf(stdout, "chdir .. failed\n");
     a0a:	a1 04 62 00 00       	mov    0x6204,%eax
     a0f:	c7 44 24 04 70 44 00 	movl   $0x4470,0x4(%esp)
     a16:	00 
  ...
  if(chdir("dir0") < 0){
    printf(stdout, "chdir dir0 failed\n");
     a24:	a1 04 62 00 00       	mov    0x6204,%eax
     a29:	c7 44 24 04 5d 44 00 	movl   $0x445d,0x4(%esp)
     a30:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     a46:	a1 04 62 00 00       	mov    0x6204,%eax
     a4b:	c7 44 24 04 a4 44 00 	movl   $0x44a4,0x4(%esp)
     a52:	00 
     a53:	89 04 24             	mov    %eax,(%esp)
     a56:	e8 c5 33 00 00       	call   3e20 <printf>
  if(exec("echo", echoargv) < 0){
     a5b:	c7 44 24 04 08 62 00 	movl   $0x6208,0x4(%esp)
     a62:	00 
     a63:	c7 04 24 6d 42 00 00 	movl   $0x426d,(%esp)
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    printf(stdout, "exec echo failed\n");
     a75:	a1 04 62 00 00       	mov    0x6204,%eax
     a7a:	c7 44 24 04 af 44 00 	movl   $0x44af,0x4(%esp)
     a81:	00 
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
      for(i = 0; i < n; i++){
        if((buf[i] & 0xff) != (seq++ & 0xff)){
          printf(1, "pipe1 oops 2\n");
     b31:	c7 44 24 04 de 44 00 	movl   $0x44de,0x4(%esp)
     b38:	00 
...
pipe1(void)
{
  ...
  printf(1, "pipe1 ok\n");
     bc4:	c7 44 24 04 03 45 00 	movl   $0x4503,0x4(%esp)
     bcb:	00 
    ...
    if(total != 5 * 1033){
     ...
     be0:	c7 44 24 04 ec 44 00 	movl   $0x44ec,0x4(%esp)
     be7:	00 
     ...
     bf8:	eb ac                	jmp    ba6 <pipe1+0x116>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     bfa:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
     c01:	00 
    ...
    printf(1, "fork() failed\n");
     c13:	c7 44 24 04 0d 45 00 	movl   $0x450d,0x4(%esp)
     c1a:	00 
    ...
    for(n = 0; n < 5; n++){
      ...
      if(write(fds[1], buf, 1033) != 1033){
        printf(1, "pipe1 oops 1\n");
     c2c:	c7 44 24 04 d0 44 00 	movl   $0x44d0,0x4(%esp)
     c33:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     c59:	c7 44 24 04 1c 45 00 	movl   $0x451c,0x4(%esp)
     c60:	00 
     ...
     c72:	85 c0                	test   %eax,%eax
{
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     cb8:	00 
     cb9:	c7 44 24 04 e1 4a 00 	movl   $0x4ae1,0x4(%esp)
     cc0:	00 
     ...
     cce:	c7 44 24 04 26 45 00 	movl   $0x4526,0x4(%esp)
     cd5:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     d1a:	c7 44 24 04 3a 45 00 	movl   $0x453a,0x4(%esp)
     d21:	00 
  ...
  printf(1, "kill... ");
     d41:	c7 44 24 04 4d 45 00 	movl   $0x454d,0x4(%esp)
     d48:	00 
  ...
  printf(1, "wait... ");
     d6d:	c7 44 24 04 56 45 00 	movl   $0x4556,0x4(%esp)
     d74:	00 
  ...
  printf(1, "preempt ok\n");
     d95:	c7 44 24 04 5f 45 00 	movl   $0x455f,0x4(%esp)
     d9c:	00 
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ddb:	79 e3                	jns    dc0 <exitwait+0x10>
      printf(1, "fork failed\n");
     ddd:	c7 44 24 04 c9 50 00 	movl   $0x50c9,0x4(%esp)
     de4:	00 
  ...
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     df8:	c7 44 24 04 6b 45 00 	movl   $0x456b,0x4(%esp)
     dff:	00 
  ...
  printf(1, "exitwait ok\n");
     e18:	c7 44 24 04 7b 45 00 	movl   $0x457b,0x4(%esp)
     e1f:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     e49:	c7 44 24 04 88 45 00 	movl   $0x4588,0x4(%esp)
     e50:	00 
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     e83:	e8 18 32 00 00       	call   40a0 <malloc>
    ...
    while(m1){
     ...
     e9f:	e8 6c 31 00 00       	call   4010 <free>
    m1 = 0;
    while((m2 = malloc(10001)) != 0){
      *(char**)m2 = m1;
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     eaf:	e8 ec 31 00 00       	call   40a0 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     ebb:	e8 50 31 00 00       	call   4010 <free>
    printf(1, "mem ok\n");
     ec0:	c7 44 24 04 ac 45 00 	movl   $0x45ac,0x4(%esp)
     ec7:	00 
    ...
    if(m1 == 0){
      printf(1, "couldn't allocate mem?!!\n");
     ef0:	c7 44 24 04 92 45 00 	movl   $0x4592,0x4(%esp)
     ef7:	00 
...
sharedfd(void)
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     fb6:	c7 44 24 04 b4 52 00 	movl   $0x52b4,0x4(%esp)
     fbd:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     fe9:	00 
     fea:	c7 04 24 c3 45 00 00 	movl   $0x45c3,(%esp)
  ...
  unlink("sharedfd");
    106c:	c7 04 24 c3 45 00 00 	movl   $0x45c3,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    108b:	c7 44 24 04 cc 45 00 	movl   $0x45cc,0x4(%esp)
    1092:	00 
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for writing");
    10a7:	c7 44 24 04 88 52 00 	movl   $0x5288,0x4(%esp)
    10ae:	00 
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for reading\n");
    10c3:	c7 44 24 04 d4 52 00 	movl   $0x52d4,0x4(%esp)
    10ca:	00 
  ...
  if(nc == 10000 && np == 10000){
    ...
    10e7:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
    10ee:	00 
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    1105:	be ee 45 00 00       	mov    $0x45ee,%esi
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    1110:	c7 44 24 04 f4 45 00 	movl   $0x45f4,0x4(%esp)
    1117:	00 
...
fourfiles(void)
{
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    111f:	c7 45 d8 ee 45 00 00 	movl   $0x45ee,-0x28(%ebp)
    1126:	c7 45 dc 37 47 00 00 	movl   $0x4737,-0x24(%ebp)
    112d:	c7 45 e0 3b 47 00 00 	movl   $0x473b,-0x20(%ebp)
    1134:	c7 45 e4 f1 45 00 00 	movl   $0x45f1,-0x1c(%ebp)
  char *fname;
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1182:	c7 45 d4 ee 45 00 00 	movl   $0x45ee,-0x2c(%ebp)
  }
  ...
  printf(1, "fourfiles ok\n");
    11fa:	c7 44 24 04 32 46 00 	movl   $0x4632,0x4(%esp)
    1201:	00 
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
      for(j = 0; j < n; j++){
        if(buf[j] != '0'+i){
          printf(1, "wrong char\n");
    1226:	c7 44 24 04 15 46 00 	movl   $0x4615,0x4(%esp)
    122d:	00 
    ...
    12a8:	c7 44 24 04 04 46 00 	movl   $0x4604,0x4(%esp)
    12af:	00 
    ...
    12c5:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
    12cc:	00 
    ...
    if(pid < 0){
      printf(1, "fork failed\n");
    12de:	c7 44 24 04 c9 50 00 	movl   $0x50c9,0x4(%esp)
    12e5:	00 
    ...
    if(pid == 0){
      ...
      if(fd < 0){
        printf(1, "create failed\n");
    12f7:	c7 44 24 04 8f 48 00 	movl   $0x488f,0x4(%esp)
    12fe:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    131b:	c7 44 24 04 40 46 00 	movl   $0x4640,0x4(%esp)
    1322:	00 
  ...
  printf(1, "createdelete ok\n");
    1415:	c7 44 24 04 53 46 00 	movl   $0x4653,0x4(%esp)
    141c:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    14bc:	c7 44 24 04 41 42 00 	movl   $0x4241,0x4(%esp)
    14c3:	00 
    ...
    14dc:	c7 44 24 04 00 53 00 	movl   $0x5300,0x4(%esp)
    14e3:	00 
    ...
    14f0:	e8 ad 27 00 00       	call   3ca2 <exit>
      ...
      for(i = 0; i < N; i++){
        ...
        if(fd < 0){
          printf(1, "create failed\n");
    14f5:	c7 44 24 04 8f 48 00 	movl   $0x488f,0x4(%esp)
    14fc:	00 
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    if(pid < 0){
      printf(1, "fork failed\n");
    150e:	c7 44 24 04 c9 50 00 	movl   $0x50c9,0x4(%esp)
    1515:	00 
    ...
    152b:	c7 44 24 04 24 53 00 	movl   $0x5324,0x4(%esp)
    1532:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1558:	c7 44 24 04 64 46 00 	movl   $0x4664,0x4(%esp)
    155f:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1573:	00 
    1574:	c7 04 24 75 46 00 00 	movl   $0x4675,(%esp)
...
unlinkread(void)
{
  ...
  write(fd, "hello", 5);
    ...
    1591:	00 
    1592:	c7 44 24 04 9a 46 00 	movl   $0x469a,0x4(%esp)
    1599:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    15b1:	00 
    15b2:	c7 04 24 75 46 00 00 	movl   $0x4675,(%esp)
  ...
  if(unlink("unlinkread") != 0){
    15c8:	c7 04 24 75 46 00 00 	movl   $0x4675,(%esp)
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15e3:	00 
    15e4:	c7 04 24 75 46 00 00 	movl   $0x4675,(%esp)
    15eb:	e8 f2 26 00 00       	call   3ce2 <open>
  write(fd1, "yyy", 3);
    15f0:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    15f7:	00 
    15f8:	c7 44 24 04 d2 46 00 	movl   $0x46d2,0x4(%esp)
    15ff:	00 
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    exit();
  ...
  unlink("unlinkread");
    1661:	c7 04 24 75 46 00 00 	movl   $0x4675,(%esp)
    1668:	e8 85 26 00 00       	call   3cf2 <unlink>
  printf(1, "unlinkread ok\n");
    166d:	c7 44 24 04 1d 47 00 	movl   $0x471d,0x4(%esp)
    1674:	00 
  ...
  if(fd < 0){
    printf(1, "create unlinkread failed\n");
    1688:	c7 44 24 04 80 46 00 	movl   $0x4680,0x4(%esp)
    168f:	00 
  ...
  if(write(fd, buf, 10) != 10){
    printf(1, "unlinkread write failed\n");
    16a1:	c7 44 24 04 04 47 00 	movl   $0x4704,0x4(%esp)
    16a8:	00 
  ...
  if(buf[0] != 'h'){
    printf(1, "unlinkread wrong data\n");
    16ba:	c7 44 24 04 ed 46 00 	movl   $0x46ed,0x4(%esp)
    16c1:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "unlinkread read failed");
    16d3:	c7 44 24 04 d6 46 00 	movl   $0x46d6,0x4(%esp)
    16da:	00 
  ...
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    16ec:	c7 44 24 04 b8 46 00 	movl   $0x46b8,0x4(%esp)
    16f3:	00 
  ...
  if(fd < 0){
    printf(1, "open unlinkread failed\n");
    1705:	c7 44 24 04 a0 46 00 	movl   $0x46a0,0x4(%esp)
    170c:	00 
...
linktest(void)
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1778:	00 
    1779:	c7 44 24 04 9a 46 00 	movl   $0x469a,0x4(%esp)
    1780:	00 
  ...
  if(link("lf1", "lf2") < 0){
    179a:	c7 44 24 04 3a 47 00 	movl   $0x473a,0x4(%esp)
    17a1:	00 
    17a2:	c7 04 24 36 47 00 00 	movl   $0x4736,(%esp)
  ...
  unlink("lf1");
    17b6:	c7 04 24 36 47 00 00 	movl   $0x4736,(%esp)
    17bd:	e8 30 25 00 00       	call   3cf2 <unlink>

  if(open("lf1", 0) >= 0){
    17c2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    17c9:	00 
    17ca:	c7 04 24 36 47 00 00 	movl   $0x4736,(%esp)
  ...
  fd = open("lf2", 0);
    ...
    17e5:	00 
    17e6:	c7 04 24 3a 47 00 00 	movl   $0x473a,(%esp)
  ...
  if(link("lf2", "lf2") >= 0){
    1825:	c7 44 24 04 3a 47 00 	movl   $0x473a,0x4(%esp)
    182c:	00 
    182d:	c7 04 24 3a 47 00 00 	movl   $0x473a,(%esp)
  ...
  unlink("lf2");
    1841:	c7 04 24 3a 47 00 00 	movl   $0x473a,(%esp)
    1848:	e8 a5 24 00 00       	call   3cf2 <unlink>
  if(link("lf2", "lf1") >= 0){
    184d:	c7 44 24 04 36 47 00 	movl   $0x4736,0x4(%esp)
    1854:	00 
    1855:	c7 04 24 3a 47 00 00 	movl   $0x473a,(%esp)
  ...
  if(link(".", "lf1") >= 0){
    1865:	c7 44 24 04 36 47 00 	movl   $0x4736,0x4(%esp)
    186c:	00 
    186d:	c7 04 24 fe 49 00 00 	movl   $0x49fe,(%esp)
  ...
  printf(1, "linktest ok\n");
    187d:	c7 44 24 04 d4 47 00 	movl   $0x47d4,0x4(%esp)
    1884:	00 
  ...
  if(fd < 0){
    printf(1, "create lf1 failed\n");
    1897:	c7 44 24 04 3e 47 00 	movl   $0x473e,0x4(%esp)
    189e:	00 
  ...
  if(link(".", "lf1") >= 0){
    printf(1, "link . lf1 succeeded! oops\n");
    18b0:	c7 44 24 04 b8 47 00 	movl   $0x47b8,0x4(%esp)
    18b7:	00 
  ...
  if(link("lf2", "lf1") >= 0){
    printf(1, "link non-existant succeeded! oops\n");
    18c9:	c7 44 24 04 6c 53 00 	movl   $0x536c,0x4(%esp)
    18d0:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    printf(1, "link lf2 lf2 succeeded! oops\n");
    18e2:	c7 44 24 04 9a 47 00 	movl   $0x479a,0x4(%esp)
    18e9:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "read lf2 failed\n");
    18fb:	c7 44 24 04 89 47 00 	movl   $0x4789,0x4(%esp)
    1902:	00 
  ...
  if(fd < 0){
    printf(1, "open lf2 failed\n");
    1914:	c7 44 24 04 78 47 00 	movl   $0x4778,0x4(%esp)
    191b:	00 
  ...
  if(open("lf1", 0) >= 0){
    printf(1, "unlinked lf1 but it is still there!\n");
    192d:	c7 44 24 04 44 53 00 	movl   $0x5344,0x4(%esp)
    1934:	00 
  ...
  if(link("lf1", "lf2") < 0){
    printf(1, "link lf1 lf2 failed\n");
    1946:	c7 44 24 04 63 47 00 	movl   $0x4763,0x4(%esp)
    194d:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    printf(1, "write lf1 failed\n");
    195f:	c7 44 24 04 51 47 00 	movl   $0x4751,0x4(%esp)
    1966:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    198b:	c7 44 24 04 e1 47 00 	movl   $0x47e1,0x4(%esp)
    1992:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    1a34:	c7 04 24 f1 47 00 00 	movl   $0x47f1,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid && (i % 3) == 1){
      link("C0", file);
    1a4f:	c7 04 24 f1 47 00 00 	movl   $0x47f1,(%esp)
  ...
  fd = open(".", 0);
    ...
    1a8d:	00 
    1a8e:	c7 04 24 fe 49 00 00 	movl   $0x49fe,(%esp)
  ...
  printf(1, "concreate ok\n");
    1bf0:	c7 44 24 04 46 48 00 	movl   $0x4846,0x4(%esp)
    1bf7:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid < 0){
      printf(1, "fork failed\n");
    1c0c:	c7 44 24 04 c9 50 00 	movl   $0x50c9,0x4(%esp)
    1c13:	00 
    ...
    1c29:	c7 44 24 04 f4 47 00 	movl   $0x47f4,0x4(%esp)
    1c30:	00 
    ...
    1c49:	c7 44 24 04 10 48 00 	movl   $0x4810,0x4(%esp)
    1c50:	00 
  ...
  if(n != 40){
    printf(1, "concreate not enough files in directory listing\n");
    1c62:	c7 44 24 04 90 53 00 	movl   $0x5390,0x4(%esp)
    1c69:	00 
    ...
    1c82:	c7 44 24 04 29 48 00 	movl   $0x4829,0x4(%esp)
    1c89:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1ca9:	c7 44 24 04 54 48 00 	movl   $0x4854,0x4(%esp)
    1cb0:	00 
    1cb1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cb8:	e8 63 21 00 00       	call   3e20 <printf>

  unlink("x");
    1cbd:	c7 04 24 e1 4a 00 00 	movl   $0x4ae1,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    1cfb:	74 7b                	je     1d78 <linkunlink+0xd8>
      ...
      unlink("x");
    1cfd:	c7 04 24 e1 4a 00 00 	movl   $0x4ae1,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    1d30:	00 
    1d31:	c7 04 24 e1 4a 00 00 	movl   $0x4ae1,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1d56:	c7 44 24 04 69 48 00 	movl   $0x4869,0x4(%esp)
    1d5d:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if((x % 3) == 0){
      ...
      link("cat", "x");
    1d78:	c7 44 24 04 e1 4a 00 	movl   $0x4ae1,0x4(%esp)
    1d7f:	00 
    1d80:	c7 04 24 65 48 00 00 	movl   $0x4865,(%esp)
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
    1d91:	c7 44 24 04 c9 50 00 	movl   $0x50c9,0x4(%esp)
    1d98:	00 
...
bigdir(void)
{
  ...
  for(i = 0; i < 500; i++){
    ...
    1e1f:	c7 04 24 85 48 00 00 	movl   $0x4885,(%esp)
    exit();
  }
  close(fd);
  ...
  unlink("bd");
    1e45:	c7 04 24 85 48 00 00 	movl   $0x4885,(%esp)
  for(i = 0; i < 500; i++){
  ...
  printf(1, "bigdir ok\n");
    1e8d:	c7 44 24 04 c7 48 00 	movl   $0x48c7,0x4(%esp)
    1e94:	00 
    ...
    if(link("bd", name) != 0){
      printf(1, "bigdir link failed\n");
    1ea8:	c7 44 24 04 9e 48 00 	movl   $0x489e,0x4(%esp)
    1eaf:	00 
    ...
    if(unlink(name) != 0){
      printf(1, "bigdir unlink failed");
    1ec1:	c7 44 24 04 b2 48 00 	movl   $0x48b2,0x4(%esp)
    1ec8:	00 
  ...
  if(fd < 0){
    printf(1, "bigdir create failed\n");
    1eda:	c7 44 24 04 88 48 00 	movl   $0x4888,0x4(%esp)
    1ee1:	00 
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f07:	c7 44 24 04 d2 48 00 	movl   $0x48d2,0x4(%esp)
    1f0e:	00 
    1f0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f16:	e8 05 1f 00 00       	call   3e20 <printf>

  unlink("ff");
    1f1b:	c7 04 24 5b 49 00 00 	movl   $0x495b,(%esp)
    1f22:	e8 cb 1d 00 00       	call   3cf2 <unlink>
  if(mkdir("dd") != 0){
    1f27:	c7 04 24 f8 49 00 00 	movl   $0x49f8,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f42:	00 
    1f43:	c7 04 24 31 49 00 00 	movl   $0x4931,(%esp)
  ...
  write(fd, "ff", 2);
    ...
    1f60:	00 
    1f61:	c7 44 24 04 5b 49 00 	movl   $0x495b,0x4(%esp)
    1f68:	00 
  ...
  if(unlink("dd") >= 0){
    1f79:	c7 04 24 f8 49 00 00 	movl   $0x49f8,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    1f8d:	c7 04 24 0c 49 00 00 	movl   $0x490c,(%esp)
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1fa8:	00 
    1fa9:	c7 04 24 2e 49 00 00 	movl   $0x492e,(%esp)
  ...
  write(fd, "FF", 2);
    ...
    1fc6:	00 
    1fc7:	c7 44 24 04 4f 49 00 	movl   $0x494f,0x4(%esp)
    1fce:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1fe6:	00 
    1fe7:	c7 04 24 52 49 00 00 	movl   $0x4952,(%esp)
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2033:	c7 44 24 04 92 49 00 	movl   $0x4992,0x4(%esp)
    203a:	00 
    203b:	c7 04 24 2e 49 00 00 	movl   $0x492e,(%esp)
  ...
  if(unlink("dd/dd/ff") != 0){
    204f:	c7 04 24 2e 49 00 00 	movl   $0x492e,(%esp)
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    206a:	00 
    206b:	c7 04 24 2e 49 00 00 	movl   $0x492e,(%esp)
  ...
  if(chdir("dd") != 0){
    207f:	c7 04 24 f8 49 00 00 	movl   $0x49f8,(%esp)
  ...
  if(chdir("dd/../../dd") != 0){
    2093:	c7 04 24 c6 49 00 00 	movl   $0x49c6,(%esp)
  ...
  if(chdir("dd/../../../dd") != 0){
    20a7:	c7 04 24 ec 49 00 00 	movl   $0x49ec,(%esp)
  ...
  if(chdir("./..") != 0){
    20bb:	c7 04 24 fb 49 00 00 	movl   $0x49fb,(%esp)
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    20d6:	00 
    20d7:	c7 04 24 92 49 00 00 	movl   $0x4992,(%esp)
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    211d:	00 
    211e:	c7 04 24 2e 49 00 00 	movl   $0x492e,(%esp)
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2139:	00 
    213a:	c7 04 24 46 4a 00 00 	movl   $0x4a46,(%esp)
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2155:	00 
    2156:	c7 04 24 6b 4a 00 00 	movl   $0x4a6b,(%esp)
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2171:	00 
    2172:	c7 04 24 f8 49 00 00 	movl   $0x49f8,(%esp)
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    218d:	00 
    218e:	c7 04 24 f8 49 00 00 	movl   $0x49f8,(%esp)
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    21a9:	00 
    21aa:	c7 04 24 f8 49 00 00 	movl   $0x49f8,(%esp)
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    21be:	c7 44 24 04 da 4a 00 	movl   $0x4ada,0x4(%esp)
    21c5:	00 
    21c6:	c7 04 24 46 4a 00 00 	movl   $0x4a46,(%esp)
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    21da:	c7 44 24 04 da 4a 00 	movl   $0x4ada,0x4(%esp)
    21e1:	00 
    21e2:	c7 04 24 6b 4a 00 00 	movl   $0x4a6b,(%esp)
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    21f6:	c7 44 24 04 92 49 00 	movl   $0x4992,0x4(%esp)
    21fd:	00 
    21fe:	c7 04 24 31 49 00 00 	movl   $0x4931,(%esp)
  ...
  if(mkdir("dd/ff/ff") == 0){
    2212:	c7 04 24 46 4a 00 00 	movl   $0x4a46,(%esp)
  ...
  if(mkdir("dd/xx/ff") == 0){
    2226:	c7 04 24 6b 4a 00 00 	movl   $0x4a6b,(%esp)
  ...
  if(mkdir("dd/dd/ffff") == 0){
    223a:	c7 04 24 92 49 00 00 	movl   $0x4992,(%esp)
  ...
  if(unlink("dd/xx/ff") == 0){
    224e:	c7 04 24 6b 4a 00 00 	movl   $0x4a6b,(%esp)
  ...
  if(unlink("dd/ff/ff") == 0){
    2262:	c7 04 24 46 4a 00 00 	movl   $0x4a46,(%esp)
  ...
  if(chdir("dd/ff") == 0){
    2276:	c7 04 24 31 49 00 00 	movl   $0x4931,(%esp)
  ...
  if(chdir("dd/xx") == 0){
    228a:	c7 04 24 dd 4a 00 00 	movl   $0x4add,(%esp)
  ...
  if(unlink("dd/dd/ffff") != 0){
    229e:	c7 04 24 92 49 00 00 	movl   $0x4992,(%esp)
  ...
  if(unlink("dd/ff") != 0){
    22b2:	c7 04 24 31 49 00 00 	movl   $0x4931,(%esp)
  ...
  if(unlink("dd") == 0){
    22c6:	c7 04 24 f8 49 00 00 	movl   $0x49f8,(%esp)
  ...
  if(unlink("dd/dd") < 0){
    22da:	c7 04 24 0d 49 00 00 	movl   $0x490d,(%esp)
  ...
  if(unlink("dd") < 0){
    22ee:	c7 04 24 f8 49 00 00 	movl   $0x49f8,(%esp)
  ...
  printf(1, "subdir ok\n");
    2302:	c7 44 24 04 da 4b 00 	movl   $0x4bda,0x4(%esp)
    2309:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    printf(1, "dd/dd/../ff wrong content\n");
    231c:	c7 44 24 04 77 49 00 	movl   $0x4977,0x4(%esp)
    2323:	00 
  ...
  if(chdir("dd/../../dd") != 0){
    printf(1, "chdir dd/../../dd failed\n");
    2335:	c7 44 24 04 d2 49 00 	movl   $0x49d2,0x4(%esp)
    233c:	00 
  ...
  if(unlink("dd/dd/ff") != 0){
    printf(1, "unlink dd/dd/ff failed\n");
    234e:	c7 44 24 04 9d 49 00 	movl   $0x499d,0x4(%esp)
    2355:	00 
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/ff/ff succeeded!\n");
    2367:	c7 44 24 04 4f 4a 00 	movl   $0x4a4f,0x4(%esp)
    236e:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2380:	c7 44 24 04 34 54 00 	movl   $0x5434,0x4(%esp)
    2387:	00 
  ...
  if(mkdir("dd/ff/ff") == 0){
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    2399:	c7 44 24 04 e3 4a 00 	movl   $0x4ae3,0x4(%esp)
    23a0:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    23b2:	c7 44 24 04 a4 54 00 	movl   $0x54a4,0x4(%esp)
    23b9:	00 
  ...
  if(fd < 0){
    printf(1, "open dd/dd/../ff failed\n");
    23cb:	c7 44 24 04 5e 49 00 	movl   $0x495e,0x4(%esp)
    23d2:	00 
  ...
  if(fd < 0){
    printf(1, "create dd/dd/ff failed\n");
    23e4:	c7 44 24 04 37 49 00 	movl   $0x4937,0x4(%esp)
    23eb:	00 
  ...
  if(chdir("./..") != 0){
    printf(1, "chdir ./.. failed\n");
    23fd:	c7 44 24 04 00 4a 00 	movl   $0x4a00,0x4(%esp)
    2404:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2416:	c7 44 24 04 ec 53 00 	movl   $0x53ec,0x4(%esp)
    241d:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    242f:	c7 44 24 04 80 54 00 	movl   $0x5480,0x4(%esp)
    2436:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    2448:	c7 44 24 04 5c 54 00 	movl   $0x545c,0x4(%esp)
    244f:	00 
  ...
  if(open("dd", O_WRONLY) >= 0){
    printf(1, "open dd wronly succeeded!\n");
    2461:	c7 44 24 04 bf 4a 00 	movl   $0x4abf,0x4(%esp)
    2468:	00 
  ...
  if(open("dd", O_RDWR) >= 0){
    printf(1, "open dd rdwr succeeded!\n");
    247a:	c7 44 24 04 a6 4a 00 	movl   $0x4aa6,0x4(%esp)
    2481:	00 
  ...
  if(open("dd", O_CREATE) >= 0){
    printf(1, "create dd succeeded!\n");
    2493:	c7 44 24 04 90 4a 00 	movl   $0x4a90,0x4(%esp)
    249a:	00 
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/xx/ff succeeded!\n");
    24ac:	c7 44 24 04 74 4a 00 	movl   $0x4a74,0x4(%esp)
    24b3:	00 
  ...
  if(chdir("dd") != 0){
    printf(1, "chdir dd failed\n");
    24c5:	c7 44 24 04 b5 49 00 	movl   $0x49b5,0x4(%esp)
    24cc:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    24de:	c7 44 24 04 10 54 00 	movl   $0x5410,0x4(%esp)
    24e5:	00 
  ...
  if(mkdir("/dd/dd") != 0){
    printf(1, "subdir mkdir dd/dd failed\n");
    24f7:	c7 44 24 04 13 49 00 	movl   $0x4913,0x4(%esp)
    24fe:	00 
  ...
  if(unlink("dd") >= 0){
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    2510:	c7 44 24 04 c4 53 00 	movl   $0x53c4,0x4(%esp)
    2517:	00 
  ...
  if(fd < 0){
    printf(1, "create dd/ff failed\n");
    2529:	c7 44 24 04 f7 48 00 	movl   $0x48f7,0x4(%esp)
    2530:	00 
  ...
  if(mkdir("dd") != 0){
    printf(1, "subdir mkdir dd failed\n");
    2542:	c7 44 24 04 df 48 00 	movl   $0x48df,0x4(%esp)
    2549:	00 
  ...
  if(unlink("dd") < 0){
    printf(1, "unlink dd failed\n");
    255b:	c7 44 24 04 c8 4b 00 	movl   $0x4bc8,0x4(%esp)
    2562:	00 
  ...
  if(unlink("dd/dd") < 0){
    printf(1, "unlink dd/dd failed\n");
    2574:	c7 44 24 04 b3 4b 00 	movl   $0x4bb3,0x4(%esp)
    257b:	00 
  ...
  if(unlink("dd") == 0){
    printf(1, "unlink non-empty dd succeeded!\n");
    258d:	c7 44 24 04 c8 54 00 	movl   $0x54c8,0x4(%esp)
    2594:	00 
  ...
  if(unlink("dd/ff") != 0){
    printf(1, "unlink dd/ff failed\n");
    25a6:	c7 44 24 04 9e 4b 00 	movl   $0x4b9e,0x4(%esp)
    25ad:	00 
  ...
  if(chdir("dd/xx") == 0){
    printf(1, "chdir dd/xx succeeded!\n");
    25bf:	c7 44 24 04 86 4b 00 	movl   $0x4b86,0x4(%esp)
    25c6:	00 
  ...
  if(chdir("dd/ff") == 0){
    printf(1, "chdir dd/ff succeeded!\n");
    25d8:	c7 44 24 04 6e 4b 00 	movl   $0x4b6e,0x4(%esp)
    25df:	00 
  ...
  if(unlink("dd/ff/ff") == 0){
    printf(1, "unlink dd/ff/ff succeeded!\n");
    25f1:	c7 44 24 04 52 4b 00 	movl   $0x4b52,0x4(%esp)
    25f8:	00 
  ...
  if(unlink("dd/xx/ff") == 0){
    printf(1, "unlink dd/xx/ff succeeded!\n");
    260a:	c7 44 24 04 36 4b 00 	movl   $0x4b36,0x4(%esp)
    2611:	00 
  ...
  if(mkdir("dd/dd/ffff") == 0){
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2623:	c7 44 24 04 19 4b 00 	movl   $0x4b19,0x4(%esp)
    262a:	00 
  ...
  if(mkdir("dd/xx/ff") == 0){
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    263c:	c7 44 24 04 fe 4a 00 	movl   $0x4afe,0x4(%esp)
    2643:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    printf(1, "read dd/dd/ffff wrong len\n");
    2655:	c7 44 24 04 2b 4a 00 	movl   $0x4a2b,0x4(%esp)
    265c:	00 
  ...
  if(fd < 0){
    printf(1, "open dd/dd/ffff failed\n");
    266e:	c7 44 24 04 13 4a 00 	movl   $0x4a13,0x4(%esp)
    2675:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    269d:	c7 44 24 04 e5 4b 00 	movl   $0x4be5,0x4(%esp)
    26a4:	00 
    26a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26ac:	e8 6f 17 00 00       	call   3e20 <printf>

  unlink("bigwrite");
    26b1:	c7 04 24 f4 4b 00 00 	movl   $0x4bf4,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26c7:	00 
    26c8:	c7 04 24 f4 4b 00 00 	movl   $0x4bf4,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    271c:	c7 04 24 f4 4b 00 00 	movl   $0x4bf4,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2730:	c7 44 24 04 27 4c 00 	movl   $0x4c27,0x4(%esp)
    2737:	00 
    ...
    2753:	c7 44 24 04 15 4c 00 	movl   $0x4c15,0x4(%esp)
    275a:	00 
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    if(fd < 0){
      printf(1, "cannot create bigwrite\n");
    276c:	c7 44 24 04 fd 4b 00 	movl   $0x4bfd,0x4(%esp)
    2773:	00 
...
bigfile(void)
{
  ...
  fd = open("bigfile", 0);
    ...
    2832:	00 
    2833:	c7 04 24 50 4c 00 00 	movl   $0x4c50,(%esp)
  ...
  unlink("bigfile");
    28b1:	c7 04 24 50 4c 00 00 	movl   $0x4c50,(%esp)
    28b8:	e8 35 14 00 00       	call   3cf2 <unlink>

  printf(1, "bigfile test ok\n");
    28bd:	c7 44 24 04 df 4c 00 	movl   $0x4cdf,0x4(%esp)
    28c4:	00 
    ...
    if(buf[0] != i/2 || buf[299] != i/2){
      printf(1, "read bigfile wrong data\n");
    28d9:	c7 44 24 04 ac 4c 00 	movl   $0x4cac,0x4(%esp)
    28e0:	00 
    ...
    if(cc != 300){
      printf(1, "short read bigfile\n");
    28f2:	c7 44 24 04 98 4c 00 	movl   $0x4c98,0x4(%esp)
    28f9:	00 
  ...
  for(i = 0; ; i++){
    ...
    if(cc < 0){
      printf(1, "read bigfile failed\n");
    290b:	c7 44 24 04 83 4c 00 	movl   $0x4c83,0x4(%esp)
    2912:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    if(write(fd, buf, 600) != 600){
      printf(1, "write bigfile failed\n");
    2924:	c7 44 24 04 58 4c 00 	movl   $0x4c58,0x4(%esp)
    292b:	00 
  ...
  if(fd < 0){
    printf(1, "cannot open bigfile\n");
    293d:	c7 44 24 04 6e 4c 00 	movl   $0x4c6e,0x4(%esp)
    2944:	00 
  ...
  if(fd < 0){
    printf(1, "cannot create bigfile");
    2956:	c7 44 24 04 42 4c 00 	movl   $0x4c42,0x4(%esp)
    295d:	00 
  ...
  if(total != 20*600){
    printf(1, "read bigfile wrong total\n");
    296f:	c7 44 24 04 c5 4c 00 	movl   $0x4cc5,0x4(%esp)
    2976:	00 
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    2996:	c7 44 24 04 f0 4c 00 	movl   $0x4cf0,0x4(%esp)
    299d:	00 
    299e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29a5:	e8 76 14 00 00       	call   3e20 <printf>

  if(mkdir("12345678901234") != 0){
    29aa:	c7 04 24 2b 4d 00 00 	movl   $0x4d2b,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    29be:	c7 04 24 e8 54 00 00 	movl   $0x54e8,(%esp)
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29d9:	00 
    29da:	c7 04 24 38 55 00 00 	movl   $0x5538,(%esp)
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29fd:	00 
    29fe:	c7 04 24 a8 55 00 00 	movl   $0x55a8,(%esp)
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2a1a:	c7 04 24 1c 4d 00 00 	movl   $0x4d1c,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    2a2a:	c7 04 24 44 56 00 00 	movl   $0x5644,(%esp)
  ...
  printf(1, "fourteen ok\n");
    2a3a:	c7 44 24 04 3a 4d 00 	movl   $0x4d3a,0x4(%esp)
    2a41:	00 
  ...
  if(mkdir("12345678901234") != 0){
    printf(1, "mkdir 12345678901234 failed\n");
    2a50:	c7 44 24 04 ff 4c 00 	movl   $0x4cff,0x4(%esp)
    2a57:	00 
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2a69:	c7 44 24 04 64 56 00 	movl   $0x5664,0x4(%esp)
    2a70:	00 
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2a82:	c7 44 24 04 14 56 00 	movl   $0x5614,0x4(%esp)
    2a89:	00 
  ...
  if(fd < 0){
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2a9b:	c7 44 24 04 d8 55 00 	movl   $0x55d8,0x4(%esp)
    2aa2:	00 
  ...
  if(fd < 0){
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    2ab4:	c7 44 24 04 68 55 00 	movl   $0x5568,0x4(%esp)
    2abb:	00 
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    2acd:	c7 44 24 04 08 55 00 	movl   $0x5508,0x4(%esp)
    2ad4:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    2af6:	c7 44 24 04 47 4d 00 	movl   $0x4d47,0x4(%esp)
    2afd:	00 
    2afe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b05:	e8 16 13 00 00       	call   3e20 <printf>
  if(mkdir("dots") != 0){
    2b0a:	c7 04 24 53 4d 00 00 	movl   $0x4d53,(%esp)
  ...
  if(chdir("dots") != 0){
    2b1e:	c7 04 24 53 4d 00 00 	movl   $0x4d53,(%esp)
  ...
  if(unlink(".") == 0){
    2b32:	c7 04 24 fe 49 00 00 	movl   $0x49fe,(%esp)
  ...
  if(unlink("..") == 0){
    2b46:	c7 04 24 fd 49 00 00 	movl   $0x49fd,(%esp)
  ...
  if(chdir("/") != 0){
    2b5a:	c7 04 24 d1 41 00 00 	movl   $0x41d1,(%esp)
  ...
  if(unlink("dots/.") == 0){
    2b6e:	c7 04 24 9b 4d 00 00 	movl   $0x4d9b,(%esp)
  ...
  if(unlink("dots/..") == 0){
    2b82:	c7 04 24 b9 4d 00 00 	movl   $0x4db9,(%esp)
  ...
  if(unlink("dots") != 0){
    2b92:	c7 04 24 53 4d 00 00 	movl   $0x4d53,(%esp)
  ...
  printf(1, "rmdot ok\n");
    2ba2:	c7 44 24 04 ee 4d 00 	movl   $0x4dee,0x4(%esp)
    2ba9:	00 
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    printf(1, "mkdir dots failed\n");
    2bb8:	c7 44 24 04 58 4d 00 	movl   $0x4d58,0x4(%esp)
    2bbf:	00 
  ...
  if(unlink("dots") != 0){
    printf(1, "unlink dots failed!\n");
    2bd1:	c7 44 24 04 d9 4d 00 	movl   $0x4dd9,0x4(%esp)
    2bd8:	00 
  ...
  if(unlink("dots/..") == 0){
    printf(1, "unlink dots/.. worked!\n");
    2bea:	c7 44 24 04 c1 4d 00 	movl   $0x4dc1,0x4(%esp)
    2bf1:	00 
  ...
  if(unlink("dots/.") == 0){
    printf(1, "unlink dots/. worked!\n");
    2c03:	c7 44 24 04 a2 4d 00 	movl   $0x4da2,0x4(%esp)
    2c0a:	00 
  ...
  if(chdir("/") != 0){
    printf(1, "chdir / failed\n");
    2c1c:	c7 44 24 04 d3 41 00 	movl   $0x41d3,0x4(%esp)
    2c23:	00 
  ...
  if(unlink("..") == 0){
    printf(1, "rm .. worked!\n");
    2c35:	c7 44 24 04 8c 4d 00 	movl   $0x4d8c,0x4(%esp)
    2c3c:	00 
  ...
  if(unlink(".") == 0){
    printf(1, "rm . worked!\n");
    2c4e:	c7 44 24 04 7e 4d 00 	movl   $0x4d7e,0x4(%esp)
    2c55:	00 
  ...
  if(chdir("dots") != 0){
    printf(1, "chdir dots failed\n");
    2c67:	c7 44 24 04 6b 4d 00 	movl   $0x4d6b,0x4(%esp)
    2c6e:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2c87:	c7 44 24 04 f8 4d 00 	movl   $0x4df8,0x4(%esp)
    2c8e:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2ca2:	00 
    2ca3:	c7 04 24 05 4e 00 00 	movl   $0x4e05,(%esp)
  ...
  if(chdir("dirfile") == 0){
    2cbf:	c7 04 24 05 4e 00 00 	movl   $0x4e05,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2cda:	00 
    2cdb:	c7 04 24 3e 4e 00 00 	movl   $0x4e3e,(%esp)
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2cf6:	00 
    2cf7:	c7 04 24 3e 4e 00 00 	movl   $0x4e3e,(%esp)
  ...
  if(mkdir("dirfile/xx") == 0){
    2d0b:	c7 04 24 3e 4e 00 00 	movl   $0x4e3e,(%esp)
  ...
  if(unlink("dirfile/xx") == 0){
    2d1f:	c7 04 24 3e 4e 00 00 	movl   $0x4e3e,(%esp)
  ...
  if(link("README", "dirfile/xx") == 0){
    2d33:	c7 44 24 04 3e 4e 00 	movl   $0x4e3e,0x4(%esp)
    2d3a:	00 
    2d3b:	c7 04 24 a2 4e 00 00 	movl   $0x4ea2,(%esp)
  ...
  if(unlink("dirfile") != 0){
    2d4f:	c7 04 24 05 4e 00 00 	movl   $0x4e05,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2d6a:	00 
    2d6b:	c7 04 24 fe 49 00 00 	movl   $0x49fe,(%esp)
  ...
  fd = open(".", 0);
    ...
    2d86:	00 
    2d87:	c7 04 24 fe 49 00 00 	movl   $0x49fe,(%esp)
    2d8e:	e8 4f 0f 00 00       	call   3ce2 <open>
  if(write(fd, "x", 1) > 0){
    2d93:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2d9a:	00 
    2d9b:	c7 44 24 04 e1 4a 00 	movl   $0x4ae1,0x4(%esp)
    2da2:	00 
  ...
  printf(1, "dir vs file OK\n");
    2db9:	c7 44 24 04 d5 4e 00 	movl   $0x4ed5,0x4(%esp)
    2dc0:	00 
  ...
  if(fd >= 0){
    printf(1, "create dirfile/xx succeeded!\n");
    2dd3:	c7 44 24 04 49 4e 00 	movl   $0x4e49,0x4(%esp)
    2dda:	00 
  ...
  if(chdir("dirfile") == 0){
    printf(1, "chdir dirfile succeeded!\n");
    2dec:	c7 44 24 04 24 4e 00 	movl   $0x4e24,0x4(%esp)
    2df3:	00 
  ...
  if(fd < 0){
    printf(1, "create dirfile failed\n");
    2e05:	c7 44 24 04 0d 4e 00 	movl   $0x4e0d,0x4(%esp)
    2e0c:	00 
  ...
  if(write(fd, "x", 1) > 0){
    printf(1, "write . succeeded!\n");
    2e1e:	c7 44 24 04 c1 4e 00 	movl   $0x4ec1,0x4(%esp)
    2e25:	00 
  ...
  if(fd >= 0){
    printf(1, "open . for writing succeeded!\n");
    2e37:	c7 44 24 04 b8 56 00 	movl   $0x56b8,0x4(%esp)
    2e3e:	00 
  ...
  if(unlink("dirfile") != 0){
    printf(1, "unlink dirfile failed!\n");
    2e50:	c7 44 24 04 a9 4e 00 	movl   $0x4ea9,0x4(%esp)
    2e57:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    printf(1, "link to dirfile/xx succeeded!\n");
    2e69:	c7 44 24 04 98 56 00 	movl   $0x5698,0x4(%esp)
    2e70:	00 
  ...
  if(unlink("dirfile/xx") == 0){
    printf(1, "unlink dirfile/xx succeeded!\n");
    2e82:	c7 44 24 04 84 4e 00 	movl   $0x4e84,0x4(%esp)
    2e89:	00 
  ...
  if(mkdir("dirfile/xx") == 0){
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2e9b:	c7 44 24 04 67 4e 00 	movl   $0x4e67,0x4(%esp)
    2ea2:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ecc:	c7 44 24 04 e5 4e 00 	movl   $0x4ee5,0x4(%esp)
    2ed3:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
    2ee0:	c7 04 24 f6 4e 00 00 	movl   $0x4ef6,(%esp)
    ...
    if(chdir("irefd") != 0){
    2ef4:	c7 04 24 f6 4e 00 00 	movl   $0x4ef6,(%esp)
    ...
    mkdir("");
    2f08:	c7 04 24 ab 45 00 00 	movl   $0x45ab,(%esp)
    2f0f:	e8 f6 0d 00 00       	call   3d0a <mkdir>
    link("README", "");
    2f14:	c7 44 24 04 ab 45 00 	movl   $0x45ab,0x4(%esp)
    2f1b:	00 
    2f1c:	c7 04 24 a2 4e 00 00 	movl   $0x4ea2,(%esp)
    2f23:	e8 da 0d 00 00       	call   3d02 <link>
    fd = open("", O_CREATE);
    2f28:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2f2f:	00 
    2f30:	c7 04 24 ab 45 00 00 	movl   $0x45ab,(%esp)
    ...
    2f4f:	00 
    2f50:	c7 04 24 e0 4a 00 00 	movl   $0x4ae0,(%esp)
    ...
    unlink("xx");
    2f68:	c7 04 24 e0 4a 00 00 	movl   $0x4ae0,(%esp)
  ...
  chdir("/");
    2f7d:	c7 04 24 d1 41 00 00 	movl   $0x41d1,(%esp)
    2f84:	e8 89 0d 00 00       	call   3d12 <chdir>
  printf(1, "empty file name OK\n");
    2f89:	c7 44 24 04 24 4f 00 	movl   $0x4f24,0x4(%esp)
    2f90:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
      printf(1, "mkdir irefd failed\n");
    2fa3:	c7 44 24 04 fc 4e 00 	movl   $0x4efc,0x4(%esp)
    2faa:	00 
    ...
    if(chdir("irefd") != 0){
      printf(1, "chdir irefd failed\n");
    2fbc:	c7 44 24 04 10 4f 00 	movl   $0x4f10,0x4(%esp)
    2fc3:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2fe9:	c7 44 24 04 38 4f 00 	movl   $0x4f38,0x4(%esp)
    2ff0:	00 
    ...
    3000:	0f 84 87 00 00 00    	je     308d <forktest+0xad>
{
  ...
  printf(1, "fork test OK\n");
    3042:	c7 44 24 04 6a 4f 00 	movl   $0x4f6a,0x4(%esp)
    3049:	00 
  ...
  if(n == 1000){
    printf(1, "fork claimed to work 1000 times!\n");
    3060:	c7 44 24 04 d8 56 00 	movl   $0x56d8,0x4(%esp)
    3067:	00 
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
    3079:	c7 44 24 04 43 4f 00 	movl   $0x4f43,0x4(%esp)
    3080:	00 
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
    3092:	c7 44 24 04 57 4f 00 	movl   $0x4f57,0x4(%esp)
    3099:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30bb:	a1 04 62 00 00       	mov    0x6204,%eax
    30c0:	c7 44 24 04 78 4f 00 	movl   $0x4f78,0x4(%esp)
    30c7:	00 
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    331a:	a1 04 62 00 00       	mov    0x6204,%eax
    331f:	c7 44 24 04 20 50 00 	movl   $0x5020,0x4(%esp)
    3326:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    335c:	00 
    335d:	c7 44 24 04 e1 4a 00 	movl   $0x4ae1,0x4(%esp)
    3364:	00 
  ...
  for(i = 0; i < 5000; i++){
    ...
    3382:	a1 04 62 00 00       	mov    0x6204,%eax
    3387:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    338b:	89 74 24 08          	mov    %esi,0x8(%esp)
    338f:	c7 44 24 04 83 4f 00 	movl   $0x4f83,0x4(%esp)
    3396:	00 
  ...
  if(c == (char*)0xffffffff){
    printf(stdout, "failed sbrk leaked memory\n");
    33a4:	a1 04 62 00 00       	mov    0x6204,%eax
    33a9:	c7 44 24 04 05 50 00 	movl   $0x5005,0x4(%esp)
    33b0:	00 
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
    33be:	c7 44 24 04 c1 44 00 	movl   $0x44c1,0x4(%esp)
    33c5:	00 
    ...
    33de:	c7 44 24 04 ec 4f 00 	movl   $0x4fec,0x4(%esp)
    33e5:	00 
    33e6:	89 44 24 0c          	mov    %eax,0xc(%esp)
    33ea:	a1 04 62 00 00       	mov    0x6204,%eax
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    if(pid < 0){
      printf(stdout, "fork failed\n");
    3404:	a1 04 62 00 00       	mov    0x6204,%eax
    3409:	c7 44 24 04 c9 50 00 	movl   $0x50c9,0x4(%esp)
    3410:	00 
  ...
  if(c != a){
    ...
    3422:	a1 04 62 00 00       	mov    0x6204,%eax
    3427:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    342b:	c7 44 24 04 cc 57 00 	movl   $0x57cc,0x4(%esp)
    3432:	00 
  ...
  if(*lastaddr == 99){
    // should be zero
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    3440:	a1 04 62 00 00       	mov    0x6204,%eax
    3445:	c7 44 24 04 9c 57 00 	movl   $0x579c,0x4(%esp)
    344c:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    345a:	a1 04 62 00 00       	mov    0x6204,%eax
    345f:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    3463:	89 74 24 08          	mov    %esi,0x8(%esp)
    3467:	c7 44 24 04 74 57 00 	movl   $0x5774,0x4(%esp)
    346e:	00 
  ...
  if(c != a - 4096){
    ...
    3480:	a1 04 62 00 00       	mov    0x6204,%eax
    3485:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    3489:	c7 44 24 04 3c 57 00 	movl   $0x573c,0x4(%esp)
    3490:	00 
  ...
  if(c == (char*)0xffffffff){
    printf(stdout, "sbrk could not deallocate\n");
    349e:	a1 04 62 00 00       	mov    0x6204,%eax
    34a3:	c7 44 24 04 d1 4f 00 	movl   $0x4fd1,0x4(%esp)
    34aa:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    34b8:	a1 04 62 00 00       	mov    0x6204,%eax
    34bd:	c7 44 24 04 fc 56 00 	movl   $0x56fc,0x4(%esp)
    34c4:	00 
  ...
  if(c != a + 1){
    printf(stdout, "sbrk test failed post-fork\n");
    34d2:	a1 04 62 00 00       	mov    0x6204,%eax
    34d7:	c7 44 24 04 b5 4f 00 	movl   $0x4fb5,0x4(%esp)
    34de:	00 
  ...
  if(pid < 0){
    printf(stdout, "sbrk test fork failed\n");
    34ec:	a1 04 62 00 00       	mov    0x6204,%eax
    34f1:	c7 44 24 04 9e 4f 00 	movl   $0x4f9e,0x4(%esp)
    34f8:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    352a:	a1 04 62 00 00       	mov    0x6204,%eax
    352f:	c7 44 24 04 2e 50 00 	movl   $0x502e,0x4(%esp)
    3536:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3574:	c7 04 24 3d 50 00 00 	movl   $0x503d,(%esp)
  ...
  printf(stdout, "validate ok\n");
    3593:	a1 04 62 00 00       	mov    0x6204,%eax
    3598:	c7 44 24 04 61 50 00 	movl   $0x5061,0x4(%esp)
    359f:	00 
    ...
    if(link("nosuchfile", (char*)p) != -1){
      printf(stdout, "link should not succeed\n");
    35af:	a1 04 62 00 00       	mov    0x6204,%eax
    35b4:	c7 44 24 04 48 50 00 	movl   $0x5048,0x4(%esp)
    35bb:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    35d6:	a1 04 62 00 00       	mov    0x6204,%eax
    35db:	c7 44 24 04 6e 50 00 	movl   $0x506e,0x4(%esp)
    35e2:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3613:	a1 04 62 00 00       	mov    0x6204,%eax
    3618:	c7 44 24 04 89 50 00 	movl   $0x5089,0x4(%esp)
    361f:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
      printf(stdout, "bss test failed\n");
    362a:	a1 04 62 00 00       	mov    0x6204,%eax
    362f:	c7 44 24 04 78 50 00 	movl   $0x5078,0x4(%esp)
    3636:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3656:	c7 04 24 96 50 00 00 	movl   $0x5096,(%esp)
  ...
  fd = open("bigarg-ok", 0);
    ...
    3682:	00 
    3683:	c7 04 24 96 50 00 00 	movl   $0x5096,(%esp)
  ...
  unlink("bigarg-ok");
    369f:	c7 04 24 96 50 00 00 	movl   $0x5096,(%esp)
  ...
  if(pid == 0){
    ...
    36b0:	c7 04 85 20 62 00 00 	movl   $0x57f0,0x6220(,%eax,4)
    36b7:	f0 57 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    36c3:	a1 04 62 00 00       	mov    0x6204,%eax
    36c8:	c7 44 24 04 a0 50 00 	movl   $0x50a0,0x4(%esp)
    36cf:	00 
  if(pid == 0){
    static char *args[MAXARG];
    int i;
    ...
    36e9:	00 
    36ea:	c7 04 24 6d 42 00 00 	movl   $0x426d,(%esp)
    36f1:	e8 e4 05 00 00       	call   3cda <exec>
    printf(stdout, "bigarg test ok\n");
    36f6:	a1 04 62 00 00       	mov    0x6204,%eax
    36fb:	c7 44 24 04 ad 50 00 	movl   $0x50ad,0x4(%esp)
    3702:	00 
    ...
    3712:	00 
    3713:	c7 04 24 96 50 00 00 	movl   $0x5096,(%esp)
  ...
  if(fd < 0){
    printf(stdout, "bigarg test failed!\n");
    372c:	a1 04 62 00 00       	mov    0x6204,%eax
    3731:	c7 44 24 04 d6 50 00 	movl   $0x50d6,0x4(%esp)
    3738:	00 
    ...
    printf(stdout, "bigargtest: fork failed\n");
    3746:	a1 04 62 00 00       	mov    0x6204,%eax
    374b:	c7 44 24 04 bd 50 00 	movl   $0x50bd,0x4(%esp)
    3752:	00 
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    376b:	c7 44 24 04 eb 50 00 	movl   $0x50eb,0x4(%esp)
    3772:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    name[5] = '\0';
    printf(1, "writing %s\n", name);
    3790:	c7 44 24 04 f8 50 00 	movl   $0x50f8,0x4(%esp)
    3797:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3865:	c7 44 24 04 14 51 00 	movl   $0x5114,0x4(%esp)
    386c:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3894:	c7 44 24 04 04 51 00 	movl   $0x5104,0x4(%esp)
    389b:	00 
  ...
  printf(1, "fsfull test finished\n");
    3941:	c7 44 24 04 24 51 00 	movl   $0x5124,0x4(%esp)
    3948:	00 
...
uio()
{
  ...
  printf(1, "uio test\n");
    3966:	c7 44 24 04 3a 51 00 	movl   $0x513a,0x4(%esp)
    396d:	00 
  ...
  printf(1, "uio test done\n");
    398a:	c7 44 24 04 44 51 00 	movl   $0x5144,0x4(%esp)
    3991:	00 
  ...
  if(pid == 0){
    ...
    39ad:	ec                   	in     (%dx),%al
    printf(1, "uio: uio succeeded; test FAILED\n");
    39ae:	c7 44 24 04 d0 58 00 	movl   $0x58d0,0x4(%esp)
    39b5:	00 
    ...
    printf (1, "fork failed\n");
    39c7:	c7 44 24 04 c9 50 00 	movl   $0x50c9,0x4(%esp)
    39ce:	00 
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    39ee:	00 
    39ef:	c7 04 24 53 51 00 00 	movl   $0x5153,(%esp)
...
void argptest()
{
  ...
  printf(1, "arg test passed\n");
    3a2c:	c7 44 24 04 65 51 00 	movl   $0x5165,0x4(%esp)
    3a33:	00 
...
void argptest()
{
  ...
  if (fd < 0) {
    printf(2, "open failed\n");
    3a46:	c7 44 24 04 58 51 00 	movl   $0x5158,0x4(%esp)
    3a4d:	00 
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    3a60:	69 05 00 62 00 00 0d 	imul   $0x19660d,0x6200,%eax
    3a67:	66 19 00 
}
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    ...
    3a73:	a3 00 62 00 00       	mov    %eax,0x6200
  return randstate;
}
    3a78:	c3                   	ret    
...
SYSCALL(recoverFS)
    ...
    3d6f:	cd 40                	int    $0x40
    3d71:	c3                   	ret    
    3d72:	66 90                	xchg   %ax,%ax
    3d74:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3db9:	0f b6 92 27 59 00 00 	movzbl 0x5927(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3e41:	e9 c2 00 00 00       	jmp    3f08 <printf+0xe8>
    3e46:	66 90                	xchg   %ax,%ax
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    3e48:	83 fa 25             	cmp    $0x25,%edx
    3e4b:	0f 84 bf 00 00 00    	je     3f10 <printf+0xf0>
#include "user.h"
...
{
  write(fd, &c, 1);
    3e51:	8d 45 e2             	lea    -0x1e(%ebp),%eax
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3e74:	0f 84 8e 00 00 00    	je     3f08 <printf+0xe8>
    c = fmt[i] & 0xff;
    if(state == 0){
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3e84:	75 e5                	jne    3e6b <printf+0x4b>
      if(c == 'd'){
    3e86:	83 fa 64             	cmp    $0x64,%edx
    3e89:	0f 84 31 01 00 00    	je     3fc0 <printf+0x1a0>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3e8f:	25 f7 00 00 00       	and    $0xf7,%eax
    3e94:	83 f8 70             	cmp    $0x70,%eax
    3e97:	0f 84 83 00 00 00    	je     3f20 <printf+0x100>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3e9d:	83 fa 73             	cmp    $0x73,%edx
    3ea0:	0f 84 a2 00 00 00    	je     3f48 <printf+0x128>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3ea6:	83 fa 63             	cmp    $0x63,%edx
    3ea9:	0f 84 35 01 00 00    	je     3fe4 <printf+0x1c4>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3eaf:	83 fa 25             	cmp    $0x25,%edx
    3eb2:	0f 84 e0 00 00 00    	je     3f98 <printf+0x178>
#include "user.h"
...
{
  write(fd, &c, 1);
    3eb8:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    3ebb:	83 c3 01             	add    $0x1,%ebx
    3ebe:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ec5:	00 
      } else {
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3ecc:	89 34 24             	mov    %esi,(%esp)
    3ecf:	89 55 d0             	mov    %edx,-0x30(%ebp)
    3ed2:	c6 45 e6 25          	movb   $0x25,-0x1a(%ebp)
    3ed6:	e8 e7 fd ff ff       	call   3cc2 <write>
      } else if(c == '%'){
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    3edb:	8b 55 d0             	mov    -0x30(%ebp),%edx
#include "user.h"
...
{
  write(fd, &c, 1);
    3ede:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3ee1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ee8:	00 
    3ee9:	89 44 24 04          	mov    %eax,0x4(%esp)
    3eed:	89 34 24             	mov    %esi,(%esp)
      } else if(c == '%'){
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
...
{
  write(fd, &c, 1);
    3ef3:	e8 ca fd ff ff       	call   3cc2 <write>
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3ef8:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
    3efc:	84 d2                	test   %dl,%dl
    3efe:	0f 85 76 ff ff ff    	jne    3e7a <printf+0x5a>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
      if(c == '%'){
        state = '%';
    3f10:	bf 25 00 00 00       	mov    $0x25,%edi
    3f15:	e9 51 ff ff ff       	jmp    3e6b <printf+0x4b>
    ...
    3f35:	e8 46 fe ff ff       	call   3d80 <printint>
        ap++;
    3f3a:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    3f3e:	e9 28 ff ff ff       	jmp    3e6b <printf+0x4b>
    3f43:	90                   	nop
    3f44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      } else if(c == 's'){
        s = (char*)*ap;
    3f48:	8b 45 d4             	mov    -0x2c(%ebp),%eax
        ap++;
    3f4b:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
        ...
        s = (char*)*ap;
    3f4f:	8b 38                	mov    (%eax),%edi
        ap++;
        if(s == 0)
          s = "(null)";
    3f51:	b8 20 59 00 00       	mov    $0x5920,%eax
    3f56:	85 ff                	test   %edi,%edi
    3f58:	0f 44 f8             	cmove  %eax,%edi
        while(*s != 0){
    3f5b:	0f b6 07             	movzbl (%edi),%eax
    3f5e:	84 c0                	test   %al,%al
    3f60:	74 2a                	je     3f8c <printf+0x16c>
    3f62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3f68:	88 45 e3             	mov    %al,-0x1d(%ebp)
#include "user.h"
...
{
  write(fd, &c, 1);
    3f6b:	8d 45 e3             	lea    -0x1d(%ebp),%eax
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3f78:	00 
    3f79:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f7d:	89 34 24             	mov    %esi,(%esp)
    3f80:	e8 3d fd ff ff       	call   3cc2 <write>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    3f85:	0f b6 07             	movzbl (%edi),%eax
    3f88:	84 c0                	test   %al,%al
    3f8a:	75 dc                	jne    3f68 <printf+0x148>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
      ...
      state = 0;
    3f8c:	31 ff                	xor    %edi,%edi
    3f8e:	e9 d8 fe ff ff       	jmp    3e6b <printf+0x4b>
    3f93:	90                   	nop
...
{
  write(fd, &c, 1);
    3f98:	8d 45 e5             	lea    -0x1b(%ebp),%eax
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
...
{
  write(fd, &c, 1);
    3f9d:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3fa4:	00 
    3fa5:	89 44 24 04          	mov    %eax,0x4(%esp)
    3fa9:	89 34 24             	mov    %esi,(%esp)
    3fac:	c6 45 e5 25          	movb   $0x25,-0x1b(%ebp)
    3fb0:	e8 0d fd ff ff       	call   3cc2 <write>
    3fb5:	e9 b1 fe ff ff       	jmp    3e6b <printf+0x4b>
    ...
    3fd6:	e8 a5 fd ff ff       	call   3d80 <printint>
        ap++;
    3fdb:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    3fdf:	e9 87 fe ff ff       	jmp    3e6b <printf+0x4b>
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
        ...
        putc(fd, *ap);
    3fe4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
...
{
  write(fd, &c, 1);
    3feb:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ff2:	00 
    3ff3:	89 34 24             	mov    %esi,(%esp)
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
...
{
  write(fd, &c, 1);
    3ff9:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    3ffc:	89 44 24 04          	mov    %eax,0x4(%esp)
    4000:	e8 bd fc ff ff       	call   3cc2 <write>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
        putc(fd, *ap);
        ap++;
    4005:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    4009:	e9 5d fe ff ff       	jmp    3e6b <printf+0x4b>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4011:	a1 a0 62 00 00       	mov    0x62a0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    4020:	8d 53 f8             	lea    -0x8(%ebx),%edx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4023:	39 d0                	cmp    %edx,%eax
    4025:	72 11                	jb     4038 <free+0x28>
    4027:	90                   	nop
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4028:	39 c8                	cmp    %ecx,%eax
    402a:	72 04                	jb     4030 <free+0x20>
    402c:	39 ca                	cmp    %ecx,%edx
    402e:	72 10                	jb     4040 <free+0x30>
    4030:	89 c8                	mov    %ecx,%eax
free(void *ap)
{
  Header *bp, *p;
  ...
  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4032:	39 d0                	cmp    %edx,%eax
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4034:	8b 08                	mov    (%eax),%ecx
free(void *ap)
{
  Header *bp, *p;
  ...
  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4036:	73 f0                	jae    4028 <free+0x18>
    4038:	39 ca                	cmp    %ecx,%edx
    403a:	72 04                	jb     4040 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    403c:	39 c8                	cmp    %ecx,%eax
    403e:	72 f0                	jb     4030 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    4040:	8b 73 fc             	mov    -0x4(%ebx),%esi
    4043:	8d 3c f2             	lea    (%edx,%esi,8),%edi
    4046:	39 cf                	cmp    %ecx,%edi
    4048:	74 1e                	je     4068 <free+0x58>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    404a:	89 4b f8             	mov    %ecx,-0x8(%ebx)
  if(p + p->s.size == bp){
    404d:	8b 48 04             	mov    0x4(%eax),%ecx
    4050:	8d 34 c8             	lea    (%eax,%ecx,8),%esi
    4053:	39 f2                	cmp    %esi,%edx
    4055:	74 28                	je     407f <free+0x6f>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  ...
  freep = p;
    4059:	a3 a0 62 00 00       	mov    %eax,0x62a0
}
    405e:	5b                   	pop    %ebx
    405f:	5e                   	pop    %esi
    4060:	5f                   	pop    %edi
  ...
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    4068:	03 71 04             	add    0x4(%ecx),%esi
    406b:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    406e:	8b 08                	mov    (%eax),%ecx
    4070:	8b 09                	mov    (%ecx),%ecx
    4072:	89 4b f8             	mov    %ecx,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    4075:	8b 48 04             	mov    0x4(%eax),%ecx
    4078:	8d 34 c8             	lea    (%eax,%ecx,8),%esi
    407b:	39 f2                	cmp    %esi,%edx
    407d:	75 d8                	jne    4057 <free+0x47>
    p->s.size += bp->s.size;
    407f:	03 4b fc             	add    -0x4(%ebx),%ecx
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  freep = p;
    4082:	a3 a0 62 00 00       	mov    %eax,0x62a0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    4087:	89 48 04             	mov    %ecx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    408a:	8b 53 f8             	mov    -0x8(%ebx),%edx
    408d:	89 10                	mov    %edx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
}
    ...
    4092:	5d                   	pop    %ebp
    4093:	c3                   	ret    
    4094:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    409a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40ac:	8b 1d a0 62 00 00    	mov    0x62a0,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    40b2:	8d 48 07             	lea    0x7(%eax),%ecx
    40b5:	c1 e9 03             	shr    $0x3,%ecx
  if((prevp = freep) == 0){
    40b8:	85 db                	test   %ebx,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    40ba:	8d 71 01             	lea    0x1(%ecx),%esi
  if((prevp = freep) == 0){
    40bd:	0f 84 9b 00 00 00    	je     415e <malloc+0xbe>
    40c3:	8b 13                	mov    (%ebx),%edx
    40c5:	8b 7a 04             	mov    0x4(%edx),%edi
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    40c8:	39 fe                	cmp    %edi,%esi
    40ca:	76 64                	jbe    4130 <malloc+0x90>
    40cc:	8d 04 f5 00 00 00 00 	lea    0x0(,%esi,8),%eax
morecore(uint nu)
{
  char *p;
  Header *hp;
  ...
  if(nu < 4096)
    40d3:	bb 00 80 00 00       	mov    $0x8000,%ebx
    40d8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    40db:	eb 0e                	jmp    40eb <malloc+0x4b>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    40e0:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    40e2:	8b 78 04             	mov    0x4(%eax),%edi
    40e5:	39 fe                	cmp    %edi,%esi
    40e7:	76 4f                	jbe    4138 <malloc+0x98>
    40e9:	89 c2                	mov    %eax,%edx
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    40eb:	3b 15 a0 62 00 00    	cmp    0x62a0,%edx
    40f1:	75 ed                	jne    40e0 <malloc+0x40>
morecore(uint nu)
{
  char *p;
  Header *hp;
  ...
  if(nu < 4096)
    40f3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    40f6:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    40fc:	bf 00 10 00 00       	mov    $0x1000,%edi
    4101:	0f 43 fe             	cmovae %esi,%edi
    4104:	0f 42 c3             	cmovb  %ebx,%eax
    nu = 4096;
  p = sbrk(nu * sizeof(Header));
    4107:	89 04 24             	mov    %eax,(%esp)
    410a:	e8 1b fc ff ff       	call   3d2a <sbrk>
  if(p == (char*)-1)
    410f:	83 f8 ff             	cmp    $0xffffffff,%eax
    4112:	74 18                	je     412c <malloc+0x8c>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    4114:	89 78 04             	mov    %edi,0x4(%eax)
  free((void*)(hp + 1));
    4117:	83 c0 08             	add    $0x8,%eax
    411a:	89 04 24             	mov    %eax,(%esp)
    411d:	e8 ee fe ff ff       	call   4010 <free>
  return freep;
    4122:	8b 15 a0 62 00 00    	mov    0x62a0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
    ...
    4128:	85 d2                	test   %edx,%edx
    412a:	75 b4                	jne    40e0 <malloc+0x40>
        return 0;
    412c:	31 c0                	xor    %eax,%eax
    412e:	eb 20                	jmp    4150 <malloc+0xb0>
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    4130:	89 d0                	mov    %edx,%eax
    4132:	89 da                	mov    %ebx,%edx
    4134:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    4138:	39 fe                	cmp    %edi,%esi
    413a:	74 1c                	je     4158 <malloc+0xb8>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    413c:	29 f7                	sub    %esi,%edi
    413e:	89 78 04             	mov    %edi,0x4(%eax)
        p += p->s.size;
    4141:	8d 04 f8             	lea    (%eax,%edi,8),%eax
        p->s.size = nunits;
    4144:	89 70 04             	mov    %esi,0x4(%eax)
      }
      freep = prevp;
    4147:	89 15 a0 62 00 00    	mov    %edx,0x62a0
      return (void*)(p + 1);
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
        prevp->s.ptr = p->s.ptr;
    4158:	8b 08                	mov    (%eax),%ecx
    415a:	89 0a                	mov    %ecx,(%edx)
    415c:	eb e9                	jmp    4147 <malloc+0xa7>
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    415e:	c7 05 a0 62 00 00 a4 	movl   $0x62a4,0x62a0
    4165:	62 00 00 
    base.s.size = 0;
    4168:	ba a4 62 00 00       	mov    $0x62a4,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    416d:	c7 05 a4 62 00 00 a4 	movl   $0x62a4,0x62a4
    4174:	62 00 00 
    base.s.size = 0;
    4177:	c7 05 a8 62 00 00 00 	movl   $0x0,0x62a8
    417e:	00 00 00 
    4181:	e9 46 ff ff ff       	jmp    40cc <malloc+0x2c>
