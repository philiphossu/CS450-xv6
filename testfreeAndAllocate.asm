...
int main(int argc, char **argv){
   ...
   7:	83 ec 10             	sub    $0x10,%esp
	// Part 1
	printf(1,"Begin Test\n");
   a:	c7 44 24 04 18 08 00 	movl   $0x818,0x4(%esp)
  11:	00 
  12:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  19:	e8 92 04 00 00       	call   4b0 <printf>
	myMemory();
  1e:	e8 df 03 00 00       	call   402 <myMemory>
	printf(1,"sbrk'ing 8192 (2 pages)\n");
  23:	c7 44 24 04 24 08 00 	movl   $0x824,0x4(%esp)
  2a:	00 
  ...
  43:	e8 ba 03 00 00       	call   402 <myMemory>
	printf(1,"sbrk'ing -8192 (2 pages)\n");
  48:	c7 44 24 04 3d 08 00 	movl   $0x83d,0x4(%esp)
  4f:	00 
  ...
  6d:	c7 44 24 04 58 08 00 	movl   $0x858,0x4(%esp)
  74:	00 
  ...
  88:	e8 a3 06 00 00       	call   730 <malloc>
  ...
  94:	c7 44 24 04 80 08 00 	movl   $0x880,0x4(%esp)
  9b:	00 
  9c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  a3:	e8 08 04 00 00       	call   4b0 <printf>
    free(arrayPointer);
  a8:	89 1c 24             	mov    %ebx,(%esp)
  ab:	e8 f0 05 00 00       	call   6a0 <free>
    myMemory();
  b0:	e8 4d 03 00 00       	call   402 <myMemory>
    printf(1,"Force sbrk to reduce # of pages\n");
  b5:	c7 44 24 04 b4 08 00 	movl   $0x8b4,0x4(%esp)
  bc:	00 
  bd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c4:	e8 e7 03 00 00       	call   4b0 <printf>
    sbrk(-49152);
  ...
  da:	c7 44 24 04 d8 08 00 	movl   $0x8d8,0x4(%esp)
  e1:	00 
  e2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e9:	e8 c2 03 00 00       	call   4b0 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 449:	0f b6 92 1b 09 00 00 	movzbl 0x91b(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5df:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 5e1:	b8 14 09 00 00       	mov    $0x914,%eax
...
free(void *ap)
{
 ...
 6a1:	a1 90 0b 00 00       	mov    0xb90,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6e7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6e9:	a3 90 0b 00 00       	mov    %eax,0xb90
}
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 ...
 70f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 712:	a3 90 0b 00 00       	mov    %eax,0xb90
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 1d 90 0b 00 00    	mov    0xb90,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 779:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 77b:	3b 15 90 0b 00 00    	cmp    0xb90,%edx
...
morecore(uint nu)
{
 ...
 7ad:	e8 ee fe ff ff       	call   6a0 <free>
  return freep;
 7b2:	8b 15 90 0b 00 00    	mov    0xb90,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7d4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 7d7:	89 15 90 0b 00 00    	mov    %edx,0xb90
      return (void*)(p + 1);
 ...
 7ec:	eb e9                	jmp    7d7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7ee:	c7 05 90 0b 00 00 94 	movl   $0xb94,0xb90
 7f5:	0b 00 00 
    base.s.size = 0;
 7f8:	ba 94 0b 00 00       	mov    $0xb94,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7fd:	c7 05 94 0b 00 00 94 	movl   $0xb94,0xb94
 804:	0b 00 00 
    base.s.size = 0;
 807:	c7 05 98 0b 00 00 00 	movl   $0x0,0xb98
 80e:	00 00 00 
