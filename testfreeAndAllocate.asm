...
int main(int argc, char **argv){
   ...
   7:	83 ec 10             	sub    $0x10,%esp
	// Part 1
	printf(1,"Begin Test\n");
   a:	c7 44 24 04 28 08 00 	movl   $0x828,0x4(%esp)
  11:	00 
  ...
  23:	c7 44 24 04 34 08 00 	movl   $0x834,0x4(%esp)
  2a:	00 
  ...
  43:	e8 ba 03 00 00       	call   402 <myMemory>
	printf(1,"sbrk'ing -8192 (2 pages)\n");
  48:	c7 44 24 04 4d 08 00 	movl   $0x84d,0x4(%esp)
  4f:	00 
  ...
  6d:	c7 44 24 04 68 08 00 	movl   $0x868,0x4(%esp)
  74:	00 
  ...
  88:	e8 b3 06 00 00       	call   740 <malloc>
  ...
  c4:	e8 f7 03 00 00       	call   4c0 <printf>
    sbrk(-49152);
  ...
  da:	c7 44 24 04 e8 08 00 	movl   $0x8e8,0x4(%esp)
  e1:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 459:	0f b6 92 2b 09 00 00 	movzbl 0x92b(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5ef:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 5f1:	b8 24 09 00 00       	mov    $0x924,%eax
...
free(void *ap)
{
 ...
 6f7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6f9:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 1d a0 0b 00 00    	mov    0xba0,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 789:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 78b:	3b 15 a0 0b 00 00    	cmp    0xba0,%edx
...
morecore(uint nu)
{
 ...
 7bd:	e8 ee fe ff ff       	call   6b0 <free>
  return freep;
 7c2:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7fc:	eb e9                	jmp    7e7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7fe:	c7 05 a0 0b 00 00 a4 	movl   $0xba4,0xba0
 805:	0b 00 00 
    base.s.size = 0;
 808:	ba a4 0b 00 00       	mov    $0xba4,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 80d:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 814:	0b 00 00 
    base.s.size = 0;
 817:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 81e:	00 00 00 
