...
int main(int argc, char **argv) {
   ...
   9:	c7 44 24 04 68 07 00 	movl   $0x768,0x4(%esp)
  10:	00 
  11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  18:	e8 e3 03 00 00       	call   400 <printf>
	inodeTBWalker();
  1d:	e8 08 03 00 00       	call   32a <inodeTBWalker>
	printf(1,"\n\n");
  22:	c7 44 24 04 b4 07 00 	movl   $0x7b4,0x4(%esp)
  29:	00 
  2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  31:	e8 ca 03 00 00       	call   400 <printf>
	printf(1,"\n= = = Calling directory walker = = =\n");
  36:	c7 44 24 04 8c 07 00 	movl   $0x78c,0x4(%esp)
  3d:	00 
  3e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  45:	e8 b6 03 00 00       	call   400 <printf>
	directoryWalker(".");
  4a:	c7 04 24 b7 07 00 00 	movl   $0x7b7,(%esp)
  51:	e8 e4 02 00 00       	call   33a <directoryWalker>
...
putc(int fd, char c)
{
 ...
 52f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 531:	b8 b9 07 00 00       	mov    $0x7b9,%eax
