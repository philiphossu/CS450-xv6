...
8010004c:	c7 44 24 04 20 76 10 	movl   $0x80107620,0x4(%esp)
80100053:	80 
...
80100094:	c7 44 24 04 27 76 10 	movl   $0x80107627,0x4(%esp)
8010009b:	80 
...
80100188:	c7 04 24 2e 76 10 80 	movl   $0x8010762e,(%esp)
...
bwrite(struct buf *b)
{
  if(!holdingsleep(&b->lock))
    panic("bwrite");
801001c9:	c7 04 24 3f 76 10 80 	movl   $0x8010763f,(%esp)
...
brelse(struct buf *b)
{
  if(!holdingsleep(&b->lock))
    panic("brelse");
80100255:	c7 04 24 46 76 10 80 	movl   $0x80107646,(%esp)
...
8010037e:	c7 04 24 4d 76 10 80 	movl   $0x8010764d,(%esp)
...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 02 7e 10 80 	movl   $0x80107e02,(%esp)
...
801003bd:	c7 04 24 61 76 10 80 	movl   $0x80107661,(%esp)
...
80100409:	e8 72 5d 00 00       	call   80106180 <uartputc>
}
...
801004b9:	e8 c2 5c 00 00       	call   80106180 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 b6 5c 00 00       	call   80106180 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 aa 5c 00 00       	call   80106180 <uartputc>
...
80100525:	e9 59 ff ff ff       	jmp    80100483 <consputc+0xa3>
  ...
  if(pos < 0 || pos > 25*80)
    panic("pos under/overflow");
8010052a:	c7 04 24 65 76 10 80 	movl   $0x80107665,(%esp)
...
80100599:	0f b6 92 90 76 10 80 	movzbl -0x7fef8970(%edx),%edx
  }while((x /= base) != 0);
...
8010075d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        s = "(null)";
80100760:	b8 78 76 10 80       	mov    $0x80107678,%eax
...
8010079c:	e9 c8 fe ff ff       	jmp    80100669 <cprintf+0x19>
  ...
  if (fmt == 0)
    panic("null fmt");
801007a1:	c7 04 24 7f 76 10 80 	movl   $0x8010767f,(%esp)
...
80100956:	c7 44 24 04 88 76 10 	movl   $0x80107688,0x4(%esp)
8010095d:	80 
...
80100a2a:	75 d4                	jne    80100a00 <exec+0x60>
  ...
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 3f 69 00 00       	call   80107370 <setupkvm>
...
80100ad2:	e8 09 67 00 00       	call   801071e0 <allocuvm>
...
80100b13:	e8 08 66 00 00       	call   80107120 <loaduvm>
...
80100b29:	e8 c2 67 00 00       	call   801072f0 <freevm>
...
80100b6c:	e8 6f 66 00 00       	call   801071e0 <allocuvm>
...
80100b84:	e8 67 67 00 00       	call   801072f0 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100b93:	e8 68 20 00 00       	call   80102c00 <end_op>
    cprintf("exec: fail\n");
80100b98:	c7 04 24 a1 76 10 80 	movl   $0x801076a1,(%esp)
...
80100bc8:	e8 53 68 00 00       	call   80107420 <clearpteu>
  sp = sz;
...
80100c31:	e8 4a 69 00 00       	call   80107580 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 d7 68 00 00       	call   80107580 <copyout>
...
80100d1f:	e8 6c 62 00 00       	call   80106f90 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 c4 65 00 00       	call   801072f0 <freevm>
  return 0;
...
80100d56:	c7 44 24 04 ad 76 10 	movl   $0x801076ad,0x4(%esp)
80100d5d:	80 
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100e17:	c7 04 24 b4 76 10 80 	movl   $0x801076b4,(%esp)
...
80100ed7:	e9 24 1d 00 00       	jmp    80102c00 <end_op>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100edc:	c7 04 24 bc 76 10 80 	movl   $0x801076bc,(%esp)
...
80100fc5:	eb d8                	jmp    80100f9f <fileread+0x5f>
  ...
  panic("fileread");
80100fc7:	c7 04 24 c6 76 10 80 	movl   $0x801076c6,(%esp)
...
801010dc:	e9 8f 22 00 00       	jmp    80103370 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
801010e1:	c7 04 24 cf 76 10 80 	movl   $0x801076cf,(%esp)
801010e8:	e8 73 f2 ff ff       	call   80100360 <panic>
  ...
  panic("filewrite");
801010ed:	c7 04 24 d5 76 10 80 	movl   $0x801076d5,(%esp)
...
801011ac:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801011ad:	c7 04 24 df 76 10 80 	movl   $0x801076df,(%esp)
...
80101265:	c7 04 24 ef 76 10 80 	movl   $0x801076ef,(%esp)
...
80101385:	eb 93                	jmp    8010131a <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101387:	c7 04 24 05 77 10 80 	movl   $0x80107705,(%esp)
...
80101488:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101489:	c7 04 24 18 77 10 80 	movl   $0x80107718,(%esp)
...
801014ac:	c7 44 24 04 2b 77 10 	movl   $0x8010772b,0x4(%esp)
801014b3:	80 
...
801014c9:	c7 44 24 04 32 77 10 	movl   $0x80107732,0x4(%esp)
801014d0:	80 
...
801014f6:	c7 04 24 98 77 10 80 	movl   $0x80107798,(%esp)
...
8010160c:	e9 ef fa ff ff       	jmp    80101100 <iget>
  ...
  panic("ialloc: no inodes");
80101611:	c7 04 24 38 77 10 80 	movl   $0x80107738,(%esp)
...
80101794:	0f 85 76 ff ff ff    	jne    80101710 <ilock+0x30>
      panic("ilock: no type");
8010179a:	c7 04 24 50 77 10 80 	movl   $0x80107750,(%esp)
801017a1:	e8 ba eb ff ff       	call   80100360 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
801017a6:	c7 04 24 4a 77 10 80 	movl   $0x8010774a,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801017f3:	c7 04 24 5f 77 10 80 	movl   $0x8010775f,(%esp)
...
80101ce1:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
80101ce2:	c7 04 24 79 77 10 80 	movl   $0x80107779,(%esp)
80101ce9:	e8 72 e6 ff ff       	call   80100360 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101cee:	c7 04 24 67 77 10 80 	movl   $0x80107767,(%esp)
...
80101f63:	eb e9                	jmp    80101f4e <dirlink+0xae>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101f65:	c7 04 24 88 77 10 80 	movl   $0x80107788,(%esp)
80101f6c:	e8 ef e3 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101f71:	c7 04 24 96 7d 10 80 	movl   $0x80107d96,(%esp)
...
8010205f:	c7 04 24 f4 77 10 80 	movl   $0x801077f4,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
8010206b:	c7 04 24 eb 77 10 80 	movl   $0x801077eb,(%esp)
...
80102086:	c7 44 24 04 06 78 10 	movl   $0x80107806,0x4(%esp)
8010208d:	80 
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
8010225b:	c7 04 24 0a 78 10 80 	movl   $0x8010780a,(%esp)
80102262:	e8 f9 e0 ff ff       	call   80100360 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
80102267:	c7 04 24 35 78 10 80 	movl   $0x80107835,(%esp)
8010226e:	e8 ed e0 ff ff       	call   80100360 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
80102273:	c7 04 24 20 78 10 80 	movl   $0x80107820,(%esp)
...
801022c8:	c7 04 24 54 78 10 80 	movl   $0x80107854,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
801023fe:	c7 04 24 86 78 10 80 	movl   $0x80107886,(%esp)
...
8010246b:	c7 44 24 04 8c 78 10 	movl   $0x8010788c,0x4(%esp)
80102472:	80 
...
801025b4:	0f b6 81 c0 79 10 80 	movzbl -0x7fef8640(%ecx),%eax
...
801025e8:	0f b6 91 c0 79 10 80 	movzbl -0x7fef8640(%ecx),%edx
  shift ^= togglecode[data];
801025ef:	0f b6 81 c0 78 10 80 	movzbl -0x7fef8740(%ecx),%eax
    // Last character was an E0 escape; or with 0x80
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
801025ff:	8b 04 85 a0 78 10 80 	mov    -0x7fef8760(,%eax,4),%eax
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
80102afb:	c7 44 24 04 c0 7a 10 	movl   $0x80107ac0,0x4(%esp)
80102b02:	80 
...
80102d22:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102d23:	c7 04 24 c4 7a 10 80 	movl   $0x80107ac4,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102de0:	c7 04 24 d3 7a 10 80 	movl   $0x80107ad3,(%esp)
80102de7:	e8 74 d5 ff ff       	call   80100360 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102dec:	c7 04 24 e9 7a 10 80 	movl   $0x80107ae9,(%esp)
...
80102e17:	c7 04 24 04 7b 10 80 	movl   $0x80107b04,(%esp)
80102e1e:	89 44 24 04          	mov    %eax,0x4(%esp)
80102e22:	e8 29 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102e27:	e8 84 30 00 00       	call   80105eb0 <idtinit>
...
80102e53:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e56:	e8 15 41 00 00       	call   80106f70 <switchkvm>
  seginit();
80102e5b:	e8 50 40 00 00       	call   80106eb0 <seginit>
  lapicinit();
...
80102e93:	e8 68 45 00 00       	call   80107400 <kvmalloc>
...
80102ea5:	e8 06 40 00 00       	call   80106eb0 <seginit>
  picinit();       // disable pic
...
80102eba:	e8 11 33 00 00       	call   801061d0 <uartinit>
80102ebf:	90                   	nop
  pinit();         // process table
80102ec0:	e8 9b 07 00 00       	call   80103660 <pinit>
  tvinit();        // trap vectors
80102ec5:	e8 46 2f 00 00       	call   80105e10 <tvinit>
  binit();         // buffer cache
...
80102fbf:	00 
80102fc0:	c7 44 24 04 18 7b 10 	movl   $0x80107b18,0x4(%esp)
80102fc7:	80 
...
8010307a:	00 
8010307b:	c7 44 24 04 1d 7b 10 	movl   $0x80107b1d,0x4(%esp)
80103082:	80 
...
8010310c:	ff 24 8d 5c 7b 10 80 	jmp    *-0x7fef84a4(,%ecx,4)
80103113:	90                   	nop
...
80103197:	0f 85 c5 fe ff ff    	jne    80103062 <mpinit+0x52>
  ...
  if((conf = mpconfig(&mp)) == 0)
    panic("Expect to run on an SMP");
8010319d:	c7 04 24 22 7b 10 80 	movl   $0x80107b22,(%esp)
...
801031b8:	eb e3                	jmp    8010319d <mpinit+0x18d>
  ...
  if(!ismp)
    panic("Didn't find a suitable machine");
801031ba:	c7 04 24 3c 7b 10 80 	movl   $0x80107b3c,(%esp)
...
8010325f:	c7 44 24 04 70 7b 10 	movl   $0x80107b70,0x4(%esp)
80103266:	80 
...
801035ad:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801035b0:	c7 40 14 05 5e 10 80 	movl   $0x80105e05,0x14(%eax)
...
80103666:	c7 44 24 04 75 7b 10 	movl   $0x80107b75,0x4(%esp)
8010366d:	80 
...
801036d8:	eb ea                	jmp    801036c4 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
801036da:	c7 04 24 7c 7b 10 80 	movl   $0x80107b7c,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
801036e6:	c7 04 24 58 7c 10 80 	movl   $0x80107c58,(%esp)
...
80103763:	e8 08 3c 00 00       	call   80107370 <setupkvm>
...
80103785:	80 
80103786:	e8 15 39 00 00       	call   801070a0 <inituvm>
  p->sz = PGSIZE;
...
80103802:	00 
80103803:	c7 44 24 04 a5 7b 10 	movl   $0x80107ba5,0x4(%esp)
8010380a:	80 
8010380b:	89 04 24             	mov    %eax,(%esp)
8010380e:	e8 cd 0c 00 00       	call   801044e0 <safestrcpy>
  p->cwd = namei("/");
80103813:	c7 04 24 ae 7b 10 80 	movl   $0x80107bae,(%esp)
...
80103846:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
80103847:	c7 04 24 8c 7b 10 80 	movl   $0x80107b8c,(%esp)
...
80103889:	e8 52 39 00 00       	call   801071e0 <allocuvm>
...
80103897:	e8 f4 36 00 00       	call   80106f90 <switchuvm>
  return 0;
...
801038ba:	e8 11 3a 00 00       	call   801072d0 <deallocuvm>
...
801038fe:	e8 4d 3b 00 00       	call   80107450 <copyuvm>
...
80103a32:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a35:	e8 56 35 00 00       	call   80106f90 <switchuvm>
      p->state = RUNNING;
...
80103a4b:	e8 eb 0a 00 00       	call   8010453b <swtch>
      switchkvm();
80103a50:	e8 1b 35 00 00       	call   80106f70 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103aed:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103aee:	c7 04 24 b0 7b 10 80 	movl   $0x80107bb0,(%esp)
80103af5:	e8 66 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103afa:	c7 04 24 dc 7b 10 80 	movl   $0x80107bdc,(%esp)
80103b01:	e8 5a c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103b06:	c7 04 24 ce 7b 10 80 	movl   $0x80107bce,(%esp)
80103b0d:	e8 4e c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103b12:	c7 04 24 c2 7b 10 80 	movl   $0x80107bc2,(%esp)
...
80103c16:	e8 65 fe ff ff       	call   80103a80 <sched>
  panic("zombie exit");
80103c1b:	c7 04 24 fd 7b 10 80 	movl   $0x80107bfd,(%esp)
80103c22:	e8 39 c7 ff ff       	call   80100360 <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103c27:	c7 04 24 f0 7b 10 80 	movl   $0x80107bf0,(%esp)
...
80103d0e:	c7 04 24 0f 7c 10 80 	movl   $0x80107c0f,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103d1a:	c7 04 24 09 7c 10 80 	movl   $0x80107c09,(%esp)
...
80103db8:	e8 33 35 00 00       	call   801072f0 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103f04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f08:	c7 04 24 02 7e 10 80 	movl   $0x80107e02,(%esp)
...
80103f2a:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103f2d:	ba 20 7c 10 80       	mov    $0x80107c20,%edx
  uint pc[10];
...
80103f34:	8b 14 85 80 7c 10 80 	mov    -0x7fef8380(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103f3b:	b8 20 7c 10 80       	mov    $0x80107c20,%eax
...
80103f50:	c7 04 24 24 7c 10 80 	movl   $0x80107c24,(%esp)
...
80103f99:	c7 04 24 61 76 10 80 	movl   $0x80107661,(%esp)
...
80103fca:	c7 44 24 04 98 7c 10 	movl   $0x80107c98,0x4(%esp)
80103fd1:	80 
...
80104227:	eb ac                	jmp    801041d5 <acquire+0x15>
    panic("acquire");
80104229:	c7 04 24 a3 7c 10 80 	movl   $0x80107ca3,(%esp)
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010428a:	c7 04 24 c2 7c 10 80 	movl   $0x80107cc2,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104296:	c7 04 24 ab 7c 10 80 	movl   $0x80107cab,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
801042c1:	c7 04 24 c9 7c 10 80 	movl   $0x80107cc9,(%esp)
...
801046dd:	8b 14 85 00 7d 10 80 	mov    -0x7fef8300(,%eax,4),%edx
...
80104706:	c7 04 24 d1 7c 10 80 	movl   $0x80107cd1,(%esp)
...
80104890:	c7 44 24 04 8c 7d 10 	movl   $0x80107d8c,0x4(%esp)
80104897:	80 
...
801048ab:	c7 44 24 04 8b 7d 10 	movl   $0x80107d8b,0x4(%esp)
801048b2:	80 
...
801048c1:	79 89                	jns    8010484c <create+0xdc>
			panic("create dots");
801048c3:	c7 04 24 7f 7d 10 80 	movl   $0x80107d7f,(%esp)
801048ca:	e8 91 ba ff ff       	call   80100360 <panic>
	}

	if(dirlink(dp, name, ip->inum) < 0)
		panic("create: dirlink");
801048cf:	c7 04 24 8e 7d 10 80 	movl   $0x80107d8e,(%esp)
801048d6:	e8 85 ba ff ff       	call   80100360 <panic>
	...
	if((ip = ialloc(dp->dev, type)) == 0)
		panic("create: ialloc");
801048db:	c7 04 24 70 7d 10 80 	movl   $0x80107d70,(%esp)
...
8010498d:	c7 44 24 04 8c 7d 10 	movl   $0x80107d8c,0x4(%esp)
80104994:	80 
...
801049a4:	c7 44 24 04 8b 7d 10 	movl   $0x80107d8b,0x4(%esp)
801049ab:	80 
...
80104a9f:	ba 9e 7d 10 80       	mov    $0x80107d9e,%edx
...
80104b86:	c7 04 24 a3 7d 10 80 	movl   $0x80107da3,(%esp)
...
80104bc6:	74 14                	je     80104bdc <sys_recoverFS+0x7c>
			cprintf("FIXING A PROBLEM\n");
80104bc8:	c7 04 24 a3 7d 10 80 	movl   $0x80107da3,(%esp)
...
80104d06:	83 ec 3c             	sub    $0x3c,%esp
...
80104d16:	89 c3                	mov    %eax,%ebx
	if(!ip){
80104d18:	0f 84 99 02 00 00    	je     80104fb7 <directoryWalkerSubRoutine+0x2b7>
...
80104d26:	e8 b5 c9 ff ff       	call   801016e0 <ilock>
	if(ip->type == T_DIR){
80104d2b:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104d30:	0f 85 2a 02 00 00    	jne    80104f60 <directoryWalkerSubRoutine+0x260>
		// The specified path is a directory, go through its directory entries
		for(off = 0; off < ip->size; off += sizeof(de)){
80104d36:	8b 4b 58             	mov    0x58(%ebx),%ecx
80104d39:	85 c9                	test   %ecx,%ecx
80104d3b:	0f 84 1f 02 00 00    	je     80104f60 <directoryWalkerSubRoutine+0x260>
...
80104d4b:	39 73 58             	cmp    %esi,0x58(%ebx)
80104d4e:	0f 86 0c 02 00 00    	jbe    80104f60 <directoryWalkerSubRoutine+0x260>
...
80104d67:	89 1c 24             	mov    %ebx,(%esp)
80104d6a:	e8 71 cc ff ff       	call   801019e0 <readi>
80104d6f:	83 f8 10             	cmp    $0x10,%eax
80104d72:	0f 85 33 02 00 00    	jne    80104fab <directoryWalkerSubRoutine+0x2ab>
				// Reading was not successful
				panic("dirlookup read");
			}
			if(off==0 && (strcmp(de.name,"."))){
80104d78:	85 f6                	test   %esi,%esi
80104d7a:	75 78                	jne    80104df4 <directoryWalkerSubRoutine+0xf4>
  *s1 = 0;
}
...
80104d82:	0f 84 f7 01 00 00    	je     80104f7f <directoryWalkerSubRoutine+0x27f>
80104d88:	0f b6 55 db          	movzbl -0x25(%ebp),%edx
80104d8c:	3c 2e                	cmp    $0x2e,%al
80104d8e:	b9 8d 7d 10 80       	mov    $0x80107d8d,%ecx
80104d93:	0f 45 d0             	cmovne %eax,%edx
80104d96:	b8 8c 7d 10 80       	mov    $0x80107d8c,%eax
...
80104da0:	74 52                	je     80104df4 <directoryWalkerSubRoutine+0xf4>
...
80104dd9:	0f 84 67 01 00 00    	je     80104f46 <directoryWalkerSubRoutine+0x246>
					ilock(ip);
					continue;
				}
				corruptDirs[ip->inum] = brokenDirParent->inum;
80104ddf:	8b 53 04             	mov    0x4(%ebx),%edx
...
80104de5:	89 1c 24             	mov    %ebx,(%esp)
				...
				corruptDirs[ip->inum] = brokenDirParent->inum;
80104de8:	89 04 95 60 5c 11 80 	mov    %eax,-0x7feea3a0(,%edx,4)
				ilock(ip);
80104def:	e8 ec c8 ff ff       	call   801016e0 <ilock>
			}

		    if(de.inum == 0){
80104df4:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
80104df8:	66 85 c0             	test   %ax,%ax
80104dfb:	0f 84 47 ff ff ff    	je     80104d48 <directoryWalkerSubRoutine+0x48>
		      continue;
		    }

			cprintf("Name: %s \t inode#: %d\n",de.name,de.inum);
80104e01:	89 44 24 08          	mov    %eax,0x8(%esp)
80104e05:	8d 45 da             	lea    -0x26(%ebp),%eax
80104e08:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e0c:	c7 04 24 c7 7d 10 80 	movl   $0x80107dc7,(%esp)
80104e13:	e8 38 b8 ff ff       	call   80100650 <cprintf>
  *s1 = 0;
}
...
{
  for (; *s1 && *s2 && *s1==*s2; s1++, s2++);
80104e18:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
80104e1c:	84 c0                	test   %al,%al
80104e1e:	0f 84 67 01 00 00    	je     80104f8b <directoryWalkerSubRoutine+0x28b>
80104e24:	3c 2e                	cmp    $0x2e,%al
80104e26:	0f 85 6b 01 00 00    	jne    80104f97 <directoryWalkerSubRoutine+0x297>
80104e2c:	80 7d db 00          	cmpb   $0x0,-0x25(%ebp)
		      continue;
		    }
...
80104e30:	b8 8b 7d 10 80       	mov    $0x80107d8b,%eax
80104e35:	8d 55 da             	lea    -0x26(%ebp),%edx
...
{
  for (; *s1 && *s2 && *s1==*s2; s1++, s2++);
80104e3a:	75 1f                	jne    80104e5b <directoryWalkerSubRoutine+0x15b>
80104e3c:	e9 07 ff ff ff       	jmp    80104d48 <directoryWalkerSubRoutine+0x48>
80104e41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104e48:	0f b6 18             	movzbl (%eax),%ebx
80104e4b:	84 db                	test   %bl,%bl
80104e4d:	0f 84 25 01 00 00    	je     80104f78 <directoryWalkerSubRoutine+0x278>
80104e53:	38 d9                	cmp    %bl,%cl
80104e55:	0f 85 1d 01 00 00    	jne    80104f78 <directoryWalkerSubRoutine+0x278>
80104e5b:	83 c2 01             	add    $0x1,%edx
80104e5e:	0f b6 0a             	movzbl (%edx),%ecx
80104e61:	83 c0 01             	add    $0x1,%eax
80104e64:	84 c9                	test   %cl,%cl
80104e66:	75 e0                	jne    80104e48 <directoryWalkerSubRoutine+0x148>
80104e68:	89 fb                	mov    %edi,%ebx
80104e6a:	31 c9                	xor    %ecx,%ecx
		      continue;
		    }
			...
			if (strcmp(de.name, ".") == 0 || strcmp(de.name, "..") == 0){
80104e6c:	38 08                	cmp    %cl,(%eax)
80104e6e:	0f 84 d4 fe ff ff    	je     80104d48 <directoryWalkerSubRoutine+0x48>
				continue;
			}
			struct inode *dir_ip;
			dir_ip = dirlookup(ip,de.name,0);
80104e74:	8d 45 da             	lea    -0x26(%ebp),%eax
80104e77:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80104e7e:	00 
80104e7f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e83:	89 1c 24             	mov    %ebx,(%esp)
80104e86:	e8 b5 cd ff ff       	call   80101c40 <dirlookup>
			inodeLinkLog[de.inum]++;
80104e8b:	0f b7 55 d8          	movzwl -0x28(%ebp),%edx
80104e8f:	83 04 95 80 5f 11 80 	addl   $0x1,-0x7feea080(,%edx,4)
80104e96:	01 
			if(dir_ip->type == T_DIR){
80104e97:	66 83 78 50 01       	cmpw   $0x1,0x50(%eax)
80104e9c:	0f 85 a6 fe ff ff    	jne    80104d48 <directoryWalkerSubRoutine+0x48>
				// we found a directory, recursively call
				char new_path[14] = {0};
80104ea2:	31 c0                	xor    %eax,%eax
80104ea4:	66 89 45 d6          	mov    %ax,-0x2a(%ebp)
     reverse(s);
 }
...
80104ea8:	8b 45 08             	mov    0x8(%ebp),%eax
			...
			if(dir_ip->type == T_DIR){
				// we found a directory, recursively call
				char new_path[14] = {0};
80104eab:	c7 45 ca 00 00 00 00 	movl   $0x0,-0x36(%ebp)
80104eb2:	c7 45 ce 00 00 00 00 	movl   $0x0,-0x32(%ebp)
80104eb9:	c7 45 d2 00 00 00 00 	movl   $0x0,-0x2e(%ebp)
     reverse(s);
 }
...
80104ec5:	0f 84 d8 00 00 00    	je     80104fa3 <directoryWalkerSubRoutine+0x2a3>
80104ecb:	89 c1                	mov    %eax,%ecx
80104ecd:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104ed0:	83 c0 01             	add    $0x1,%eax
80104ed3:	83 c1 01             	add    $0x1,%ecx
80104ed6:	88 50 ff             	mov    %dl,-0x1(%eax)
80104ed9:	0f b6 11             	movzbl (%ecx),%edx
80104edc:	84 d2                	test   %dl,%dl
80104ede:	75 f0                	jne    80104ed0 <directoryWalkerSubRoutine+0x1d0>
  *s1 = 0;
80104ee0:	c6 00 00             	movb   $0x0,(%eax)
     s[i] = '\0';
     reverse(s);
 }
...
void strcat(char* s1, const char* s2){
  while (*s1) ++s1;
80104ee3:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104ee6:	80 7d ca 00          	cmpb   $0x0,-0x36(%ebp)
80104eea:	74 0c                	je     80104ef8 <directoryWalkerSubRoutine+0x1f8>
80104eec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104ef0:	83 c0 01             	add    $0x1,%eax
80104ef3:	80 38 00             	cmpb   $0x0,(%eax)
80104ef6:	75 f8                	jne    80104ef0 <directoryWalkerSubRoutine+0x1f0>
  while (*s2) *s1++ = *s2++;
80104ef8:	c6 00 2f             	movb   $0x2f,(%eax)
  *s1 = 0;
80104efb:	c6 40 01 00          	movb   $0x0,0x1(%eax)
     s[i] = '\0';
     reverse(s);
 }
...
void strcat(char* s1, const char* s2){
  while (*s1) ++s1;
80104eff:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104f02:	80 7d ca 00          	cmpb   $0x0,-0x36(%ebp)
80104f06:	74 08                	je     80104f10 <directoryWalkerSubRoutine+0x210>
80104f08:	83 c0 01             	add    $0x1,%eax
80104f0b:	80 38 00             	cmpb   $0x0,(%eax)
80104f0e:	75 f8                	jne    80104f08 <directoryWalkerSubRoutine+0x208>
  while (*s2) *s1++ = *s2++;
80104f10:	0f b6 55 da          	movzbl -0x26(%ebp),%edx
80104f14:	84 d2                	test   %dl,%dl
80104f16:	74 18                	je     80104f30 <directoryWalkerSubRoutine+0x230>
80104f18:	8d 4d da             	lea    -0x26(%ebp),%ecx
80104f1b:	90                   	nop
80104f1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104f20:	83 c0 01             	add    $0x1,%eax
80104f23:	83 c1 01             	add    $0x1,%ecx
80104f26:	88 50 ff             	mov    %dl,-0x1(%eax)
80104f29:	0f b6 11             	movzbl (%ecx),%edx
80104f2c:	84 d2                	test   %dl,%dl
80104f2e:	75 f0                	jne    80104f20 <directoryWalkerSubRoutine+0x220>
  *s1 = 0;
...
80104f36:	e8 85 c8 ff ff       	call   801017c0 <iunlock>
				directoryWalkerSubRoutine(new_path);
80104f3b:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104f3e:	89 04 24             	mov    %eax,(%esp)
80104f41:	e8 ba fd ff ff       	call   80104d00 <directoryWalkerSubRoutine>
				ilock(ip);
80104f46:	89 1c 24             	mov    %ebx,(%esp)
	...
	if(ip->type == T_DIR){
		// The specified path is a directory, go through its directory entries
		for(off = 0; off < ip->size; off += sizeof(de)){
80104f49:	83 c6 10             	add    $0x10,%esi
				strcat(new_path,path);
				strcat(new_path,"/");
				strcat(new_path,de.name);
				iunlock(ip);
				directoryWalkerSubRoutine(new_path);
				ilock(ip);
80104f4c:	e8 8f c7 ff ff       	call   801016e0 <ilock>
	}
	begin_op();
	ilock(ip);
	if(ip->type == T_DIR){
		// The specified path is a directory, go through its directory entries
		for(off = 0; off < ip->size; off += sizeof(de)){
80104f51:	39 73 58             	cmp    %esi,0x58(%ebx)
80104f54:	0f 87 fa fd ff ff    	ja     80104d54 <directoryWalkerSubRoutine+0x54>
80104f5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	...
	iunlock(ip);
80104f60:	89 1c 24             	mov    %ebx,(%esp)
80104f63:	e8 58 c8 ff ff       	call   801017c0 <iunlock>
	end_op();
80104f68:	e8 93 dc ff ff       	call   80102c00 <end_op>
}
80104f6d:	83 c4 3c             	add    $0x3c,%esp
80104f70:	5b                   	pop    %ebx
80104f71:	5e                   	pop    %esi
80104f72:	5f                   	pop    %edi
80104f73:	5d                   	pop    %ebp
...
80104f78:	89 fb                	mov    %edi,%ebx
80104f7a:	e9 ed fe ff ff       	jmp    80104e6c <directoryWalkerSubRoutine+0x16c>
  *s1 = 0;
}
...
{
  for (; *s1 && *s2 && *s1==*s2; s1++, s2++);
80104f7f:	31 d2                	xor    %edx,%edx
80104f81:	b9 8c 7d 10 80       	mov    $0x80107d8c,%ecx
80104f86:	e9 13 fe ff ff       	jmp    80104d9e <directoryWalkerSubRoutine+0x9e>
80104f8b:	31 c9                	xor    %ecx,%ecx
80104f8d:	b8 8b 7d 10 80       	mov    $0x80107d8b,%eax
80104f92:	e9 d5 fe ff ff       	jmp    80104e6c <directoryWalkerSubRoutine+0x16c>
80104f97:	89 c1                	mov    %eax,%ecx
		      continue;
		    }
			...
			if (strcmp(de.name, ".") == 0 || strcmp(de.name, "..") == 0){
80104f99:	b8 8b 7d 10 80       	mov    $0x80107d8b,%eax
80104f9e:	e9 c9 fe ff ff       	jmp    80104e6c <directoryWalkerSubRoutine+0x16c>
     reverse(s);
 }
...
void strcat(char* s1, const char* s2){
  while (*s1) ++s1;
  while (*s2) *s1++ = *s2++;
80104fa3:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104fa6:	e9 35 ff ff ff       	jmp    80104ee0 <directoryWalkerSubRoutine+0x1e0>
	if(ip->type == T_DIR){
		// The specified path is a directory, go through its directory entries
		for(off = 0; off < ip->size; off += sizeof(de)){
			if(readi(ip, (char*)&de, off, sizeof(de)) != sizeof(de)){
				// Reading was not successful
				panic("dirlookup read");
80104fab:	c7 04 24 79 77 10 80 	movl   $0x80107779,(%esp)
80104fb2:	e8 a9 b3 ff ff       	call   80100360 <panic>
	...
	if(!ip){
		panic("Invalid File Path");
80104fb7:	c7 04 24 b5 7d 10 80 	movl   $0x80107db5,(%esp)
80104fbe:	e8 9d b3 ff ff       	call   80100360 <panic>
80104fc3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104fc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80104fd0 <sys_directoryWalker>:
	inodeNum = 0;
	for(inodeNum = 0; inodeNum<200;inodeNum++){
		corruptDirs[inodeNum]=0;
	}
...
80104fdd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104fe4:	e8 97 f6 ff ff       	call   80104680 <argstr>
	if(!path){
80104fe9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fec:	85 c0                	test   %eax,%eax
80104fee:	74 54                	je     80105044 <sys_directoryWalker+0x74>
		path = ".";
	}
	cprintf("path is %s\n",path);
80104ff0:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ff4:	c7 04 24 de 7d 10 80 	movl   $0x80107dde,(%esp)
80104ffb:	e8 50 b6 ff ff       	call   80100650 <cprintf>
  return *(unsigned char*)s1-*(unsigned char*)s2;
}
void resetArrays(){
	// initialize link log
...
80105002:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		inodeLinkLog[inodeNum]=0;
80105008:	c7 04 85 80 5f 11 80 	movl   $0x0,-0x7feea080(,%eax,4)
8010500f:	00 00 00 00 
  return *(unsigned char*)s1-*(unsigned char*)s2;
}
void resetArrays(){
	// initialize link log
...
80105016:	3d c8 00 00 00       	cmp    $0xc8,%eax
8010501b:	75 eb                	jne    80105008 <sys_directoryWalker+0x38>
8010501d:	30 c0                	xor    %al,%al
8010501f:	90                   	nop
		inodeLinkLog[inodeNum]=0;
	}
	// initialize corrupt directory log
	...
	for(inodeNum = 0; inodeNum<200;inodeNum++){
		corruptDirs[inodeNum]=0;
80105020:	c7 04 85 60 5c 11 80 	movl   $0x0,-0x7feea3a0(,%eax,4)
80105027:	00 00 00 00 
	for(inodeNum = 0; inodeNum<200;inodeNum++){
		inodeLinkLog[inodeNum]=0;
	}
	// initialize corrupt directory log
	inodeNum = 0;
	for(inodeNum = 0; inodeNum<200;inodeNum++){
8010502b:	83 c0 01             	add    $0x1,%eax
8010502e:	3d c8 00 00 00       	cmp    $0xc8,%eax
80105033:	75 eb                	jne    80105020 <sys_directoryWalker+0x50>
		path = ".";
	}
	cprintf("path is %s\n",path);
	resetArrays();
...
8010503b:	e8 c0 fc ff ff       	call   80104d00 <directoryWalkerSubRoutine>
...
int sys_directoryWalker(void){
	...
	if(!path){
		path = ".";
80105044:	c7 45 f4 8c 7d 10 80 	movl   $0x80107d8c,-0xc(%ebp)
8010504b:	b8 8c 7d 10 80       	mov    $0x80107d8c,%eax
80105050:	eb 9e                	jmp    80104ff0 <sys_directoryWalker+0x20>
80105052:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105059:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80105060 <sys_inodeTBWalker>:
	end_op();
}
...
80105068:	c7 04 85 a0 62 11 80 	movl   $0x0,-0x7fee9d60(,%eax,4)
8010506f:	00 00 00 00 
	end_op();
}
...
80105076:	3d c8 00 00 00       	cmp    $0xc8,%eax
8010507b:	75 eb                	jne    80105068 <sys_inodeTBWalker+0x8>
	}
	iunlock(ip);
	end_op();
}
...
80105080:	56                   	push   %esi
	...
	for(inum = 1; inum < sb.ninodes; inum++){
80105081:	be 01 00 00 00       	mov    $0x1,%esi
	}
	iunlock(ip);
	end_op();
}
...
80105086:	53                   	push   %ebx
	...
	readsb(1,&sb); // Read superblock
	for(inum = 1; inum < sb.ninodes; inum++){
80105087:	bb 01 00 00 00       	mov    $0x1,%ebx
	}
	iunlock(ip);
	end_op();
}
...
8010508c:	83 ec 10             	sub    $0x10,%esp
	...
	struct dinode *dip;
	readsb(1,&sb); // Read superblock
8010508f:	c7 44 24 04 c0 19 11 	movl   $0x801119c0,0x4(%esp)
80105096:	80 
80105097:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010509e:	e8 1d c3 ff ff       	call   801013c0 <readsb>
	for(inum = 1; inum < sb.ninodes; inum++){
801050a3:	83 3d c8 19 11 80 01 	cmpl   $0x1,0x801119c8
801050aa:	77 19                	ja     801050c5 <sys_inodeTBWalker+0x65>
801050ac:	eb 6a                	jmp    80105118 <sys_inodeTBWalker+0xb8>
...
801050b3:	83 c3 01             	add    $0x1,%ebx
		...
		brelse(bp);
801050b6:	e8 25 b1 ff ff       	call   801001e0 <brelse>
	}
	int inum; // Loop counter
	struct buf *bp;
	struct dinode *dip;
	readsb(1,&sb); // Read superblock
	for(inum = 1; inum < sb.ninodes; inum++){
801050bb:	89 de                	mov    %ebx,%esi
801050bd:	3b 1d c8 19 11 80    	cmp    0x801119c8,%ebx
801050c3:	73 53                	jae    80105118 <sys_inodeTBWalker+0xb8>
		bp = bread(1, IBLOCK(inum, sb));
801050c5:	89 f0                	mov    %esi,%eax
		dip = (struct dinode*)bp->data + inum%IPB;
801050c7:	83 e6 07             	and    $0x7,%esi
	int inum; // Loop counter
	struct buf *bp;
	struct dinode *dip;
	readsb(1,&sb); // Read superblock
	for(inum = 1; inum < sb.ninodes; inum++){
		bp = bread(1, IBLOCK(inum, sb));
801050ca:	c1 e8 03             	shr    $0x3,%eax
801050cd:	03 05 d4 19 11 80    	add    0x801119d4,%eax
801050d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801050da:	89 44 24 04          	mov    %eax,0x4(%esp)
801050de:	e8 ed af ff ff       	call   801000d0 <bread>
		dip = (struct dinode*)bp->data + inum%IPB;
801050e3:	89 f2                	mov    %esi,%edx
		if(dip->type != 0){  // not a free inode
801050e5:	c1 e2 06             	shl    $0x6,%edx
801050e8:	0f bf 54 10 5c       	movswl 0x5c(%eax,%edx,1),%edx
801050ed:	66 85 d2             	test   %dx,%dx
801050f0:	74 be                	je     801050b0 <sys_inodeTBWalker+0x50>
			// Found allocated inode
			cprintf("inode#: %d \t type: %d\n",inum,dip->type);
801050f2:	89 54 24 08          	mov    %edx,0x8(%esp)
801050f6:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801050fa:	c7 04 24 ea 7d 10 80 	movl   $0x80107dea,(%esp)
80105101:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105104:	e8 47 b5 ff ff       	call   80100650 <cprintf>
			inodeTBWalkerLinkLog[inum]++;
80105109:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010510c:	83 04 9d a0 62 11 80 	addl   $0x1,-0x7fee9d60(,%ebx,4)
80105113:	01 
80105114:	eb 9a                	jmp    801050b0 <sys_inodeTBWalker+0x50>
...
8010511f:	5d                   	pop    %ebp
80105120:	c3                   	ret    
80105121:	eb 0d                	jmp    80105130 <sys_compareWalkers>
80105123:	90                   	nop
80105124:	90                   	nop
80105125:	90                   	nop
80105126:	90                   	nop
...
80105132:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		inodeLinkLog[inodeNum]=0;
80105138:	c7 04 85 80 5f 11 80 	movl   $0x0,-0x7feea080(,%eax,4)
8010513f:	00 00 00 00 
  return *(unsigned char*)s1-*(unsigned char*)s2;
}
void resetArrays(){
	// initialize link log
...
80105146:	3d c8 00 00 00       	cmp    $0xc8,%eax
8010514b:	75 eb                	jne    80105138 <sys_compareWalkers+0x8>
8010514d:	30 c0                	xor    %al,%al
8010514f:	90                   	nop
		inodeLinkLog[inodeNum]=0;
	}
	// initialize corrupt directory log
	...
	for(inodeNum = 0; inodeNum<200;inodeNum++){
		corruptDirs[inodeNum]=0;
80105150:	c7 04 85 60 5c 11 80 	movl   $0x0,-0x7feea3a0(,%eax,4)
...
8010515e:	3d c8 00 00 00       	cmp    $0xc8,%eax
80105163:	75 eb                	jne    80105150 <sys_compareWalkers+0x20>
	dirlink(ip,newName,inum);
	iunlock(ip);
	end_op();
}
...
80105168:	56                   	push   %esi
	...
	int inodeIndex;
	int similarity = 1;
80105169:	be 01 00 00 00       	mov    $0x1,%esi
	dirlink(ip,newName,inum);
	iunlock(ip);
	end_op();
}
...
8010516e:	53                   	push   %ebx
	...
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
8010516f:	bb 02 00 00 00       	mov    $0x2,%ebx
	dirlink(ip,newName,inum);
	iunlock(ip);
	end_op();
}
...
80105177:	c7 04 24 38 7e 10 80 	movl   $0x80107e38,(%esp)
8010517e:	e8 cd b4 ff ff       	call   80100650 <cprintf>
	sys_inodeTBWalker();
80105183:	e8 d8 fe ff ff       	call   80105060 <sys_inodeTBWalker>
	cprintf("\n\n");
80105188:	c7 04 24 01 7e 10 80 	movl   $0x80107e01,(%esp)
8010518f:	e8 bc b4 ff ff       	call   80100650 <cprintf>
	cprintf("\n= = = Calling directoryWalker = = =\n");
80105194:	c7 04 24 5c 7e 10 80 	movl   $0x80107e5c,(%esp)
8010519b:	e8 b0 b4 ff ff       	call   80100650 <cprintf>
	directoryWalkerSubRoutine(".");
801051a0:	c7 04 24 8c 7d 10 80 	movl   $0x80107d8c,(%esp)
801051a7:	e8 54 fb ff ff       	call   80104d00 <directoryWalkerSubRoutine>
	cprintf("\n\n");
801051ac:	c7 04 24 01 7e 10 80 	movl   $0x80107e01,(%esp)
801051b3:	e8 98 b4 ff ff       	call   80100650 <cprintf>
	cprintf("\n= = = Comparing walkers = = =\n");
801051b8:	c7 04 24 84 7e 10 80 	movl   $0x80107e84,(%esp)
801051bf:	e8 8c b4 ff ff       	call   80100650 <cprintf>
801051c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
		if(inodeLinkLog[inodeIndex] != inodeTBWalkerLinkLog[inodeIndex]){
801051c8:	8b 04 9d a0 62 11 80 	mov    -0x7fee9d60(,%ebx,4),%eax
801051cf:	39 04 9d 80 5f 11 80 	cmp    %eax,-0x7feea080(,%ebx,4)
801051d6:	74 34                	je     8010520c <sys_compareWalkers+0xdc>
			similarity = 0;
			cprintf("Found difference between inodeTBWalker & directoryWalker @ inode#: %d\n",inodeIndex);
801051d8:	89 5c 24 04          	mov    %ebx,0x4(%esp)
	int inodeIndex;
	int similarity = 1;
	// We begin at 2 because the root will be the same
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
		if(inodeLinkLog[inodeIndex] != inodeTBWalkerLinkLog[inodeIndex]){
			similarity = 0;
801051dc:	31 f6                	xor    %esi,%esi
			cprintf("Found difference between inodeTBWalker & directoryWalker @ inode#: %d\n",inodeIndex);
801051de:	c7 04 24 a4 7e 10 80 	movl   $0x80107ea4,(%esp)
801051e5:	e8 66 b4 ff ff       	call   80100650 <cprintf>
			cprintf("inodeTBwalker #links: %d \t directoryWalker #links: %d\n\n",inodeTBWalkerLinkLog[inodeIndex],inodeLinkLog[inodeIndex]);
801051ea:	8b 04 9d 80 5f 11 80 	mov    -0x7feea080(,%ebx,4),%eax
801051f1:	c7 04 24 ec 7e 10 80 	movl   $0x80107eec,(%esp)
801051f8:	89 44 24 08          	mov    %eax,0x8(%esp)
801051fc:	8b 04 9d a0 62 11 80 	mov    -0x7fee9d60(,%ebx,4),%eax
80105203:	89 44 24 04          	mov    %eax,0x4(%esp)
80105207:	e8 44 b4 ff ff       	call   80100650 <cprintf>
	cprintf("\n\n");
	cprintf("\n= = = Comparing walkers = = =\n");
	int inodeIndex;
	int similarity = 1;
	// We begin at 2 because the root will be the same
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
8010520c:	83 c3 01             	add    $0x1,%ebx
8010520f:	81 fb c8 00 00 00    	cmp    $0xc8,%ebx
80105215:	75 b1                	jne    801051c8 <sys_compareWalkers+0x98>
80105217:	b3 02                	mov    $0x2,%bl
80105219:	eb 10                	jmp    8010522b <sys_compareWalkers+0xfb>
8010521b:	90                   	nop
...
80105223:	81 fb c8 00 00 00    	cmp    $0xc8,%ebx
80105229:	74 26                	je     80105251 <sys_compareWalkers+0x121>
		if(corruptDirs[inodeIndex] != 0){
8010522b:	8b 04 9d 60 5c 11 80 	mov    -0x7feea3a0(,%ebx,4),%eax
80105232:	85 c0                	test   %eax,%eax
80105234:	74 ea                	je     80105220 <sys_compareWalkers+0xf0>
			cprintf("Found a corrupted directory#: %d\n",inodeIndex);
80105236:	89 5c 24 04          	mov    %ebx,0x4(%esp)
			similarity = 0;
			cprintf("Found difference between inodeTBWalker & directoryWalker @ inode#: %d\n",inodeIndex);
			cprintf("inodeTBwalker #links: %d \t directoryWalker #links: %d\n\n",inodeTBWalkerLinkLog[inodeIndex],inodeLinkLog[inodeIndex]);
		}
	...
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
8010523a:	83 c3 01             	add    $0x1,%ebx
		if(corruptDirs[inodeIndex] != 0){
			cprintf("Found a corrupted directory#: %d\n",inodeIndex);
8010523d:	c7 04 24 24 7f 10 80 	movl   $0x80107f24,(%esp)
80105244:	e8 07 b4 ff ff       	call   80100650 <cprintf>
			similarity = 0;
			cprintf("Found difference between inodeTBWalker & directoryWalker @ inode#: %d\n",inodeIndex);
			cprintf("inodeTBwalker #links: %d \t directoryWalker #links: %d\n\n",inodeTBWalkerLinkLog[inodeIndex],inodeLinkLog[inodeIndex]);
		}
	...
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
80105249:	81 fb c8 00 00 00    	cmp    $0xc8,%ebx
8010524f:	75 da                	jne    8010522b <sys_compareWalkers+0xfb>
		if(corruptDirs[inodeIndex] != 0){
			cprintf("Found a corrupted directory#: %d\n",inodeIndex);
		}
	}
...
80105274:	e8 77 f3 ff ff       	call   801045f0 <argint>
	callDeleteInFS(inum);
80105279:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010527c:	89 04 24             	mov    %eax,(%esp)
8010527f:	e8 7c c5 ff ff       	call   80101800 <callDeleteInFS>
	return 0;
}
...
80105296:	83 ec 24             	sub    $0x24,%esp
	struct file *f;
	int fd;

	if(argfd(0, 0, &f) < 0)
80105299:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010529c:	e8 4f f6 ff ff       	call   801048f0 <argfd.constprop.0>
801052a1:	85 c0                	test   %eax,%eax
801052a3:	78 23                	js     801052c8 <sys_dup+0x38>
		return -1;
	if((fd=fdalloc(f)) < 0)
801052a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052a8:	e8 83 f4 ff ff       	call   80104730 <fdalloc>
801052ad:	85 c0                	test   %eax,%eax
801052af:	89 c3                	mov    %eax,%ebx
801052b1:	78 15                	js     801052c8 <sys_dup+0x38>
		return -1;
	filedup(f);
801052b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052b6:	89 04 24             	mov    %eax,(%esp)
801052b9:	e8 22 bb ff ff       	call   80100de0 <filedup>
	return fd;
801052be:	89 d8                	mov    %ebx,%eax
}
801052c0:	83 c4 24             	add    $0x24,%esp
801052c3:	5b                   	pop    %ebx
801052c4:	5d                   	pop    %ebp
801052c5:	c3                   	ret    
...
801052cd:	eb f1                	jmp    801052c0 <sys_dup+0x30>
801052cf:	90                   	nop
...
801052db:	e8 10 f6 ff ff       	call   801048f0 <argfd.constprop.0>
801052e0:	85 c0                	test   %eax,%eax
801052e2:	78 54                	js     80105338 <sys_read+0x68>
801052e4:	8d 45 f0             	lea    -0x10(%ebp),%eax
801052e7:	89 44 24 04          	mov    %eax,0x4(%esp)
801052eb:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801052f2:	e8 f9 f2 ff ff       	call   801045f0 <argint>
801052f7:	85 c0                	test   %eax,%eax
801052f9:	78 3d                	js     80105338 <sys_read+0x68>
801052fb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801052fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105305:	89 44 24 08          	mov    %eax,0x8(%esp)
80105309:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010530c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105310:	e8 0b f3 ff ff       	call   80104620 <argptr>
80105315:	85 c0                	test   %eax,%eax
80105317:	78 1f                	js     80105338 <sys_read+0x68>
		return -1;
...
80105327:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010532a:	89 04 24             	mov    %eax,(%esp)
8010532d:	e8 0e bc ff ff       	call   80100f40 <fileread>
}
80105332:	c9                   	leave  
80105333:	c3                   	ret    
...
8010534b:	e8 a0 f5 ff ff       	call   801048f0 <argfd.constprop.0>
80105350:	85 c0                	test   %eax,%eax
80105352:	78 54                	js     801053a8 <sys_write+0x68>
80105354:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105357:	89 44 24 04          	mov    %eax,0x4(%esp)
8010535b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105362:	e8 89 f2 ff ff       	call   801045f0 <argint>
80105367:	85 c0                	test   %eax,%eax
80105369:	78 3d                	js     801053a8 <sys_write+0x68>
8010536b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010536e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105375:	89 44 24 08          	mov    %eax,0x8(%esp)
80105379:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010537c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105380:	e8 9b f2 ff ff       	call   80104620 <argptr>
80105385:	85 c0                	test   %eax,%eax
80105387:	78 1f                	js     801053a8 <sys_write+0x68>
		return -1;
...
80105397:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010539a:	89 04 24             	mov    %eax,(%esp)
8010539d:	e8 3e bc ff ff       	call   80100fe0 <filewrite>
}
801053a2:	c9                   	leave  
801053a3:	c3                   	ret    
...
801053bc:	e8 2f f5 ff ff       	call   801048f0 <argfd.constprop.0>
801053c1:	85 c0                	test   %eax,%eax
801053c3:	78 23                	js     801053e8 <sys_close+0x38>
		return -1;
	myproc()->ofile[fd] = 0;
801053c5:	e8 56 e3 ff ff       	call   80103720 <myproc>
801053ca:	8b 55 f0             	mov    -0x10(%ebp),%edx
801053cd:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
801053d4:	00 
	fileclose(f);
801053d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053d8:	89 04 24             	mov    %eax,(%esp)
801053db:	e8 50 ba ff ff       	call   80100e30 <fileclose>
	return 0;
...
801053f5:	83 ec 28             	sub    $0x28,%esp
	struct file *f;
	struct stat *st;

	if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
801053f8:	8d 55 f0             	lea    -0x10(%ebp),%edx
801053fb:	e8 f0 f4 ff ff       	call   801048f0 <argfd.constprop.0>
80105400:	85 c0                	test   %eax,%eax
80105402:	78 34                	js     80105438 <sys_fstat+0x48>
80105404:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105407:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010540e:	00 
8010540f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105413:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010541a:	e8 01 f2 ff ff       	call   80104620 <argptr>
8010541f:	85 c0                	test   %eax,%eax
80105421:	78 15                	js     80105438 <sys_fstat+0x48>
		return -1;
...
80105430:	e8 bb ba ff ff       	call   80100ef0 <filestat>
}
80105435:	c9                   	leave  
80105436:	c3                   	ret    
80105437:	90                   	nop
...
80105446:	83 ec 3c             	sub    $0x3c,%esp
...
80105450:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105457:	e8 24 f2 ff ff       	call   80104680 <argstr>
8010545c:	85 c0                	test   %eax,%eax
8010545e:	0f 88 e6 00 00 00    	js     8010554a <sys_link+0x10a>
80105464:	8d 45 d0             	lea    -0x30(%ebp),%eax
80105467:	89 44 24 04          	mov    %eax,0x4(%esp)
8010546b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105472:	e8 09 f2 ff ff       	call   80104680 <argstr>
80105477:	85 c0                	test   %eax,%eax
80105479:	0f 88 cb 00 00 00    	js     8010554a <sys_link+0x10a>
		return -1;

	begin_op();
8010547f:	e8 0c d7 ff ff       	call   80102b90 <begin_op>
	if((ip = namei(old)) == 0){
80105484:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105487:	89 04 24             	mov    %eax,(%esp)
8010548a:	e8 f1 ca ff ff       	call   80101f80 <namei>
8010548f:	85 c0                	test   %eax,%eax
80105491:	89 c3                	mov    %eax,%ebx
80105493:	0f 84 ac 00 00 00    	je     80105545 <sys_link+0x105>
		end_op();
		return -1;
	}
...
801054a6:	0f 84 91 00 00 00    	je     8010553d <sys_link+0xfd>
		iunlockput(ip);
		end_op();
		return -1;
	}
...
801054b1:	8d 7d da             	lea    -0x26(%ebp),%edi
		end_op();
		return -1;
	}
...
801054b7:	e8 64 c1 ff ff       	call   80101620 <iupdate>
	iunlock(ip);
801054bc:	89 1c 24             	mov    %ebx,(%esp)
801054bf:	e8 fc c2 ff ff       	call   801017c0 <iunlock>

	if((dp = nameiparent(new, name)) == 0)
801054c4:	8b 45 d0             	mov    -0x30(%ebp),%eax
801054c7:	89 7c 24 04          	mov    %edi,0x4(%esp)
801054cb:	89 04 24             	mov    %eax,(%esp)
801054ce:	e8 cd ca ff ff       	call   80101fa0 <nameiparent>
801054d3:	85 c0                	test   %eax,%eax
801054d5:	89 c6                	mov    %eax,%esi
801054d7:	74 4f                	je     80105528 <sys_link+0xe8>
		goto bad;
	ilock(dp);
801054d9:	89 04 24             	mov    %eax,(%esp)
801054dc:	e8 ff c1 ff ff       	call   801016e0 <ilock>
	if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801054e1:	8b 03                	mov    (%ebx),%eax
801054e3:	39 06                	cmp    %eax,(%esi)
801054e5:	75 39                	jne    80105520 <sys_link+0xe0>
801054e7:	8b 43 04             	mov    0x4(%ebx),%eax
801054ea:	89 7c 24 04          	mov    %edi,0x4(%esp)
801054ee:	89 34 24             	mov    %esi,(%esp)
801054f1:	89 44 24 08          	mov    %eax,0x8(%esp)
801054f5:	e8 a6 c9 ff ff       	call   80101ea0 <dirlink>
801054fa:	85 c0                	test   %eax,%eax
801054fc:	78 22                	js     80105520 <sys_link+0xe0>
		iunlockput(dp);
		goto bad;
	}
	iunlockput(dp);
801054fe:	89 34 24             	mov    %esi,(%esp)
80105501:	e8 8a c4 ff ff       	call   80101990 <iunlockput>
	iput(ip);
80105506:	89 1c 24             	mov    %ebx,(%esp)
80105509:	e8 42 c3 ff ff       	call   80101850 <iput>

	end_op();
8010550e:	e8 ed d6 ff ff       	call   80102c00 <end_op>
	ip->nlink--;
	iupdate(ip);
	iunlockput(ip);
	end_op();
...
80105513:	83 c4 3c             	add    $0x3c,%esp
	iunlockput(dp);
	iput(ip);
...
8010551d:	8d 76 00             	lea    0x0(%esi),%esi
	...
	if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
		iunlockput(dp);
80105520:	89 34 24             	mov    %esi,(%esp)
80105523:	e8 68 c4 ff ff       	call   80101990 <iunlockput>
	end_op();
...
8010552b:	e8 b0 c1 ff ff       	call   801016e0 <ilock>
	ip->nlink--;
80105530:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
	iupdate(ip);
80105535:	89 1c 24             	mov    %ebx,(%esp)
80105538:	e8 e3 c0 ff ff       	call   80101620 <iupdate>
	iunlockput(ip);
8010553d:	89 1c 24             	mov    %ebx,(%esp)
80105540:	e8 4b c4 ff ff       	call   80101990 <iunlockput>
	end_op();
80105545:	e8 b6 d6 ff ff       	call   80102c00 <end_op>
	return -1;
}
8010554a:	83 c4 3c             	add    $0x3c,%esp
	ilock(ip);
	ip->nlink--;
	iupdate(ip);
	iunlockput(ip);
...
80105566:	83 ec 5c             	sub    $0x5c,%esp
	struct inode *ip, *dp;
	struct dirent de;
...
80105577:	e8 04 f1 ff ff       	call   80104680 <argstr>
8010557c:	85 c0                	test   %eax,%eax
8010557e:	0f 88 76 01 00 00    	js     801056fa <sys_unlink+0x19a>
		return -1;

	begin_op();
80105584:	e8 07 d6 ff ff       	call   80102b90 <begin_op>
	if((dp = nameiparent(path, name)) == 0){
80105589:	8b 45 c0             	mov    -0x40(%ebp),%eax
8010558c:	8d 5d ca             	lea    -0x36(%ebp),%ebx
8010558f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80105593:	89 04 24             	mov    %eax,(%esp)
80105596:	e8 05 ca ff ff       	call   80101fa0 <nameiparent>
8010559b:	85 c0                	test   %eax,%eax
8010559d:	89 45 b4             	mov    %eax,-0x4c(%ebp)
801055a0:	0f 84 4f 01 00 00    	je     801056f5 <sys_unlink+0x195>
		end_op();
		return -1;
	}

	ilock(dp);
801055a6:	8b 75 b4             	mov    -0x4c(%ebp),%esi
801055a9:	89 34 24             	mov    %esi,(%esp)
801055ac:	e8 2f c1 ff ff       	call   801016e0 <ilock>

	// Cannot unlink "." or "..".
	if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801055b1:	c7 44 24 04 8c 7d 10 	movl   $0x80107d8c,0x4(%esp)
801055b8:	80 
801055b9:	89 1c 24             	mov    %ebx,(%esp)
801055bc:	e8 4f c6 ff ff       	call   80101c10 <namecmp>
801055c1:	85 c0                	test   %eax,%eax
801055c3:	0f 84 21 01 00 00    	je     801056ea <sys_unlink+0x18a>
801055c9:	c7 44 24 04 8b 7d 10 	movl   $0x80107d8b,0x4(%esp)
801055d0:	80 
801055d1:	89 1c 24             	mov    %ebx,(%esp)
801055d4:	e8 37 c6 ff ff       	call   80101c10 <namecmp>
801055d9:	85 c0                	test   %eax,%eax
801055db:	0f 84 09 01 00 00    	je     801056ea <sys_unlink+0x18a>
		goto bad;

	if((ip = dirlookup(dp, name, &off)) == 0)
801055e1:	8d 45 c4             	lea    -0x3c(%ebp),%eax
801055e4:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801055e8:	89 44 24 08          	mov    %eax,0x8(%esp)
801055ec:	89 34 24             	mov    %esi,(%esp)
801055ef:	e8 4c c6 ff ff       	call   80101c40 <dirlookup>
801055f4:	85 c0                	test   %eax,%eax
801055f6:	89 c3                	mov    %eax,%ebx
801055f8:	0f 84 ec 00 00 00    	je     801056ea <sys_unlink+0x18a>
		goto bad;
	ilock(ip);
801055fe:	89 04 24             	mov    %eax,(%esp)
80105601:	e8 da c0 ff ff       	call   801016e0 <ilock>

	if(ip->nlink < 1)
80105606:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
8010560b:	0f 8e 24 01 00 00    	jle    80105735 <sys_unlink+0x1d5>
		panic("unlink: nlink < 1");
	if(ip->type == T_DIR && !isdirempty(ip)){
80105611:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105616:	8d 75 d8             	lea    -0x28(%ebp),%esi
80105619:	74 7d                	je     80105698 <sys_unlink+0x138>
		iunlockput(ip);
		goto bad;
	}

	memset(&de, 0, sizeof(de));
8010561b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105622:	00 
80105623:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010562a:	00 
8010562b:	89 34 24             	mov    %esi,(%esp)
8010562e:	e8 cd ec ff ff       	call   80104300 <memset>
	if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105633:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80105636:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010563d:	00 
8010563e:	89 74 24 04          	mov    %esi,0x4(%esp)
80105642:	89 44 24 08          	mov    %eax,0x8(%esp)
80105646:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80105649:	89 04 24             	mov    %eax,(%esp)
8010564c:	e8 8f c4 ff ff       	call   80101ae0 <writei>
80105651:	83 f8 10             	cmp    $0x10,%eax
80105654:	0f 85 cf 00 00 00    	jne    80105729 <sys_unlink+0x1c9>
		panic("unlink: writei");
	if(ip->type == T_DIR){
8010565a:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010565f:	0f 84 a3 00 00 00    	je     80105708 <sys_unlink+0x1a8>
		dp->nlink--;
		iupdate(dp);
	}
	iunlockput(dp);
80105665:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80105668:	89 04 24             	mov    %eax,(%esp)
8010566b:	e8 20 c3 ff ff       	call   80101990 <iunlockput>

	ip->nlink--;
80105670:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
	iupdate(ip);
80105675:	89 1c 24             	mov    %ebx,(%esp)
80105678:	e8 a3 bf ff ff       	call   80101620 <iupdate>
	iunlockput(ip);
8010567d:	89 1c 24             	mov    %ebx,(%esp)
80105680:	e8 0b c3 ff ff       	call   80101990 <iunlockput>

	end_op();
80105685:	e8 76 d5 ff ff       	call   80102c00 <end_op>
...
8010568a:	83 c4 5c             	add    $0x5c,%esp
	iupdate(ip);
	iunlockput(ip);
...
80105698:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
8010569c:	0f 86 79 ff ff ff    	jbe    8010561b <sys_unlink+0xbb>
801056a2:	bf 20 00 00 00       	mov    $0x20,%edi
801056a7:	eb 15                	jmp    801056be <sys_unlink+0x15e>
801056a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801056b0:	8d 57 10             	lea    0x10(%edi),%edx
801056b3:	3b 53 58             	cmp    0x58(%ebx),%edx
801056b6:	0f 83 5f ff ff ff    	jae    8010561b <sys_unlink+0xbb>
801056bc:	89 d7                	mov    %edx,%edi
		if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801056be:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801056c5:	00 
801056c6:	89 7c 24 08          	mov    %edi,0x8(%esp)
801056ca:	89 74 24 04          	mov    %esi,0x4(%esp)
801056ce:	89 1c 24             	mov    %ebx,(%esp)
801056d1:	e8 0a c3 ff ff       	call   801019e0 <readi>
801056d6:	83 f8 10             	cmp    $0x10,%eax
801056d9:	75 42                	jne    8010571d <sys_unlink+0x1bd>
			panic("isdirempty: readi");
		if(de.inum != 0)
801056db:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
801056e0:	74 ce                	je     801056b0 <sys_unlink+0x150>
	ilock(ip);
...
801056e5:	e8 a6 c2 ff ff       	call   80101990 <iunlockput>
	end_op();
	...
	bad:
	iunlockput(dp);
801056ea:	8b 45 b4             	mov    -0x4c(%ebp),%eax
801056ed:	89 04 24             	mov    %eax,(%esp)
801056f0:	e8 9b c2 ff ff       	call   80101990 <iunlockput>
	end_op();
801056f5:	e8 06 d5 ff ff       	call   80102c00 <end_op>
	return -1;
}
801056fa:	83 c4 5c             	add    $0x5c,%esp
	return 0;
...
8010570b:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
		iupdate(dp);
80105710:	89 04 24             	mov    %eax,(%esp)
80105713:	e8 08 bf ff ff       	call   80101620 <iupdate>
80105718:	e9 48 ff ff ff       	jmp    80105665 <sys_unlink+0x105>
	int off;
	struct dirent de;
	...
	for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
		if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
			panic("isdirempty: readi");
8010571d:	c7 04 24 16 7e 10 80 	movl   $0x80107e16,(%esp)
80105724:	e8 37 ac ff ff       	call   80100360 <panic>
		goto bad;
	}
	...
	if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
		panic("unlink: writei");
80105729:	c7 04 24 28 7e 10 80 	movl   $0x80107e28,(%esp)
80105730:	e8 2b ac ff ff       	call   80100360 <panic>
	if((ip = dirlookup(dp, name, &off)) == 0)
		goto bad;
	ilock(ip);
	...
	if(ip->nlink < 1)
		panic("unlink: nlink < 1");
80105735:	c7 04 24 04 7e 10 80 	movl   $0x80107e04,(%esp)
8010573c:	e8 1f ac ff ff       	call   80100360 <panic>
80105741:	eb 0d                	jmp    80105750 <sys_open>
80105743:	90                   	nop
80105744:	90                   	nop
80105745:	90                   	nop
80105746:	90                   	nop
...
80105756:	83 ec 2c             	sub    $0x2c,%esp
	char *path;
	int fd, omode;
	struct file *f;
	struct inode *ip;
...
80105759:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010575c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105760:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105767:	e8 14 ef ff ff       	call   80104680 <argstr>
8010576c:	85 c0                	test   %eax,%eax
8010576e:	0f 88 d1 00 00 00    	js     80105845 <sys_open+0xf5>
80105774:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105777:	89 44 24 04          	mov    %eax,0x4(%esp)
8010577b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105782:	e8 69 ee ff ff       	call   801045f0 <argint>
80105787:	85 c0                	test   %eax,%eax
80105789:	0f 88 b6 00 00 00    	js     80105845 <sys_open+0xf5>
		return -1;

	begin_op();
8010578f:	e8 fc d3 ff ff       	call   80102b90 <begin_op>

	if(omode & O_CREATE){
80105794:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105798:	0f 85 82 00 00 00    	jne    80105820 <sys_open+0xd0>
		if(ip == 0){
			end_op();
			return -1;
		}
		...
		if((ip = namei(path)) == 0){
8010579e:	8b 45 e0             	mov    -0x20(%ebp),%eax
801057a1:	89 04 24             	mov    %eax,(%esp)
801057a4:	e8 d7 c7 ff ff       	call   80101f80 <namei>
801057a9:	85 c0                	test   %eax,%eax
801057ab:	89 c6                	mov    %eax,%esi
801057ad:	0f 84 8d 00 00 00    	je     80105840 <sys_open+0xf0>
			end_op();
			return -1;
		}
		ilock(ip);
801057b3:	89 04 24             	mov    %eax,(%esp)
801057b6:	e8 25 bf ff ff       	call   801016e0 <ilock>
		if(ip->type == T_DIR && omode != O_RDONLY){
801057bb:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801057c0:	0f 84 92 00 00 00    	je     80105858 <sys_open+0x108>
			end_op();
			return -1;
		}
	}
...
801057c6:	e8 a5 b5 ff ff       	call   80100d70 <filealloc>
801057cb:	85 c0                	test   %eax,%eax
801057cd:	89 c3                	mov    %eax,%ebx
801057cf:	0f 84 93 00 00 00    	je     80105868 <sys_open+0x118>
801057d5:	e8 56 ef ff ff       	call   80104730 <fdalloc>
801057da:	85 c0                	test   %eax,%eax
801057dc:	89 c7                	mov    %eax,%edi
801057de:	0f 88 94 00 00 00    	js     80105878 <sys_open+0x128>
			fileclose(f);
		iunlockput(ip);
		end_op();
		return -1;
...
801057e7:	e8 d4 bf ff ff       	call   801017c0 <iunlock>
	end_op();
801057ec:	e8 0f d4 ff ff       	call   80102c00 <end_op>

	f->type = FD_INODE;
801057f1:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
	f->ip = ip;
	f->off = 0;
...
801057f7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
	...
	f->type = FD_INODE;
	f->ip = ip;
801057fa:	89 73 10             	mov    %esi,0x10(%ebx)
	f->off = 0;
801057fd:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
	f->readable = !(omode & O_WRONLY);
80105804:	89 c2                	mov    %eax,%edx
80105806:	83 e2 01             	and    $0x1,%edx
80105809:	83 f2 01             	xor    $0x1,%edx
	f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010580c:	a8 03                	test   $0x3,%al
	end_op();
	...
	f->off = 0;
	f->readable = !(omode & O_WRONLY);
8010580e:	88 53 08             	mov    %dl,0x8(%ebx)
	f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
	return fd;
80105811:	89 f8                	mov    %edi,%eax
	...
	f->readable = !(omode & O_WRONLY);
	f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105813:	0f 95 43 09          	setne  0x9(%ebx)
	return fd;
}
...
80105820:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105823:	31 c9                	xor    %ecx,%ecx
80105825:	ba 02 00 00 00       	mov    $0x2,%edx
8010582a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105831:	e8 3a ef ff ff       	call   80104770 <create>
		if(ip == 0){
80105836:	85 c0                	test   %eax,%eax
	...
	if(omode & O_CREATE){
		ip = create(path, T_FILE, 0, 0);
80105838:	89 c6                	mov    %eax,%esi
		if(ip == 0){
8010583a:	75 8a                	jne    801057c6 <sys_open+0x76>
8010583c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
		...
		iunlockput(ip);
		end_op();
80105840:	e8 bb d3 ff ff       	call   80102c00 <end_op>
	f->ip = ip;
	f->off = 0;
	f->readable = !(omode & O_WRONLY);
	f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
...
80105845:	83 c4 2c             	add    $0x2c,%esp
	if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
		if(f)
			fileclose(f);
		iunlockput(ip);
...
8010585d:	0f 84 63 ff ff ff    	je     801057c6 <sys_open+0x76>
80105863:	90                   	nop
80105864:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
		if(f)
			fileclose(f);
		iunlockput(ip);
80105868:	89 34 24             	mov    %esi,(%esp)
8010586b:	e8 20 c1 ff ff       	call   80101990 <iunlockput>
80105870:	eb ce                	jmp    80105840 <sys_open+0xf0>
...
8010587b:	e8 b0 b5 ff ff       	call   80100e30 <fileclose>
80105880:	eb e6                	jmp    80105868 <sys_open+0x118>
...
80105893:	83 ec 28             	sub    $0x28,%esp
	...
	begin_op();
80105896:	e8 f5 d2 ff ff       	call   80102b90 <begin_op>
	if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
8010589b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010589e:	89 44 24 04          	mov    %eax,0x4(%esp)
801058a2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801058a9:	e8 d2 ed ff ff       	call   80104680 <argstr>
801058ae:	85 c0                	test   %eax,%eax
801058b0:	78 2e                	js     801058e0 <sys_mkdir+0x50>
801058b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058b5:	31 c9                	xor    %ecx,%ecx
801058b7:	ba 01 00 00 00       	mov    $0x1,%edx
801058bc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801058c3:	e8 a8 ee ff ff       	call   80104770 <create>
801058c8:	85 c0                	test   %eax,%eax
801058ca:	74 14                	je     801058e0 <sys_mkdir+0x50>
		end_op();
		return -1;
	}
	iunlockput(ip);
801058cc:	89 04 24             	mov    %eax,(%esp)
801058cf:	e8 bc c0 ff ff       	call   80101990 <iunlockput>
	end_op();
801058d4:	e8 27 d3 ff ff       	call   80102c00 <end_op>
	return 0;
...
801058dd:	8d 76 00             	lea    0x0(%esi),%esi
	...
	if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
		end_op();
801058e0:	e8 1b d3 ff ff       	call   80102c00 <end_op>
		return -1;
...
801058f3:	83 ec 28             	sub    $0x28,%esp
	...
	begin_op();
801058f6:	e8 95 d2 ff ff       	call   80102b90 <begin_op>
	if((argstr(0, &path)) < 0 ||
801058fb:	8d 45 ec             	lea    -0x14(%ebp),%eax
801058fe:	89 44 24 04          	mov    %eax,0x4(%esp)
80105902:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105909:	e8 72 ed ff ff       	call   80104680 <argstr>
8010590e:	85 c0                	test   %eax,%eax
80105910:	78 5e                	js     80105970 <sys_mknod+0x80>
			argint(1, &major) < 0 ||
80105912:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105915:	89 44 24 04          	mov    %eax,0x4(%esp)
80105919:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105920:	e8 cb ec ff ff       	call   801045f0 <argint>
	struct inode *ip;
	char *path;
	int major, minor;
...
80105927:	78 47                	js     80105970 <sys_mknod+0x80>
			argint(1, &major) < 0 ||
			argint(2, &minor) < 0 ||
80105929:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010592c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105930:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105937:	e8 b4 ec ff ff       	call   801045f0 <argint>
	char *path;
	int major, minor;
...
8010593e:	78 30                	js     80105970 <sys_mknod+0x80>
			argint(2, &minor) < 0 ||
			(ip = create(path, T_DEV, major, minor)) == 0){
80105940:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
	int major, minor;
	...
	if((argstr(0, &path)) < 0 ||
			argint(1, &major) < 0 ||
			argint(2, &minor) < 0 ||
80105944:	ba 03 00 00 00       	mov    $0x3,%edx
			(ip = create(path, T_DEV, major, minor)) == 0){
80105949:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
8010594d:	89 04 24             	mov    %eax,(%esp)
	...
	if((argstr(0, &path)) < 0 ||
			argint(1, &major) < 0 ||
			argint(2, &minor) < 0 ||
80105950:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105953:	e8 18 ee ff ff       	call   80104770 <create>
80105958:	85 c0                	test   %eax,%eax
8010595a:	74 14                	je     80105970 <sys_mknod+0x80>
			(ip = create(path, T_DEV, major, minor)) == 0){
		end_op();
		return -1;
	}
...
8010595f:	e8 2c c0 ff ff       	call   80101990 <iunlockput>
	end_op();
80105964:	e8 97 d2 ff ff       	call   80102c00 <end_op>
	return 0;
...
8010596d:	8d 76 00             	lea    0x0(%esi),%esi
	...
	if((argstr(0, &path)) < 0 ||
			...
			(ip = create(path, T_DEV, major, minor)) == 0){
		end_op();
80105970:	e8 8b d2 ff ff       	call   80102c00 <end_op>
		return -1;
...
80105985:	83 ec 20             	sub    $0x20,%esp
	char *path;
	struct inode *ip;
	struct proc *curproc = myproc();
80105988:	e8 93 dd ff ff       	call   80103720 <myproc>
8010598d:	89 c6                	mov    %eax,%esi

	begin_op();
8010598f:	e8 fc d1 ff ff       	call   80102b90 <begin_op>
	if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105994:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105997:	89 44 24 04          	mov    %eax,0x4(%esp)
8010599b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059a2:	e8 d9 ec ff ff       	call   80104680 <argstr>
801059a7:	85 c0                	test   %eax,%eax
801059a9:	78 4a                	js     801059f5 <sys_chdir+0x75>
801059ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059ae:	89 04 24             	mov    %eax,(%esp)
801059b1:	e8 ca c5 ff ff       	call   80101f80 <namei>
801059b6:	85 c0                	test   %eax,%eax
801059b8:	89 c3                	mov    %eax,%ebx
801059ba:	74 39                	je     801059f5 <sys_chdir+0x75>
		end_op();
		return -1;
	}
	ilock(ip);
801059bc:	89 04 24             	mov    %eax,(%esp)
801059bf:	e8 1c bd ff ff       	call   801016e0 <ilock>
	if(ip->type != T_DIR){
801059c4:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
		iunlockput(ip);
801059c9:	89 1c 24             	mov    %ebx,(%esp)
	if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
		end_op();
		return -1;
	}
	ilock(ip);
	if(ip->type != T_DIR){
801059cc:	75 22                	jne    801059f0 <sys_chdir+0x70>
		iunlockput(ip);
		end_op();
		return -1;
	}
	iunlock(ip);
801059ce:	e8 ed bd ff ff       	call   801017c0 <iunlock>
	iput(curproc->cwd);
801059d3:	8b 46 68             	mov    0x68(%esi),%eax
801059d6:	89 04 24             	mov    %eax,(%esp)
801059d9:	e8 72 be ff ff       	call   80101850 <iput>
	end_op();
801059de:	e8 1d d2 ff ff       	call   80102c00 <end_op>
	curproc->cwd = ip;
	return 0;
801059e3:	31 c0                	xor    %eax,%eax
	...
	end_op();
	curproc->cwd = ip;
801059e5:	89 5e 68             	mov    %ebx,0x68(%esi)
	return 0;
}
801059e8:	83 c4 20             	add    $0x20,%esp
801059eb:	5b                   	pop    %ebx
801059ec:	5e                   	pop    %esi
801059ed:	5d                   	pop    %ebp
801059ee:	c3                   	ret    
801059ef:	90                   	nop
	...
	if(ip->type != T_DIR){
		iunlockput(ip);
801059f0:	e8 9b bf ff ff       	call   80101990 <iunlockput>
		end_op();
801059f5:	e8 06 d2 ff ff       	call   80102c00 <end_op>
	iunlock(ip);
	iput(curproc->cwd);
	end_op();
	curproc->cwd = ip;
...
801059fa:	83 c4 20             	add    $0x20,%esp
	}
	ilock(ip);
	if(ip->type != T_DIR){
		iunlockput(ip);
...
80105a16:	81 ec ac 00 00 00    	sub    $0xac,%esp
	char *path, *argv[MAXARG];
	int i;
	uint uargv, uarg;

	if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80105a1c:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
80105a22:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a26:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a2d:	e8 4e ec ff ff       	call   80104680 <argstr>
80105a32:	85 c0                	test   %eax,%eax
80105a34:	0f 88 84 00 00 00    	js     80105abe <sys_exec+0xae>
80105a3a:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105a40:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a4b:	e8 a0 eb ff ff       	call   801045f0 <argint>
80105a50:	85 c0                	test   %eax,%eax
80105a52:	78 6a                	js     80105abe <sys_exec+0xae>
		return -1;
	}
...
80105a5a:	31 db                	xor    %ebx,%ebx
	...
	memset(argv, 0, sizeof(argv));
80105a5c:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105a63:	00 
80105a64:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
80105a6a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105a71:	00 
80105a72:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105a78:	89 04 24             	mov    %eax,(%esp)
80105a7b:	e8 80 e8 ff ff       	call   80104300 <memset>
	for(i=0;; i++){
		if(i >= NELEM(argv))
			return -1;
		if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105a80:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105a86:	89 7c 24 04          	mov    %edi,0x4(%esp)
80105a8a:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80105a8d:	89 04 24             	mov    %eax,(%esp)
80105a90:	e8 bb ea ff ff       	call   80104550 <fetchint>
80105a95:	85 c0                	test   %eax,%eax
80105a97:	78 25                	js     80105abe <sys_exec+0xae>
			return -1;
		if(uarg == 0){
80105a99:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
80105a9f:	85 c0                	test   %eax,%eax
80105aa1:	74 2d                	je     80105ad0 <sys_exec+0xc0>
			argv[i] = 0;
			break;
		}
		if(fetchstr(uarg, &argv[i]) < 0)
80105aa3:	89 74 24 04          	mov    %esi,0x4(%esp)
80105aa7:	89 04 24             	mov    %eax,(%esp)
80105aaa:	e8 e1 ea ff ff       	call   80104590 <fetchstr>
80105aaf:	85 c0                	test   %eax,%eax
80105ab1:	78 0b                	js     80105abe <sys_exec+0xae>
...
80105ab6:	83 c6 04             	add    $0x4,%esi
		if(i >= NELEM(argv))
80105ab9:	83 fb 20             	cmp    $0x20,%ebx
80105abc:	75 c2                	jne    80105a80 <sys_exec+0x70>
		}
		if(fetchstr(uarg, &argv[i]) < 0)
			return -1;
	}
...
80105abe:	81 c4 ac 00 00 00    	add    $0xac,%esp
	char *path, *argv[MAXARG];
	int i;
	uint uargv, uarg;
...
80105ad6:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ada:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
		if(i >= NELEM(argv))
			return -1;
		if(fetchint(uargv+4*i, (int*)&uarg) < 0)
			return -1;
...
80105aee:	e8 ad ae ff ff       	call   801009a0 <exec>
}
80105af3:	81 c4 ac 00 00 00    	add    $0xac,%esp
80105af9:	5b                   	pop    %ebx
80105afa:	5e                   	pop    %esi
80105afb:	5f                   	pop    %edi
80105afc:	5d                   	pop    %ebp
...
80105b04:	83 ec 24             	sub    $0x24,%esp
	int *fd;
	struct file *rf, *wf;
	int fd0, fd1;
...
80105b0a:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105b11:	00 
80105b12:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b16:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b1d:	e8 fe ea ff ff       	call   80104620 <argptr>
80105b22:	85 c0                	test   %eax,%eax
80105b24:	78 6d                	js     80105b93 <sys_pipe+0x93>
		return -1;
...
80105b33:	e8 b8 d6 ff ff       	call   801031f0 <pipealloc>
80105b38:	85 c0                	test   %eax,%eax
80105b3a:	78 57                	js     80105b93 <sys_pipe+0x93>
		return -1;
	fd0 = -1;
	if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105b3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b3f:	e8 ec eb ff ff       	call   80104730 <fdalloc>
80105b44:	85 c0                	test   %eax,%eax
80105b46:	89 c3                	mov    %eax,%ebx
80105b48:	78 33                	js     80105b7d <sys_pipe+0x7d>
80105b4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b4d:	e8 de eb ff ff       	call   80104730 <fdalloc>
80105b52:	85 c0                	test   %eax,%eax
80105b54:	78 1a                	js     80105b70 <sys_pipe+0x70>
			myproc()->ofile[fd0] = 0;
		fileclose(rf);
		fileclose(wf);
		return -1;
	...
	fd[0] = fd0;
80105b56:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105b59:	89 1a                	mov    %ebx,(%edx)
	fd[1] = fd1;
80105b5b:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105b5e:	89 42 04             	mov    %eax,0x4(%edx)
	return 0;
}
80105b61:	83 c4 24             	add    $0x24,%esp
		fileclose(wf);
		return -1;
	}
	fd[0] = fd0;
...
80105b69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	...
	if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
		if(fd0 >= 0)
			myproc()->ofile[fd0] = 0;
80105b70:	e8 ab db ff ff       	call   80103720 <myproc>
80105b75:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80105b7c:	00 
		fileclose(rf);
80105b7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b80:	89 04 24             	mov    %eax,(%esp)
80105b83:	e8 a8 b2 ff ff       	call   80100e30 <fileclose>
		fileclose(wf);
80105b88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b8b:	89 04 24             	mov    %eax,(%esp)
80105b8e:	e8 9d b2 ff ff       	call   80100e30 <fileclose>
		return -1;
	}
	fd[0] = fd0;
	fd[1] = fd1;
...
80105b93:	83 c4 24             	add    $0x24,%esp
	if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
		if(fd0 >= 0)
			myproc()->ofile[fd0] = 0;
		fileclose(rf);
...
80105baa:	83 ec 1c             	sub    $0x1c,%esp
	pde_t * pageDirectory = myproc()->pgdir;
80105bad:	e8 6e db ff ff       	call   80103720 <myproc>
	pte_t * pageTable;
	int pageDirectoryIndex;
	int pageTableIndex;
	int presentPagesCounter = 0;
...
80105bb2:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
#include "proc.h"
//#include "user.h"
...
sys_myMemory(void){
	pde_t * pageDirectory = myproc()->pgdir;
80105bb9:	8b 40 04             	mov    0x4(%eax),%eax
80105bbc:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105bbf:	90                   	nop
	int pageDirectoryIndex;
	int pageTableIndex;
	int presentPagesCounter = 0;
...
80105bc0:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105bc3:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80105bc6:	8b 04 98             	mov    (%eax,%ebx,4),%eax
80105bc9:	a8 01                	test   $0x1,%al
80105bcb:	74 3b                	je     80105c08 <sys_myMemory+0x68>
			pageTable = (pde_t *)P2V(PTE_ADDR(pageDirectory[pageDirectoryIndex]));
80105bcd:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80105bd2:	8d 98 00 10 00 80    	lea    -0x7ffff000(%eax),%ebx
80105bd8:	05 00 00 00 80       	add    $0x80000000,%eax
80105bdd:	eb 08                	jmp    80105be7 <sys_myMemory+0x47>
80105bdf:	90                   	nop
80105be0:	83 c0 04             	add    $0x4,%eax
			for(pageTableIndex=0; pageTableIndex<1024; pageTableIndex++){
80105be3:	39 d8                	cmp    %ebx,%eax
80105be5:	74 21                	je     80105c08 <sys_myMemory+0x68>
				if((pageTable[pageTableIndex] & (uint)PTE_U) && (pageTable[pageTableIndex] & (uint)PTE_P)){
80105be7:	8b 10                	mov    (%eax),%edx
80105be9:	89 d1                	mov    %edx,%ecx
80105beb:	83 e1 05             	and    $0x5,%ecx
80105bee:	83 f9 05             	cmp    $0x5,%ecx
80105bf1:	75 ed                	jne    80105be0 <sys_myMemory+0x40>
					// Page is present
					presentPagesCounter++;
					if ((pageTable[pageTableIndex] & (uint)PTE_W)){
80105bf3:	83 e2 02             	and    $0x2,%edx
		if ((((pageDirectory[pageDirectoryIndex]) & (uint)PTE_P))){
			pageTable = (pde_t *)P2V(PTE_ADDR(pageDirectory[pageDirectoryIndex]));
			for(pageTableIndex=0; pageTableIndex<1024; pageTableIndex++){
				if((pageTable[pageTableIndex] & (uint)PTE_U) && (pageTable[pageTableIndex] & (uint)PTE_P)){
					// Page is present
					presentPagesCounter++;
80105bf6:	83 c6 01             	add    $0x1,%esi
					if ((pageTable[pageTableIndex] & (uint)PTE_W)){
						//Page is accessible and writable
						userWritePagesCounter++;
80105bf9:	83 fa 01             	cmp    $0x1,%edx
80105bfc:	83 df ff             	sbb    $0xffffffff,%edi
80105bff:	83 c0 04             	add    $0x4,%eax
	int presentPagesCounter = 0;
	int userWritePagesCounter = 0;
	for(pageDirectoryIndex=0; pageDirectoryIndex < 1024;pageDirectoryIndex++){
		if ((((pageDirectory[pageDirectoryIndex]) & (uint)PTE_P))){
			pageTable = (pde_t *)P2V(PTE_ADDR(pageDirectory[pageDirectoryIndex]));
			for(pageTableIndex=0; pageTableIndex<1024; pageTableIndex++){
80105c02:	39 d8                	cmp    %ebx,%eax
80105c04:	75 e1                	jne    80105be7 <sys_myMemory+0x47>
80105c06:	66 90                	xchg   %ax,%ax
	...
	int userWritePagesCounter = 0;
	for(pageDirectoryIndex=0; pageDirectoryIndex < 1024;pageDirectoryIndex++){
80105c08:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80105c0c:	81 7d e4 00 04 00 00 	cmpl   $0x400,-0x1c(%ebp)
80105c13:	75 ab                	jne    80105bc0 <sys_myMemory+0x20>
				}
			}
		}
	}
...
80105c15:	89 74 24 04          	mov    %esi,0x4(%esp)
80105c19:	c7 04 24 46 7f 10 80 	movl   $0x80107f46,(%esp)
80105c20:	e8 2b aa ff ff       	call   80100650 <cprintf>
	cprintf("Write/User Pages: %d\n",userWritePagesCounter);
80105c25:	89 7c 24 04          	mov    %edi,0x4(%esp)
80105c29:	c7 04 24 59 7f 10 80 	movl   $0x80107f59,(%esp)
80105c30:	e8 1b aa ff ff       	call   80100650 <cprintf>
	return presentPagesCounter;
}
80105c35:	83 c4 1c             	add    $0x1c,%esp
80105c38:	89 f0                	mov    %esi,%eax
80105c3a:	5b                   	pop    %ebx
80105c3b:	5e                   	pop    %esi
80105c3c:	5f                   	pop    %edi
80105c3d:	5d                   	pop    %ebp
...
{
  return fork();
80105c44:	e9 87 dc ff ff       	jmp    801038d0 <fork>
...
80105c53:	83 ec 08             	sub    $0x8,%esp
  exit();
80105c56:	e8 c5 de ff ff       	call   80103b20 <exit>
...
{
  return wait();
80105c64:	e9 c7 e0 ff ff       	jmp    80103d30 <wait>
...
80105c84:	e8 67 e9 ff ff       	call   801045f0 <argint>
80105c89:	85 c0                	test   %eax,%eax
80105c8b:	78 13                	js     80105ca0 <sys_kill+0x30>
    return -1;
  return kill(pid);
80105c8d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c90:	89 04 24             	mov    %eax,(%esp)
80105c93:	e8 d8 e1 ff ff       	call   80103e70 <kill>
}
80105c98:	c9                   	leave  
80105c99:	c3                   	ret    
...
80105cb3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105cb6:	e8 65 da ff ff       	call   80103720 <myproc>
...
80105cc4:	83 ec 24             	sub    $0x24,%esp
  int addr;
  int n;
...
80105cd5:	e8 16 e9 ff ff       	call   801045f0 <argint>
80105cda:	85 c0                	test   %eax,%eax
80105cdc:	78 22                	js     80105d00 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105cde:	e8 3d da ff ff       	call   80103720 <myproc>
  if(growproc(n) < 0)
80105ce3:	8b 55 f4             	mov    -0xc(%ebp),%edx
  int addr;
  int n;
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = myproc()->sz;
80105ce6:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105ce8:	89 14 24             	mov    %edx,(%esp)
80105ceb:	e8 70 db ff ff       	call   80103860 <growproc>
80105cf0:	85 c0                	test   %eax,%eax
80105cf2:	78 0c                	js     80105d00 <sys_sbrk+0x40>
    return -1;
  return addr;
80105cf4:	89 d8                	mov    %ebx,%eax
}
80105cf6:	83 c4 24             	add    $0x24,%esp
80105cf9:	5b                   	pop    %ebx
80105cfa:	5d                   	pop    %ebp
80105cfb:	c3                   	ret    
...
80105d14:	83 ec 24             	sub    $0x24,%esp
  int n;
  uint ticks0;
...
80105d25:	e8 c6 e8 ff ff       	call   801045f0 <argint>
80105d2a:	85 c0                	test   %eax,%eax
80105d2c:	78 7e                	js     80105dac <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
80105d2e:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105d35:	e8 86 e4 ff ff       	call   801041c0 <acquire>
  ticks0 = ticks;
...
80105d3a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105d3d:	8b 1d 00 6e 11 80    	mov    0x80116e00,%ebx
  while(ticks - ticks0 < n){
80105d43:	85 d2                	test   %edx,%edx
80105d45:	75 29                	jne    80105d70 <sys_sleep+0x60>
80105d47:	eb 4f                	jmp    80105d98 <sys_sleep+0x88>
...
80105d50:	c7 44 24 04 c0 65 11 	movl   $0x801165c0,0x4(%esp)
80105d57:	80 
80105d58:	c7 04 24 00 6e 11 80 	movl   $0x80116e00,(%esp)
80105d5f:	e8 1c df ff ff       	call   80103c80 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105d64:	a1 00 6e 11 80       	mov    0x80116e00,%eax
80105d69:	29 d8                	sub    %ebx,%eax
80105d6b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80105d6e:	73 28                	jae    80105d98 <sys_sleep+0x88>
    if(myproc()->killed){
80105d70:	e8 ab d9 ff ff       	call   80103720 <myproc>
80105d75:	8b 40 24             	mov    0x24(%eax),%eax
80105d78:	85 c0                	test   %eax,%eax
80105d7a:	74 d4                	je     80105d50 <sys_sleep+0x40>
      release(&tickslock);
80105d7c:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105d83:	e8 28 e5 ff ff       	call   801042b0 <release>
      return -1;
...
80105d8d:	83 c4 24             	add    $0x24,%esp
80105d90:	5b                   	pop    %ebx
80105d91:	5d                   	pop    %ebp
80105d92:	c3                   	ret    
80105d93:	90                   	nop
80105d94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105d98:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105d9f:	e8 0c e5 ff ff       	call   801042b0 <release>
  return 0;
}
...
80105db1:	eb da                	jmp    80105d8d <sys_sleep+0x7d>
80105db3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80105dc4:	83 ec 14             	sub    $0x14,%esp
  uint xticks;

  acquire(&tickslock);
80105dc7:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105dce:	e8 ed e3 ff ff       	call   801041c0 <acquire>
  xticks = ticks;
80105dd3:	8b 1d 00 6e 11 80    	mov    0x80116e00,%ebx
  release(&tickslock);
80105dd9:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105de0:	e8 cb e4 ff ff       	call   801042b0 <release>
  return xticks;
}
80105de5:	83 c4 14             	add    $0x14,%esp
80105de8:	89 d8                	mov    %ebx,%eax
80105dea:	5b                   	pop    %ebx
80105deb:	5d                   	pop    %ebp
80105dec:	c3                   	ret    
...
80105dee:	06                   	push   %es
  pushl %fs
80105def:	0f a0                	push   %fs
  pushl %gs
80105df1:	0f a8                	push   %gs
  pushal
80105df3:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105df4:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105df8:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105dfa:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105dfc:	54                   	push   %esp
  call trap
80105dfd:	e8 de 00 00 00       	call   80105ee0 <trap>
  addl $4, %esp
80105e02:	83 c4 04             	add    $0x4,%esp
...
80105e05:	61                   	popa   
  popl %gs
80105e06:	0f a9                	pop    %gs
  popl %fs
80105e08:	0f a1                	pop    %fs
  popl %es
80105e0a:	07                   	pop    %es
  popl %ds
80105e0b:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105e0c:	83 c4 08             	add    $0x8,%esp
  iret
80105e0f:	cf                   	iret   
...
80105e18:	8b 14 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%edx
80105e1f:	b9 08 00 00 00       	mov    $0x8,%ecx
80105e24:	66 89 0c c5 02 66 11 	mov    %cx,-0x7fee99fe(,%eax,8)
80105e2b:	80 
80105e2c:	c6 04 c5 04 66 11 80 	movb   $0x0,-0x7fee99fc(,%eax,8)
80105e33:	00 
80105e34:	c6 04 c5 05 66 11 80 	movb   $0x8e,-0x7fee99fb(,%eax,8)
80105e3b:	8e 
80105e3c:	66 89 14 c5 00 66 11 	mov    %dx,-0x7fee9a00(,%eax,8)
80105e43:	80 
80105e44:	c1 ea 10             	shr    $0x10,%edx
80105e47:	66 89 14 c5 06 66 11 	mov    %dx,-0x7fee99fa(,%eax,8)
80105e4e:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80105e4f:	83 c0 01             	add    $0x1,%eax
80105e52:	3d 00 01 00 00       	cmp    $0x100,%eax
80105e57:	75 bf                	jne    80105e18 <tvinit+0x8>
...
80105e5a:	ba 08 00 00 00       	mov    $0x8,%edx
struct spinlock tickslock;
uint ticks;
...
80105e61:	83 ec 18             	sub    $0x18,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e64:	a1 08 b1 10 80       	mov    0x8010b108,%eax

  initlock(&tickslock, "time");
80105e69:	c7 44 24 04 6f 7f 10 	movl   $0x80107f6f,0x4(%esp)
80105e70:	80 
80105e71:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e78:	66 89 15 02 68 11 80 	mov    %dx,0x80116802
80105e7f:	66 a3 00 68 11 80    	mov    %ax,0x80116800
80105e85:	c1 e8 10             	shr    $0x10,%eax
80105e88:	c6 05 04 68 11 80 00 	movb   $0x0,0x80116804
80105e8f:	c6 05 05 68 11 80 ef 	movb   $0xef,0x80116805
80105e96:	66 a3 06 68 11 80    	mov    %ax,0x80116806

  initlock(&tickslock, "time");
80105e9c:	e8 2f e2 ff ff       	call   801040d0 <initlock>
}
80105ea1:	c9                   	leave  
80105ea2:	c3                   	ret    
80105ea3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80105ebb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105ebf:	b8 00 66 11 80       	mov    $0x80116600,%eax
...
80105efe:	77 08                	ja     80105f08 <trap+0x28>
80105f00:	ff 24 85 18 80 10 80 	jmp    *-0x7fef7fe8(,%eax,4)
80105f07:	90                   	nop
    lapiceoi();
    break;
...
80105f08:	e8 13 d8 ff ff       	call   80103720 <myproc>
80105f0d:	85 c0                	test   %eax,%eax
80105f0f:	90                   	nop
80105f10:	0f 84 fa 01 00 00    	je     80106110 <trap+0x230>
80105f16:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105f1a:	0f 84 f0 01 00 00    	je     80106110 <trap+0x230>
...
80105f23:	8b 53 38             	mov    0x38(%ebx),%edx
80105f26:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105f29:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105f2c:	e8 cf d7 ff ff       	call   80103700 <cpuid>
80105f31:	8b 73 30             	mov    0x30(%ebx),%esi
80105f34:	89 c7                	mov    %eax,%edi
80105f36:	8b 43 34             	mov    0x34(%ebx),%eax
80105f39:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105f3c:	e8 df d7 ff ff       	call   80103720 <myproc>
80105f41:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105f44:	e8 d7 d7 ff ff       	call   80103720 <myproc>
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105f49:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105f4c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105f50:	8b 75 e0             	mov    -0x20(%ebp),%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105f53:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105f56:	89 7c 24 14          	mov    %edi,0x14(%esp)
80105f5a:	89 54 24 18          	mov    %edx,0x18(%esp)
80105f5e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105f61:	83 c6 6c             	add    $0x6c,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105f64:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105f68:	89 74 24 08          	mov    %esi,0x8(%esp)
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105f6c:	89 54 24 10          	mov    %edx,0x10(%esp)
80105f70:	8b 40 10             	mov    0x10(%eax),%eax
80105f73:	c7 04 24 d4 7f 10 80 	movl   $0x80107fd4,(%esp)
80105f7a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f7e:	e8 cd a6 ff ff       	call   80100650 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105f83:	e8 98 d7 ff ff       	call   80103720 <myproc>
80105f88:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80105f8f:	90                   	nop
  }
...
80105f97:	74 0c                	je     80105fa5 <trap+0xc5>
80105f99:	e8 82 d7 ff ff       	call   80103720 <myproc>
80105f9e:	8b 50 24             	mov    0x24(%eax),%edx
80105fa1:	85 d2                	test   %edx,%edx
80105fa3:	75 4b                	jne    80105ff0 <trap+0x110>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105fa5:	e8 76 d7 ff ff       	call   80103720 <myproc>
80105faa:	85 c0                	test   %eax,%eax
80105fac:	74 0d                	je     80105fbb <trap+0xdb>
80105fae:	66 90                	xchg   %ax,%ax
80105fb0:	e8 6b d7 ff ff       	call   80103720 <myproc>
80105fb5:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105fb9:	74 4d                	je     80106008 <trap+0x128>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105fbb:	e8 60 d7 ff ff       	call   80103720 <myproc>
80105fc0:	85 c0                	test   %eax,%eax
80105fc2:	74 1d                	je     80105fe1 <trap+0x101>
80105fc4:	e8 57 d7 ff ff       	call   80103720 <myproc>
80105fc9:	8b 40 24             	mov    0x24(%eax),%eax
80105fcc:	85 c0                	test   %eax,%eax
80105fce:	74 11                	je     80105fe1 <trap+0x101>
80105fd0:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105fd4:	83 e0 03             	and    $0x3,%eax
80105fd7:	66 83 f8 03          	cmp    $0x3,%ax
80105fdb:	0f 84 e8 00 00 00    	je     801060c9 <trap+0x1e9>
    exit();
}
80105fe1:	83 c4 3c             	add    $0x3c,%esp
80105fe4:	5b                   	pop    %ebx
80105fe5:	5e                   	pop    %esi
80105fe6:	5f                   	pop    %edi
80105fe7:	5d                   	pop    %ebp
...
80105fe9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ff0:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105ff4:	83 e0 03             	and    $0x3,%eax
80105ff7:	66 83 f8 03          	cmp    $0x3,%ax
80105ffb:	75 a8                	jne    80105fa5 <trap+0xc5>
    exit();
80105ffd:	e8 1e db ff ff       	call   80103b20 <exit>
80106002:	eb a1                	jmp    80105fa5 <trap+0xc5>
...
80106010:	75 a9                	jne    80105fbb <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80106012:	e8 29 dc ff ff       	call   80103c40 <yield>
80106017:	eb a2                	jmp    80105fbb <trap+0xdb>
80106019:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80106020:	e8 db d6 ff ff       	call   80103700 <cpuid>
80106025:	85 c0                	test   %eax,%eax
80106027:	0f 84 b3 00 00 00    	je     801060e0 <trap+0x200>
8010602d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80106030:	e8 cb c7 ff ff       	call   80102800 <lapiceoi>
    break;
80106035:	e9 56 ff ff ff       	jmp    80105f90 <trap+0xb0>
8010603a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106040:	e8 0b c6 ff ff       	call   80102650 <kbdintr>
    lapiceoi();
80106045:	e8 b6 c7 ff ff       	call   80102800 <lapiceoi>
    break;
8010604a:	e9 41 ff ff ff       	jmp    80105f90 <trap+0xb0>
8010604f:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106050:	e8 1b 02 00 00       	call   80106270 <uartintr>
    lapiceoi();
80106055:	e8 a6 c7 ff ff       	call   80102800 <lapiceoi>
    break;
8010605a:	e9 31 ff ff ff       	jmp    80105f90 <trap+0xb0>
8010605f:	90                   	nop
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106060:	8b 7b 38             	mov    0x38(%ebx),%edi
80106063:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80106067:	e8 94 d6 ff ff       	call   80103700 <cpuid>
8010606c:	c7 04 24 7c 7f 10 80 	movl   $0x80107f7c,(%esp)
80106073:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106077:	89 74 24 08          	mov    %esi,0x8(%esp)
8010607b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010607f:	e8 cc a5 ff ff       	call   80100650 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80106084:	e8 77 c7 ff ff       	call   80102800 <lapiceoi>
    break;
80106089:	e9 02 ff ff ff       	jmp    80105f90 <trap+0xb0>
8010608e:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106090:	e8 6b c0 ff ff       	call   80102100 <ideintr>
80106095:	eb 96                	jmp    8010602d <trap+0x14d>
80106097:	90                   	nop
80106098:	90                   	nop
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
801060a0:	e8 7b d6 ff ff       	call   80103720 <myproc>
801060a5:	8b 70 24             	mov    0x24(%eax),%esi
801060a8:	85 f6                	test   %esi,%esi
801060aa:	75 2c                	jne    801060d8 <trap+0x1f8>
      exit();
    myproc()->tf = tf;
801060ac:	e8 6f d6 ff ff       	call   80103720 <myproc>
801060b1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801060b4:	e8 07 e6 ff ff       	call   801046c0 <syscall>
    if(myproc()->killed)
801060b9:	e8 62 d6 ff ff       	call   80103720 <myproc>
801060be:	8b 48 24             	mov    0x24(%eax),%ecx
801060c1:	85 c9                	test   %ecx,%ecx
801060c3:	0f 84 18 ff ff ff    	je     80105fe1 <trap+0x101>
    yield();
...
801060c9:	83 c4 3c             	add    $0x3c,%esp
801060cc:	5b                   	pop    %ebx
801060cd:	5e                   	pop    %esi
801060ce:	5f                   	pop    %edi
801060cf:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801060d0:	e9 4b da ff ff       	jmp    80103b20 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801060d8:	e8 43 da ff ff       	call   80103b20 <exit>
801060dd:	eb cd                	jmp    801060ac <trap+0x1cc>
801060df:	90                   	nop
  }
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
801060e0:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
801060e7:	e8 d4 e0 ff ff       	call   801041c0 <acquire>
      ticks++;
      wakeup(&ticks);
801060ec:	c7 04 24 00 6e 11 80 	movl   $0x80116e00,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
801060f3:	83 05 00 6e 11 80 01 	addl   $0x1,0x80116e00
      wakeup(&ticks);
801060fa:	e8 11 dd ff ff       	call   80103e10 <wakeup>
      release(&tickslock);
801060ff:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80106106:	e8 a5 e1 ff ff       	call   801042b0 <release>
8010610b:	e9 1d ff ff ff       	jmp    8010602d <trap+0x14d>
80106110:	0f 20 d7             	mov    %cr2,%edi
  ...
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106113:	8b 73 38             	mov    0x38(%ebx),%esi
80106116:	e8 e5 d5 ff ff       	call   80103700 <cpuid>
8010611b:	89 7c 24 10          	mov    %edi,0x10(%esp)
8010611f:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106123:	89 44 24 08          	mov    %eax,0x8(%esp)
80106127:	8b 43 30             	mov    0x30(%ebx),%eax
8010612a:	c7 04 24 a0 7f 10 80 	movl   $0x80107fa0,(%esp)
80106131:	89 44 24 04          	mov    %eax,0x4(%esp)
80106135:	e8 16 a5 ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010613a:	c7 04 24 74 7f 10 80 	movl   $0x80107f74,(%esp)
80106141:	e8 1a a2 ff ff       	call   80100360 <panic>
...
{
  if(!uart)
80106150:	a1 bc b5 10 80       	mov    0x8010b5bc,%eax
  outb(COM1+0, c);
}
...
8010615a:	74 14                	je     80106170 <uartgetc+0x20>
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010615c:	ba fd 03 00 00       	mov    $0x3fd,%edx
80106161:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80106162:	a8 01                	test   $0x1,%al
80106164:	74 0a                	je     80106170 <uartgetc+0x20>
80106166:	b2 f8                	mov    $0xf8,%dl
...
80106187:	74 3f                	je     801061c8 <uartputc+0x48>
    uartputc(*p);
}
...
8010619b:	eb 14                	jmp    801061b1 <uartputc+0x31>
8010619d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
    microdelay(10);
801061a0:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801061a7:	e8 74 c6 ff ff       	call   80102820 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801061ac:	83 eb 01             	sub    $0x1,%ebx
801061af:	74 07                	je     801061b8 <uartputc+0x38>
801061b1:	89 f2                	mov    %esi,%edx
801061b3:	ec                   	in     (%dx),%al
801061b4:	a8 20                	test   $0x20,%al
801061b6:	74 e8                	je     801061a0 <uartputc+0x20>
    microdelay(10);
  outb(COM1+0, c);
801061b8:	0f b6 45 08          	movzbl 0x8(%ebp),%eax
}
...
801061d1:	31 c9                	xor    %ecx,%ecx
801061d3:	89 e5                	mov    %esp,%ebp
801061d5:	89 c8                	mov    %ecx,%eax
801061d7:	57                   	push   %edi
801061d8:	bf fa 03 00 00       	mov    $0x3fa,%edi
801061dd:	56                   	push   %esi
801061de:	89 fa                	mov    %edi,%edx
801061e0:	53                   	push   %ebx
801061e1:	83 ec 1c             	sub    $0x1c,%esp
801061e4:	ee                   	out    %al,(%dx)
801061e5:	be fb 03 00 00       	mov    $0x3fb,%esi
801061ea:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801061ef:	89 f2                	mov    %esi,%edx
801061f1:	ee                   	out    %al,(%dx)
801061f2:	b8 0c 00 00 00       	mov    $0xc,%eax
801061f7:	b2 f8                	mov    $0xf8,%dl
801061f9:	ee                   	out    %al,(%dx)
801061fa:	bb f9 03 00 00       	mov    $0x3f9,%ebx
801061ff:	89 c8                	mov    %ecx,%eax
80106201:	89 da                	mov    %ebx,%edx
80106203:	ee                   	out    %al,(%dx)
80106204:	b8 03 00 00 00       	mov    $0x3,%eax
80106209:	89 f2                	mov    %esi,%edx
8010620b:	ee                   	out    %al,(%dx)
8010620c:	b2 fc                	mov    $0xfc,%dl
8010620e:	89 c8                	mov    %ecx,%eax
80106210:	ee                   	out    %al,(%dx)
80106211:	b8 01 00 00 00       	mov    $0x1,%eax
80106216:	89 da                	mov    %ebx,%edx
80106218:	ee                   	out    %al,(%dx)
static inline uchar
inb(ushort port)
{
  uchar data;
...
8010621b:	ec                   	in     (%dx),%al
  ...
  if(inb(COM1+5) == 0xFF)
8010621c:	3c ff                	cmp    $0xff,%al
8010621e:	74 42                	je     80106262 <uartinit+0x92>
    return;
  uart = 1;
80106220:	c7 05 bc b5 10 80 01 	movl   $0x1,0x8010b5bc
80106227:	00 00 00 
8010622a:	89 fa                	mov    %edi,%edx
8010622c:	ec                   	in     (%dx),%al
8010622d:	b2 f8                	mov    $0xf8,%dl
8010622f:	ec                   	in     (%dx),%al
...
80106230:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106237:	00 

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106238:	bb 98 80 10 80       	mov    $0x80108098,%ebx
  ...
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
8010623d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106244:	e8 e7 c0 ff ff       	call   80102330 <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106249:	b8 78 00 00 00       	mov    $0x78,%eax
...
80106250:	89 04 24             	mov    %eax,(%esp)
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106253:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80106256:	e8 25 ff ff ff       	call   80106180 <uartputc>
  inb(COM1+2);
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010625b:	0f be 03             	movsbl (%ebx),%eax
8010625e:	84 c0                	test   %al,%al
80106260:	75 ee                	jne    80106250 <uartinit+0x80>
    uartputc(*p);
}
80106262:	83 c4 1c             	add    $0x1c,%esp
80106265:	5b                   	pop    %ebx
80106266:	5e                   	pop    %esi
80106267:	5f                   	pop    %edi
80106268:	5d                   	pop    %ebp
...
80106276:	c7 04 24 50 61 10 80 	movl   $0x80106150,(%esp)
8010627d:	e8 2e a5 ff ff       	call   801007b0 <consoleintr>
}
80106282:	c9                   	leave  
80106283:	c3                   	ret    
...
80106286:	6a 00                	push   $0x0
  jmp alltraps
80106288:	e9 60 fb ff ff       	jmp    80105ded <alltraps>
...
8010628f:	6a 01                	push   $0x1
  jmp alltraps
80106291:	e9 57 fb ff ff       	jmp    80105ded <alltraps>
...
80106298:	6a 02                	push   $0x2
  jmp alltraps
8010629a:	e9 4e fb ff ff       	jmp    80105ded <alltraps>
...
801062a1:	6a 03                	push   $0x3
  jmp alltraps
801062a3:	e9 45 fb ff ff       	jmp    80105ded <alltraps>
...
801062a8:	6a 00                	push   $0x0
  pushl $4
801062aa:	6a 04                	push   $0x4
  jmp alltraps
801062ac:	e9 3c fb ff ff       	jmp    80105ded <alltraps>
...
801062b1:	6a 00                	push   $0x0
  pushl $5
801062b3:	6a 05                	push   $0x5
  jmp alltraps
801062b5:	e9 33 fb ff ff       	jmp    80105ded <alltraps>
...
801062ba:	6a 00                	push   $0x0
  pushl $6
801062bc:	6a 06                	push   $0x6
  jmp alltraps
801062be:	e9 2a fb ff ff       	jmp    80105ded <alltraps>
...
801062c3:	6a 00                	push   $0x0
  pushl $7
801062c5:	6a 07                	push   $0x7
  jmp alltraps
801062c7:	e9 21 fb ff ff       	jmp    80105ded <alltraps>
...
801062cc:	6a 08                	push   $0x8
  jmp alltraps
801062ce:	e9 1a fb ff ff       	jmp    80105ded <alltraps>
...
801062d3:	6a 00                	push   $0x0
  pushl $9
801062d5:	6a 09                	push   $0x9
  jmp alltraps
801062d7:	e9 11 fb ff ff       	jmp    80105ded <alltraps>

801062dc <vector10>:
.globl vector10
vector10:
  pushl $10
801062dc:	6a 0a                	push   $0xa
  jmp alltraps
801062de:	e9 0a fb ff ff       	jmp    80105ded <alltraps>

801062e3 <vector11>:
.globl vector11
vector11:
  pushl $11
801062e3:	6a 0b                	push   $0xb
  jmp alltraps
801062e5:	e9 03 fb ff ff       	jmp    80105ded <alltraps>

801062ea <vector12>:
.globl vector12
vector12:
  pushl $12
801062ea:	6a 0c                	push   $0xc
  jmp alltraps
801062ec:	e9 fc fa ff ff       	jmp    80105ded <alltraps>

801062f1 <vector13>:
.globl vector13
vector13:
  pushl $13
801062f1:	6a 0d                	push   $0xd
  jmp alltraps
801062f3:	e9 f5 fa ff ff       	jmp    80105ded <alltraps>

801062f8 <vector14>:
.globl vector14
vector14:
  pushl $14
801062f8:	6a 0e                	push   $0xe
  jmp alltraps
801062fa:	e9 ee fa ff ff       	jmp    80105ded <alltraps>
...
801062ff:	6a 00                	push   $0x0
  pushl $15
80106301:	6a 0f                	push   $0xf
  jmp alltraps
80106303:	e9 e5 fa ff ff       	jmp    80105ded <alltraps>
...
80106308:	6a 00                	push   $0x0
  pushl $16
8010630a:	6a 10                	push   $0x10
  jmp alltraps
8010630c:	e9 dc fa ff ff       	jmp    80105ded <alltraps>

80106311 <vector17>:
.globl vector17
vector17:
  pushl $17
80106311:	6a 11                	push   $0x11
  jmp alltraps
80106313:	e9 d5 fa ff ff       	jmp    80105ded <alltraps>
...
80106318:	6a 00                	push   $0x0
  pushl $18
8010631a:	6a 12                	push   $0x12
  jmp alltraps
8010631c:	e9 cc fa ff ff       	jmp    80105ded <alltraps>
...
80106321:	6a 00                	push   $0x0
  pushl $19
80106323:	6a 13                	push   $0x13
  jmp alltraps
80106325:	e9 c3 fa ff ff       	jmp    80105ded <alltraps>
...
8010632a:	6a 00                	push   $0x0
  pushl $20
8010632c:	6a 14                	push   $0x14
  jmp alltraps
8010632e:	e9 ba fa ff ff       	jmp    80105ded <alltraps>
...
80106333:	6a 00                	push   $0x0
  pushl $21
80106335:	6a 15                	push   $0x15
  jmp alltraps
80106337:	e9 b1 fa ff ff       	jmp    80105ded <alltraps>
...
8010633c:	6a 00                	push   $0x0
  pushl $22
8010633e:	6a 16                	push   $0x16
  jmp alltraps
80106340:	e9 a8 fa ff ff       	jmp    80105ded <alltraps>
...
80106345:	6a 00                	push   $0x0
  pushl $23
80106347:	6a 17                	push   $0x17
  jmp alltraps
80106349:	e9 9f fa ff ff       	jmp    80105ded <alltraps>
...
8010634e:	6a 00                	push   $0x0
  pushl $24
80106350:	6a 18                	push   $0x18
  jmp alltraps
80106352:	e9 96 fa ff ff       	jmp    80105ded <alltraps>
...
80106357:	6a 00                	push   $0x0
  pushl $25
80106359:	6a 19                	push   $0x19
  jmp alltraps
8010635b:	e9 8d fa ff ff       	jmp    80105ded <alltraps>
...
80106360:	6a 00                	push   $0x0
  pushl $26
80106362:	6a 1a                	push   $0x1a
  jmp alltraps
80106364:	e9 84 fa ff ff       	jmp    80105ded <alltraps>
...
80106369:	6a 00                	push   $0x0
  pushl $27
8010636b:	6a 1b                	push   $0x1b
  jmp alltraps
8010636d:	e9 7b fa ff ff       	jmp    80105ded <alltraps>
...
80106372:	6a 00                	push   $0x0
  pushl $28
80106374:	6a 1c                	push   $0x1c
  jmp alltraps
80106376:	e9 72 fa ff ff       	jmp    80105ded <alltraps>
...
8010637b:	6a 00                	push   $0x0
  pushl $29
8010637d:	6a 1d                	push   $0x1d
  jmp alltraps
8010637f:	e9 69 fa ff ff       	jmp    80105ded <alltraps>
...
80106384:	6a 00                	push   $0x0
  pushl $30
80106386:	6a 1e                	push   $0x1e
  jmp alltraps
80106388:	e9 60 fa ff ff       	jmp    80105ded <alltraps>
...
8010638d:	6a 00                	push   $0x0
  pushl $31
8010638f:	6a 1f                	push   $0x1f
  jmp alltraps
80106391:	e9 57 fa ff ff       	jmp    80105ded <alltraps>
...
80106396:	6a 00                	push   $0x0
  pushl $32
80106398:	6a 20                	push   $0x20
  jmp alltraps
8010639a:	e9 4e fa ff ff       	jmp    80105ded <alltraps>
...
8010639f:	6a 00                	push   $0x0
  pushl $33
801063a1:	6a 21                	push   $0x21
  jmp alltraps
801063a3:	e9 45 fa ff ff       	jmp    80105ded <alltraps>
...
801063a8:	6a 00                	push   $0x0
  pushl $34
801063aa:	6a 22                	push   $0x22
  jmp alltraps
801063ac:	e9 3c fa ff ff       	jmp    80105ded <alltraps>
...
801063b1:	6a 00                	push   $0x0
  pushl $35
801063b3:	6a 23                	push   $0x23
  jmp alltraps
801063b5:	e9 33 fa ff ff       	jmp    80105ded <alltraps>
...
801063ba:	6a 00                	push   $0x0
  pushl $36
801063bc:	6a 24                	push   $0x24
  jmp alltraps
801063be:	e9 2a fa ff ff       	jmp    80105ded <alltraps>
...
801063c3:	6a 00                	push   $0x0
  pushl $37
801063c5:	6a 25                	push   $0x25
  jmp alltraps
801063c7:	e9 21 fa ff ff       	jmp    80105ded <alltraps>
...
801063cc:	6a 00                	push   $0x0
  pushl $38
801063ce:	6a 26                	push   $0x26
  jmp alltraps
801063d0:	e9 18 fa ff ff       	jmp    80105ded <alltraps>
...
801063d5:	6a 00                	push   $0x0
  pushl $39
801063d7:	6a 27                	push   $0x27
  jmp alltraps
801063d9:	e9 0f fa ff ff       	jmp    80105ded <alltraps>
...
801063de:	6a 00                	push   $0x0
  pushl $40
801063e0:	6a 28                	push   $0x28
  jmp alltraps
801063e2:	e9 06 fa ff ff       	jmp    80105ded <alltraps>
...
801063e7:	6a 00                	push   $0x0
  pushl $41
801063e9:	6a 29                	push   $0x29
  jmp alltraps
801063eb:	e9 fd f9 ff ff       	jmp    80105ded <alltraps>
...
801063f0:	6a 00                	push   $0x0
  pushl $42
801063f2:	6a 2a                	push   $0x2a
  jmp alltraps
801063f4:	e9 f4 f9 ff ff       	jmp    80105ded <alltraps>
...
801063f9:	6a 00                	push   $0x0
  pushl $43
801063fb:	6a 2b                	push   $0x2b
  jmp alltraps
801063fd:	e9 eb f9 ff ff       	jmp    80105ded <alltraps>
...
80106402:	6a 00                	push   $0x0
  pushl $44
80106404:	6a 2c                	push   $0x2c
  jmp alltraps
80106406:	e9 e2 f9 ff ff       	jmp    80105ded <alltraps>
...
8010640b:	6a 00                	push   $0x0
  pushl $45
8010640d:	6a 2d                	push   $0x2d
  jmp alltraps
8010640f:	e9 d9 f9 ff ff       	jmp    80105ded <alltraps>
...
80106414:	6a 00                	push   $0x0
  pushl $46
80106416:	6a 2e                	push   $0x2e
  jmp alltraps
80106418:	e9 d0 f9 ff ff       	jmp    80105ded <alltraps>
...
8010641d:	6a 00                	push   $0x0
  pushl $47
8010641f:	6a 2f                	push   $0x2f
  jmp alltraps
80106421:	e9 c7 f9 ff ff       	jmp    80105ded <alltraps>
...
80106426:	6a 00                	push   $0x0
  pushl $48
80106428:	6a 30                	push   $0x30
  jmp alltraps
8010642a:	e9 be f9 ff ff       	jmp    80105ded <alltraps>
...
8010642f:	6a 00                	push   $0x0
  pushl $49
80106431:	6a 31                	push   $0x31
  jmp alltraps
80106433:	e9 b5 f9 ff ff       	jmp    80105ded <alltraps>
...
80106438:	6a 00                	push   $0x0
  pushl $50
8010643a:	6a 32                	push   $0x32
  jmp alltraps
8010643c:	e9 ac f9 ff ff       	jmp    80105ded <alltraps>
...
80106441:	6a 00                	push   $0x0
  pushl $51
80106443:	6a 33                	push   $0x33
  jmp alltraps
80106445:	e9 a3 f9 ff ff       	jmp    80105ded <alltraps>
...
8010644a:	6a 00                	push   $0x0
  pushl $52
8010644c:	6a 34                	push   $0x34
  jmp alltraps
8010644e:	e9 9a f9 ff ff       	jmp    80105ded <alltraps>
...
80106453:	6a 00                	push   $0x0
  pushl $53
80106455:	6a 35                	push   $0x35
  jmp alltraps
80106457:	e9 91 f9 ff ff       	jmp    80105ded <alltraps>
...
8010645c:	6a 00                	push   $0x0
  pushl $54
8010645e:	6a 36                	push   $0x36
  jmp alltraps
80106460:	e9 88 f9 ff ff       	jmp    80105ded <alltraps>
...
80106465:	6a 00                	push   $0x0
  pushl $55
80106467:	6a 37                	push   $0x37
  jmp alltraps
80106469:	e9 7f f9 ff ff       	jmp    80105ded <alltraps>
...
8010646e:	6a 00                	push   $0x0
  pushl $56
80106470:	6a 38                	push   $0x38
  jmp alltraps
80106472:	e9 76 f9 ff ff       	jmp    80105ded <alltraps>
...
80106477:	6a 00                	push   $0x0
  pushl $57
80106479:	6a 39                	push   $0x39
  jmp alltraps
8010647b:	e9 6d f9 ff ff       	jmp    80105ded <alltraps>
...
80106480:	6a 00                	push   $0x0
  pushl $58
80106482:	6a 3a                	push   $0x3a
  jmp alltraps
80106484:	e9 64 f9 ff ff       	jmp    80105ded <alltraps>
...
80106489:	6a 00                	push   $0x0
  pushl $59
8010648b:	6a 3b                	push   $0x3b
  jmp alltraps
8010648d:	e9 5b f9 ff ff       	jmp    80105ded <alltraps>
...
80106492:	6a 00                	push   $0x0
  pushl $60
80106494:	6a 3c                	push   $0x3c
  jmp alltraps
80106496:	e9 52 f9 ff ff       	jmp    80105ded <alltraps>
...
8010649b:	6a 00                	push   $0x0
  pushl $61
8010649d:	6a 3d                	push   $0x3d
  jmp alltraps
8010649f:	e9 49 f9 ff ff       	jmp    80105ded <alltraps>
...
801064a4:	6a 00                	push   $0x0
  pushl $62
801064a6:	6a 3e                	push   $0x3e
  jmp alltraps
801064a8:	e9 40 f9 ff ff       	jmp    80105ded <alltraps>
...
801064ad:	6a 00                	push   $0x0
  pushl $63
801064af:	6a 3f                	push   $0x3f
  jmp alltraps
801064b1:	e9 37 f9 ff ff       	jmp    80105ded <alltraps>
...
801064b6:	6a 00                	push   $0x0
  pushl $64
801064b8:	6a 40                	push   $0x40
  jmp alltraps
801064ba:	e9 2e f9 ff ff       	jmp    80105ded <alltraps>
...
801064bf:	6a 00                	push   $0x0
  pushl $65
801064c1:	6a 41                	push   $0x41
  jmp alltraps
801064c3:	e9 25 f9 ff ff       	jmp    80105ded <alltraps>
...
801064c8:	6a 00                	push   $0x0
  pushl $66
801064ca:	6a 42                	push   $0x42
  jmp alltraps
801064cc:	e9 1c f9 ff ff       	jmp    80105ded <alltraps>
...
801064d1:	6a 00                	push   $0x0
  pushl $67
801064d3:	6a 43                	push   $0x43
  jmp alltraps
801064d5:	e9 13 f9 ff ff       	jmp    80105ded <alltraps>
...
801064da:	6a 00                	push   $0x0
  pushl $68
801064dc:	6a 44                	push   $0x44
  jmp alltraps
801064de:	e9 0a f9 ff ff       	jmp    80105ded <alltraps>
...
801064e3:	6a 00                	push   $0x0
  pushl $69
801064e5:	6a 45                	push   $0x45
  jmp alltraps
801064e7:	e9 01 f9 ff ff       	jmp    80105ded <alltraps>
...
801064ec:	6a 00                	push   $0x0
  pushl $70
801064ee:	6a 46                	push   $0x46
  jmp alltraps
801064f0:	e9 f8 f8 ff ff       	jmp    80105ded <alltraps>
...
801064f5:	6a 00                	push   $0x0
  pushl $71
801064f7:	6a 47                	push   $0x47
  jmp alltraps
801064f9:	e9 ef f8 ff ff       	jmp    80105ded <alltraps>
...
801064fe:	6a 00                	push   $0x0
  pushl $72
80106500:	6a 48                	push   $0x48
  jmp alltraps
80106502:	e9 e6 f8 ff ff       	jmp    80105ded <alltraps>
...
80106507:	6a 00                	push   $0x0
  pushl $73
80106509:	6a 49                	push   $0x49
  jmp alltraps
8010650b:	e9 dd f8 ff ff       	jmp    80105ded <alltraps>
...
80106510:	6a 00                	push   $0x0
  pushl $74
80106512:	6a 4a                	push   $0x4a
  jmp alltraps
80106514:	e9 d4 f8 ff ff       	jmp    80105ded <alltraps>
...
80106519:	6a 00                	push   $0x0
  pushl $75
8010651b:	6a 4b                	push   $0x4b
  jmp alltraps
8010651d:	e9 cb f8 ff ff       	jmp    80105ded <alltraps>
...
80106522:	6a 00                	push   $0x0
  pushl $76
80106524:	6a 4c                	push   $0x4c
  jmp alltraps
80106526:	e9 c2 f8 ff ff       	jmp    80105ded <alltraps>
...
8010652b:	6a 00                	push   $0x0
  pushl $77
8010652d:	6a 4d                	push   $0x4d
  jmp alltraps
8010652f:	e9 b9 f8 ff ff       	jmp    80105ded <alltraps>
...
80106534:	6a 00                	push   $0x0
  pushl $78
80106536:	6a 4e                	push   $0x4e
  jmp alltraps
80106538:	e9 b0 f8 ff ff       	jmp    80105ded <alltraps>
...
8010653d:	6a 00                	push   $0x0
  pushl $79
8010653f:	6a 4f                	push   $0x4f
  jmp alltraps
80106541:	e9 a7 f8 ff ff       	jmp    80105ded <alltraps>
...
80106546:	6a 00                	push   $0x0
  pushl $80
80106548:	6a 50                	push   $0x50
  jmp alltraps
8010654a:	e9 9e f8 ff ff       	jmp    80105ded <alltraps>
...
8010654f:	6a 00                	push   $0x0
  pushl $81
80106551:	6a 51                	push   $0x51
  jmp alltraps
80106553:	e9 95 f8 ff ff       	jmp    80105ded <alltraps>
...
80106558:	6a 00                	push   $0x0
  pushl $82
8010655a:	6a 52                	push   $0x52
  jmp alltraps
8010655c:	e9 8c f8 ff ff       	jmp    80105ded <alltraps>
...
80106561:	6a 00                	push   $0x0
  pushl $83
80106563:	6a 53                	push   $0x53
  jmp alltraps
80106565:	e9 83 f8 ff ff       	jmp    80105ded <alltraps>
...
8010656a:	6a 00                	push   $0x0
  pushl $84
8010656c:	6a 54                	push   $0x54
  jmp alltraps
8010656e:	e9 7a f8 ff ff       	jmp    80105ded <alltraps>
...
80106573:	6a 00                	push   $0x0
  pushl $85
80106575:	6a 55                	push   $0x55
  jmp alltraps
80106577:	e9 71 f8 ff ff       	jmp    80105ded <alltraps>
...
8010657c:	6a 00                	push   $0x0
  pushl $86
8010657e:	6a 56                	push   $0x56
  jmp alltraps
80106580:	e9 68 f8 ff ff       	jmp    80105ded <alltraps>
...
80106585:	6a 00                	push   $0x0
  pushl $87
80106587:	6a 57                	push   $0x57
  jmp alltraps
80106589:	e9 5f f8 ff ff       	jmp    80105ded <alltraps>
...
8010658e:	6a 00                	push   $0x0
  pushl $88
80106590:	6a 58                	push   $0x58
  jmp alltraps
80106592:	e9 56 f8 ff ff       	jmp    80105ded <alltraps>
...
80106597:	6a 00                	push   $0x0
  pushl $89
80106599:	6a 59                	push   $0x59
  jmp alltraps
8010659b:	e9 4d f8 ff ff       	jmp    80105ded <alltraps>
...
801065a0:	6a 00                	push   $0x0
  pushl $90
801065a2:	6a 5a                	push   $0x5a
  jmp alltraps
801065a4:	e9 44 f8 ff ff       	jmp    80105ded <alltraps>
...
801065a9:	6a 00                	push   $0x0
  pushl $91
801065ab:	6a 5b                	push   $0x5b
  jmp alltraps
801065ad:	e9 3b f8 ff ff       	jmp    80105ded <alltraps>
...
801065b2:	6a 00                	push   $0x0
  pushl $92
801065b4:	6a 5c                	push   $0x5c
  jmp alltraps
801065b6:	e9 32 f8 ff ff       	jmp    80105ded <alltraps>
...
801065bb:	6a 00                	push   $0x0
  pushl $93
801065bd:	6a 5d                	push   $0x5d
  jmp alltraps
801065bf:	e9 29 f8 ff ff       	jmp    80105ded <alltraps>
...
801065c4:	6a 00                	push   $0x0
  pushl $94
801065c6:	6a 5e                	push   $0x5e
  jmp alltraps
801065c8:	e9 20 f8 ff ff       	jmp    80105ded <alltraps>
...
801065cd:	6a 00                	push   $0x0
  pushl $95
801065cf:	6a 5f                	push   $0x5f
  jmp alltraps
801065d1:	e9 17 f8 ff ff       	jmp    80105ded <alltraps>
...
801065d6:	6a 00                	push   $0x0
  pushl $96
801065d8:	6a 60                	push   $0x60
  jmp alltraps
801065da:	e9 0e f8 ff ff       	jmp    80105ded <alltraps>
...
801065df:	6a 00                	push   $0x0
  pushl $97
801065e1:	6a 61                	push   $0x61
  jmp alltraps
801065e3:	e9 05 f8 ff ff       	jmp    80105ded <alltraps>
...
801065e8:	6a 00                	push   $0x0
  pushl $98
801065ea:	6a 62                	push   $0x62
  jmp alltraps
801065ec:	e9 fc f7 ff ff       	jmp    80105ded <alltraps>
...
801065f1:	6a 00                	push   $0x0
  pushl $99
801065f3:	6a 63                	push   $0x63
  jmp alltraps
801065f5:	e9 f3 f7 ff ff       	jmp    80105ded <alltraps>
...
801065fa:	6a 00                	push   $0x0
  pushl $100
801065fc:	6a 64                	push   $0x64
  jmp alltraps
801065fe:	e9 ea f7 ff ff       	jmp    80105ded <alltraps>
...
80106603:	6a 00                	push   $0x0
  pushl $101
80106605:	6a 65                	push   $0x65
  jmp alltraps
80106607:	e9 e1 f7 ff ff       	jmp    80105ded <alltraps>
...
8010660c:	6a 00                	push   $0x0
  pushl $102
8010660e:	6a 66                	push   $0x66
  jmp alltraps
80106610:	e9 d8 f7 ff ff       	jmp    80105ded <alltraps>
...
80106615:	6a 00                	push   $0x0
  pushl $103
80106617:	6a 67                	push   $0x67
  jmp alltraps
80106619:	e9 cf f7 ff ff       	jmp    80105ded <alltraps>
...
8010661e:	6a 00                	push   $0x0
  pushl $104
80106620:	6a 68                	push   $0x68
  jmp alltraps
80106622:	e9 c6 f7 ff ff       	jmp    80105ded <alltraps>
...
80106627:	6a 00                	push   $0x0
  pushl $105
80106629:	6a 69                	push   $0x69
  jmp alltraps
8010662b:	e9 bd f7 ff ff       	jmp    80105ded <alltraps>
...
80106630:	6a 00                	push   $0x0
  pushl $106
80106632:	6a 6a                	push   $0x6a
  jmp alltraps
80106634:	e9 b4 f7 ff ff       	jmp    80105ded <alltraps>
...
80106639:	6a 00                	push   $0x0
  pushl $107
8010663b:	6a 6b                	push   $0x6b
  jmp alltraps
8010663d:	e9 ab f7 ff ff       	jmp    80105ded <alltraps>
...
80106642:	6a 00                	push   $0x0
  pushl $108
80106644:	6a 6c                	push   $0x6c
  jmp alltraps
80106646:	e9 a2 f7 ff ff       	jmp    80105ded <alltraps>
...
8010664b:	6a 00                	push   $0x0
  pushl $109
8010664d:	6a 6d                	push   $0x6d
  jmp alltraps
8010664f:	e9 99 f7 ff ff       	jmp    80105ded <alltraps>
...
80106654:	6a 00                	push   $0x0
  pushl $110
80106656:	6a 6e                	push   $0x6e
  jmp alltraps
80106658:	e9 90 f7 ff ff       	jmp    80105ded <alltraps>
...
8010665d:	6a 00                	push   $0x0
  pushl $111
8010665f:	6a 6f                	push   $0x6f
  jmp alltraps
80106661:	e9 87 f7 ff ff       	jmp    80105ded <alltraps>
...
80106666:	6a 00                	push   $0x0
  pushl $112
80106668:	6a 70                	push   $0x70
  jmp alltraps
8010666a:	e9 7e f7 ff ff       	jmp    80105ded <alltraps>
...
8010666f:	6a 00                	push   $0x0
  pushl $113
80106671:	6a 71                	push   $0x71
  jmp alltraps
80106673:	e9 75 f7 ff ff       	jmp    80105ded <alltraps>
...
80106678:	6a 00                	push   $0x0
  pushl $114
8010667a:	6a 72                	push   $0x72
  jmp alltraps
8010667c:	e9 6c f7 ff ff       	jmp    80105ded <alltraps>
...
80106681:	6a 00                	push   $0x0
  pushl $115
80106683:	6a 73                	push   $0x73
  jmp alltraps
80106685:	e9 63 f7 ff ff       	jmp    80105ded <alltraps>
...
8010668a:	6a 00                	push   $0x0
  pushl $116
8010668c:	6a 74                	push   $0x74
  jmp alltraps
8010668e:	e9 5a f7 ff ff       	jmp    80105ded <alltraps>
...
80106693:	6a 00                	push   $0x0
  pushl $117
80106695:	6a 75                	push   $0x75
  jmp alltraps
80106697:	e9 51 f7 ff ff       	jmp    80105ded <alltraps>
...
8010669c:	6a 00                	push   $0x0
  pushl $118
8010669e:	6a 76                	push   $0x76
  jmp alltraps
801066a0:	e9 48 f7 ff ff       	jmp    80105ded <alltraps>
...
801066a5:	6a 00                	push   $0x0
  pushl $119
801066a7:	6a 77                	push   $0x77
  jmp alltraps
801066a9:	e9 3f f7 ff ff       	jmp    80105ded <alltraps>
...
801066ae:	6a 00                	push   $0x0
  pushl $120
801066b0:	6a 78                	push   $0x78
  jmp alltraps
801066b2:	e9 36 f7 ff ff       	jmp    80105ded <alltraps>
...
801066b7:	6a 00                	push   $0x0
  pushl $121
801066b9:	6a 79                	push   $0x79
  jmp alltraps
801066bb:	e9 2d f7 ff ff       	jmp    80105ded <alltraps>
...
801066c0:	6a 00                	push   $0x0
  pushl $122
801066c2:	6a 7a                	push   $0x7a
  jmp alltraps
801066c4:	e9 24 f7 ff ff       	jmp    80105ded <alltraps>
...
801066c9:	6a 00                	push   $0x0
  pushl $123
801066cb:	6a 7b                	push   $0x7b
  jmp alltraps
801066cd:	e9 1b f7 ff ff       	jmp    80105ded <alltraps>
...
801066d2:	6a 00                	push   $0x0
  pushl $124
801066d4:	6a 7c                	push   $0x7c
  jmp alltraps
801066d6:	e9 12 f7 ff ff       	jmp    80105ded <alltraps>
...
801066db:	6a 00                	push   $0x0
  pushl $125
801066dd:	6a 7d                	push   $0x7d
  jmp alltraps
801066df:	e9 09 f7 ff ff       	jmp    80105ded <alltraps>
...
801066e4:	6a 00                	push   $0x0
  pushl $126
801066e6:	6a 7e                	push   $0x7e
  jmp alltraps
801066e8:	e9 00 f7 ff ff       	jmp    80105ded <alltraps>
...
801066ed:	6a 00                	push   $0x0
  pushl $127
801066ef:	6a 7f                	push   $0x7f
  jmp alltraps
801066f1:	e9 f7 f6 ff ff       	jmp    80105ded <alltraps>
...
801066f6:	6a 00                	push   $0x0
  pushl $128
801066f8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801066fd:	e9 eb f6 ff ff       	jmp    80105ded <alltraps>
...
80106702:	6a 00                	push   $0x0
  pushl $129
80106704:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106709:	e9 df f6 ff ff       	jmp    80105ded <alltraps>
...
8010670e:	6a 00                	push   $0x0
  pushl $130
80106710:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106715:	e9 d3 f6 ff ff       	jmp    80105ded <alltraps>
...
8010671a:	6a 00                	push   $0x0
  pushl $131
8010671c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106721:	e9 c7 f6 ff ff       	jmp    80105ded <alltraps>
...
80106726:	6a 00                	push   $0x0
  pushl $132
80106728:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010672d:	e9 bb f6 ff ff       	jmp    80105ded <alltraps>
...
80106732:	6a 00                	push   $0x0
  pushl $133
80106734:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106739:	e9 af f6 ff ff       	jmp    80105ded <alltraps>
...
8010673e:	6a 00                	push   $0x0
  pushl $134
80106740:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106745:	e9 a3 f6 ff ff       	jmp    80105ded <alltraps>
...
8010674a:	6a 00                	push   $0x0
  pushl $135
8010674c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106751:	e9 97 f6 ff ff       	jmp    80105ded <alltraps>
...
80106756:	6a 00                	push   $0x0
  pushl $136
80106758:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010675d:	e9 8b f6 ff ff       	jmp    80105ded <alltraps>
...
80106762:	6a 00                	push   $0x0
  pushl $137
80106764:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106769:	e9 7f f6 ff ff       	jmp    80105ded <alltraps>
...
8010676e:	6a 00                	push   $0x0
  pushl $138
80106770:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106775:	e9 73 f6 ff ff       	jmp    80105ded <alltraps>
...
8010677a:	6a 00                	push   $0x0
  pushl $139
8010677c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106781:	e9 67 f6 ff ff       	jmp    80105ded <alltraps>
...
80106786:	6a 00                	push   $0x0
  pushl $140
80106788:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010678d:	e9 5b f6 ff ff       	jmp    80105ded <alltraps>
...
80106792:	6a 00                	push   $0x0
  pushl $141
80106794:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106799:	e9 4f f6 ff ff       	jmp    80105ded <alltraps>
...
8010679e:	6a 00                	push   $0x0
  pushl $142
801067a0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801067a5:	e9 43 f6 ff ff       	jmp    80105ded <alltraps>
...
801067aa:	6a 00                	push   $0x0
  pushl $143
801067ac:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801067b1:	e9 37 f6 ff ff       	jmp    80105ded <alltraps>
...
801067b6:	6a 00                	push   $0x0
  pushl $144
801067b8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801067bd:	e9 2b f6 ff ff       	jmp    80105ded <alltraps>
...
801067c2:	6a 00                	push   $0x0
  pushl $145
801067c4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801067c9:	e9 1f f6 ff ff       	jmp    80105ded <alltraps>
...
801067ce:	6a 00                	push   $0x0
  pushl $146
801067d0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801067d5:	e9 13 f6 ff ff       	jmp    80105ded <alltraps>
...
801067da:	6a 00                	push   $0x0
  pushl $147
801067dc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801067e1:	e9 07 f6 ff ff       	jmp    80105ded <alltraps>
...
801067e6:	6a 00                	push   $0x0
  pushl $148
801067e8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801067ed:	e9 fb f5 ff ff       	jmp    80105ded <alltraps>
...
801067f2:	6a 00                	push   $0x0
  pushl $149
801067f4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801067f9:	e9 ef f5 ff ff       	jmp    80105ded <alltraps>
...
801067fe:	6a 00                	push   $0x0
  pushl $150
80106800:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106805:	e9 e3 f5 ff ff       	jmp    80105ded <alltraps>
...
8010680a:	6a 00                	push   $0x0
  pushl $151
8010680c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106811:	e9 d7 f5 ff ff       	jmp    80105ded <alltraps>
...
80106816:	6a 00                	push   $0x0
  pushl $152
80106818:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010681d:	e9 cb f5 ff ff       	jmp    80105ded <alltraps>
...
80106822:	6a 00                	push   $0x0
  pushl $153
80106824:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106829:	e9 bf f5 ff ff       	jmp    80105ded <alltraps>
...
8010682e:	6a 00                	push   $0x0
  pushl $154
80106830:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106835:	e9 b3 f5 ff ff       	jmp    80105ded <alltraps>
...
8010683a:	6a 00                	push   $0x0
  pushl $155
8010683c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106841:	e9 a7 f5 ff ff       	jmp    80105ded <alltraps>
...
80106846:	6a 00                	push   $0x0
  pushl $156
80106848:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010684d:	e9 9b f5 ff ff       	jmp    80105ded <alltraps>
...
80106852:	6a 00                	push   $0x0
  pushl $157
80106854:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106859:	e9 8f f5 ff ff       	jmp    80105ded <alltraps>
...
8010685e:	6a 00                	push   $0x0
  pushl $158
80106860:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106865:	e9 83 f5 ff ff       	jmp    80105ded <alltraps>
...
8010686a:	6a 00                	push   $0x0
  pushl $159
8010686c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106871:	e9 77 f5 ff ff       	jmp    80105ded <alltraps>
...
80106876:	6a 00                	push   $0x0
  pushl $160
80106878:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010687d:	e9 6b f5 ff ff       	jmp    80105ded <alltraps>
...
80106882:	6a 00                	push   $0x0
  pushl $161
80106884:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106889:	e9 5f f5 ff ff       	jmp    80105ded <alltraps>
...
8010688e:	6a 00                	push   $0x0
  pushl $162
80106890:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106895:	e9 53 f5 ff ff       	jmp    80105ded <alltraps>
...
8010689a:	6a 00                	push   $0x0
  pushl $163
8010689c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801068a1:	e9 47 f5 ff ff       	jmp    80105ded <alltraps>
...
801068a6:	6a 00                	push   $0x0
  pushl $164
801068a8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801068ad:	e9 3b f5 ff ff       	jmp    80105ded <alltraps>
...
801068b2:	6a 00                	push   $0x0
  pushl $165
801068b4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801068b9:	e9 2f f5 ff ff       	jmp    80105ded <alltraps>
...
801068be:	6a 00                	push   $0x0
  pushl $166
801068c0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801068c5:	e9 23 f5 ff ff       	jmp    80105ded <alltraps>
...
801068ca:	6a 00                	push   $0x0
  pushl $167
801068cc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801068d1:	e9 17 f5 ff ff       	jmp    80105ded <alltraps>
...
801068d6:	6a 00                	push   $0x0
  pushl $168
801068d8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801068dd:	e9 0b f5 ff ff       	jmp    80105ded <alltraps>
...
801068e2:	6a 00                	push   $0x0
  pushl $169
801068e4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801068e9:	e9 ff f4 ff ff       	jmp    80105ded <alltraps>
...
801068ee:	6a 00                	push   $0x0
  pushl $170
801068f0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801068f5:	e9 f3 f4 ff ff       	jmp    80105ded <alltraps>
...
801068fa:	6a 00                	push   $0x0
  pushl $171
801068fc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106901:	e9 e7 f4 ff ff       	jmp    80105ded <alltraps>
...
80106906:	6a 00                	push   $0x0
  pushl $172
80106908:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010690d:	e9 db f4 ff ff       	jmp    80105ded <alltraps>
...
80106912:	6a 00                	push   $0x0
  pushl $173
80106914:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106919:	e9 cf f4 ff ff       	jmp    80105ded <alltraps>
...
8010691e:	6a 00                	push   $0x0
  pushl $174
80106920:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106925:	e9 c3 f4 ff ff       	jmp    80105ded <alltraps>
...
8010692a:	6a 00                	push   $0x0
  pushl $175
8010692c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106931:	e9 b7 f4 ff ff       	jmp    80105ded <alltraps>
...
80106936:	6a 00                	push   $0x0
  pushl $176
80106938:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010693d:	e9 ab f4 ff ff       	jmp    80105ded <alltraps>
...
80106942:	6a 00                	push   $0x0
  pushl $177
80106944:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106949:	e9 9f f4 ff ff       	jmp    80105ded <alltraps>
...
8010694e:	6a 00                	push   $0x0
  pushl $178
80106950:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106955:	e9 93 f4 ff ff       	jmp    80105ded <alltraps>
...
8010695a:	6a 00                	push   $0x0
  pushl $179
8010695c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106961:	e9 87 f4 ff ff       	jmp    80105ded <alltraps>
...
80106966:	6a 00                	push   $0x0
  pushl $180
80106968:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010696d:	e9 7b f4 ff ff       	jmp    80105ded <alltraps>
...
80106972:	6a 00                	push   $0x0
  pushl $181
80106974:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106979:	e9 6f f4 ff ff       	jmp    80105ded <alltraps>
...
8010697e:	6a 00                	push   $0x0
  pushl $182
80106980:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106985:	e9 63 f4 ff ff       	jmp    80105ded <alltraps>
...
8010698a:	6a 00                	push   $0x0
  pushl $183
8010698c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106991:	e9 57 f4 ff ff       	jmp    80105ded <alltraps>
...
80106996:	6a 00                	push   $0x0
  pushl $184
80106998:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010699d:	e9 4b f4 ff ff       	jmp    80105ded <alltraps>
...
801069a2:	6a 00                	push   $0x0
  pushl $185
801069a4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801069a9:	e9 3f f4 ff ff       	jmp    80105ded <alltraps>
...
801069ae:	6a 00                	push   $0x0
  pushl $186
801069b0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801069b5:	e9 33 f4 ff ff       	jmp    80105ded <alltraps>
...
801069ba:	6a 00                	push   $0x0
  pushl $187
801069bc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801069c1:	e9 27 f4 ff ff       	jmp    80105ded <alltraps>
...
801069c6:	6a 00                	push   $0x0
  pushl $188
801069c8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801069cd:	e9 1b f4 ff ff       	jmp    80105ded <alltraps>
...
801069d2:	6a 00                	push   $0x0
  pushl $189
801069d4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801069d9:	e9 0f f4 ff ff       	jmp    80105ded <alltraps>
...
801069de:	6a 00                	push   $0x0
  pushl $190
801069e0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801069e5:	e9 03 f4 ff ff       	jmp    80105ded <alltraps>
...
801069ea:	6a 00                	push   $0x0
  pushl $191
801069ec:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801069f1:	e9 f7 f3 ff ff       	jmp    80105ded <alltraps>
...
801069f6:	6a 00                	push   $0x0
  pushl $192
801069f8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801069fd:	e9 eb f3 ff ff       	jmp    80105ded <alltraps>
...
80106a02:	6a 00                	push   $0x0
  pushl $193
80106a04:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106a09:	e9 df f3 ff ff       	jmp    80105ded <alltraps>
...
80106a0e:	6a 00                	push   $0x0
  pushl $194
80106a10:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106a15:	e9 d3 f3 ff ff       	jmp    80105ded <alltraps>
...
80106a1a:	6a 00                	push   $0x0
  pushl $195
80106a1c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106a21:	e9 c7 f3 ff ff       	jmp    80105ded <alltraps>
...
80106a26:	6a 00                	push   $0x0
  pushl $196
80106a28:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106a2d:	e9 bb f3 ff ff       	jmp    80105ded <alltraps>
...
80106a32:	6a 00                	push   $0x0
  pushl $197
80106a34:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106a39:	e9 af f3 ff ff       	jmp    80105ded <alltraps>
...
80106a3e:	6a 00                	push   $0x0
  pushl $198
80106a40:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106a45:	e9 a3 f3 ff ff       	jmp    80105ded <alltraps>
...
80106a4a:	6a 00                	push   $0x0
  pushl $199
80106a4c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106a51:	e9 97 f3 ff ff       	jmp    80105ded <alltraps>
...
80106a56:	6a 00                	push   $0x0
  pushl $200
80106a58:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106a5d:	e9 8b f3 ff ff       	jmp    80105ded <alltraps>
...
80106a62:	6a 00                	push   $0x0
  pushl $201
80106a64:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106a69:	e9 7f f3 ff ff       	jmp    80105ded <alltraps>
...
80106a6e:	6a 00                	push   $0x0
  pushl $202
80106a70:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106a75:	e9 73 f3 ff ff       	jmp    80105ded <alltraps>
...
80106a7a:	6a 00                	push   $0x0
  pushl $203
80106a7c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106a81:	e9 67 f3 ff ff       	jmp    80105ded <alltraps>
...
80106a86:	6a 00                	push   $0x0
  pushl $204
80106a88:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106a8d:	e9 5b f3 ff ff       	jmp    80105ded <alltraps>
...
80106a92:	6a 00                	push   $0x0
  pushl $205
80106a94:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106a99:	e9 4f f3 ff ff       	jmp    80105ded <alltraps>
...
80106a9e:	6a 00                	push   $0x0
  pushl $206
80106aa0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106aa5:	e9 43 f3 ff ff       	jmp    80105ded <alltraps>
...
80106aaa:	6a 00                	push   $0x0
  pushl $207
80106aac:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106ab1:	e9 37 f3 ff ff       	jmp    80105ded <alltraps>
...
80106ab6:	6a 00                	push   $0x0
  pushl $208
80106ab8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106abd:	e9 2b f3 ff ff       	jmp    80105ded <alltraps>
...
80106ac2:	6a 00                	push   $0x0
  pushl $209
80106ac4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106ac9:	e9 1f f3 ff ff       	jmp    80105ded <alltraps>
...
80106ace:	6a 00                	push   $0x0
  pushl $210
80106ad0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106ad5:	e9 13 f3 ff ff       	jmp    80105ded <alltraps>
...
80106ada:	6a 00                	push   $0x0
  pushl $211
80106adc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106ae1:	e9 07 f3 ff ff       	jmp    80105ded <alltraps>
...
80106ae6:	6a 00                	push   $0x0
  pushl $212
80106ae8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106aed:	e9 fb f2 ff ff       	jmp    80105ded <alltraps>
...
80106af2:	6a 00                	push   $0x0
  pushl $213
80106af4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106af9:	e9 ef f2 ff ff       	jmp    80105ded <alltraps>
...
80106afe:	6a 00                	push   $0x0
  pushl $214
80106b00:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106b05:	e9 e3 f2 ff ff       	jmp    80105ded <alltraps>
...
80106b0a:	6a 00                	push   $0x0
  pushl $215
80106b0c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106b11:	e9 d7 f2 ff ff       	jmp    80105ded <alltraps>
...
80106b16:	6a 00                	push   $0x0
  pushl $216
80106b18:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106b1d:	e9 cb f2 ff ff       	jmp    80105ded <alltraps>
...
80106b22:	6a 00                	push   $0x0
  pushl $217
80106b24:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106b29:	e9 bf f2 ff ff       	jmp    80105ded <alltraps>
...
80106b2e:	6a 00                	push   $0x0
  pushl $218
80106b30:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106b35:	e9 b3 f2 ff ff       	jmp    80105ded <alltraps>
...
80106b3a:	6a 00                	push   $0x0
  pushl $219
80106b3c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106b41:	e9 a7 f2 ff ff       	jmp    80105ded <alltraps>
...
80106b46:	6a 00                	push   $0x0
  pushl $220
80106b48:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106b4d:	e9 9b f2 ff ff       	jmp    80105ded <alltraps>
...
80106b52:	6a 00                	push   $0x0
  pushl $221
80106b54:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106b59:	e9 8f f2 ff ff       	jmp    80105ded <alltraps>
...
80106b5e:	6a 00                	push   $0x0
  pushl $222
80106b60:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106b65:	e9 83 f2 ff ff       	jmp    80105ded <alltraps>
...
80106b6a:	6a 00                	push   $0x0
  pushl $223
80106b6c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106b71:	e9 77 f2 ff ff       	jmp    80105ded <alltraps>
...
80106b76:	6a 00                	push   $0x0
  pushl $224
80106b78:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106b7d:	e9 6b f2 ff ff       	jmp    80105ded <alltraps>
...
80106b82:	6a 00                	push   $0x0
  pushl $225
80106b84:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106b89:	e9 5f f2 ff ff       	jmp    80105ded <alltraps>
...
80106b8e:	6a 00                	push   $0x0
  pushl $226
80106b90:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106b95:	e9 53 f2 ff ff       	jmp    80105ded <alltraps>
...
80106b9a:	6a 00                	push   $0x0
  pushl $227
80106b9c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106ba1:	e9 47 f2 ff ff       	jmp    80105ded <alltraps>
...
80106ba6:	6a 00                	push   $0x0
  pushl $228
80106ba8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106bad:	e9 3b f2 ff ff       	jmp    80105ded <alltraps>
...
80106bb2:	6a 00                	push   $0x0
  pushl $229
80106bb4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106bb9:	e9 2f f2 ff ff       	jmp    80105ded <alltraps>
...
80106bbe:	6a 00                	push   $0x0
  pushl $230
80106bc0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106bc5:	e9 23 f2 ff ff       	jmp    80105ded <alltraps>
...
80106bca:	6a 00                	push   $0x0
  pushl $231
80106bcc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106bd1:	e9 17 f2 ff ff       	jmp    80105ded <alltraps>
...
80106bd6:	6a 00                	push   $0x0
  pushl $232
80106bd8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106bdd:	e9 0b f2 ff ff       	jmp    80105ded <alltraps>
...
80106be2:	6a 00                	push   $0x0
  pushl $233
80106be4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106be9:	e9 ff f1 ff ff       	jmp    80105ded <alltraps>
...
80106bee:	6a 00                	push   $0x0
  pushl $234
80106bf0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106bf5:	e9 f3 f1 ff ff       	jmp    80105ded <alltraps>
...
80106bfa:	6a 00                	push   $0x0
  pushl $235
80106bfc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106c01:	e9 e7 f1 ff ff       	jmp    80105ded <alltraps>
...
80106c06:	6a 00                	push   $0x0
  pushl $236
80106c08:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106c0d:	e9 db f1 ff ff       	jmp    80105ded <alltraps>
...
80106c12:	6a 00                	push   $0x0
  pushl $237
80106c14:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106c19:	e9 cf f1 ff ff       	jmp    80105ded <alltraps>
...
80106c1e:	6a 00                	push   $0x0
  pushl $238
80106c20:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106c25:	e9 c3 f1 ff ff       	jmp    80105ded <alltraps>
...
80106c2a:	6a 00                	push   $0x0
  pushl $239
80106c2c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106c31:	e9 b7 f1 ff ff       	jmp    80105ded <alltraps>
...
80106c36:	6a 00                	push   $0x0
  pushl $240
80106c38:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106c3d:	e9 ab f1 ff ff       	jmp    80105ded <alltraps>
...
80106c42:	6a 00                	push   $0x0
  pushl $241
80106c44:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106c49:	e9 9f f1 ff ff       	jmp    80105ded <alltraps>
...
80106c4e:	6a 00                	push   $0x0
  pushl $242
80106c50:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106c55:	e9 93 f1 ff ff       	jmp    80105ded <alltraps>
...
80106c5a:	6a 00                	push   $0x0
  pushl $243
80106c5c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106c61:	e9 87 f1 ff ff       	jmp    80105ded <alltraps>
...
80106c66:	6a 00                	push   $0x0
  pushl $244
80106c68:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106c6d:	e9 7b f1 ff ff       	jmp    80105ded <alltraps>
...
80106c72:	6a 00                	push   $0x0
  pushl $245
80106c74:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106c79:	e9 6f f1 ff ff       	jmp    80105ded <alltraps>
...
80106c7e:	6a 00                	push   $0x0
  pushl $246
80106c80:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106c85:	e9 63 f1 ff ff       	jmp    80105ded <alltraps>
...
80106c8a:	6a 00                	push   $0x0
  pushl $247
80106c8c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106c91:	e9 57 f1 ff ff       	jmp    80105ded <alltraps>
...
80106c96:	6a 00                	push   $0x0
  pushl $248
80106c98:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106c9d:	e9 4b f1 ff ff       	jmp    80105ded <alltraps>
...
80106ca2:	6a 00                	push   $0x0
  pushl $249
80106ca4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106ca9:	e9 3f f1 ff ff       	jmp    80105ded <alltraps>
...
80106cae:	6a 00                	push   $0x0
  pushl $250
80106cb0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106cb5:	e9 33 f1 ff ff       	jmp    80105ded <alltraps>
...
80106cba:	6a 00                	push   $0x0
  pushl $251
80106cbc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106cc1:	e9 27 f1 ff ff       	jmp    80105ded <alltraps>
...
80106cc6:	6a 00                	push   $0x0
  pushl $252
80106cc8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106ccd:	e9 1b f1 ff ff       	jmp    80105ded <alltraps>
...
80106cd2:	6a 00                	push   $0x0
  pushl $253
80106cd4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106cd9:	e9 0f f1 ff ff       	jmp    80105ded <alltraps>
...
80106cde:	6a 00                	push   $0x0
  pushl $254
80106ce0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106ce5:	e9 03 f1 ff ff       	jmp    80105ded <alltraps>
...
80106cea:	6a 00                	push   $0x0
  pushl $255
80106cec:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106cf1:	e9 f7 f0 ff ff       	jmp    80105ded <alltraps>
80106cf6:	66 90                	xchg   %ax,%ax
80106cf8:	66 90                	xchg   %ax,%ax
...
80106d1e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80106d24:	c1 ee 0a             	shr    $0xa,%esi
}
80106d27:	83 c4 1c             	add    $0x1c,%esp
    // The permissions here are overly generous, but they can
    // be further restricted by tlayhe permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
  ...
  return &pgtab[PTX(va)];
80106d2a:	89 f2                	mov    %esi,%edx
80106d2c:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80106d32:	8d 04 13             	lea    (%ebx,%edx,1),%eax
}
80106d35:	5b                   	pop    %ebx
80106d36:	5e                   	pop    %esi
80106d37:	5f                   	pop    %edi
...
80106d42:	74 34                	je     80106d78 <walkpgdir+0x78>
80106d44:	e8 d7 b7 ff ff       	call   80102520 <kalloc>
80106d49:	85 c0                	test   %eax,%eax
80106d4b:	89 c3                	mov    %eax,%ebx
80106d4d:	74 29                	je     80106d78 <walkpgdir+0x78>
      return 0;
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80106d4f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d56:	00 
80106d57:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106d5e:	00 
80106d5f:	89 04 24             	mov    %eax,(%esp)
80106d62:	e8 99 d5 ff ff       	call   80104300 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by tlayhe permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106d67:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106d6d:	83 c8 07             	or     $0x7,%eax
80106d70:	89 07                	mov    %eax,(%edi)
80106d72:	eb b0                	jmp    80106d24 <walkpgdir+0x24>
...
80106d9b:	8b 7d 08             	mov    0x8(%ebp),%edi
  char *a, *last;
  pte_t *pte;
...
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
80106da4:	89 45 e0             	mov    %eax,-0x20(%ebp)
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106da7:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80106dab:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106dae:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
{
  char *a, *last;
  pte_t *pte;
  ...
  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106db2:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
80106db9:	29 df                	sub    %ebx,%edi
80106dbb:	eb 18                	jmp    80106dd5 <mappages+0x45>
...
80106dc3:	75 3d                	jne    80106e02 <mappages+0x72>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106dc5:	0b 75 0c             	or     0xc(%ebp),%esi
    if(a == last)
80106dc8:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
...
80106dcb:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106dcd:	74 29                	je     80106df8 <mappages+0x68>
      break;
    a += PGSIZE;
...
80106de2:	e8 19 ff ff ff       	call   80106d00 <walkpgdir>
...
80106deb:	83 c4 1c             	add    $0x1c,%esp
...
80106df6:	5d                   	pop    %ebp
80106df7:	c3                   	ret    
80106df8:	83 c4 1c             	add    $0x1c,%esp
    if(a == last)
      break;
    a += PGSIZE;
    pa += PGSIZE;
...
80106e01:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106e02:	c7 04 24 a0 80 10 80 	movl   $0x801080a0,(%esp)
...
80106e19:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
80106e1a:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106e20:	83 ec 1c             	sub    $0x1c,%esp
  uint a, pa;
  ...
  a = PGROUNDUP(newsz);
80106e23:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106e29:	39 d3                	cmp    %edx,%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106e2b:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106e2e:	72 3b                	jb     80106e6b <deallocuvm.part.0+0x5b>
80106e30:	eb 5e                	jmp    80106e90 <deallocuvm.part.0+0x80>
...
80106e3d:	74 22                	je     80106e61 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106e3f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106e45:	74 54                	je     80106e9b <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80106e47:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
80106e4d:	89 14 24             	mov    %edx,(%esp)
80106e50:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e53:	e8 18 b5 ff ff       	call   80102370 <kfree>
      *pte = 0;
...
80106e67:	39 f3                	cmp    %esi,%ebx
80106e69:	73 25                	jae    80106e90 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106e6b:	31 c9                	xor    %ecx,%ecx
80106e6d:	89 da                	mov    %ebx,%edx
80106e6f:	89 f8                	mov    %edi,%eax
80106e71:	e8 8a fe ff ff       	call   80106d00 <walkpgdir>
    if(!pte)
80106e76:	85 c0                	test   %eax,%eax
80106e78:	75 be                	jne    80106e38 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106e7a:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106e80:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106e86:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106e8c:	39 f3                	cmp    %esi,%ebx
80106e8e:	72 db                	jb     80106e6b <deallocuvm.part.0+0x5b>
      kfree(v);
      *pte = 0;
    }
  }
...
80106e93:	83 c4 1c             	add    $0x1c,%esp
80106e96:	5b                   	pop    %ebx
80106e97:	5e                   	pop    %esi
80106e98:	5f                   	pop    %edi
80106e99:	5d                   	pop    %ebp
80106e9a:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
80106e9b:	c7 04 24 86 78 10 80 	movl   $0x80107886,(%esp)
...
80106eb3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106eb6:	e8 45 c8 ff ff       	call   80103700 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106ebb:	31 c9                	xor    %ecx,%ecx
80106ebd:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
80106ec2:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106ec8:	05 80 37 11 80       	add    $0x80113780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106ecd:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106ed1:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
  lgdt(c->gdt, sizeof(c->gdt));
80106ed6:	83 c0 70             	add    $0x70,%eax
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106ed9:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106edd:	31 c9                	xor    %ecx,%ecx
80106edf:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106ee3:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106ee8:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106eec:	31 c9                	xor    %ecx,%ecx
80106eee:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106ef2:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106ef7:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106efb:	31 c9                	xor    %ecx,%ecx
  ...
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106efd:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
80106f01:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106f05:	c6 40 15 92          	movb   $0x92,0x15(%eax)
80106f09:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106f0d:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
80106f11:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106f15:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
80106f19:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
80106f1d:	66 89 50 20          	mov    %dx,0x20(%eax)
static inline void
...
80106f21:	ba 2f 00 00 00       	mov    $0x2f,%edx
  ...
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106f26:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
80106f2a:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106f2e:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106f32:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106f36:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
80106f3a:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106f3e:	66 89 48 22          	mov    %cx,0x22(%eax)
80106f42:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106f46:	c6 40 27 00          	movb   $0x0,0x27(%eax)
80106f4a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
80106f4e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106f52:	c1 e8 10             	shr    $0x10,%eax
80106f55:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106f59:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106f5c:	0f 01 10             	lgdtl  (%eax)
  lgdt(c->gdt, sizeof(c->gdt));
}
80106f5f:	c9                   	leave  
80106f60:	c3                   	ret    
80106f61:	eb 0d                	jmp    80106f70 <switchkvm>
80106f63:	90                   	nop
80106f64:	90                   	nop
80106f65:	90                   	nop
80106f66:	90                   	nop
...
80106f70:	a1 04 6e 11 80       	mov    0x80116e04,%eax
...
80106fb4:	0f 84 c3 00 00 00    	je     8010707d <switchuvm+0xed>
    panic("switchuvm: no pgdir");

  pushcli();
80106fba:	e8 c1 d1 ff ff       	call   80104180 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106fbf:	e8 bc c6 ff ff       	call   80103680 <mycpu>
80106fc4:	89 c3                	mov    %eax,%ebx
80106fc6:	e8 b5 c6 ff ff       	call   80103680 <mycpu>
80106fcb:	89 c7                	mov    %eax,%edi
80106fcd:	e8 ae c6 ff ff       	call   80103680 <mycpu>
80106fd2:	83 c7 08             	add    $0x8,%edi
80106fd5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106fd8:	e8 a3 c6 ff ff       	call   80103680 <mycpu>
80106fdd:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106fe0:	ba 67 00 00 00       	mov    $0x67,%edx
80106fe5:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
80106fec:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106ff3:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
80106ffa:	83 c1 08             	add    $0x8,%ecx
80106ffd:	c1 e9 10             	shr    $0x10,%ecx
80107000:	83 c0 08             	add    $0x8,%eax
80107003:	c1 e8 18             	shr    $0x18,%eax
80107006:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
8010700c:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80107013:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
...
80107019:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010701e:	e8 5d c6 ff ff       	call   80103680 <mycpu>
80107023:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010702a:	e8 51 c6 ff ff       	call   80103680 <mycpu>
8010702f:	b9 10 00 00 00       	mov    $0x10,%ecx
80107034:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107038:	e8 43 c6 ff ff       	call   80103680 <mycpu>
...
80107046:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107049:	e8 32 c6 ff ff       	call   80103680 <mycpu>
...
80107065:	83 c4 1c             	add    $0x1c,%esp
80107068:	5b                   	pop    %ebx
80107069:	5e                   	pop    %esi
8010706a:	5f                   	pop    %edi
8010706b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010706c:	e9 cf d1 ff ff       	jmp    80104240 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80107071:	c7 04 24 a6 80 10 80 	movl   $0x801080a6,(%esp)
80107078:	e8 e3 92 ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010707d:	c7 04 24 d1 80 10 80 	movl   $0x801080d1,(%esp)
80107084:	e8 d7 92 ff ff       	call   80100360 <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80107089:	c7 04 24 bc 80 10 80 	movl   $0x801080bc,(%esp)
80107090:	e8 cb 92 ff ff       	call   80100360 <panic>
80107095:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
801070b8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  if(sz >= PGSIZE)
801070bb:	77 54                	ja     80107111 <inituvm+0x71>
    panic("inituvm: more than a page");
  mem = kalloc();
801070bd:	e8 5e b4 ff ff       	call   80102520 <kalloc>
  memset(mem, 0, PGSIZE);
801070c2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801070c9:	00 
801070ca:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801070d1:	00 
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
801070d2:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801070d4:	89 04 24             	mov    %eax,(%esp)
801070d7:	e8 24 d2 ff ff       	call   80104300 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801070dc:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801070e2:	b9 00 10 00 00       	mov    $0x1000,%ecx
801070e7:	89 04 24             	mov    %eax,(%esp)
801070ea:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801070ed:	31 d2                	xor    %edx,%edx
801070ef:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
801070f6:	00 
801070f7:	e8 94 fc ff ff       	call   80106d90 <mappages>
  memmove(mem, init, sz);
801070fc:	89 75 10             	mov    %esi,0x10(%ebp)
801070ff:	89 7d 0c             	mov    %edi,0xc(%ebp)
80107102:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80107105:	83 c4 1c             	add    $0x1c,%esp
80107108:	5b                   	pop    %ebx
80107109:	5e                   	pop    %esi
8010710a:	5f                   	pop    %edi
8010710b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010710c:	e9 8f d2 ff ff       	jmp    801043a0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80107111:	c7 04 24 e5 80 10 80 	movl   $0x801080e5,(%esp)
80107118:	e8 43 92 ff ff       	call   80100360 <panic>
...
80107130:	0f 85 98 00 00 00    	jne    801071ce <loaduvm+0xae>
...
8010713f:	eb 77                	jmp    801071b8 <loaduvm+0x98>
...
80107157:	76 5f                	jbe    801071b8 <loaduvm+0x98>
...
80107163:	e8 98 fb ff ff       	call   80106d00 <walkpgdir>
80107168:	85 c0                	test   %eax,%eax
8010716a:	74 56                	je     801071c2 <loaduvm+0xa2>
...
80107173:	8b 4d 14             	mov    0x14(%ebp),%ecx
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
...
80107176:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
      ...
      n = PGSIZE;
8010717b:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
80107181:	0f 42 fe             	cmovb  %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107184:	05 00 00 00 80       	add    $0x80000000,%eax
80107189:	89 44 24 04          	mov    %eax,0x4(%esp)
8010718d:	8b 45 10             	mov    0x10(%ebp),%eax
80107190:	01 d9                	add    %ebx,%ecx
80107192:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80107196:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010719a:	89 04 24             	mov    %eax,(%esp)
8010719d:	e8 3e a8 ff ff       	call   801019e0 <readi>
801071a2:	39 f8                	cmp    %edi,%eax
801071a4:	74 a2                	je     80107148 <loaduvm+0x28>
      return -1;
  }
  return 0;
}
801071a6:	83 c4 1c             	add    $0x1c,%esp
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
801071b8:	83 c4 1c             	add    $0x1c,%esp
    else
      n = PGSIZE;
    if(readi(ip, P2V(pa), offset+i, n) != n)
      return -1;
...
801071c1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801071c2:	c7 04 24 ff 80 10 80 	movl   $0x801080ff,(%esp)
801071c9:	e8 92 91 ff ff       	call   80100360 <panic>
{
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
801071ce:	c7 04 24 a0 81 10 80 	movl   $0x801081a0,(%esp)
801071d5:	e8 86 91 ff ff       	call   80100360 <panic>
...
801071ee:	0f 88 7e 00 00 00    	js     80107272 <allocuvm+0x92>
    return 0;
  if(newsz < oldsz)
801071f4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
801071f7:	8b 45 0c             	mov    0xc(%ebp),%eax
  char *mem;
  uint a;
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
801071fa:	72 78                	jb     80107274 <allocuvm+0x94>
    return oldsz;

  a = PGROUNDUP(oldsz);
801071fc:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80107202:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80107208:	39 df                	cmp    %ebx,%edi
8010720a:	77 4a                	ja     80107256 <allocuvm+0x76>
8010720c:	eb 72                	jmp    80107280 <allocuvm+0xa0>
8010720e:	66 90                	xchg   %ax,%ax
    ...
    memset(mem, 0, PGSIZE);
80107210:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107217:	00 
80107218:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010721f:	00 
80107220:	89 04 24             	mov    %eax,(%esp)
80107223:	e8 d8 d0 ff ff       	call   80104300 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107228:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
8010722e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107233:	89 04 24             	mov    %eax,(%esp)
80107236:	8b 45 08             	mov    0x8(%ebp),%eax
80107239:	89 da                	mov    %ebx,%edx
8010723b:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80107242:	00 
80107243:	e8 48 fb ff ff       	call   80106d90 <mappages>
80107248:	85 c0                	test   %eax,%eax
8010724a:	78 44                	js     80107290 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
8010724c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107252:	39 df                	cmp    %ebx,%edi
80107254:	76 2a                	jbe    80107280 <allocuvm+0xa0>
    mem = kalloc();
80107256:	e8 c5 b2 ff ff       	call   80102520 <kalloc>
    if(mem == 0){
8010725b:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
8010725d:	89 c6                	mov    %eax,%esi
    if(mem == 0){
8010725f:	75 af                	jne    80107210 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80107261:	c7 04 24 1d 81 10 80 	movl   $0x8010811d,(%esp)
80107268:	e8 e3 93 ff ff       	call   80100650 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
8010726d:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80107270:	77 48                	ja     801072ba <allocuvm+0xda>
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      ...
      kfree(mem);
      return 0;
80107272:	31 c0                	xor    %eax,%eax
    }
  }
  return newsz;
}
80107274:	83 c4 1c             	add    $0x1c,%esp
80107277:	5b                   	pop    %ebx
80107278:	5e                   	pop    %esi
80107279:	5f                   	pop    %edi
8010727a:	5d                   	pop    %ebp
...
8010728a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80107290:	c7 04 24 35 81 10 80 	movl   $0x80108135,(%esp)
80107297:	e8 b4 93 ff ff       	call   80100650 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
8010729c:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010729f:	76 0d                	jbe    801072ae <allocuvm+0xce>
801072a1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801072a4:	89 fa                	mov    %edi,%edx
801072a6:	8b 45 08             	mov    0x8(%ebp),%eax
801072a9:	e8 62 fb ff ff       	call   80106e10 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
      deallocuvm(pgdir, newsz, oldsz);
      kfree(mem);
801072ae:	89 34 24             	mov    %esi,(%esp)
801072b1:	e8 ba b0 ff ff       	call   80102370 <kfree>
      return 0;
801072b6:	31 c0                	xor    %eax,%eax
801072b8:	eb ba                	jmp    80107274 <allocuvm+0x94>
801072ba:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801072bd:	89 fa                	mov    %edi,%edx
801072bf:	8b 45 08             	mov    0x8(%ebp),%eax
801072c2:	e8 49 fb ff ff       	call   80106e10 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
801072c9:	eb a9                	jmp    80107274 <allocuvm+0x94>
801072cb:	90                   	nop
...
801072de:	73 08                	jae    801072e8 <deallocuvm+0x18>
      kfree(v);
      *pte = 0;
    }
  }
...
801072e0:	5d                   	pop    %ebp
801072e1:	e9 2a fb ff ff       	jmp    80106e10 <deallocuvm.part.0>
801072e6:	66 90                	xchg   %ax,%ax
801072e8:	89 d0                	mov    %edx,%eax
801072ea:	5d                   	pop    %ebp
801072eb:	c3                   	ret    
...
801072f8:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
801072fb:	85 f6                	test   %esi,%esi
801072fd:	74 59                	je     80107358 <freevm+0x68>
801072ff:	31 c9                	xor    %ecx,%ecx
80107301:	ba 00 00 00 80       	mov    $0x80000000,%edx
80107306:	89 f0                	mov    %esi,%eax
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107308:	31 db                	xor    %ebx,%ebx
8010730a:	e8 01 fb ff ff       	call   80106e10 <deallocuvm.part.0>
8010730f:	eb 12                	jmp    80107323 <freevm+0x33>
80107311:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107318:	83 c3 01             	add    $0x1,%ebx
8010731b:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80107321:	74 27                	je     8010734a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80107323:	8b 14 9e             	mov    (%esi,%ebx,4),%edx
80107326:	f6 c2 01             	test   $0x1,%dl
80107329:	74 ed                	je     80107318 <freevm+0x28>
      char * v = P2V(PTE_ADDR(pgdir[i]));
8010732b:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107331:	83 c3 01             	add    $0x1,%ebx
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
80107334:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
8010733a:	89 14 24             	mov    %edx,(%esp)
8010733d:	e8 2e b0 ff ff       	call   80102370 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107342:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80107348:	75 d9                	jne    80107323 <freevm+0x33>
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
  ...
  kfree((char*)pgdir);
8010734a:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80107352:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80107353:	e9 18 b0 ff ff       	jmp    80102370 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80107358:	c7 04 24 51 81 10 80 	movl   $0x80108151,(%esp)
8010735f:	e8 fc 8f ff ff       	call   80100360 <panic>
...
80107374:	53                   	push   %ebx
80107375:	83 ec 10             	sub    $0x10,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107378:	e8 a3 b1 ff ff       	call   80102520 <kalloc>
8010737d:	85 c0                	test   %eax,%eax
8010737f:	89 c6                	mov    %eax,%esi
80107381:	74 6d                	je     801073f0 <setupkvm+0x80>
    return 0;
  memset(pgdir, 0, PGSIZE);
80107383:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010738a:	00 
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010738b:	bb 20 b4 10 80       	mov    $0x8010b420,%ebx
  pde_t *pgdir;
  struct kmap *k;
  ...
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
80107390:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107397:	00 
80107398:	89 04 24             	mov    %eax,(%esp)
8010739b:	e8 60 cf ff ff       	call   80104300 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801073a0:	8b 53 0c             	mov    0xc(%ebx),%edx
801073a3:	8b 43 04             	mov    0x4(%ebx),%eax
801073a6:	8b 4b 08             	mov    0x8(%ebx),%ecx
801073a9:	89 54 24 04          	mov    %edx,0x4(%esp)
801073ad:	8b 13                	mov    (%ebx),%edx
801073af:	89 04 24             	mov    %eax,(%esp)
801073b2:	29 c1                	sub    %eax,%ecx
801073b4:	89 f0                	mov    %esi,%eax
801073b6:	e8 d5 f9 ff ff       	call   80106d90 <mappages>
801073bb:	85 c0                	test   %eax,%eax
801073bd:	78 19                	js     801073d8 <setupkvm+0x68>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801073bf:	83 c3 10             	add    $0x10,%ebx
801073c2:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
801073c8:	72 d6                	jb     801073a0 <setupkvm+0x30>
...
801073d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
801073d8:	89 34 24             	mov    %esi,(%esp)
801073db:	e8 10 ff ff ff       	call   801072f0 <freevm>
      return 0;
    }
  return pgdir;
}
...
801073f2:	eb d8                	jmp    801073cc <setupkvm+0x5c>
...
80107403:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107406:	e8 65 ff ff ff       	call   80107370 <setupkvm>
8010740b:	a3 04 6e 11 80       	mov    %eax,0x80116e04
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80107425:	83 ec 18             	sub    $0x18,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80107428:	8b 55 0c             	mov    0xc(%ebp),%edx
8010742b:	8b 45 08             	mov    0x8(%ebp),%eax
8010742e:	e8 cd f8 ff ff       	call   80106d00 <walkpgdir>
  if(pte == 0)
...
8010743b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
8010743c:	c7 04 24 62 81 10 80 	movl   $0x80108162,(%esp)
80107443:	e8 18 8f ff ff       	call   80100360 <panic>
80107448:	90                   	nop
...
80107456:	83 ec 2c             	sub    $0x2c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80107459:	e8 12 ff ff ff       	call   80107370 <setupkvm>
8010745e:	85 c0                	test   %eax,%eax
80107460:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107463:	0f 84 b2 00 00 00    	je     8010751b <copyuvm+0xcb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107469:	8b 45 0c             	mov    0xc(%ebp),%eax
8010746c:	85 c0                	test   %eax,%eax
8010746e:	0f 84 9c 00 00 00    	je     80107510 <copyuvm+0xc0>
80107474:	31 db                	xor    %ebx,%ebx
80107476:	eb 48                	jmp    801074c0 <copyuvm+0x70>
...
80107478:	81 c7 00 00 00 80    	add    $0x80000000,%edi
8010747e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107485:	00 
80107486:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010748a:	89 04 24             	mov    %eax,(%esp)
8010748d:	e8 0e cf ff ff       	call   801043a0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80107492:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107495:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
8010749b:	89 14 24             	mov    %edx,(%esp)
8010749e:	b9 00 10 00 00       	mov    $0x1000,%ecx
801074a3:	89 da                	mov    %ebx,%edx
801074a5:	89 44 24 04          	mov    %eax,0x4(%esp)
801074a9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801074ac:	e8 df f8 ff ff       	call   80106d90 <mappages>
801074b1:	85 c0                	test   %eax,%eax
801074b3:	78 41                	js     801074f6 <copyuvm+0xa6>
  uint pa, i, flags;
  char *mem;
...
801074bb:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
801074be:	76 50                	jbe    80107510 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801074c0:	8b 45 08             	mov    0x8(%ebp),%eax
801074c3:	31 c9                	xor    %ecx,%ecx
801074c5:	89 da                	mov    %ebx,%edx
801074c7:	e8 34 f8 ff ff       	call   80106d00 <walkpgdir>
801074cc:	85 c0                	test   %eax,%eax
801074ce:	74 5b                	je     8010752b <copyuvm+0xdb>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
801074d0:	8b 30                	mov    (%eax),%esi
801074d2:	f7 c6 01 00 00 00    	test   $0x1,%esi
801074d8:	74 45                	je     8010751f <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801074da:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
801074dc:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
801074e2:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
801074e5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
801074eb:	e8 30 b0 ff ff       	call   80102520 <kalloc>
801074f0:	85 c0                	test   %eax,%eax
801074f2:	89 c6                	mov    %eax,%esi
801074f4:	75 82                	jne    80107478 <copyuvm+0x28>
      goto bad;
  }
  return d;
...
801074f9:	89 04 24             	mov    %eax,(%esp)
801074fc:	e8 ef fd ff ff       	call   801072f0 <freevm>
  return 0;
80107501:	31 c0                	xor    %eax,%eax
}
80107503:	83 c4 2c             	add    $0x2c,%esp
80107506:	5b                   	pop    %ebx
80107507:	5e                   	pop    %esi
80107508:	5f                   	pop    %edi
80107509:	5d                   	pop    %ebp
...
80107510:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107513:	83 c4 2c             	add    $0x2c,%esp
80107516:	5b                   	pop    %ebx
80107517:	5e                   	pop    %esi
80107518:	5f                   	pop    %edi
80107519:	5d                   	pop    %ebp
...
8010751d:	eb e4                	jmp    80107503 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
8010751f:	c7 04 24 86 81 10 80 	movl   $0x80108186,(%esp)
80107526:	e8 35 8e ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
8010752b:	c7 04 24 6c 81 10 80 	movl   $0x8010816c,(%esp)
80107532:	e8 29 8e ff ff       	call   80100360 <panic>
...
8010754e:	e8 ad f7 ff ff       	call   80106d00 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80107557:	83 e2 05             	and    $0x5,%edx
    return 0;
  if((*pte & PTE_U) == 0)
8010755a:	83 fa 05             	cmp    $0x5,%edx
8010755d:	75 11                	jne    80107570 <uva2ka+0x30>
    return 0;
  return (char*)P2V(PTE_ADDR(*pte));
8010755f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107564:	05 00 00 00 80       	add    $0x80000000,%eax
}
80107569:	c9                   	leave  
8010756a:	c3                   	ret    
8010756b:	90                   	nop
...
80107589:	8b 5d 14             	mov    0x14(%ebp),%ebx
8010758c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010758f:	8b 7d 10             	mov    0x10(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107592:	85 db                	test   %ebx,%ebx
80107594:	75 3a                	jne    801075d0 <copyout+0x50>
80107596:	eb 68                	jmp    80107600 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80107598:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010759b:	89 f2                	mov    %esi,%edx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
8010759d:	89 7c 24 04          	mov    %edi,0x4(%esp)
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
801075a1:	29 ca                	sub    %ecx,%edx
801075a3:	81 c2 00 10 00 00    	add    $0x1000,%edx
801075a9:	39 da                	cmp    %ebx,%edx
801075ab:	0f 47 d3             	cmova  %ebx,%edx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801075ae:	29 f1                	sub    %esi,%ecx
801075b0:	01 c8                	add    %ecx,%eax
801075b2:	89 54 24 08          	mov    %edx,0x8(%esp)
801075b6:	89 04 24             	mov    %eax,(%esp)
801075b9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801075bc:	e8 df cd ff ff       	call   801043a0 <memmove>
    len -= n;
    buf += n;
801075c1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    va = va0 + PGSIZE;
801075c4:	8d 8e 00 10 00 00    	lea    0x1000(%esi),%ecx
    n = PGSIZE - (va - va0);
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
...
801075ca:	01 d7                	add    %edx,%edi
{
  ...
  buf = (char*)p;
  while(len > 0){
801075cc:	29 d3                	sub    %edx,%ebx
801075ce:	74 30                	je     80107600 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
801075d0:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
801075d3:	89 ce                	mov    %ecx,%esi
801075d5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
801075db:	89 74 24 04          	mov    %esi,0x4(%esp)
  char *buf, *pa0;
  uint n, va0;
  ...
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
801075df:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
801075e2:	89 04 24             	mov    %eax,(%esp)
801075e5:	e8 56 ff ff ff       	call   80107540 <uva2ka>
    if(pa0 == 0)
801075ea:	85 c0                	test   %eax,%eax
801075ec:	75 aa                	jne    80107598 <copyout+0x18>
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
  }
...
801075ee:	83 c4 1c             	add    $0x1c,%esp
  buf = (char*)p;
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
...
80107600:	83 c4 1c             	add    $0x1c,%esp
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
