...
int main(int argc, char **argv) {
   ...
   6:	83 ec 10             	sub    $0x10,%esp
	inodeTBWalker();
   9:	e8 ec 02 00 00       	call   2fa <inodeTBWalker>
	deleteIData(10);
   e:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  15:	e8 e8 02 00 00       	call   302 <deleteIData>
	inodeTBWalker();
  1a:	e8 db 02 00 00       	call   2fa <inodeTBWalker>
	exit();
  1f:	e8 2e 02 00 00       	call   252 <exit>
  24:	66 90                	xchg   %ax,%ax
  26:	66 90                	xchg   %ax,%ax
  28:	66 90                	xchg   %ax,%ax
  2a:	66 90                	xchg   %ax,%ax
