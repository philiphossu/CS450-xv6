...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 a3 7d 10 80 	movl   $0x80107da3,(%esp)
...
80100409:	e8 02 5d 00 00       	call   80106110 <uartputc>
}
...
801004b9:	e8 52 5c 00 00       	call   80106110 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 46 5c 00 00       	call   80106110 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 3a 5c 00 00       	call   80106110 <uartputc>
...
80100a2a:	75 d4                	jne    80100a00 <exec+0x60>
  ...
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 cf 68 00 00       	call   80107300 <setupkvm>
...
80100ad2:	e8 99 66 00 00       	call   80107170 <allocuvm>
...
80100b13:	e8 98 65 00 00       	call   801070b0 <loaduvm>
...
80100b29:	e8 52 67 00 00       	call   80107280 <freevm>
...
80100b6c:	e8 ff 65 00 00       	call   80107170 <allocuvm>
...
80100b84:	e8 f7 66 00 00       	call   80107280 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100bc8:	e8 e3 67 00 00       	call   801073b0 <clearpteu>
  sp = sz;
...
80100c31:	e8 da 68 00 00       	call   80107510 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 67 68 00 00       	call   80107510 <copyout>
...
80100d1f:	e8 fc 61 00 00       	call   80106f20 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 54 65 00 00       	call   80107280 <freevm>
  return 0;
...
80102e27:	e8 14 30 00 00       	call   80105e40 <idtinit>
...
80102e53:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e56:	e8 a5 40 00 00       	call   80106f00 <switchkvm>
  seginit();
80102e5b:	e8 e0 3f 00 00       	call   80106e40 <seginit>
  lapicinit();
...
80102e93:	e8 f8 44 00 00       	call   80107390 <kvmalloc>
...
80102ea5:	e8 96 3f 00 00       	call   80106e40 <seginit>
  picinit();       // disable pic
...
80102eba:	e8 a1 32 00 00       	call   80106160 <uartinit>
80102ebf:	90                   	nop
  pinit();         // process table
80102ec0:	e8 9b 07 00 00       	call   80103660 <pinit>
  tvinit();        // trap vectors
80102ec5:	e8 d6 2e 00 00       	call   80105da0 <tvinit>
  binit();         // buffer cache
...
801035ad:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801035b0:	c7 40 14 95 5d 10 80 	movl   $0x80105d95,0x14(%eax)
...
80103763:	e8 98 3b 00 00       	call   80107300 <setupkvm>
...
80103785:	80 
80103786:	e8 a5 38 00 00       	call   80107030 <inituvm>
  p->sz = PGSIZE;
...
80103889:	e8 e2 38 00 00       	call   80107170 <allocuvm>
...
80103897:	e8 84 36 00 00       	call   80106f20 <switchuvm>
  return 0;
...
801038ba:	e8 a1 39 00 00       	call   80107260 <deallocuvm>
...
801038fe:	e8 dd 3a 00 00       	call   801073e0 <copyuvm>
...
80103a32:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a35:	e8 e6 34 00 00       	call   80106f20 <switchuvm>
      p->state = RUNNING;
...
80103a4b:	e8 eb 0a 00 00       	call   8010453b <swtch>
      switchkvm();
80103a50:	e8 ab 34 00 00       	call   80106f00 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103db8:	e8 c3 34 00 00       	call   80107280 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103f04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f08:	c7 04 24 a3 7d 10 80 	movl   $0x80107da3,(%esp)
...
80104b86:	c7 04 24 23 7d 10 80 	movl   $0x80107d23,(%esp)
...
80104bc6:	74 14                	je     80104bdc <sys_recoverFS+0x7c>
			cprintf("FIXING A PROBLEM\n");
80104bc8:	c7 04 24 23 7d 10 80 	movl   $0x80107d23,(%esp)
...
80104ccf:	e8 ac d2 ff ff       	call   80101f80 <namei>
	if(!ip){
...
80104cd6:	89 c3                	mov    %eax,%ebx
	if(!ip){
80104cd8:	0f 84 99 02 00 00    	je     80104f77 <subRoutine+0x2b7>
		panic("Invalid File Path");
	}
	begin_op();
80104cde:	e8 ad de ff ff       	call   80102b90 <begin_op>
	ilock(ip);
80104ce3:	89 1c 24             	mov    %ebx,(%esp)
80104ce6:	e8 f5 c9 ff ff       	call   801016e0 <ilock>
	if(ip->type == T_DIR){
80104ceb:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104cf0:	0f 85 2a 02 00 00    	jne    80104f20 <subRoutine+0x260>
		// The specified path is a directory, go through its directory entries
		for(off = 0; off < ip->size; off += sizeof(de)){
80104cf6:	8b 4b 58             	mov    0x58(%ebx),%ecx
80104cf9:	85 c9                	test   %ecx,%ecx
80104cfb:	0f 84 1f 02 00 00    	je     80104f20 <subRoutine+0x260>
80104d01:	31 f6                	xor    %esi,%esi
80104d03:	eb 0f                	jmp    80104d14 <subRoutine+0x54>
80104d05:	8d 76 00             	lea    0x0(%esi),%esi
80104d08:	83 c6 10             	add    $0x10,%esi
80104d0b:	39 73 58             	cmp    %esi,0x58(%ebx)
80104d0e:	0f 86 0c 02 00 00    	jbe    80104f20 <subRoutine+0x260>
			if(readi(ip, (char*)&de, off, sizeof(de)) != sizeof(de)){
80104d14:	8d 45 d8             	lea    -0x28(%ebp),%eax
80104d17:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104d1e:	00 
80104d1f:	89 74 24 08          	mov    %esi,0x8(%esp)
80104d23:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d27:	89 1c 24             	mov    %ebx,(%esp)
80104d2a:	e8 b1 cc ff ff       	call   801019e0 <readi>
80104d2f:	83 f8 10             	cmp    $0x10,%eax
80104d32:	0f 85 33 02 00 00    	jne    80104f6b <subRoutine+0x2ab>
				// Reading was not successful
				panic("dirlookup read");
			}
			if(off==0 && (strcmp(de.name,"."))){
80104d38:	85 f6                	test   %esi,%esi
80104d3a:	75 78                	jne    80104db4 <subRoutine+0xf4>
  *s1 = 0;
}
...
{
  for (; *s1 && *s2 && *s1==*s2; s1++, s2++);
80104d3c:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
80104d40:	84 c0                	test   %al,%al
80104d42:	0f 84 f7 01 00 00    	je     80104f3f <subRoutine+0x27f>
80104d48:	0f b6 55 db          	movzbl -0x25(%ebp),%edx
80104d4c:	3c 2e                	cmp    $0x2e,%al
80104d4e:	b9 0d 7d 10 80       	mov    $0x80107d0d,%ecx
80104d53:	0f 45 d0             	cmovne %eax,%edx
80104d56:	b8 0c 7d 10 80       	mov    $0x80107d0c,%eax
80104d5b:	0f 45 c8             	cmovne %eax,%ecx
		for(off = 0; off < ip->size; off += sizeof(de)){
			if(readi(ip, (char*)&de, off, sizeof(de)) != sizeof(de)){
				// Reading was not successful
				panic("dirlookup read");
			...
			if(off==0 && (strcmp(de.name,"."))){
80104d5e:	38 11                	cmp    %dl,(%ecx)
80104d60:	74 52                	je     80104db4 <subRoutine+0xf4>
				struct inode* brokenDirParent;
				char name[14] = "..";
80104d62:	31 d2                	xor    %edx,%edx
				iunlock(ip);
80104d64:	89 1c 24             	mov    %ebx,(%esp)
			...
			if(off==0 && (strcmp(de.name,"."))){
				struct inode* brokenDirParent;
				char name[14] = "..";
80104d67:	66 89 55 d6          	mov    %dx,-0x2a(%ebp)
80104d6b:	c7 45 ca 2e 2e 00 00 	movl   $0x2e2e,-0x36(%ebp)
80104d72:	c7 45 ce 00 00 00 00 	movl   $0x0,-0x32(%ebp)
80104d79:	c7 45 d2 00 00 00 00 	movl   $0x0,-0x2e(%ebp)
				iunlock(ip);
80104d80:	e8 3b ca ff ff       	call   801017c0 <iunlock>
...
80104d85:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104d88:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d8c:	8b 45 08             	mov    0x8(%ebp),%eax
80104d8f:	89 04 24             	mov    %eax,(%esp)
80104d92:	e8 09 d2 ff ff       	call   80101fa0 <nameiparent>
80104d97:	85 c0                	test   %eax,%eax
80104d99:	0f 84 67 01 00 00    	je     80104f06 <subRoutine+0x246>
					ilock(ip);
					continue;
				}
...
80104da5:	89 1c 24             	mov    %ebx,(%esp)
				...
				corruptDirs[ip->inum] = brokenDirParent->inum;
80104da8:	89 04 95 60 5c 11 80 	mov    %eax,-0x7feea3a0(,%edx,4)
				ilock(ip);
80104daf:	e8 2c c9 ff ff       	call   801016e0 <ilock>
			}

		    if(de.inum == 0){
80104db4:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
80104db8:	66 85 c0             	test   %ax,%ax
80104dbb:	0f 84 47 ff ff ff    	je     80104d08 <subRoutine+0x48>
		      continue;
		    }

			cprintf("Name: %s \t inode#: %d\n",de.name,de.inum);
80104dc1:	89 44 24 08          	mov    %eax,0x8(%esp)
80104dc5:	8d 45 da             	lea    -0x26(%ebp),%eax
80104dc8:	89 44 24 04          	mov    %eax,0x4(%esp)
80104dcc:	c7 04 24 47 7d 10 80 	movl   $0x80107d47,(%esp)
80104dd3:	e8 78 b8 ff ff       	call   80100650 <cprintf>
  *s1 = 0;
}
...
{
  for (; *s1 && *s2 && *s1==*s2; s1++, s2++);
80104dd8:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
80104ddc:	84 c0                	test   %al,%al
80104dde:	0f 84 67 01 00 00    	je     80104f4b <subRoutine+0x28b>
80104de4:	3c 2e                	cmp    $0x2e,%al
80104de6:	0f 85 6b 01 00 00    	jne    80104f57 <subRoutine+0x297>
80104dec:	80 7d db 00          	cmpb   $0x0,-0x25(%ebp)
		      continue;
		    }
...
80104df0:	b8 0b 7d 10 80       	mov    $0x80107d0b,%eax
80104df5:	8d 55 da             	lea    -0x26(%ebp),%edx
...
{
  for (; *s1 && *s2 && *s1==*s2; s1++, s2++);
80104dfa:	75 1f                	jne    80104e1b <subRoutine+0x15b>
80104dfc:	e9 07 ff ff ff       	jmp    80104d08 <subRoutine+0x48>
80104e01:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104e08:	0f b6 18             	movzbl (%eax),%ebx
80104e0b:	84 db                	test   %bl,%bl
80104e0d:	0f 84 25 01 00 00    	je     80104f38 <subRoutine+0x278>
80104e13:	38 d9                	cmp    %bl,%cl
80104e15:	0f 85 1d 01 00 00    	jne    80104f38 <subRoutine+0x278>
80104e1b:	83 c2 01             	add    $0x1,%edx
80104e1e:	0f b6 0a             	movzbl (%edx),%ecx
80104e21:	83 c0 01             	add    $0x1,%eax
80104e24:	84 c9                	test   %cl,%cl
80104e26:	75 e0                	jne    80104e08 <subRoutine+0x148>
80104e28:	89 fb                	mov    %edi,%ebx
80104e2a:	31 c9                	xor    %ecx,%ecx
		      continue;
		    }
			...
			if (strcmp(de.name, ".") == 0 || strcmp(de.name, "..") == 0){
80104e2c:	38 08                	cmp    %cl,(%eax)
80104e2e:	0f 84 d4 fe ff ff    	je     80104d08 <subRoutine+0x48>
				continue;
			}
			struct inode *dir_ip;
			dir_ip = dirlookup(ip,de.name,0);
80104e34:	8d 45 da             	lea    -0x26(%ebp),%eax
80104e37:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80104e3e:	00 
80104e3f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e43:	89 1c 24             	mov    %ebx,(%esp)
80104e46:	e8 f5 cd ff ff       	call   80101c40 <dirlookup>
			inodeLinkLog[de.inum]++;
80104e4b:	0f b7 55 d8          	movzwl -0x28(%ebp),%edx
80104e4f:	83 04 95 80 5f 11 80 	addl   $0x1,-0x7feea080(,%edx,4)
80104e56:	01 
			if(dir_ip->type == T_DIR){
80104e57:	66 83 78 50 01       	cmpw   $0x1,0x50(%eax)
80104e5c:	0f 85 a6 fe ff ff    	jne    80104d08 <subRoutine+0x48>
				// we found a directory, recursively call
				char new_path[14] = {0};
80104e62:	31 c0                	xor    %eax,%eax
80104e64:	66 89 45 d6          	mov    %ax,-0x2a(%ebp)
     reverse(s);
 }
...
80104e68:	8b 45 08             	mov    0x8(%ebp),%eax
			...
			if(dir_ip->type == T_DIR){
				// we found a directory, recursively call
				char new_path[14] = {0};
80104e6b:	c7 45 ca 00 00 00 00 	movl   $0x0,-0x36(%ebp)
80104e72:	c7 45 ce 00 00 00 00 	movl   $0x0,-0x32(%ebp)
80104e79:	c7 45 d2 00 00 00 00 	movl   $0x0,-0x2e(%ebp)
     reverse(s);
 }
...
80104e85:	0f 84 d8 00 00 00    	je     80104f63 <subRoutine+0x2a3>
80104e8b:	89 c1                	mov    %eax,%ecx
80104e8d:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104e90:	83 c0 01             	add    $0x1,%eax
80104e93:	83 c1 01             	add    $0x1,%ecx
80104e96:	88 50 ff             	mov    %dl,-0x1(%eax)
80104e99:	0f b6 11             	movzbl (%ecx),%edx
80104e9c:	84 d2                	test   %dl,%dl
80104e9e:	75 f0                	jne    80104e90 <subRoutine+0x1d0>
  *s1 = 0;
80104ea0:	c6 00 00             	movb   $0x0,(%eax)
     s[i] = '\0';
     reverse(s);
 }
...
void strcat(char* s1, const char* s2){
  while (*s1) ++s1;
80104ea3:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104ea6:	80 7d ca 00          	cmpb   $0x0,-0x36(%ebp)
80104eaa:	74 0c                	je     80104eb8 <subRoutine+0x1f8>
80104eac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104eb0:	83 c0 01             	add    $0x1,%eax
80104eb3:	80 38 00             	cmpb   $0x0,(%eax)
80104eb6:	75 f8                	jne    80104eb0 <subRoutine+0x1f0>
  while (*s2) *s1++ = *s2++;
80104eb8:	c6 00 2f             	movb   $0x2f,(%eax)
  *s1 = 0;
80104ebb:	c6 40 01 00          	movb   $0x0,0x1(%eax)
     s[i] = '\0';
     reverse(s);
 }
...
void strcat(char* s1, const char* s2){
  while (*s1) ++s1;
80104ebf:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104ec2:	80 7d ca 00          	cmpb   $0x0,-0x36(%ebp)
80104ec6:	74 08                	je     80104ed0 <subRoutine+0x210>
80104ec8:	83 c0 01             	add    $0x1,%eax
80104ecb:	80 38 00             	cmpb   $0x0,(%eax)
80104ece:	75 f8                	jne    80104ec8 <subRoutine+0x208>
  while (*s2) *s1++ = *s2++;
80104ed0:	0f b6 55 da          	movzbl -0x26(%ebp),%edx
80104ed4:	84 d2                	test   %dl,%dl
80104ed6:	74 18                	je     80104ef0 <subRoutine+0x230>
80104ed8:	8d 4d da             	lea    -0x26(%ebp),%ecx
80104edb:	90                   	nop
80104edc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104ee0:	83 c0 01             	add    $0x1,%eax
80104ee3:	83 c1 01             	add    $0x1,%ecx
80104ee6:	88 50 ff             	mov    %dl,-0x1(%eax)
80104ee9:	0f b6 11             	movzbl (%ecx),%edx
80104eec:	84 d2                	test   %dl,%dl
80104eee:	75 f0                	jne    80104ee0 <subRoutine+0x220>
  *s1 = 0;
...
80104ef6:	e8 c5 c8 ff ff       	call   801017c0 <iunlock>
				subRoutine(new_path);
80104efb:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104efe:	89 04 24             	mov    %eax,(%esp)
80104f01:	e8 ba fd ff ff       	call   80104cc0 <subRoutine>
				ilock(ip);
80104f06:	89 1c 24             	mov    %ebx,(%esp)
	...
	if(ip->type == T_DIR){
		// The specified path is a directory, go through its directory entries
		for(off = 0; off < ip->size; off += sizeof(de)){
80104f09:	83 c6 10             	add    $0x10,%esi
				strcat(new_path,path);
				strcat(new_path,"/");
				strcat(new_path,de.name);
				iunlock(ip);
				subRoutine(new_path);
				ilock(ip);
80104f0c:	e8 cf c7 ff ff       	call   801016e0 <ilock>
	}
	begin_op();
	ilock(ip);
	if(ip->type == T_DIR){
		// The specified path is a directory, go through its directory entries
		for(off = 0; off < ip->size; off += sizeof(de)){
80104f11:	39 73 58             	cmp    %esi,0x58(%ebx)
80104f14:	0f 87 fa fd ff ff    	ja     80104d14 <subRoutine+0x54>
80104f1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	...
	iunlock(ip);
80104f20:	89 1c 24             	mov    %ebx,(%esp)
80104f23:	e8 98 c8 ff ff       	call   801017c0 <iunlock>
	end_op();
80104f28:	e8 d3 dc ff ff       	call   80102c00 <end_op>
}
80104f2d:	83 c4 3c             	add    $0x3c,%esp
80104f30:	5b                   	pop    %ebx
80104f31:	5e                   	pop    %esi
80104f32:	5f                   	pop    %edi
80104f33:	5d                   	pop    %ebp
...
80104f3a:	e9 ed fe ff ff       	jmp    80104e2c <subRoutine+0x16c>
  *s1 = 0;
}
...
{
  for (; *s1 && *s2 && *s1==*s2; s1++, s2++);
80104f3f:	31 d2                	xor    %edx,%edx
80104f41:	b9 0c 7d 10 80       	mov    $0x80107d0c,%ecx
80104f46:	e9 13 fe ff ff       	jmp    80104d5e <subRoutine+0x9e>
80104f4b:	31 c9                	xor    %ecx,%ecx
80104f4d:	b8 0b 7d 10 80       	mov    $0x80107d0b,%eax
80104f52:	e9 d5 fe ff ff       	jmp    80104e2c <subRoutine+0x16c>
80104f57:	89 c1                	mov    %eax,%ecx
		      continue;
		    }
			...
			if (strcmp(de.name, ".") == 0 || strcmp(de.name, "..") == 0){
80104f59:	b8 0b 7d 10 80       	mov    $0x80107d0b,%eax
80104f5e:	e9 c9 fe ff ff       	jmp    80104e2c <subRoutine+0x16c>
     reverse(s);
 }
...
void strcat(char* s1, const char* s2){
  while (*s1) ++s1;
  while (*s2) *s1++ = *s2++;
80104f63:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104f66:	e9 35 ff ff ff       	jmp    80104ea0 <subRoutine+0x1e0>
	if(ip->type == T_DIR){
		// The specified path is a directory, go through its directory entries
		for(off = 0; off < ip->size; off += sizeof(de)){
			if(readi(ip, (char*)&de, off, sizeof(de)) != sizeof(de)){
				// Reading was not successful
				panic("dirlookup read");
80104f6b:	c7 04 24 f9 76 10 80 	movl   $0x801076f9,(%esp)
80104f72:	e8 e9 b3 ff ff       	call   80100360 <panic>
	...
	if(!ip){
		panic("Invalid File Path");
80104f77:	c7 04 24 35 7d 10 80 	movl   $0x80107d35,(%esp)
80104f7e:	e8 dd b3 ff ff       	call   80100360 <panic>
...
80104fa4:	e8 d7 f6 ff ff       	call   80104680 <argstr>
	cprintf("argSTR is = %d\n",useless);
80104fa9:	c7 04 24 5e 7d 10 80 	movl   $0x80107d5e,(%esp)
80104fb0:	89 44 24 04          	mov    %eax,0x4(%esp)
80104fb4:	e8 97 b6 ff ff       	call   80100650 <cprintf>
	if(!path){
80104fb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fbc:	85 c0                	test   %eax,%eax
80104fbe:	74 54                	je     80105014 <sys_directoryWalker+0x84>
		path = ".";
		cprintf("changing course\n");
	}
	cprintf("path is %s\n",path);
80104fc0:	89 44 24 04          	mov    %eax,0x4(%esp)
80104fc4:	c7 04 24 7f 7d 10 80 	movl   $0x80107d7f,(%esp)
80104fcb:	e8 80 b6 ff ff       	call   80100650 <cprintf>
//		cprintf("aahhhhhhhh");
//		argstr(0,&path);
//	}
	// initialize link log
...
80104fd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		inodeLinkLog[inodeNum]=0;
80104fd8:	c7 04 85 80 5f 11 80 	movl   $0x0,-0x7feea080(,%eax,4)
80104fdf:	00 00 00 00 
//		cprintf("aahhhhhhhh");
//		argstr(0,&path);
//	}
	// initialize link log
	int inodeNum = 0;
	for(inodeNum = 0; inodeNum<200;inodeNum++){
80104fe3:	83 c0 01             	add    $0x1,%eax
80104fe6:	3d c8 00 00 00       	cmp    $0xc8,%eax
80104feb:	75 eb                	jne    80104fd8 <sys_directoryWalker+0x48>
80104fed:	30 c0                	xor    %al,%al
80104fef:	90                   	nop
		inodeLinkLog[inodeNum]=0;
	}
	...
	for(inodeNum = 0; inodeNum<200;inodeNum++){
		corruptDirs[inodeNum]=0;
80104ff0:	c7 04 85 60 5c 11 80 	movl   $0x0,-0x7feea3a0(,%eax,4)
80104ff7:	00 00 00 00 
	for(inodeNum = 0; inodeNum<200;inodeNum++){
		inodeLinkLog[inodeNum]=0;
	}
	// initialize corrupt directory log
	inodeNum = 0;
	for(inodeNum = 0; inodeNum<200;inodeNum++){
80104ffb:	83 c0 01             	add    $0x1,%eax
80104ffe:	3d c8 00 00 00       	cmp    $0xc8,%eax
80105003:	75 eb                	jne    80104ff0 <sys_directoryWalker+0x60>
		corruptDirs[inodeNum]=0;
	}
...
8010500b:	e8 b0 fc ff ff       	call   80104cc0 <subRoutine>
...
80105013:	c3                   	ret    
	...
	if(!path){
		path = ".";
		cprintf("changing course\n");
80105014:	c7 04 24 6e 7d 10 80 	movl   $0x80107d6e,(%esp)
int sys_directoryWalker(void){
	char *path;
	int useless = argstr(0,&path);
	cprintf("argSTR is = %d\n",useless);
	if(!path){
		path = ".";
8010501b:	c7 45 f4 0c 7d 10 80 	movl   $0x80107d0c,-0xc(%ebp)
		cprintf("changing course\n");
80105022:	e8 29 b6 ff ff       	call   80100650 <cprintf>
80105027:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010502a:	eb 94                	jmp    80104fc0 <sys_directoryWalker+0x30>
8010502c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105030 <sys_inodeTBWalker>:
	end_op();
}
...
80105038:	c7 04 85 a0 62 11 80 	movl   $0x0,-0x7fee9d60(,%eax,4)
...
int sys_inodeTBWalker(void){
	int inodeNum = 0;
	for(inodeNum = 0; inodeNum<200;inodeNum++){
80105043:	83 c0 01             	add    $0x1,%eax
80105046:	3d c8 00 00 00       	cmp    $0xc8,%eax
8010504b:	75 eb                	jne    80105038 <sys_inodeTBWalker+0x8>
	}
	iunlock(ip);
	end_op();
}
...
80105050:	56                   	push   %esi
	...
	for(inum = 1; inum < sb.ninodes; inum++){
80105051:	be 01 00 00 00       	mov    $0x1,%esi
	}
	iunlock(ip);
	end_op();
}
...
80105056:	53                   	push   %ebx
	...
	readsb(1,&sb); // Read superblock
	for(inum = 1; inum < sb.ninodes; inum++){
80105057:	bb 01 00 00 00       	mov    $0x1,%ebx
	}
	iunlock(ip);
	end_op();
}
...
8010505c:	83 ec 10             	sub    $0x10,%esp
	...
	struct dinode *dip;
	readsb(1,&sb); // Read superblock
8010505f:	c7 44 24 04 c0 19 11 	movl   $0x801119c0,0x4(%esp)
80105066:	80 
80105067:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010506e:	e8 4d c3 ff ff       	call   801013c0 <readsb>
	for(inum = 1; inum < sb.ninodes; inum++){
80105073:	83 3d c8 19 11 80 01 	cmpl   $0x1,0x801119c8
8010507a:	77 19                	ja     80105095 <sys_inodeTBWalker+0x65>
8010507c:	eb 6a                	jmp    801050e8 <sys_inodeTBWalker+0xb8>
...
80105083:	83 c3 01             	add    $0x1,%ebx
		...
		brelse(bp);
80105086:	e8 55 b1 ff ff       	call   801001e0 <brelse>
	}
	int inum; // Loop counter
	struct buf *bp;
	struct dinode *dip;
	readsb(1,&sb); // Read superblock
	for(inum = 1; inum < sb.ninodes; inum++){
8010508b:	89 de                	mov    %ebx,%esi
8010508d:	3b 1d c8 19 11 80    	cmp    0x801119c8,%ebx
80105093:	73 53                	jae    801050e8 <sys_inodeTBWalker+0xb8>
		bp = bread(1, IBLOCK(inum, sb));
80105095:	89 f0                	mov    %esi,%eax
		dip = (struct dinode*)bp->data + inum%IPB;
80105097:	83 e6 07             	and    $0x7,%esi
	int inum; // Loop counter
	struct buf *bp;
	struct dinode *dip;
	readsb(1,&sb); // Read superblock
	for(inum = 1; inum < sb.ninodes; inum++){
		bp = bread(1, IBLOCK(inum, sb));
8010509a:	c1 e8 03             	shr    $0x3,%eax
8010509d:	03 05 d4 19 11 80    	add    0x801119d4,%eax
801050a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801050aa:	89 44 24 04          	mov    %eax,0x4(%esp)
801050ae:	e8 1d b0 ff ff       	call   801000d0 <bread>
		dip = (struct dinode*)bp->data + inum%IPB;
801050b3:	89 f2                	mov    %esi,%edx
		if(dip->type != 0){  // not a free inode
801050b5:	c1 e2 06             	shl    $0x6,%edx
801050b8:	0f bf 54 10 5c       	movswl 0x5c(%eax,%edx,1),%edx
801050bd:	66 85 d2             	test   %dx,%dx
801050c0:	74 be                	je     80105080 <sys_inodeTBWalker+0x50>
			// Found allocated inode
			cprintf("inode#: %d \t type: %d\n",inum,dip->type);
801050c2:	89 54 24 08          	mov    %edx,0x8(%esp)
801050c6:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801050ca:	c7 04 24 8b 7d 10 80 	movl   $0x80107d8b,(%esp)
801050d1:	89 45 f4             	mov    %eax,-0xc(%ebp)
801050d4:	e8 77 b5 ff ff       	call   80100650 <cprintf>
			inodeTBWalkerLinkLog[inum]++;
801050d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050dc:	83 04 9d a0 62 11 80 	addl   $0x1,-0x7fee9d60(,%ebx,4)
801050e3:	01 
801050e4:	eb 9a                	jmp    80105080 <sys_inodeTBWalker+0x50>
...
801050ef:	5d                   	pop    %ebp
801050f0:	c3                   	ret    
801050f1:	eb 0d                	jmp    80105100 <sys_compareWalkers>
801050f3:	90                   	nop
801050f4:	90                   	nop
801050f5:	90                   	nop
801050f6:	90                   	nop
...
80105103:	56                   	push   %esi
	...
	int inodeIndex;
	int similarity = 1;
80105104:	be 01 00 00 00       	mov    $0x1,%esi
	dirlink(ip,newName,inum);
	iunlock(ip);
	end_op();
}
...
80105109:	53                   	push   %ebx
	...
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
8010510a:	bb 02 00 00 00       	mov    $0x2,%ebx
	dirlink(ip,newName,inum);
	iunlock(ip);
	end_op();
}
...
80105112:	c7 04 24 d8 7d 10 80 	movl   $0x80107dd8,(%esp)
80105119:	e8 32 b5 ff ff       	call   80100650 <cprintf>
	sys_inodeTBWalker();
8010511e:	e8 0d ff ff ff       	call   80105030 <sys_inodeTBWalker>
	cprintf("\n\n");
80105123:	c7 04 24 a2 7d 10 80 	movl   $0x80107da2,(%esp)
8010512a:	e8 21 b5 ff ff       	call   80100650 <cprintf>
	cprintf("\n= = = Calling directoryWalker = = =\n");
8010512f:	c7 04 24 fc 7d 10 80 	movl   $0x80107dfc,(%esp)
80105136:	e8 15 b5 ff ff       	call   80100650 <cprintf>
	sys_directoryWalker();
8010513b:	e8 50 fe ff ff       	call   80104f90 <sys_directoryWalker>
	cprintf("\n\n");
80105140:	c7 04 24 a2 7d 10 80 	movl   $0x80107da2,(%esp)
80105147:	e8 04 b5 ff ff       	call   80100650 <cprintf>
	cprintf("\n= = = Comparing walkers = = =\n");
8010514c:	c7 04 24 24 7e 10 80 	movl   $0x80107e24,(%esp)
80105153:	e8 f8 b4 ff ff       	call   80100650 <cprintf>
	int inodeIndex;
	int similarity = 1;
	// We begin at 2 because the root will be the same
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
		if(inodeLinkLog[inodeIndex] != inodeTBWalkerLinkLog[inodeIndex]){
80105158:	8b 04 9d a0 62 11 80 	mov    -0x7fee9d60(,%ebx,4),%eax
8010515f:	39 04 9d 80 5f 11 80 	cmp    %eax,-0x7feea080(,%ebx,4)
80105166:	74 34                	je     8010519c <sys_compareWalkers+0x9c>
			similarity = 0;
...
80105168:	89 5c 24 04          	mov    %ebx,0x4(%esp)
	...
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
		if(inodeLinkLog[inodeIndex] != inodeTBWalkerLinkLog[inodeIndex]){
			similarity = 0;
8010516c:	31 f6                	xor    %esi,%esi
			cprintf("Found difference between inodeTBWalker & directoryWalker @ inode#: %d\n",inodeIndex);
8010516e:	c7 04 24 44 7e 10 80 	movl   $0x80107e44,(%esp)
80105175:	e8 d6 b4 ff ff       	call   80100650 <cprintf>
			cprintf("inodeTBwalker #links: %d \t directoryWalker #links: %d\n\n",inodeTBWalkerLinkLog[inodeIndex],inodeLinkLog[inodeIndex]);
8010517a:	8b 04 9d 80 5f 11 80 	mov    -0x7feea080(,%ebx,4),%eax
80105181:	c7 04 24 8c 7e 10 80 	movl   $0x80107e8c,(%esp)
80105188:	89 44 24 08          	mov    %eax,0x8(%esp)
8010518c:	8b 04 9d a0 62 11 80 	mov    -0x7fee9d60(,%ebx,4),%eax
80105193:	89 44 24 04          	mov    %eax,0x4(%esp)
80105197:	e8 b4 b4 ff ff       	call   80100650 <cprintf>
	cprintf("\n\n");
	cprintf("\n= = = Comparing walkers = = =\n");
	int inodeIndex;
	int similarity = 1;
	// We begin at 2 because the root will be the same
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
8010519c:	83 c3 01             	add    $0x1,%ebx
8010519f:	81 fb c8 00 00 00    	cmp    $0xc8,%ebx
801051a5:	75 b1                	jne    80105158 <sys_compareWalkers+0x58>
801051a7:	b3 02                	mov    $0x2,%bl
801051a9:	eb 10                	jmp    801051bb <sys_compareWalkers+0xbb>
801051ab:	90                   	nop
...
801051b3:	81 fb c8 00 00 00    	cmp    $0xc8,%ebx
801051b9:	74 26                	je     801051e1 <sys_compareWalkers+0xe1>
		if(corruptDirs[inodeIndex] != 0){
801051bb:	8b 04 9d 60 5c 11 80 	mov    -0x7feea3a0(,%ebx,4),%eax
801051c2:	85 c0                	test   %eax,%eax
801051c4:	74 ea                	je     801051b0 <sys_compareWalkers+0xb0>
			cprintf("Found a corrupted directory#: %d\n",inodeIndex);
801051c6:	89 5c 24 04          	mov    %ebx,0x4(%esp)
			similarity = 0;
			cprintf("Found difference between inodeTBWalker & directoryWalker @ inode#: %d\n",inodeIndex);
			cprintf("inodeTBwalker #links: %d \t directoryWalker #links: %d\n\n",inodeTBWalkerLinkLog[inodeIndex],inodeLinkLog[inodeIndex]);
		}
	...
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
801051ca:	83 c3 01             	add    $0x1,%ebx
		if(corruptDirs[inodeIndex] != 0){
			cprintf("Found a corrupted directory#: %d\n",inodeIndex);
801051cd:	c7 04 24 c4 7e 10 80 	movl   $0x80107ec4,(%esp)
801051d4:	e8 77 b4 ff ff       	call   80100650 <cprintf>
			similarity = 0;
			cprintf("Found difference between inodeTBWalker & directoryWalker @ inode#: %d\n",inodeIndex);
			cprintf("inodeTBwalker #links: %d \t directoryWalker #links: %d\n\n",inodeTBWalkerLinkLog[inodeIndex],inodeLinkLog[inodeIndex]);
		}
	...
	for(inodeIndex=2; inodeIndex<200; inodeIndex++){
801051d9:	81 fb c8 00 00 00    	cmp    $0xc8,%ebx
801051df:	75 da                	jne    801051bb <sys_compareWalkers+0xbb>
		if(corruptDirs[inodeIndex] != 0){
			cprintf("Found a corrupted directory#: %d\n",inodeIndex);
		}
	}
...
80105204:	e8 e7 f3 ff ff       	call   801045f0 <argint>
	callDeleteInFS(inum);
80105209:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010520c:	89 04 24             	mov    %eax,(%esp)
8010520f:	e8 ec c5 ff ff       	call   80101800 <callDeleteInFS>
	return 0;
}
...
80105226:	83 ec 24             	sub    $0x24,%esp
	...
	if(argfd(0, 0, &f) < 0)
80105229:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010522c:	e8 bf f6 ff ff       	call   801048f0 <argfd.constprop.0>
80105231:	85 c0                	test   %eax,%eax
80105233:	78 23                	js     80105258 <sys_dup+0x38>
		return -1;
	if((fd=fdalloc(f)) < 0)
80105235:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105238:	e8 f3 f4 ff ff       	call   80104730 <fdalloc>
8010523d:	85 c0                	test   %eax,%eax
8010523f:	89 c3                	mov    %eax,%ebx
80105241:	78 15                	js     80105258 <sys_dup+0x38>
		return -1;
	filedup(f);
80105243:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105246:	89 04 24             	mov    %eax,(%esp)
80105249:	e8 92 bb ff ff       	call   80100de0 <filedup>
	return fd;
8010524e:	89 d8                	mov    %ebx,%eax
}
80105250:	83 c4 24             	add    $0x24,%esp
80105253:	5b                   	pop    %ebx
80105254:	5d                   	pop    %ebp
80105255:	c3                   	ret    
...
8010525d:	eb f1                	jmp    80105250 <sys_dup+0x30>
8010525f:	90                   	nop
...
8010526b:	e8 80 f6 ff ff       	call   801048f0 <argfd.constprop.0>
80105270:	85 c0                	test   %eax,%eax
80105272:	78 54                	js     801052c8 <sys_read+0x68>
80105274:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105277:	89 44 24 04          	mov    %eax,0x4(%esp)
8010527b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105282:	e8 69 f3 ff ff       	call   801045f0 <argint>
80105287:	85 c0                	test   %eax,%eax
80105289:	78 3d                	js     801052c8 <sys_read+0x68>
8010528b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010528e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105295:	89 44 24 08          	mov    %eax,0x8(%esp)
80105299:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010529c:	89 44 24 04          	mov    %eax,0x4(%esp)
801052a0:	e8 7b f3 ff ff       	call   80104620 <argptr>
801052a5:	85 c0                	test   %eax,%eax
801052a7:	78 1f                	js     801052c8 <sys_read+0x68>
		return -1;
	return fileread(f, p, n);
801052a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801052ac:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801052bd:	e8 7e bc ff ff       	call   80100f40 <fileread>
}
801052c2:	c9                   	leave  
801052c3:	c3                   	ret    
...
801052e2:	78 54                	js     80105338 <sys_write+0x68>
...
801052f9:	78 3d                	js     80105338 <sys_write+0x68>
...
80105317:	78 1f                	js     80105338 <sys_write+0x68>
		return -1;
...
8010532d:	e8 ae bc ff ff       	call   80100fe0 <filewrite>
}
80105332:	c9                   	leave  
80105333:	c3                   	ret    
...
80105343:	83 ec 28             	sub    $0x28,%esp
	...
	if(argfd(0, &fd, &f) < 0)
80105346:	8d 55 f4             	lea    -0xc(%ebp),%edx
80105349:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010534c:	e8 9f f5 ff ff       	call   801048f0 <argfd.constprop.0>
80105351:	85 c0                	test   %eax,%eax
80105353:	78 23                	js     80105378 <sys_close+0x38>
		return -1;
	myproc()->ofile[fd] = 0;
80105355:	e8 c6 e3 ff ff       	call   80103720 <myproc>
8010535a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010535d:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80105364:	00 
	fileclose(f);
80105365:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105368:	89 04 24             	mov    %eax,(%esp)
8010536b:	e8 c0 ba ff ff       	call   80100e30 <fileclose>
	return 0;
...
80105385:	83 ec 28             	sub    $0x28,%esp
	...
	if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80105388:	8d 55 f0             	lea    -0x10(%ebp),%edx
8010538b:	e8 60 f5 ff ff       	call   801048f0 <argfd.constprop.0>
80105390:	85 c0                	test   %eax,%eax
80105392:	78 34                	js     801053c8 <sys_fstat+0x48>
80105394:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105397:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010539e:	00 
8010539f:	89 44 24 04          	mov    %eax,0x4(%esp)
801053a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801053aa:	e8 71 f2 ff ff       	call   80104620 <argptr>
801053af:	85 c0                	test   %eax,%eax
801053b1:	78 15                	js     801053c8 <sys_fstat+0x48>
		return -1;
	return filestat(f, st);
801053b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801053ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053bd:	89 04 24             	mov    %eax,(%esp)
801053c0:	e8 2b bb ff ff       	call   80100ef0 <filestat>
}
801053c5:	c9                   	leave  
801053c6:	c3                   	ret    
801053c7:	90                   	nop
...
801053d6:	83 ec 3c             	sub    $0x3c,%esp
	char name[DIRSIZ], *new, *old;
	struct inode *dp, *ip;

	if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801053d9:	8d 45 d4             	lea    -0x2c(%ebp),%eax
801053dc:	89 44 24 04          	mov    %eax,0x4(%esp)
801053e0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801053e7:	e8 94 f2 ff ff       	call   80104680 <argstr>
801053ec:	85 c0                	test   %eax,%eax
801053ee:	0f 88 e6 00 00 00    	js     801054da <sys_link+0x10a>
801053f4:	8d 45 d0             	lea    -0x30(%ebp),%eax
801053f7:	89 44 24 04          	mov    %eax,0x4(%esp)
801053fb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105402:	e8 79 f2 ff ff       	call   80104680 <argstr>
80105407:	85 c0                	test   %eax,%eax
80105409:	0f 88 cb 00 00 00    	js     801054da <sys_link+0x10a>
		return -1;

	begin_op();
8010540f:	e8 7c d7 ff ff       	call   80102b90 <begin_op>
	if((ip = namei(old)) == 0){
80105414:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105417:	89 04 24             	mov    %eax,(%esp)
8010541a:	e8 61 cb ff ff       	call   80101f80 <namei>
8010541f:	85 c0                	test   %eax,%eax
80105421:	89 c3                	mov    %eax,%ebx
80105423:	0f 84 ac 00 00 00    	je     801054d5 <sys_link+0x105>
		end_op();
		return -1;
	}
...
8010542c:	e8 af c2 ff ff       	call   801016e0 <ilock>
	if(ip->type == T_DIR){
80105431:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105436:	0f 84 91 00 00 00    	je     801054cd <sys_link+0xfd>
		iunlockput(ip);
		end_op();
		return -1;
	}
	...
	ip->nlink++;
8010543c:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
	iupdate(ip);
	iunlock(ip);

	if((dp = nameiparent(new, name)) == 0)
80105441:	8d 7d da             	lea    -0x26(%ebp),%edi
		end_op();
		return -1;
	}
...
80105447:	e8 d4 c1 ff ff       	call   80101620 <iupdate>
	iunlock(ip);
8010544c:	89 1c 24             	mov    %ebx,(%esp)
8010544f:	e8 6c c3 ff ff       	call   801017c0 <iunlock>

	if((dp = nameiparent(new, name)) == 0)
80105454:	8b 45 d0             	mov    -0x30(%ebp),%eax
80105457:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010545b:	89 04 24             	mov    %eax,(%esp)
8010545e:	e8 3d cb ff ff       	call   80101fa0 <nameiparent>
80105463:	85 c0                	test   %eax,%eax
80105465:	89 c6                	mov    %eax,%esi
80105467:	74 4f                	je     801054b8 <sys_link+0xe8>
		goto bad;
	ilock(dp);
80105469:	89 04 24             	mov    %eax,(%esp)
8010546c:	e8 6f c2 ff ff       	call   801016e0 <ilock>
	if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105471:	8b 03                	mov    (%ebx),%eax
80105473:	39 06                	cmp    %eax,(%esi)
80105475:	75 39                	jne    801054b0 <sys_link+0xe0>
80105477:	8b 43 04             	mov    0x4(%ebx),%eax
8010547a:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010547e:	89 34 24             	mov    %esi,(%esp)
80105481:	89 44 24 08          	mov    %eax,0x8(%esp)
80105485:	e8 16 ca ff ff       	call   80101ea0 <dirlink>
8010548a:	85 c0                	test   %eax,%eax
8010548c:	78 22                	js     801054b0 <sys_link+0xe0>
		iunlockput(dp);
		goto bad;
	}
	iunlockput(dp);
8010548e:	89 34 24             	mov    %esi,(%esp)
80105491:	e8 fa c4 ff ff       	call   80101990 <iunlockput>
	iput(ip);
80105496:	89 1c 24             	mov    %ebx,(%esp)
80105499:	e8 b2 c3 ff ff       	call   80101850 <iput>

	end_op();
8010549e:	e8 5d d7 ff ff       	call   80102c00 <end_op>
	ip->nlink--;
	iupdate(ip);
	iunlockput(ip);
	end_op();
...
801054a3:	83 c4 3c             	add    $0x3c,%esp
	iunlockput(dp);
	iput(ip);
...
801054ad:	8d 76 00             	lea    0x0(%esi),%esi
	...
	if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
		iunlockput(dp);
801054b0:	89 34 24             	mov    %esi,(%esp)
801054b3:	e8 d8 c4 ff ff       	call   80101990 <iunlockput>
	end_op();
...
801054bb:	e8 20 c2 ff ff       	call   801016e0 <ilock>
	ip->nlink--;
801054c0:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
	iupdate(ip);
801054c5:	89 1c 24             	mov    %ebx,(%esp)
801054c8:	e8 53 c1 ff ff       	call   80101620 <iupdate>
	iunlockput(ip);
801054cd:	89 1c 24             	mov    %ebx,(%esp)
801054d0:	e8 bb c4 ff ff       	call   80101990 <iunlockput>
	end_op();
801054d5:	e8 26 d7 ff ff       	call   80102c00 <end_op>
	return -1;
}
801054da:	83 c4 3c             	add    $0x3c,%esp
	ilock(ip);
	ip->nlink--;
	iupdate(ip);
	iunlockput(ip);
...
801054f6:	83 ec 5c             	sub    $0x5c,%esp
	struct inode *ip, *dp;
	struct dirent de;
	...
	if(argstr(0, &path) < 0)
801054f9:	8d 45 c0             	lea    -0x40(%ebp),%eax
801054fc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105500:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105507:	e8 74 f1 ff ff       	call   80104680 <argstr>
8010550c:	85 c0                	test   %eax,%eax
8010550e:	0f 88 76 01 00 00    	js     8010568a <sys_unlink+0x19a>
		return -1;

	begin_op();
80105514:	e8 77 d6 ff ff       	call   80102b90 <begin_op>
	if((dp = nameiparent(path, name)) == 0){
80105519:	8b 45 c0             	mov    -0x40(%ebp),%eax
8010551c:	8d 5d ca             	lea    -0x36(%ebp),%ebx
8010551f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80105523:	89 04 24             	mov    %eax,(%esp)
80105526:	e8 75 ca ff ff       	call   80101fa0 <nameiparent>
8010552b:	85 c0                	test   %eax,%eax
8010552d:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80105530:	0f 84 4f 01 00 00    	je     80105685 <sys_unlink+0x195>
		end_op();
		return -1;
	}

	ilock(dp);
80105536:	8b 75 b4             	mov    -0x4c(%ebp),%esi
80105539:	89 34 24             	mov    %esi,(%esp)
8010553c:	e8 9f c1 ff ff       	call   801016e0 <ilock>

	// Cannot unlink "." or "..".
	if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105541:	c7 44 24 04 0c 7d 10 	movl   $0x80107d0c,0x4(%esp)
80105548:	80 
80105549:	89 1c 24             	mov    %ebx,(%esp)
8010554c:	e8 bf c6 ff ff       	call   80101c10 <namecmp>
80105551:	85 c0                	test   %eax,%eax
80105553:	0f 84 21 01 00 00    	je     8010567a <sys_unlink+0x18a>
80105559:	c7 44 24 04 0b 7d 10 	movl   $0x80107d0b,0x4(%esp)
80105560:	80 
80105561:	89 1c 24             	mov    %ebx,(%esp)
80105564:	e8 a7 c6 ff ff       	call   80101c10 <namecmp>
80105569:	85 c0                	test   %eax,%eax
8010556b:	0f 84 09 01 00 00    	je     8010567a <sys_unlink+0x18a>
		goto bad;

	if((ip = dirlookup(dp, name, &off)) == 0)
80105571:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80105574:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80105578:	89 44 24 08          	mov    %eax,0x8(%esp)
8010557c:	89 34 24             	mov    %esi,(%esp)
8010557f:	e8 bc c6 ff ff       	call   80101c40 <dirlookup>
80105584:	85 c0                	test   %eax,%eax
80105586:	89 c3                	mov    %eax,%ebx
80105588:	0f 84 ec 00 00 00    	je     8010567a <sys_unlink+0x18a>
		goto bad;
	ilock(ip);
8010558e:	89 04 24             	mov    %eax,(%esp)
80105591:	e8 4a c1 ff ff       	call   801016e0 <ilock>

	if(ip->nlink < 1)
80105596:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
8010559b:	0f 8e 24 01 00 00    	jle    801056c5 <sys_unlink+0x1d5>
		panic("unlink: nlink < 1");
	if(ip->type == T_DIR && !isdirempty(ip)){
801055a1:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801055a6:	8d 75 d8             	lea    -0x28(%ebp),%esi
801055a9:	74 7d                	je     80105628 <sys_unlink+0x138>
		iunlockput(ip);
		goto bad;
	}

	memset(&de, 0, sizeof(de));
801055ab:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801055b2:	00 
801055b3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801055ba:	00 
801055bb:	89 34 24             	mov    %esi,(%esp)
801055be:	e8 3d ed ff ff       	call   80104300 <memset>
	if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801055c3:	8b 45 c4             	mov    -0x3c(%ebp),%eax
801055c6:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801055cd:	00 
801055ce:	89 74 24 04          	mov    %esi,0x4(%esp)
801055d2:	89 44 24 08          	mov    %eax,0x8(%esp)
801055d6:	8b 45 b4             	mov    -0x4c(%ebp),%eax
801055d9:	89 04 24             	mov    %eax,(%esp)
801055dc:	e8 ff c4 ff ff       	call   80101ae0 <writei>
801055e1:	83 f8 10             	cmp    $0x10,%eax
801055e4:	0f 85 cf 00 00 00    	jne    801056b9 <sys_unlink+0x1c9>
		panic("unlink: writei");
	if(ip->type == T_DIR){
801055ea:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801055ef:	0f 84 a3 00 00 00    	je     80105698 <sys_unlink+0x1a8>
		dp->nlink--;
		iupdate(dp);
	}
	iunlockput(dp);
801055f5:	8b 45 b4             	mov    -0x4c(%ebp),%eax
801055f8:	89 04 24             	mov    %eax,(%esp)
801055fb:	e8 90 c3 ff ff       	call   80101990 <iunlockput>

	ip->nlink--;
80105600:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
	iupdate(ip);
80105605:	89 1c 24             	mov    %ebx,(%esp)
80105608:	e8 13 c0 ff ff       	call   80101620 <iupdate>
	iunlockput(ip);
8010560d:	89 1c 24             	mov    %ebx,(%esp)
80105610:	e8 7b c3 ff ff       	call   80101990 <iunlockput>

	end_op();
80105615:	e8 e6 d5 ff ff       	call   80102c00 <end_op>
...
8010561a:	83 c4 5c             	add    $0x5c,%esp
	iupdate(ip);
	iunlockput(ip);
...
80105628:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
8010562c:	0f 86 79 ff ff ff    	jbe    801055ab <sys_unlink+0xbb>
80105632:	bf 20 00 00 00       	mov    $0x20,%edi
80105637:	eb 15                	jmp    8010564e <sys_unlink+0x15e>
80105639:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105640:	8d 57 10             	lea    0x10(%edi),%edx
80105643:	3b 53 58             	cmp    0x58(%ebx),%edx
80105646:	0f 83 5f ff ff ff    	jae    801055ab <sys_unlink+0xbb>
8010564c:	89 d7                	mov    %edx,%edi
		if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010564e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105655:	00 
80105656:	89 7c 24 08          	mov    %edi,0x8(%esp)
8010565a:	89 74 24 04          	mov    %esi,0x4(%esp)
8010565e:	89 1c 24             	mov    %ebx,(%esp)
80105661:	e8 7a c3 ff ff       	call   801019e0 <readi>
80105666:	83 f8 10             	cmp    $0x10,%eax
80105669:	75 42                	jne    801056ad <sys_unlink+0x1bd>
			panic("isdirempty: readi");
		if(de.inum != 0)
8010566b:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105670:	74 ce                	je     80105640 <sys_unlink+0x150>
	ilock(ip);
...
80105675:	e8 16 c3 ff ff       	call   80101990 <iunlockput>
	end_op();
	...
	bad:
	iunlockput(dp);
8010567a:	8b 45 b4             	mov    -0x4c(%ebp),%eax
...
80105697:	90                   	nop
	...
	if(ip->type == T_DIR){
		dp->nlink--;
80105698:	8b 45 b4             	mov    -0x4c(%ebp),%eax
8010569b:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
		iupdate(dp);
801056a0:	89 04 24             	mov    %eax,(%esp)
801056a3:	e8 78 bf ff ff       	call   80101620 <iupdate>
801056a8:	e9 48 ff ff ff       	jmp    801055f5 <sys_unlink+0x105>
	int off;
	struct dirent de;
	...
	for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
		if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
			panic("isdirempty: readi");
801056ad:	c7 04 24 b7 7d 10 80 	movl   $0x80107db7,(%esp)
801056b4:	e8 a7 ac ff ff       	call   80100360 <panic>
		goto bad;
	}
	...
	if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
		panic("unlink: writei");
801056b9:	c7 04 24 c9 7d 10 80 	movl   $0x80107dc9,(%esp)
801056c0:	e8 9b ac ff ff       	call   80100360 <panic>
	if((ip = dirlookup(dp, name, &off)) == 0)
		goto bad;
	ilock(ip);
	...
	if(ip->nlink < 1)
		panic("unlink: nlink < 1");
801056c5:	c7 04 24 a5 7d 10 80 	movl   $0x80107da5,(%esp)
801056cc:	e8 8f ac ff ff       	call   80100360 <panic>
...
801056e9:	8d 45 e0             	lea    -0x20(%ebp),%eax
801056ec:	89 44 24 04          	mov    %eax,0x4(%esp)
801056f0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056f7:	e8 84 ef ff ff       	call   80104680 <argstr>
801056fc:	85 c0                	test   %eax,%eax
801056fe:	0f 88 d1 00 00 00    	js     801057d5 <sys_open+0xf5>
80105704:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105707:	89 44 24 04          	mov    %eax,0x4(%esp)
8010570b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105712:	e8 d9 ee ff ff       	call   801045f0 <argint>
80105717:	85 c0                	test   %eax,%eax
80105719:	0f 88 b6 00 00 00    	js     801057d5 <sys_open+0xf5>
		return -1;

	begin_op();
8010571f:	e8 6c d4 ff ff       	call   80102b90 <begin_op>

	if(omode & O_CREATE){
80105724:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105728:	0f 85 82 00 00 00    	jne    801057b0 <sys_open+0xd0>
		if(ip == 0){
			end_op();
			return -1;
		}
		...
		if((ip = namei(path)) == 0){
8010572e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105731:	89 04 24             	mov    %eax,(%esp)
80105734:	e8 47 c8 ff ff       	call   80101f80 <namei>
80105739:	85 c0                	test   %eax,%eax
8010573b:	89 c6                	mov    %eax,%esi
8010573d:	0f 84 8d 00 00 00    	je     801057d0 <sys_open+0xf0>
			end_op();
			return -1;
		}
		ilock(ip);
80105743:	89 04 24             	mov    %eax,(%esp)
80105746:	e8 95 bf ff ff       	call   801016e0 <ilock>
		if(ip->type == T_DIR && omode != O_RDONLY){
8010574b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105750:	0f 84 92 00 00 00    	je     801057e8 <sys_open+0x108>
			end_op();
			return -1;
		}
	}
...
8010575f:	0f 84 93 00 00 00    	je     801057f8 <sys_open+0x118>
80105765:	e8 c6 ef ff ff       	call   80104730 <fdalloc>
8010576a:	85 c0                	test   %eax,%eax
8010576c:	89 c7                	mov    %eax,%edi
8010576e:	0f 88 94 00 00 00    	js     80105808 <sys_open+0x128>
			fileclose(f);
		iunlockput(ip);
		end_op();
		return -1;
	...
	iunlock(ip);
80105774:	89 34 24             	mov    %esi,(%esp)
80105777:	e8 44 c0 ff ff       	call   801017c0 <iunlock>
	end_op();
8010577c:	e8 7f d4 ff ff       	call   80102c00 <end_op>

	f->type = FD_INODE;
80105781:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
	f->ip = ip;
	f->off = 0;
	f->readable = !(omode & O_WRONLY);
80105787:	8b 45 e4             	mov    -0x1c(%ebp),%eax
	}
	iunlock(ip);
	end_op();
	...
	f->type = FD_INODE;
	f->ip = ip;
8010578a:	89 73 10             	mov    %esi,0x10(%ebx)
	f->off = 0;
8010578d:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
	f->readable = !(omode & O_WRONLY);
80105794:	89 c2                	mov    %eax,%edx
80105796:	83 e2 01             	and    $0x1,%edx
80105799:	83 f2 01             	xor    $0x1,%edx
	f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010579c:	a8 03                	test   $0x3,%al
	end_op();
	...
	f->off = 0;
	f->readable = !(omode & O_WRONLY);
8010579e:	88 53 08             	mov    %dl,0x8(%ebx)
	f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
	return fd;
801057a1:	89 f8                	mov    %edi,%eax
	...
	f->readable = !(omode & O_WRONLY);
	f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801057a3:	0f 95 43 09          	setne  0x9(%ebx)
	return fd;
}
801057a7:	83 c4 2c             	add    $0x2c,%esp
801057aa:	5b                   	pop    %ebx
801057ab:	5e                   	pop    %esi
801057ac:	5f                   	pop    %edi
801057ad:	5d                   	pop    %ebp
...
801057b0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801057b3:	31 c9                	xor    %ecx,%ecx
801057b5:	ba 02 00 00 00       	mov    $0x2,%edx
801057ba:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801057c1:	e8 aa ef ff ff       	call   80104770 <create>
		if(ip == 0){
801057c6:	85 c0                	test   %eax,%eax
	...
	if(omode & O_CREATE){
		ip = create(path, T_FILE, 0, 0);
801057c8:	89 c6                	mov    %eax,%esi
		if(ip == 0){
801057ca:	75 8a                	jne    80105756 <sys_open+0x76>
801057cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
		...
		iunlockput(ip);
		end_op();
801057d0:	e8 2b d4 ff ff       	call   80102c00 <end_op>
	f->ip = ip;
	f->off = 0;
	f->readable = !(omode & O_WRONLY);
	f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
...
801057d5:	83 c4 2c             	add    $0x2c,%esp
	if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
		if(f)
			fileclose(f);
		iunlockput(ip);
...
801057e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		...
		ilock(ip);
		if(ip->type == T_DIR && omode != O_RDONLY){
801057e8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801057eb:	85 c0                	test   %eax,%eax
801057ed:	0f 84 63 ff ff ff    	je     80105756 <sys_open+0x76>
801057f3:	90                   	nop
801057f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
		if(f)
			fileclose(f);
		iunlockput(ip);
801057f8:	89 34 24             	mov    %esi,(%esp)
801057fb:	e8 90 c1 ff ff       	call   80101990 <iunlockput>
80105800:	eb ce                	jmp    801057d0 <sys_open+0xf0>
...
8010580b:	e8 20 b6 ff ff       	call   80100e30 <fileclose>
80105810:	eb e6                	jmp    801057f8 <sys_open+0x118>
80105812:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80105823:	83 ec 28             	sub    $0x28,%esp
	...
	begin_op();
80105826:	e8 65 d3 ff ff       	call   80102b90 <begin_op>
	if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
8010582b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010582e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105832:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105839:	e8 42 ee ff ff       	call   80104680 <argstr>
8010583e:	85 c0                	test   %eax,%eax
80105840:	78 2e                	js     80105870 <sys_mkdir+0x50>
80105842:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105845:	31 c9                	xor    %ecx,%ecx
80105847:	ba 01 00 00 00       	mov    $0x1,%edx
8010584c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105853:	e8 18 ef ff ff       	call   80104770 <create>
80105858:	85 c0                	test   %eax,%eax
8010585a:	74 14                	je     80105870 <sys_mkdir+0x50>
		end_op();
		return -1;
	}
	iunlockput(ip);
8010585c:	89 04 24             	mov    %eax,(%esp)
8010585f:	e8 2c c1 ff ff       	call   80101990 <iunlockput>
	end_op();
80105864:	e8 97 d3 ff ff       	call   80102c00 <end_op>
	return 0;
80105869:	31 c0                	xor    %eax,%eax
}
8010586b:	c9                   	leave  
8010586c:	c3                   	ret    
8010586d:	8d 76 00             	lea    0x0(%esi),%esi
	...
	if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
		end_op();
80105870:	e8 8b d3 ff ff       	call   80102c00 <end_op>
		return -1;
...
80105883:	83 ec 28             	sub    $0x28,%esp
	...
	begin_op();
80105886:	e8 05 d3 ff ff       	call   80102b90 <begin_op>
	if((argstr(0, &path)) < 0 ||
8010588b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010588e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105892:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105899:	e8 e2 ed ff ff       	call   80104680 <argstr>
8010589e:	85 c0                	test   %eax,%eax
801058a0:	78 5e                	js     80105900 <sys_mknod+0x80>
			argint(1, &major) < 0 ||
801058a2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801058a5:	89 44 24 04          	mov    %eax,0x4(%esp)
801058a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801058b0:	e8 3b ed ff ff       	call   801045f0 <argint>
	struct inode *ip;
	char *path;
	int major, minor;
...
801058ce:	78 30                	js     80105900 <sys_mknod+0x80>
			argint(2, &minor) < 0 ||
			(ip = create(path, T_DEV, major, minor)) == 0){
801058d0:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
	int major, minor;
	...
	if((argstr(0, &path)) < 0 ||
			argint(1, &major) < 0 ||
			argint(2, &minor) < 0 ||
801058d4:	ba 03 00 00 00       	mov    $0x3,%edx
			(ip = create(path, T_DEV, major, minor)) == 0){
801058d9:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
801058dd:	89 04 24             	mov    %eax,(%esp)
	...
	if((argstr(0, &path)) < 0 ||
			argint(1, &major) < 0 ||
			argint(2, &minor) < 0 ||
801058e0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801058e3:	e8 88 ee ff ff       	call   80104770 <create>
801058e8:	85 c0                	test   %eax,%eax
801058ea:	74 14                	je     80105900 <sys_mknod+0x80>
			(ip = create(path, T_DEV, major, minor)) == 0){
		end_op();
		return -1;
	}
...
801058ef:	e8 9c c0 ff ff       	call   80101990 <iunlockput>
	end_op();
801058f4:	e8 07 d3 ff ff       	call   80102c00 <end_op>
	return 0;
801058f9:	31 c0                	xor    %eax,%eax
}
801058fb:	c9                   	leave  
801058fc:	c3                   	ret    
801058fd:	8d 76 00             	lea    0x0(%esi),%esi
	...
	if((argstr(0, &path)) < 0 ||
			...
			(ip = create(path, T_DEV, major, minor)) == 0){
		end_op();
80105900:	e8 fb d2 ff ff       	call   80102c00 <end_op>
		return -1;
...
80105915:	83 ec 20             	sub    $0x20,%esp
	char *path;
	struct inode *ip;
	struct proc *curproc = myproc();
80105918:	e8 03 de ff ff       	call   80103720 <myproc>
8010591d:	89 c6                	mov    %eax,%esi

	begin_op();
8010591f:	e8 6c d2 ff ff       	call   80102b90 <begin_op>
	if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105924:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105927:	89 44 24 04          	mov    %eax,0x4(%esp)
8010592b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105932:	e8 49 ed ff ff       	call   80104680 <argstr>
80105937:	85 c0                	test   %eax,%eax
80105939:	78 4a                	js     80105985 <sys_chdir+0x75>
8010593b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010593e:	89 04 24             	mov    %eax,(%esp)
80105941:	e8 3a c6 ff ff       	call   80101f80 <namei>
80105946:	85 c0                	test   %eax,%eax
80105948:	89 c3                	mov    %eax,%ebx
8010594a:	74 39                	je     80105985 <sys_chdir+0x75>
		end_op();
		return -1;
	}
	ilock(ip);
8010594c:	89 04 24             	mov    %eax,(%esp)
8010594f:	e8 8c bd ff ff       	call   801016e0 <ilock>
	if(ip->type != T_DIR){
80105954:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
		iunlockput(ip);
80105959:	89 1c 24             	mov    %ebx,(%esp)
	if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
		end_op();
		return -1;
	}
	ilock(ip);
	if(ip->type != T_DIR){
8010595c:	75 22                	jne    80105980 <sys_chdir+0x70>
		iunlockput(ip);
		end_op();
		return -1;
	}
	iunlock(ip);
8010595e:	e8 5d be ff ff       	call   801017c0 <iunlock>
	iput(curproc->cwd);
80105963:	8b 46 68             	mov    0x68(%esi),%eax
80105966:	89 04 24             	mov    %eax,(%esp)
80105969:	e8 e2 be ff ff       	call   80101850 <iput>
	end_op();
8010596e:	e8 8d d2 ff ff       	call   80102c00 <end_op>
	curproc->cwd = ip;
	return 0;
80105973:	31 c0                	xor    %eax,%eax
	...
	end_op();
	curproc->cwd = ip;
80105975:	89 5e 68             	mov    %ebx,0x68(%esi)
	return 0;
}
80105978:	83 c4 20             	add    $0x20,%esp
8010597b:	5b                   	pop    %ebx
8010597c:	5e                   	pop    %esi
8010597d:	5d                   	pop    %ebp
8010597e:	c3                   	ret    
8010597f:	90                   	nop
	...
	if(ip->type != T_DIR){
		iunlockput(ip);
80105980:	e8 0b c0 ff ff       	call   80101990 <iunlockput>
		end_op();
80105985:	e8 76 d2 ff ff       	call   80102c00 <end_op>
	iunlock(ip);
	iput(curproc->cwd);
	end_op();
	curproc->cwd = ip;
...
8010598a:	83 c4 20             	add    $0x20,%esp
	}
	ilock(ip);
	if(ip->type != T_DIR){
		iunlockput(ip);
...
801059a6:	81 ec ac 00 00 00    	sub    $0xac,%esp
	char *path, *argv[MAXARG];
	int i;
	uint uargv, uarg;

	if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801059ac:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
801059b2:	89 44 24 04          	mov    %eax,0x4(%esp)
801059b6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059bd:	e8 be ec ff ff       	call   80104680 <argstr>
801059c2:	85 c0                	test   %eax,%eax
801059c4:	0f 88 84 00 00 00    	js     80105a4e <sys_exec+0xae>
801059ca:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
801059d0:	89 44 24 04          	mov    %eax,0x4(%esp)
801059d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801059db:	e8 10 ec ff ff       	call   801045f0 <argint>
801059e0:	85 c0                	test   %eax,%eax
801059e2:	78 6a                	js     80105a4e <sys_exec+0xae>
		return -1;
	}
...
801059ea:	31 db                	xor    %ebx,%ebx
	...
	memset(argv, 0, sizeof(argv));
801059ec:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801059f3:	00 
801059f4:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
801059fa:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105a01:	00 
80105a02:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105a08:	89 04 24             	mov    %eax,(%esp)
80105a0b:	e8 f0 e8 ff ff       	call   80104300 <memset>
	for(i=0;; i++){
		if(i >= NELEM(argv))
			return -1;
		if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105a10:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105a16:	89 7c 24 04          	mov    %edi,0x4(%esp)
80105a1a:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80105a1d:	89 04 24             	mov    %eax,(%esp)
80105a20:	e8 2b eb ff ff       	call   80104550 <fetchint>
80105a25:	85 c0                	test   %eax,%eax
80105a27:	78 25                	js     80105a4e <sys_exec+0xae>
			return -1;
		if(uarg == 0){
80105a29:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
80105a2f:	85 c0                	test   %eax,%eax
80105a31:	74 2d                	je     80105a60 <sys_exec+0xc0>
			argv[i] = 0;
			break;
		}
		if(fetchstr(uarg, &argv[i]) < 0)
80105a33:	89 74 24 04          	mov    %esi,0x4(%esp)
80105a37:	89 04 24             	mov    %eax,(%esp)
80105a3a:	e8 51 eb ff ff       	call   80104590 <fetchstr>
80105a3f:	85 c0                	test   %eax,%eax
80105a41:	78 0b                	js     80105a4e <sys_exec+0xae>
...
80105a46:	83 c6 04             	add    $0x4,%esi
		if(i >= NELEM(argv))
80105a49:	83 fb 20             	cmp    $0x20,%ebx
80105a4c:	75 c2                	jne    80105a10 <sys_exec+0x70>
		}
		if(fetchstr(uarg, &argv[i]) < 0)
			return -1;
	}
...
80105a4e:	81 c4 ac 00 00 00    	add    $0xac,%esp
	char *path, *argv[MAXARG];
	int i;
	uint uargv, uarg;
...
80105a6a:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
		if(i >= NELEM(argv))
			return -1;
		if(fetchint(uargv+4*i, (int*)&uarg) < 0)
			return -1;
...
80105a7e:	e8 1d af ff ff       	call   801009a0 <exec>
}
80105a83:	81 c4 ac 00 00 00    	add    $0xac,%esp
80105a89:	5b                   	pop    %ebx
80105a8a:	5e                   	pop    %esi
80105a8b:	5f                   	pop    %edi
80105a8c:	5d                   	pop    %ebp
...
80105a9a:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105aa1:	00 
80105aa2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105aa6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105aad:	e8 6e eb ff ff       	call   80104620 <argptr>
80105ab2:	85 c0                	test   %eax,%eax
80105ab4:	78 6d                	js     80105b23 <sys_pipe+0x93>
		return -1;
...
80105ac3:	e8 28 d7 ff ff       	call   801031f0 <pipealloc>
80105ac8:	85 c0                	test   %eax,%eax
80105aca:	78 57                	js     80105b23 <sys_pipe+0x93>
		return -1;
	fd0 = -1;
	if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105acc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105acf:	e8 5c ec ff ff       	call   80104730 <fdalloc>
80105ad4:	85 c0                	test   %eax,%eax
80105ad6:	89 c3                	mov    %eax,%ebx
80105ad8:	78 33                	js     80105b0d <sys_pipe+0x7d>
80105ada:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105add:	e8 4e ec ff ff       	call   80104730 <fdalloc>
80105ae2:	85 c0                	test   %eax,%eax
80105ae4:	78 1a                	js     80105b00 <sys_pipe+0x70>
			myproc()->ofile[fd0] = 0;
		fileclose(rf);
		fileclose(wf);
		return -1;
...
80105ae9:	89 1a                	mov    %ebx,(%edx)
	fd[1] = fd1;
80105aeb:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105aee:	89 42 04             	mov    %eax,0x4(%edx)
	return 0;
}
80105af1:	83 c4 24             	add    $0x24,%esp
		fileclose(wf);
		return -1;
	}
	fd[0] = fd0;
...
80105af9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	...
	if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
		if(fd0 >= 0)
			myproc()->ofile[fd0] = 0;
80105b00:	e8 1b dc ff ff       	call   80103720 <myproc>
80105b05:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80105b0c:	00 
		fileclose(rf);
80105b0d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b10:	89 04 24             	mov    %eax,(%esp)
80105b13:	e8 18 b3 ff ff       	call   80100e30 <fileclose>
		fileclose(wf);
80105b18:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b1b:	89 04 24             	mov    %eax,(%esp)
80105b1e:	e8 0d b3 ff ff       	call   80100e30 <fileclose>
		return -1;
	}
	fd[0] = fd0;
	fd[1] = fd1;
...
80105b23:	83 c4 24             	add    $0x24,%esp
	if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
		if(fd0 >= 0)
			myproc()->ofile[fd0] = 0;
		fileclose(rf);
...
80105b3a:	83 ec 1c             	sub    $0x1c,%esp
	pde_t * pageDirectory = myproc()->pgdir;
80105b3d:	e8 de db ff ff       	call   80103720 <myproc>
	pte_t * pageTable;
	int pageDirectoryIndex;
	int pageTableIndex;
	int presentPagesCounter = 0;
...
80105b42:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
#include "proc.h"
//#include "user.h"
...
80105b4c:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105b4f:	90                   	nop
	int pageDirectoryIndex;
	int pageTableIndex;
	int presentPagesCounter = 0;
...
80105b50:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105b53:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80105b56:	8b 04 98             	mov    (%eax,%ebx,4),%eax
80105b59:	a8 01                	test   $0x1,%al
80105b5b:	74 3b                	je     80105b98 <sys_myMemory+0x68>
			pageTable = (pde_t *)P2V(PTE_ADDR(pageDirectory[pageDirectoryIndex]));
80105b5d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80105b62:	8d 98 00 10 00 80    	lea    -0x7ffff000(%eax),%ebx
80105b68:	05 00 00 00 80       	add    $0x80000000,%eax
80105b6d:	eb 08                	jmp    80105b77 <sys_myMemory+0x47>
80105b6f:	90                   	nop
80105b70:	83 c0 04             	add    $0x4,%eax
			for(pageTableIndex=0; pageTableIndex<1024; pageTableIndex++){
80105b73:	39 d8                	cmp    %ebx,%eax
80105b75:	74 21                	je     80105b98 <sys_myMemory+0x68>
				if((pageTable[pageTableIndex] & (uint)PTE_U) && (pageTable[pageTableIndex] & (uint)PTE_P)){
80105b77:	8b 10                	mov    (%eax),%edx
80105b79:	89 d1                	mov    %edx,%ecx
80105b7b:	83 e1 05             	and    $0x5,%ecx
80105b7e:	83 f9 05             	cmp    $0x5,%ecx
80105b81:	75 ed                	jne    80105b70 <sys_myMemory+0x40>
					// Page is present
					presentPagesCounter++;
					if ((pageTable[pageTableIndex] & (uint)PTE_W)){
80105b83:	83 e2 02             	and    $0x2,%edx
		if ((((pageDirectory[pageDirectoryIndex]) & (uint)PTE_P))){
			pageTable = (pde_t *)P2V(PTE_ADDR(pageDirectory[pageDirectoryIndex]));
			for(pageTableIndex=0; pageTableIndex<1024; pageTableIndex++){
				if((pageTable[pageTableIndex] & (uint)PTE_U) && (pageTable[pageTableIndex] & (uint)PTE_P)){
					// Page is present
					presentPagesCounter++;
80105b86:	83 c6 01             	add    $0x1,%esi
					if ((pageTable[pageTableIndex] & (uint)PTE_W)){
						//Page is accessible and writable
						userWritePagesCounter++;
80105b89:	83 fa 01             	cmp    $0x1,%edx
80105b8c:	83 df ff             	sbb    $0xffffffff,%edi
80105b8f:	83 c0 04             	add    $0x4,%eax
	int presentPagesCounter = 0;
	int userWritePagesCounter = 0;
	for(pageDirectoryIndex=0; pageDirectoryIndex < 1024;pageDirectoryIndex++){
		if ((((pageDirectory[pageDirectoryIndex]) & (uint)PTE_P))){
			pageTable = (pde_t *)P2V(PTE_ADDR(pageDirectory[pageDirectoryIndex]));
			for(pageTableIndex=0; pageTableIndex<1024; pageTableIndex++){
80105b92:	39 d8                	cmp    %ebx,%eax
80105b94:	75 e1                	jne    80105b77 <sys_myMemory+0x47>
80105b96:	66 90                	xchg   %ax,%ax
	...
	int userWritePagesCounter = 0;
	for(pageDirectoryIndex=0; pageDirectoryIndex < 1024;pageDirectoryIndex++){
80105b98:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80105b9c:	81 7d e4 00 04 00 00 	cmpl   $0x400,-0x1c(%ebp)
80105ba3:	75 ab                	jne    80105b50 <sys_myMemory+0x20>
				}
			}
		}
	}
...
80105ba5:	89 74 24 04          	mov    %esi,0x4(%esp)
80105ba9:	c7 04 24 e6 7e 10 80 	movl   $0x80107ee6,(%esp)
80105bb0:	e8 9b aa ff ff       	call   80100650 <cprintf>
	cprintf("Write/User Pages: %d\n",userWritePagesCounter);
80105bb5:	89 7c 24 04          	mov    %edi,0x4(%esp)
80105bb9:	c7 04 24 f9 7e 10 80 	movl   $0x80107ef9,(%esp)
80105bc0:	e8 8b aa ff ff       	call   80100650 <cprintf>
	return presentPagesCounter;
}
80105bc5:	83 c4 1c             	add    $0x1c,%esp
80105bc8:	89 f0                	mov    %esi,%eax
80105bca:	5b                   	pop    %ebx
80105bcb:	5e                   	pop    %esi
80105bcc:	5f                   	pop    %edi
80105bcd:	5d                   	pop    %ebp
...
{
  return fork();
80105bd4:	e9 f7 dc ff ff       	jmp    801038d0 <fork>
...
80105be3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105be6:	e8 35 df ff ff       	call   80103b20 <exit>
...
{
  return wait();
80105bf4:	e9 37 e1 ff ff       	jmp    80103d30 <wait>
...
80105c03:	83 ec 28             	sub    $0x28,%esp
  int pid;
...
80105c14:	e8 d7 e9 ff ff       	call   801045f0 <argint>
80105c19:	85 c0                	test   %eax,%eax
80105c1b:	78 13                	js     80105c30 <sys_kill+0x30>
    return -1;
  return kill(pid);
80105c1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c20:	89 04 24             	mov    %eax,(%esp)
80105c23:	e8 48 e2 ff ff       	call   80103e70 <kill>
}
80105c28:	c9                   	leave  
80105c29:	c3                   	ret    
...
80105c43:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105c46:	e8 d5 da ff ff       	call   80103720 <myproc>
...
80105c54:	83 ec 24             	sub    $0x24,%esp
  int addr;
  int n;
...
80105c65:	e8 86 e9 ff ff       	call   801045f0 <argint>
80105c6a:	85 c0                	test   %eax,%eax
80105c6c:	78 22                	js     80105c90 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105c6e:	e8 ad da ff ff       	call   80103720 <myproc>
  if(growproc(n) < 0)
80105c73:	8b 55 f4             	mov    -0xc(%ebp),%edx
  int addr;
  int n;
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = myproc()->sz;
80105c76:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105c78:	89 14 24             	mov    %edx,(%esp)
80105c7b:	e8 e0 db ff ff       	call   80103860 <growproc>
80105c80:	85 c0                	test   %eax,%eax
80105c82:	78 0c                	js     80105c90 <sys_sbrk+0x40>
    return -1;
  return addr;
80105c84:	89 d8                	mov    %ebx,%eax
}
80105c86:	83 c4 24             	add    $0x24,%esp
80105c89:	5b                   	pop    %ebx
80105c8a:	5d                   	pop    %ebp
80105c8b:	c3                   	ret    
...
80105c95:	eb ef                	jmp    80105c86 <sys_sbrk+0x36>
...
80105ca4:	83 ec 24             	sub    $0x24,%esp
  int n;
  uint ticks0;
...
80105cb5:	e8 36 e9 ff ff       	call   801045f0 <argint>
80105cba:	85 c0                	test   %eax,%eax
80105cbc:	78 7e                	js     80105d3c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
80105cbe:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105cc5:	e8 f6 e4 ff ff       	call   801041c0 <acquire>
  ticks0 = ticks;
...
80105cca:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105ccd:	8b 1d 00 6e 11 80    	mov    0x80116e00,%ebx
  while(ticks - ticks0 < n){
80105cd3:	85 d2                	test   %edx,%edx
80105cd5:	75 29                	jne    80105d00 <sys_sleep+0x60>
80105cd7:	eb 4f                	jmp    80105d28 <sys_sleep+0x88>
...
80105ce0:	c7 44 24 04 c0 65 11 	movl   $0x801165c0,0x4(%esp)
80105ce7:	80 
80105ce8:	c7 04 24 00 6e 11 80 	movl   $0x80116e00,(%esp)
80105cef:	e8 8c df ff ff       	call   80103c80 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105cf4:	a1 00 6e 11 80       	mov    0x80116e00,%eax
80105cf9:	29 d8                	sub    %ebx,%eax
80105cfb:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80105cfe:	73 28                	jae    80105d28 <sys_sleep+0x88>
    if(myproc()->killed){
80105d00:	e8 1b da ff ff       	call   80103720 <myproc>
80105d05:	8b 40 24             	mov    0x24(%eax),%eax
80105d08:	85 c0                	test   %eax,%eax
80105d0a:	74 d4                	je     80105ce0 <sys_sleep+0x40>
      release(&tickslock);
80105d0c:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105d13:	e8 98 e5 ff ff       	call   801042b0 <release>
      return -1;
...
80105d1d:	83 c4 24             	add    $0x24,%esp
80105d20:	5b                   	pop    %ebx
80105d21:	5d                   	pop    %ebp
80105d22:	c3                   	ret    
80105d23:	90                   	nop
80105d24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105d28:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105d2f:	e8 7c e5 ff ff       	call   801042b0 <release>
  return 0;
}
80105d34:	83 c4 24             	add    $0x24,%esp
      return -1;
    }
    sleep(&ticks, &tickslock);
  }
...
80105d41:	eb da                	jmp    80105d1d <sys_sleep+0x7d>
...
80105d54:	83 ec 14             	sub    $0x14,%esp
  uint xticks;

  acquire(&tickslock);
80105d57:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105d5e:	e8 5d e4 ff ff       	call   801041c0 <acquire>
  xticks = ticks;
80105d63:	8b 1d 00 6e 11 80    	mov    0x80116e00,%ebx
  release(&tickslock);
80105d69:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80105d70:	e8 3b e5 ff ff       	call   801042b0 <release>
  return xticks;
}
80105d75:	83 c4 14             	add    $0x14,%esp
...
80105d7e:	06                   	push   %es
  pushl %fs
80105d7f:	0f a0                	push   %fs
  pushl %gs
80105d81:	0f a8                	push   %gs
  pushal
80105d83:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105d84:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105d88:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105d8a:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105d8c:	54                   	push   %esp
  call trap
80105d8d:	e8 de 00 00 00       	call   80105e70 <trap>
  addl $4, %esp
80105d92:	83 c4 04             	add    $0x4,%esp
...
80105d95:	61                   	popa   
  popl %gs
80105d96:	0f a9                	pop    %gs
  popl %fs
80105d98:	0f a1                	pop    %fs
  popl %es
80105d9a:	07                   	pop    %es
  popl %ds
80105d9b:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105d9c:	83 c4 08             	add    $0x8,%esp
  iret
80105d9f:	cf                   	iret   
...
80105da8:	8b 14 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%edx
80105daf:	b9 08 00 00 00       	mov    $0x8,%ecx
80105db4:	66 89 0c c5 02 66 11 	mov    %cx,-0x7fee99fe(,%eax,8)
80105dbb:	80 
80105dbc:	c6 04 c5 04 66 11 80 	movb   $0x0,-0x7fee99fc(,%eax,8)
80105dc3:	00 
80105dc4:	c6 04 c5 05 66 11 80 	movb   $0x8e,-0x7fee99fb(,%eax,8)
80105dcb:	8e 
80105dcc:	66 89 14 c5 00 66 11 	mov    %dx,-0x7fee9a00(,%eax,8)
80105dd3:	80 
80105dd4:	c1 ea 10             	shr    $0x10,%edx
80105dd7:	66 89 14 c5 06 66 11 	mov    %dx,-0x7fee99fa(,%eax,8)
80105dde:	80 
void
tvinit(void)
{
...
80105de2:	3d 00 01 00 00       	cmp    $0x100,%eax
80105de7:	75 bf                	jne    80105da8 <tvinit+0x8>
...
80105dea:	ba 08 00 00 00       	mov    $0x8,%edx
struct spinlock tickslock;
uint ticks;
...
80105df1:	83 ec 18             	sub    $0x18,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105df4:	a1 08 b1 10 80       	mov    0x8010b108,%eax

  initlock(&tickslock, "time");
80105df9:	c7 44 24 04 0f 7f 10 	movl   $0x80107f0f,0x4(%esp)
80105e00:	80 
80105e01:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e08:	66 89 15 02 68 11 80 	mov    %dx,0x80116802
80105e0f:	66 a3 00 68 11 80    	mov    %ax,0x80116800
80105e15:	c1 e8 10             	shr    $0x10,%eax
80105e18:	c6 05 04 68 11 80 00 	movb   $0x0,0x80116804
80105e1f:	c6 05 05 68 11 80 ef 	movb   $0xef,0x80116805
80105e26:	66 a3 06 68 11 80    	mov    %ax,0x80116806

  initlock(&tickslock, "time");
80105e2c:	e8 9f e2 ff ff       	call   801040d0 <initlock>
}
80105e31:	c9                   	leave  
80105e32:	c3                   	ret    
...
80105e4b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105e4f:	b8 00 66 11 80       	mov    $0x80116600,%eax
...
80105e8e:	77 08                	ja     80105e98 <trap+0x28>
80105e90:	ff 24 85 b8 7f 10 80 	jmp    *-0x7fef8048(,%eax,4)
80105e97:	90                   	nop
    lapiceoi();
    break;
...
80105e98:	e8 83 d8 ff ff       	call   80103720 <myproc>
80105e9d:	85 c0                	test   %eax,%eax
80105e9f:	90                   	nop
80105ea0:	0f 84 fa 01 00 00    	je     801060a0 <trap+0x230>
80105ea6:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105eaa:	0f 84 f0 01 00 00    	je     801060a0 <trap+0x230>
...
80105eb3:	8b 53 38             	mov    0x38(%ebx),%edx
80105eb6:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105eb9:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105ebc:	e8 3f d8 ff ff       	call   80103700 <cpuid>
80105ec1:	8b 73 30             	mov    0x30(%ebx),%esi
80105ec4:	89 c7                	mov    %eax,%edi
80105ec6:	8b 43 34             	mov    0x34(%ebx),%eax
80105ec9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105ecc:	e8 4f d8 ff ff       	call   80103720 <myproc>
80105ed1:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105ed4:	e8 47 d8 ff ff       	call   80103720 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ed9:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105edc:	89 74 24 0c          	mov    %esi,0xc(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105ee0:	8b 75 e0             	mov    -0x20(%ebp),%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ee3:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105ee6:	89 7c 24 14          	mov    %edi,0x14(%esp)
80105eea:	89 54 24 18          	mov    %edx,0x18(%esp)
80105eee:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105ef1:	83 c6 6c             	add    $0x6c,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ef4:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105ef8:	89 74 24 08          	mov    %esi,0x8(%esp)
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105efc:	89 54 24 10          	mov    %edx,0x10(%esp)
80105f00:	8b 40 10             	mov    0x10(%eax),%eax
80105f03:	c7 04 24 74 7f 10 80 	movl   $0x80107f74,(%esp)
80105f0a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f0e:	e8 3d a7 ff ff       	call   80100650 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105f13:	e8 08 d8 ff ff       	call   80103720 <myproc>
80105f18:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80105f1f:	90                   	nop
  }
...
80105f20:	e8 fb d7 ff ff       	call   80103720 <myproc>
80105f25:	85 c0                	test   %eax,%eax
80105f27:	74 0c                	je     80105f35 <trap+0xc5>
80105f29:	e8 f2 d7 ff ff       	call   80103720 <myproc>
80105f2e:	8b 50 24             	mov    0x24(%eax),%edx
80105f31:	85 d2                	test   %edx,%edx
80105f33:	75 4b                	jne    80105f80 <trap+0x110>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105f35:	e8 e6 d7 ff ff       	call   80103720 <myproc>
80105f3a:	85 c0                	test   %eax,%eax
80105f3c:	74 0d                	je     80105f4b <trap+0xdb>
80105f3e:	66 90                	xchg   %ax,%ax
80105f40:	e8 db d7 ff ff       	call   80103720 <myproc>
80105f45:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105f49:	74 4d                	je     80105f98 <trap+0x128>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f4b:	e8 d0 d7 ff ff       	call   80103720 <myproc>
80105f50:	85 c0                	test   %eax,%eax
80105f52:	74 1d                	je     80105f71 <trap+0x101>
80105f54:	e8 c7 d7 ff ff       	call   80103720 <myproc>
80105f59:	8b 40 24             	mov    0x24(%eax),%eax
80105f5c:	85 c0                	test   %eax,%eax
80105f5e:	74 11                	je     80105f71 <trap+0x101>
80105f60:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105f64:	83 e0 03             	and    $0x3,%eax
80105f67:	66 83 f8 03          	cmp    $0x3,%ax
80105f6b:	0f 84 e8 00 00 00    	je     80106059 <trap+0x1e9>
    exit();
}
80105f71:	83 c4 3c             	add    $0x3c,%esp
80105f74:	5b                   	pop    %ebx
80105f75:	5e                   	pop    %esi
80105f76:	5f                   	pop    %edi
80105f77:	5d                   	pop    %ebp
...
80105f79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f80:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105f84:	83 e0 03             	and    $0x3,%eax
80105f87:	66 83 f8 03          	cmp    $0x3,%ax
80105f8b:	75 a8                	jne    80105f35 <trap+0xc5>
    exit();
80105f8d:	e8 8e db ff ff       	call   80103b20 <exit>
80105f92:	eb a1                	jmp    80105f35 <trap+0xc5>
80105f94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105f98:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105f9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105fa0:	75 a9                	jne    80105f4b <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105fa2:	e8 99 dc ff ff       	call   80103c40 <yield>
80105fa7:	eb a2                	jmp    80105f4b <trap+0xdb>
80105fa9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105fb0:	e8 4b d7 ff ff       	call   80103700 <cpuid>
80105fb5:	85 c0                	test   %eax,%eax
80105fb7:	0f 84 b3 00 00 00    	je     80106070 <trap+0x200>
80105fbd:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105fc0:	e8 3b c8 ff ff       	call   80102800 <lapiceoi>
    break;
80105fc5:	e9 56 ff ff ff       	jmp    80105f20 <trap+0xb0>
80105fca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105fd0:	e8 7b c6 ff ff       	call   80102650 <kbdintr>
    lapiceoi();
80105fd5:	e8 26 c8 ff ff       	call   80102800 <lapiceoi>
    break;
80105fda:	e9 41 ff ff ff       	jmp    80105f20 <trap+0xb0>
80105fdf:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105fe0:	e8 1b 02 00 00       	call   80106200 <uartintr>
    lapiceoi();
80105fe5:	e8 16 c8 ff ff       	call   80102800 <lapiceoi>
    break;
80105fea:	e9 31 ff ff ff       	jmp    80105f20 <trap+0xb0>
80105fef:	90                   	nop
  case T_IRQ0 + 7:
...
80105ff7:	e8 04 d7 ff ff       	call   80103700 <cpuid>
80105ffc:	c7 04 24 1c 7f 10 80 	movl   $0x80107f1c,(%esp)
80106003:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106007:	89 74 24 08          	mov    %esi,0x8(%esp)
8010600b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010600f:	e8 3c a6 ff ff       	call   80100650 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80106014:	e8 e7 c7 ff ff       	call   80102800 <lapiceoi>
    break;
80106019:	e9 02 ff ff ff       	jmp    80105f20 <trap+0xb0>
8010601e:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106020:	e8 db c0 ff ff       	call   80102100 <ideintr>
80106025:	eb 96                	jmp    80105fbd <trap+0x14d>
80106027:	90                   	nop
80106028:	90                   	nop
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80106030:	e8 eb d6 ff ff       	call   80103720 <myproc>
80106035:	8b 70 24             	mov    0x24(%eax),%esi
80106038:	85 f6                	test   %esi,%esi
8010603a:	75 2c                	jne    80106068 <trap+0x1f8>
      exit();
    myproc()->tf = tf;
8010603c:	e8 df d6 ff ff       	call   80103720 <myproc>
80106041:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80106044:	e8 77 e6 ff ff       	call   801046c0 <syscall>
    if(myproc()->killed)
80106049:	e8 d2 d6 ff ff       	call   80103720 <myproc>
8010604e:	8b 48 24             	mov    0x24(%eax),%ecx
80106051:	85 c9                	test   %ecx,%ecx
80106053:	0f 84 18 ff ff ff    	je     80105f71 <trap+0x101>
    yield();
...
80106059:	83 c4 3c             	add    $0x3c,%esp
8010605c:	5b                   	pop    %ebx
8010605d:	5e                   	pop    %esi
8010605e:	5f                   	pop    %edi
8010605f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80106060:	e9 bb da ff ff       	jmp    80103b20 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80106068:	e8 b3 da ff ff       	call   80103b20 <exit>
8010606d:	eb cd                	jmp    8010603c <trap+0x1cc>
8010606f:	90                   	nop
  }
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
80106070:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80106077:	e8 44 e1 ff ff       	call   801041c0 <acquire>
      ticks++;
      wakeup(&ticks);
8010607c:	c7 04 24 00 6e 11 80 	movl   $0x80116e00,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80106083:	83 05 00 6e 11 80 01 	addl   $0x1,0x80116e00
      wakeup(&ticks);
8010608a:	e8 81 dd ff ff       	call   80103e10 <wakeup>
      release(&tickslock);
8010608f:	c7 04 24 c0 65 11 80 	movl   $0x801165c0,(%esp)
80106096:	e8 15 e2 ff ff       	call   801042b0 <release>
8010609b:	e9 1d ff ff ff       	jmp    80105fbd <trap+0x14d>
801060a0:	0f 20 d7             	mov    %cr2,%edi
  ...
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801060a3:	8b 73 38             	mov    0x38(%ebx),%esi
801060a6:	e8 55 d6 ff ff       	call   80103700 <cpuid>
801060ab:	89 7c 24 10          	mov    %edi,0x10(%esp)
801060af:	89 74 24 0c          	mov    %esi,0xc(%esp)
801060b3:	89 44 24 08          	mov    %eax,0x8(%esp)
801060b7:	8b 43 30             	mov    0x30(%ebx),%eax
801060ba:	c7 04 24 40 7f 10 80 	movl   $0x80107f40,(%esp)
801060c1:	89 44 24 04          	mov    %eax,0x4(%esp)
801060c5:	e8 86 a5 ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801060ca:	c7 04 24 14 7f 10 80 	movl   $0x80107f14,(%esp)
801060d1:	e8 8a a2 ff ff       	call   80100360 <panic>
...
801060ea:	74 14                	je     80106100 <uartgetc+0x20>
static inline uchar
inb(ushort port)
{
  uchar data;
...
801060f4:	74 0a                	je     80106100 <uartgetc+0x20>
801060f6:	b2 f8                	mov    $0xf8,%dl
801060f8:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
801060f9:	0f b6 c0             	movzbl %al,%eax
}
801060fc:	5d                   	pop    %ebp
801060fd:	c3                   	ret    
...
80106117:	74 3f                	je     80106158 <uartputc+0x48>
    uartputc(*p);
}
...
8010612b:	eb 14                	jmp    80106141 <uartputc+0x31>
8010612d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
    microdelay(10);
80106130:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106137:	e8 e4 c6 ff ff       	call   80102820 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010613c:	83 eb 01             	sub    $0x1,%ebx
8010613f:	74 07                	je     80106148 <uartputc+0x38>
80106141:	89 f2                	mov    %esi,%edx
80106143:	ec                   	in     (%dx),%al
80106144:	a8 20                	test   $0x20,%al
80106146:	74 e8                	je     80106130 <uartputc+0x20>
    microdelay(10);
  outb(COM1+0, c);
80106148:	0f b6 45 08          	movzbl 0x8(%ebp),%eax
}
...
80106187:	b2 f8                	mov    $0xf8,%dl
80106189:	ee                   	out    %al,(%dx)
8010618a:	bb f9 03 00 00       	mov    $0x3f9,%ebx
8010618f:	89 c8                	mov    %ecx,%eax
80106191:	89 da                	mov    %ebx,%edx
80106193:	ee                   	out    %al,(%dx)
80106194:	b8 03 00 00 00       	mov    $0x3,%eax
80106199:	89 f2                	mov    %esi,%edx
8010619b:	ee                   	out    %al,(%dx)
8010619c:	b2 fc                	mov    $0xfc,%dl
8010619e:	89 c8                	mov    %ecx,%eax
...
801061ab:	ec                   	in     (%dx),%al
  ...
  if(inb(COM1+5) == 0xFF)
801061ac:	3c ff                	cmp    $0xff,%al
801061ae:	74 42                	je     801061f2 <uartinit+0x92>
    return;
  uart = 1;
801061b0:	c7 05 bc b5 10 80 01 	movl   $0x1,0x8010b5bc
801061b7:	00 00 00 
801061ba:	89 fa                	mov    %edi,%edx
801061bc:	ec                   	in     (%dx),%al
801061bd:	b2 f8                	mov    $0xf8,%dl
...
801061c0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801061c7:	00 

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801061c8:	bb 38 80 10 80       	mov    $0x80108038,%ebx
  ...
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
801061cd:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801061d4:	e8 57 c1 ff ff       	call   80102330 <ioapicenable>
...
801061e0:	89 04 24             	mov    %eax,(%esp)
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801061e3:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
801061e6:	e8 25 ff ff ff       	call   80106110 <uartputc>
  inb(COM1+2);
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801061eb:	0f be 03             	movsbl (%ebx),%eax
801061ee:	84 c0                	test   %al,%al
801061f0:	75 ee                	jne    801061e0 <uartinit+0x80>
    uartputc(*p);
}
801061f2:	83 c4 1c             	add    $0x1c,%esp
801061f5:	5b                   	pop    %ebx
801061f6:	5e                   	pop    %esi
801061f7:	5f                   	pop    %edi
801061f8:	5d                   	pop    %ebp
...
80106206:	c7 04 24 e0 60 10 80 	movl   $0x801060e0,(%esp)
8010620d:	e8 9e a5 ff ff       	call   801007b0 <consoleintr>
}
80106212:	c9                   	leave  
80106213:	c3                   	ret    
...
80106216:	6a 00                	push   $0x0
  jmp alltraps
80106218:	e9 60 fb ff ff       	jmp    80105d7d <alltraps>
...
8010621f:	6a 01                	push   $0x1
  jmp alltraps
80106221:	e9 57 fb ff ff       	jmp    80105d7d <alltraps>
...
80106226:	6a 00                	push   $0x0
  pushl $2
80106228:	6a 02                	push   $0x2
  jmp alltraps
8010622a:	e9 4e fb ff ff       	jmp    80105d7d <alltraps>
...
8010622f:	6a 00                	push   $0x0
  pushl $3
80106231:	6a 03                	push   $0x3
  jmp alltraps
80106233:	e9 45 fb ff ff       	jmp    80105d7d <alltraps>
...
80106238:	6a 00                	push   $0x0
  pushl $4
8010623a:	6a 04                	push   $0x4
  jmp alltraps
8010623c:	e9 3c fb ff ff       	jmp    80105d7d <alltraps>
...
80106241:	6a 00                	push   $0x0
  pushl $5
80106243:	6a 05                	push   $0x5
  jmp alltraps
80106245:	e9 33 fb ff ff       	jmp    80105d7d <alltraps>
...
8010624a:	6a 00                	push   $0x0
  pushl $6
8010624c:	6a 06                	push   $0x6
  jmp alltraps
8010624e:	e9 2a fb ff ff       	jmp    80105d7d <alltraps>
...
80106253:	6a 00                	push   $0x0
  pushl $7
80106255:	6a 07                	push   $0x7
  jmp alltraps
80106257:	e9 21 fb ff ff       	jmp    80105d7d <alltraps>
...
8010625c:	6a 08                	push   $0x8
  jmp alltraps
8010625e:	e9 1a fb ff ff       	jmp    80105d7d <alltraps>
...
80106263:	6a 00                	push   $0x0
  pushl $9
80106265:	6a 09                	push   $0x9
  jmp alltraps
80106267:	e9 11 fb ff ff       	jmp    80105d7d <alltraps>

8010626c <vector10>:
.globl vector10
vector10:
  pushl $10
8010626c:	6a 0a                	push   $0xa
  jmp alltraps
8010626e:	e9 0a fb ff ff       	jmp    80105d7d <alltraps>

80106273 <vector11>:
.globl vector11
vector11:
  pushl $11
80106273:	6a 0b                	push   $0xb
  jmp alltraps
80106275:	e9 03 fb ff ff       	jmp    80105d7d <alltraps>

8010627a <vector12>:
.globl vector12
vector12:
  pushl $12
8010627a:	6a 0c                	push   $0xc
  jmp alltraps
8010627c:	e9 fc fa ff ff       	jmp    80105d7d <alltraps>

80106281 <vector13>:
.globl vector13
vector13:
  pushl $13
80106281:	6a 0d                	push   $0xd
  jmp alltraps
80106283:	e9 f5 fa ff ff       	jmp    80105d7d <alltraps>

80106288 <vector14>:
.globl vector14
vector14:
  pushl $14
80106288:	6a 0e                	push   $0xe
  jmp alltraps
8010628a:	e9 ee fa ff ff       	jmp    80105d7d <alltraps>
...
8010628f:	6a 00                	push   $0x0
  pushl $15
80106291:	6a 0f                	push   $0xf
  jmp alltraps
80106293:	e9 e5 fa ff ff       	jmp    80105d7d <alltraps>
...
80106298:	6a 00                	push   $0x0
  pushl $16
8010629a:	6a 10                	push   $0x10
  jmp alltraps
8010629c:	e9 dc fa ff ff       	jmp    80105d7d <alltraps>

801062a1 <vector17>:
.globl vector17
vector17:
  pushl $17
801062a1:	6a 11                	push   $0x11
  jmp alltraps
801062a3:	e9 d5 fa ff ff       	jmp    80105d7d <alltraps>
...
801062a8:	6a 00                	push   $0x0
  pushl $18
801062aa:	6a 12                	push   $0x12
  jmp alltraps
801062ac:	e9 cc fa ff ff       	jmp    80105d7d <alltraps>
...
801062b1:	6a 00                	push   $0x0
  pushl $19
801062b3:	6a 13                	push   $0x13
  jmp alltraps
801062b5:	e9 c3 fa ff ff       	jmp    80105d7d <alltraps>
...
801062ba:	6a 00                	push   $0x0
  pushl $20
801062bc:	6a 14                	push   $0x14
  jmp alltraps
801062be:	e9 ba fa ff ff       	jmp    80105d7d <alltraps>
...
801062c3:	6a 00                	push   $0x0
  pushl $21
801062c5:	6a 15                	push   $0x15
  jmp alltraps
801062c7:	e9 b1 fa ff ff       	jmp    80105d7d <alltraps>
...
801062cc:	6a 00                	push   $0x0
  pushl $22
801062ce:	6a 16                	push   $0x16
  jmp alltraps
801062d0:	e9 a8 fa ff ff       	jmp    80105d7d <alltraps>
...
801062d5:	6a 00                	push   $0x0
  pushl $23
801062d7:	6a 17                	push   $0x17
  jmp alltraps
801062d9:	e9 9f fa ff ff       	jmp    80105d7d <alltraps>
...
801062de:	6a 00                	push   $0x0
  pushl $24
801062e0:	6a 18                	push   $0x18
  jmp alltraps
801062e2:	e9 96 fa ff ff       	jmp    80105d7d <alltraps>
...
801062e7:	6a 00                	push   $0x0
  pushl $25
801062e9:	6a 19                	push   $0x19
  jmp alltraps
801062eb:	e9 8d fa ff ff       	jmp    80105d7d <alltraps>
...
801062f0:	6a 00                	push   $0x0
  pushl $26
801062f2:	6a 1a                	push   $0x1a
  jmp alltraps
801062f4:	e9 84 fa ff ff       	jmp    80105d7d <alltraps>
...
801062f9:	6a 00                	push   $0x0
  pushl $27
801062fb:	6a 1b                	push   $0x1b
  jmp alltraps
801062fd:	e9 7b fa ff ff       	jmp    80105d7d <alltraps>
...
80106302:	6a 00                	push   $0x0
  pushl $28
80106304:	6a 1c                	push   $0x1c
  jmp alltraps
80106306:	e9 72 fa ff ff       	jmp    80105d7d <alltraps>
...
8010630b:	6a 00                	push   $0x0
  pushl $29
8010630d:	6a 1d                	push   $0x1d
  jmp alltraps
8010630f:	e9 69 fa ff ff       	jmp    80105d7d <alltraps>
...
80106314:	6a 00                	push   $0x0
  pushl $30
80106316:	6a 1e                	push   $0x1e
  jmp alltraps
80106318:	e9 60 fa ff ff       	jmp    80105d7d <alltraps>
...
8010631d:	6a 00                	push   $0x0
  pushl $31
8010631f:	6a 1f                	push   $0x1f
  jmp alltraps
80106321:	e9 57 fa ff ff       	jmp    80105d7d <alltraps>
...
80106326:	6a 00                	push   $0x0
  pushl $32
80106328:	6a 20                	push   $0x20
  jmp alltraps
8010632a:	e9 4e fa ff ff       	jmp    80105d7d <alltraps>
...
8010632f:	6a 00                	push   $0x0
  pushl $33
80106331:	6a 21                	push   $0x21
  jmp alltraps
80106333:	e9 45 fa ff ff       	jmp    80105d7d <alltraps>
...
80106338:	6a 00                	push   $0x0
  pushl $34
8010633a:	6a 22                	push   $0x22
  jmp alltraps
8010633c:	e9 3c fa ff ff       	jmp    80105d7d <alltraps>
...
80106341:	6a 00                	push   $0x0
  pushl $35
80106343:	6a 23                	push   $0x23
  jmp alltraps
80106345:	e9 33 fa ff ff       	jmp    80105d7d <alltraps>
...
8010634a:	6a 00                	push   $0x0
  pushl $36
8010634c:	6a 24                	push   $0x24
  jmp alltraps
8010634e:	e9 2a fa ff ff       	jmp    80105d7d <alltraps>
...
80106353:	6a 00                	push   $0x0
  pushl $37
80106355:	6a 25                	push   $0x25
  jmp alltraps
80106357:	e9 21 fa ff ff       	jmp    80105d7d <alltraps>
...
8010635c:	6a 00                	push   $0x0
  pushl $38
8010635e:	6a 26                	push   $0x26
  jmp alltraps
80106360:	e9 18 fa ff ff       	jmp    80105d7d <alltraps>
...
80106365:	6a 00                	push   $0x0
  pushl $39
80106367:	6a 27                	push   $0x27
  jmp alltraps
80106369:	e9 0f fa ff ff       	jmp    80105d7d <alltraps>
...
8010636e:	6a 00                	push   $0x0
  pushl $40
80106370:	6a 28                	push   $0x28
  jmp alltraps
80106372:	e9 06 fa ff ff       	jmp    80105d7d <alltraps>
...
80106377:	6a 00                	push   $0x0
  pushl $41
80106379:	6a 29                	push   $0x29
  jmp alltraps
8010637b:	e9 fd f9 ff ff       	jmp    80105d7d <alltraps>
...
80106380:	6a 00                	push   $0x0
  pushl $42
80106382:	6a 2a                	push   $0x2a
  jmp alltraps
80106384:	e9 f4 f9 ff ff       	jmp    80105d7d <alltraps>
...
80106389:	6a 00                	push   $0x0
  pushl $43
8010638b:	6a 2b                	push   $0x2b
  jmp alltraps
8010638d:	e9 eb f9 ff ff       	jmp    80105d7d <alltraps>
...
80106392:	6a 00                	push   $0x0
  pushl $44
80106394:	6a 2c                	push   $0x2c
  jmp alltraps
80106396:	e9 e2 f9 ff ff       	jmp    80105d7d <alltraps>
...
8010639b:	6a 00                	push   $0x0
  pushl $45
8010639d:	6a 2d                	push   $0x2d
  jmp alltraps
8010639f:	e9 d9 f9 ff ff       	jmp    80105d7d <alltraps>
...
801063a4:	6a 00                	push   $0x0
  pushl $46
801063a6:	6a 2e                	push   $0x2e
  jmp alltraps
801063a8:	e9 d0 f9 ff ff       	jmp    80105d7d <alltraps>
...
801063ad:	6a 00                	push   $0x0
  pushl $47
801063af:	6a 2f                	push   $0x2f
  jmp alltraps
801063b1:	e9 c7 f9 ff ff       	jmp    80105d7d <alltraps>
...
801063b6:	6a 00                	push   $0x0
  pushl $48
801063b8:	6a 30                	push   $0x30
  jmp alltraps
801063ba:	e9 be f9 ff ff       	jmp    80105d7d <alltraps>
...
801063bf:	6a 00                	push   $0x0
  pushl $49
801063c1:	6a 31                	push   $0x31
  jmp alltraps
801063c3:	e9 b5 f9 ff ff       	jmp    80105d7d <alltraps>
...
801063c8:	6a 00                	push   $0x0
  pushl $50
801063ca:	6a 32                	push   $0x32
  jmp alltraps
801063cc:	e9 ac f9 ff ff       	jmp    80105d7d <alltraps>
...
801063d1:	6a 00                	push   $0x0
  pushl $51
801063d3:	6a 33                	push   $0x33
  jmp alltraps
801063d5:	e9 a3 f9 ff ff       	jmp    80105d7d <alltraps>
...
801063da:	6a 00                	push   $0x0
  pushl $52
801063dc:	6a 34                	push   $0x34
  jmp alltraps
801063de:	e9 9a f9 ff ff       	jmp    80105d7d <alltraps>
...
801063e3:	6a 00                	push   $0x0
  pushl $53
801063e5:	6a 35                	push   $0x35
  jmp alltraps
801063e7:	e9 91 f9 ff ff       	jmp    80105d7d <alltraps>
...
801063ec:	6a 00                	push   $0x0
  pushl $54
801063ee:	6a 36                	push   $0x36
  jmp alltraps
801063f0:	e9 88 f9 ff ff       	jmp    80105d7d <alltraps>
...
801063f5:	6a 00                	push   $0x0
  pushl $55
801063f7:	6a 37                	push   $0x37
  jmp alltraps
801063f9:	e9 7f f9 ff ff       	jmp    80105d7d <alltraps>
...
801063fe:	6a 00                	push   $0x0
  pushl $56
80106400:	6a 38                	push   $0x38
  jmp alltraps
80106402:	e9 76 f9 ff ff       	jmp    80105d7d <alltraps>
...
80106407:	6a 00                	push   $0x0
  pushl $57
80106409:	6a 39                	push   $0x39
  jmp alltraps
8010640b:	e9 6d f9 ff ff       	jmp    80105d7d <alltraps>
...
80106410:	6a 00                	push   $0x0
  pushl $58
80106412:	6a 3a                	push   $0x3a
  jmp alltraps
80106414:	e9 64 f9 ff ff       	jmp    80105d7d <alltraps>
...
80106419:	6a 00                	push   $0x0
  pushl $59
8010641b:	6a 3b                	push   $0x3b
  jmp alltraps
8010641d:	e9 5b f9 ff ff       	jmp    80105d7d <alltraps>
...
80106422:	6a 00                	push   $0x0
  pushl $60
80106424:	6a 3c                	push   $0x3c
  jmp alltraps
80106426:	e9 52 f9 ff ff       	jmp    80105d7d <alltraps>
...
8010642b:	6a 00                	push   $0x0
  pushl $61
8010642d:	6a 3d                	push   $0x3d
  jmp alltraps
8010642f:	e9 49 f9 ff ff       	jmp    80105d7d <alltraps>
...
80106434:	6a 00                	push   $0x0
  pushl $62
80106436:	6a 3e                	push   $0x3e
  jmp alltraps
80106438:	e9 40 f9 ff ff       	jmp    80105d7d <alltraps>
...
8010643d:	6a 00                	push   $0x0
  pushl $63
8010643f:	6a 3f                	push   $0x3f
  jmp alltraps
80106441:	e9 37 f9 ff ff       	jmp    80105d7d <alltraps>
...
80106448:	6a 40                	push   $0x40
  jmp alltraps
8010644a:	e9 2e f9 ff ff       	jmp    80105d7d <alltraps>
...
8010644f:	6a 00                	push   $0x0
  pushl $65
80106451:	6a 41                	push   $0x41
  jmp alltraps
80106453:	e9 25 f9 ff ff       	jmp    80105d7d <alltraps>
...
80106458:	6a 00                	push   $0x0
  pushl $66
8010645a:	6a 42                	push   $0x42
  jmp alltraps
8010645c:	e9 1c f9 ff ff       	jmp    80105d7d <alltraps>
...
80106461:	6a 00                	push   $0x0
  pushl $67
80106463:	6a 43                	push   $0x43
  jmp alltraps
80106465:	e9 13 f9 ff ff       	jmp    80105d7d <alltraps>
...
8010646a:	6a 00                	push   $0x0
  pushl $68
8010646c:	6a 44                	push   $0x44
  jmp alltraps
8010646e:	e9 0a f9 ff ff       	jmp    80105d7d <alltraps>
...
80106473:	6a 00                	push   $0x0
  pushl $69
80106475:	6a 45                	push   $0x45
  jmp alltraps
80106477:	e9 01 f9 ff ff       	jmp    80105d7d <alltraps>
...
8010647c:	6a 00                	push   $0x0
  pushl $70
8010647e:	6a 46                	push   $0x46
  jmp alltraps
80106480:	e9 f8 f8 ff ff       	jmp    80105d7d <alltraps>
...
80106485:	6a 00                	push   $0x0
  pushl $71
80106487:	6a 47                	push   $0x47
  jmp alltraps
80106489:	e9 ef f8 ff ff       	jmp    80105d7d <alltraps>
...
8010648e:	6a 00                	push   $0x0
  pushl $72
80106490:	6a 48                	push   $0x48
  jmp alltraps
80106492:	e9 e6 f8 ff ff       	jmp    80105d7d <alltraps>
...
80106497:	6a 00                	push   $0x0
  pushl $73
80106499:	6a 49                	push   $0x49
  jmp alltraps
8010649b:	e9 dd f8 ff ff       	jmp    80105d7d <alltraps>
...
801064a0:	6a 00                	push   $0x0
  pushl $74
801064a2:	6a 4a                	push   $0x4a
  jmp alltraps
801064a4:	e9 d4 f8 ff ff       	jmp    80105d7d <alltraps>
...
801064a9:	6a 00                	push   $0x0
  pushl $75
801064ab:	6a 4b                	push   $0x4b
  jmp alltraps
801064ad:	e9 cb f8 ff ff       	jmp    80105d7d <alltraps>
...
801064b2:	6a 00                	push   $0x0
  pushl $76
801064b4:	6a 4c                	push   $0x4c
  jmp alltraps
801064b6:	e9 c2 f8 ff ff       	jmp    80105d7d <alltraps>
...
801064bb:	6a 00                	push   $0x0
  pushl $77
801064bd:	6a 4d                	push   $0x4d
  jmp alltraps
801064bf:	e9 b9 f8 ff ff       	jmp    80105d7d <alltraps>
...
801064c4:	6a 00                	push   $0x0
  pushl $78
801064c6:	6a 4e                	push   $0x4e
  jmp alltraps
801064c8:	e9 b0 f8 ff ff       	jmp    80105d7d <alltraps>
...
801064cd:	6a 00                	push   $0x0
  pushl $79
801064cf:	6a 4f                	push   $0x4f
  jmp alltraps
801064d1:	e9 a7 f8 ff ff       	jmp    80105d7d <alltraps>
...
801064d6:	6a 00                	push   $0x0
  pushl $80
801064d8:	6a 50                	push   $0x50
  jmp alltraps
801064da:	e9 9e f8 ff ff       	jmp    80105d7d <alltraps>
...
801064df:	6a 00                	push   $0x0
  pushl $81
801064e1:	6a 51                	push   $0x51
  jmp alltraps
801064e3:	e9 95 f8 ff ff       	jmp    80105d7d <alltraps>
...
801064e8:	6a 00                	push   $0x0
  pushl $82
801064ea:	6a 52                	push   $0x52
  jmp alltraps
801064ec:	e9 8c f8 ff ff       	jmp    80105d7d <alltraps>
...
801064f1:	6a 00                	push   $0x0
  pushl $83
801064f3:	6a 53                	push   $0x53
  jmp alltraps
801064f5:	e9 83 f8 ff ff       	jmp    80105d7d <alltraps>
...
801064fa:	6a 00                	push   $0x0
  pushl $84
801064fc:	6a 54                	push   $0x54
  jmp alltraps
801064fe:	e9 7a f8 ff ff       	jmp    80105d7d <alltraps>
...
80106503:	6a 00                	push   $0x0
  pushl $85
80106505:	6a 55                	push   $0x55
  jmp alltraps
80106507:	e9 71 f8 ff ff       	jmp    80105d7d <alltraps>
...
8010650c:	6a 00                	push   $0x0
  pushl $86
8010650e:	6a 56                	push   $0x56
  jmp alltraps
80106510:	e9 68 f8 ff ff       	jmp    80105d7d <alltraps>
...
80106515:	6a 00                	push   $0x0
  pushl $87
80106517:	6a 57                	push   $0x57
  jmp alltraps
80106519:	e9 5f f8 ff ff       	jmp    80105d7d <alltraps>
...
8010651e:	6a 00                	push   $0x0
  pushl $88
80106520:	6a 58                	push   $0x58
  jmp alltraps
80106522:	e9 56 f8 ff ff       	jmp    80105d7d <alltraps>
...
80106527:	6a 00                	push   $0x0
  pushl $89
80106529:	6a 59                	push   $0x59
  jmp alltraps
8010652b:	e9 4d f8 ff ff       	jmp    80105d7d <alltraps>
...
80106530:	6a 00                	push   $0x0
  pushl $90
80106532:	6a 5a                	push   $0x5a
  jmp alltraps
80106534:	e9 44 f8 ff ff       	jmp    80105d7d <alltraps>
...
80106539:	6a 00                	push   $0x0
  pushl $91
8010653b:	6a 5b                	push   $0x5b
  jmp alltraps
8010653d:	e9 3b f8 ff ff       	jmp    80105d7d <alltraps>
...
80106542:	6a 00                	push   $0x0
  pushl $92
80106544:	6a 5c                	push   $0x5c
  jmp alltraps
80106546:	e9 32 f8 ff ff       	jmp    80105d7d <alltraps>
...
8010654b:	6a 00                	push   $0x0
  pushl $93
8010654d:	6a 5d                	push   $0x5d
  jmp alltraps
8010654f:	e9 29 f8 ff ff       	jmp    80105d7d <alltraps>
...
80106554:	6a 00                	push   $0x0
  pushl $94
80106556:	6a 5e                	push   $0x5e
  jmp alltraps
80106558:	e9 20 f8 ff ff       	jmp    80105d7d <alltraps>
...
8010655d:	6a 00                	push   $0x0
  pushl $95
8010655f:	6a 5f                	push   $0x5f
  jmp alltraps
80106561:	e9 17 f8 ff ff       	jmp    80105d7d <alltraps>
...
80106566:	6a 00                	push   $0x0
  pushl $96
80106568:	6a 60                	push   $0x60
  jmp alltraps
8010656a:	e9 0e f8 ff ff       	jmp    80105d7d <alltraps>
...
8010656f:	6a 00                	push   $0x0
  pushl $97
80106571:	6a 61                	push   $0x61
  jmp alltraps
80106573:	e9 05 f8 ff ff       	jmp    80105d7d <alltraps>
...
80106578:	6a 00                	push   $0x0
  pushl $98
8010657a:	6a 62                	push   $0x62
  jmp alltraps
8010657c:	e9 fc f7 ff ff       	jmp    80105d7d <alltraps>
...
80106581:	6a 00                	push   $0x0
  pushl $99
80106583:	6a 63                	push   $0x63
  jmp alltraps
80106585:	e9 f3 f7 ff ff       	jmp    80105d7d <alltraps>
...
8010658a:	6a 00                	push   $0x0
  pushl $100
8010658c:	6a 64                	push   $0x64
  jmp alltraps
8010658e:	e9 ea f7 ff ff       	jmp    80105d7d <alltraps>
...
80106593:	6a 00                	push   $0x0
  pushl $101
80106595:	6a 65                	push   $0x65
  jmp alltraps
80106597:	e9 e1 f7 ff ff       	jmp    80105d7d <alltraps>
...
8010659c:	6a 00                	push   $0x0
  pushl $102
8010659e:	6a 66                	push   $0x66
  jmp alltraps
801065a0:	e9 d8 f7 ff ff       	jmp    80105d7d <alltraps>
...
801065a5:	6a 00                	push   $0x0
  pushl $103
801065a7:	6a 67                	push   $0x67
  jmp alltraps
801065a9:	e9 cf f7 ff ff       	jmp    80105d7d <alltraps>
...
801065ae:	6a 00                	push   $0x0
  pushl $104
801065b0:	6a 68                	push   $0x68
  jmp alltraps
801065b2:	e9 c6 f7 ff ff       	jmp    80105d7d <alltraps>
...
801065b7:	6a 00                	push   $0x0
  pushl $105
801065b9:	6a 69                	push   $0x69
  jmp alltraps
801065bb:	e9 bd f7 ff ff       	jmp    80105d7d <alltraps>
...
801065c0:	6a 00                	push   $0x0
  pushl $106
801065c2:	6a 6a                	push   $0x6a
  jmp alltraps
801065c4:	e9 b4 f7 ff ff       	jmp    80105d7d <alltraps>
...
801065c9:	6a 00                	push   $0x0
  pushl $107
801065cb:	6a 6b                	push   $0x6b
  jmp alltraps
801065cd:	e9 ab f7 ff ff       	jmp    80105d7d <alltraps>
...
801065d2:	6a 00                	push   $0x0
  pushl $108
801065d4:	6a 6c                	push   $0x6c
  jmp alltraps
801065d6:	e9 a2 f7 ff ff       	jmp    80105d7d <alltraps>
...
801065db:	6a 00                	push   $0x0
  pushl $109
801065dd:	6a 6d                	push   $0x6d
  jmp alltraps
801065df:	e9 99 f7 ff ff       	jmp    80105d7d <alltraps>
...
801065e4:	6a 00                	push   $0x0
  pushl $110
801065e6:	6a 6e                	push   $0x6e
  jmp alltraps
801065e8:	e9 90 f7 ff ff       	jmp    80105d7d <alltraps>
...
801065ed:	6a 00                	push   $0x0
  pushl $111
801065ef:	6a 6f                	push   $0x6f
  jmp alltraps
801065f1:	e9 87 f7 ff ff       	jmp    80105d7d <alltraps>
...
801065f6:	6a 00                	push   $0x0
  pushl $112
801065f8:	6a 70                	push   $0x70
  jmp alltraps
801065fa:	e9 7e f7 ff ff       	jmp    80105d7d <alltraps>
...
801065ff:	6a 00                	push   $0x0
  pushl $113
80106601:	6a 71                	push   $0x71
  jmp alltraps
80106603:	e9 75 f7 ff ff       	jmp    80105d7d <alltraps>
...
80106608:	6a 00                	push   $0x0
  pushl $114
8010660a:	6a 72                	push   $0x72
  jmp alltraps
8010660c:	e9 6c f7 ff ff       	jmp    80105d7d <alltraps>
...
80106611:	6a 00                	push   $0x0
  pushl $115
80106613:	6a 73                	push   $0x73
  jmp alltraps
80106615:	e9 63 f7 ff ff       	jmp    80105d7d <alltraps>
...
8010661a:	6a 00                	push   $0x0
  pushl $116
8010661c:	6a 74                	push   $0x74
  jmp alltraps
8010661e:	e9 5a f7 ff ff       	jmp    80105d7d <alltraps>
...
80106623:	6a 00                	push   $0x0
  pushl $117
80106625:	6a 75                	push   $0x75
  jmp alltraps
80106627:	e9 51 f7 ff ff       	jmp    80105d7d <alltraps>
...
8010662c:	6a 00                	push   $0x0
  pushl $118
8010662e:	6a 76                	push   $0x76
  jmp alltraps
80106630:	e9 48 f7 ff ff       	jmp    80105d7d <alltraps>
...
80106635:	6a 00                	push   $0x0
  pushl $119
80106637:	6a 77                	push   $0x77
  jmp alltraps
80106639:	e9 3f f7 ff ff       	jmp    80105d7d <alltraps>
...
8010663e:	6a 00                	push   $0x0
  pushl $120
80106640:	6a 78                	push   $0x78
  jmp alltraps
80106642:	e9 36 f7 ff ff       	jmp    80105d7d <alltraps>
...
80106647:	6a 00                	push   $0x0
  pushl $121
80106649:	6a 79                	push   $0x79
  jmp alltraps
8010664b:	e9 2d f7 ff ff       	jmp    80105d7d <alltraps>
...
80106650:	6a 00                	push   $0x0
  pushl $122
80106652:	6a 7a                	push   $0x7a
  jmp alltraps
80106654:	e9 24 f7 ff ff       	jmp    80105d7d <alltraps>
...
80106659:	6a 00                	push   $0x0
  pushl $123
8010665b:	6a 7b                	push   $0x7b
  jmp alltraps
8010665d:	e9 1b f7 ff ff       	jmp    80105d7d <alltraps>
...
80106662:	6a 00                	push   $0x0
  pushl $124
80106664:	6a 7c                	push   $0x7c
  jmp alltraps
80106666:	e9 12 f7 ff ff       	jmp    80105d7d <alltraps>
...
8010666b:	6a 00                	push   $0x0
  pushl $125
8010666d:	6a 7d                	push   $0x7d
  jmp alltraps
8010666f:	e9 09 f7 ff ff       	jmp    80105d7d <alltraps>
...
80106674:	6a 00                	push   $0x0
  pushl $126
80106676:	6a 7e                	push   $0x7e
  jmp alltraps
80106678:	e9 00 f7 ff ff       	jmp    80105d7d <alltraps>
...
8010667d:	6a 00                	push   $0x0
  pushl $127
8010667f:	6a 7f                	push   $0x7f
  jmp alltraps
80106681:	e9 f7 f6 ff ff       	jmp    80105d7d <alltraps>
...
80106686:	6a 00                	push   $0x0
  pushl $128
80106688:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010668d:	e9 eb f6 ff ff       	jmp    80105d7d <alltraps>
...
80106692:	6a 00                	push   $0x0
  pushl $129
80106694:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106699:	e9 df f6 ff ff       	jmp    80105d7d <alltraps>
...
8010669e:	6a 00                	push   $0x0
  pushl $130
801066a0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801066a5:	e9 d3 f6 ff ff       	jmp    80105d7d <alltraps>
...
801066aa:	6a 00                	push   $0x0
  pushl $131
801066ac:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801066b1:	e9 c7 f6 ff ff       	jmp    80105d7d <alltraps>
...
801066b6:	6a 00                	push   $0x0
  pushl $132
801066b8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801066bd:	e9 bb f6 ff ff       	jmp    80105d7d <alltraps>
...
801066c2:	6a 00                	push   $0x0
  pushl $133
801066c4:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801066c9:	e9 af f6 ff ff       	jmp    80105d7d <alltraps>
...
801066ce:	6a 00                	push   $0x0
  pushl $134
801066d0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801066d5:	e9 a3 f6 ff ff       	jmp    80105d7d <alltraps>
...
801066da:	6a 00                	push   $0x0
  pushl $135
801066dc:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801066e1:	e9 97 f6 ff ff       	jmp    80105d7d <alltraps>
...
801066e6:	6a 00                	push   $0x0
  pushl $136
801066e8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801066ed:	e9 8b f6 ff ff       	jmp    80105d7d <alltraps>
...
801066f2:	6a 00                	push   $0x0
  pushl $137
801066f4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801066f9:	e9 7f f6 ff ff       	jmp    80105d7d <alltraps>
...
801066fe:	6a 00                	push   $0x0
  pushl $138
80106700:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106705:	e9 73 f6 ff ff       	jmp    80105d7d <alltraps>
...
8010670a:	6a 00                	push   $0x0
  pushl $139
8010670c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106711:	e9 67 f6 ff ff       	jmp    80105d7d <alltraps>
...
80106716:	6a 00                	push   $0x0
  pushl $140
80106718:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010671d:	e9 5b f6 ff ff       	jmp    80105d7d <alltraps>
...
80106722:	6a 00                	push   $0x0
  pushl $141
80106724:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106729:	e9 4f f6 ff ff       	jmp    80105d7d <alltraps>
...
8010672e:	6a 00                	push   $0x0
  pushl $142
80106730:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106735:	e9 43 f6 ff ff       	jmp    80105d7d <alltraps>
...
8010673a:	6a 00                	push   $0x0
  pushl $143
8010673c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106741:	e9 37 f6 ff ff       	jmp    80105d7d <alltraps>
...
80106746:	6a 00                	push   $0x0
  pushl $144
80106748:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010674d:	e9 2b f6 ff ff       	jmp    80105d7d <alltraps>
...
80106752:	6a 00                	push   $0x0
  pushl $145
80106754:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106759:	e9 1f f6 ff ff       	jmp    80105d7d <alltraps>
...
8010675e:	6a 00                	push   $0x0
  pushl $146
80106760:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106765:	e9 13 f6 ff ff       	jmp    80105d7d <alltraps>
...
8010676a:	6a 00                	push   $0x0
  pushl $147
8010676c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106771:	e9 07 f6 ff ff       	jmp    80105d7d <alltraps>
...
80106776:	6a 00                	push   $0x0
  pushl $148
80106778:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010677d:	e9 fb f5 ff ff       	jmp    80105d7d <alltraps>
...
80106782:	6a 00                	push   $0x0
  pushl $149
80106784:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106789:	e9 ef f5 ff ff       	jmp    80105d7d <alltraps>
...
8010678e:	6a 00                	push   $0x0
  pushl $150
80106790:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106795:	e9 e3 f5 ff ff       	jmp    80105d7d <alltraps>
...
8010679a:	6a 00                	push   $0x0
  pushl $151
8010679c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801067a1:	e9 d7 f5 ff ff       	jmp    80105d7d <alltraps>
...
801067a6:	6a 00                	push   $0x0
  pushl $152
801067a8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801067ad:	e9 cb f5 ff ff       	jmp    80105d7d <alltraps>
...
801067b2:	6a 00                	push   $0x0
  pushl $153
801067b4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801067b9:	e9 bf f5 ff ff       	jmp    80105d7d <alltraps>
...
801067be:	6a 00                	push   $0x0
  pushl $154
801067c0:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801067c5:	e9 b3 f5 ff ff       	jmp    80105d7d <alltraps>
...
801067ca:	6a 00                	push   $0x0
  pushl $155
801067cc:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801067d1:	e9 a7 f5 ff ff       	jmp    80105d7d <alltraps>
...
801067d6:	6a 00                	push   $0x0
  pushl $156
801067d8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801067dd:	e9 9b f5 ff ff       	jmp    80105d7d <alltraps>
...
801067e2:	6a 00                	push   $0x0
  pushl $157
801067e4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801067e9:	e9 8f f5 ff ff       	jmp    80105d7d <alltraps>
...
801067ee:	6a 00                	push   $0x0
  pushl $158
801067f0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801067f5:	e9 83 f5 ff ff       	jmp    80105d7d <alltraps>
...
801067fa:	6a 00                	push   $0x0
  pushl $159
801067fc:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106801:	e9 77 f5 ff ff       	jmp    80105d7d <alltraps>
...
80106806:	6a 00                	push   $0x0
  pushl $160
80106808:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010680d:	e9 6b f5 ff ff       	jmp    80105d7d <alltraps>
...
80106812:	6a 00                	push   $0x0
  pushl $161
80106814:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106819:	e9 5f f5 ff ff       	jmp    80105d7d <alltraps>
...
8010681e:	6a 00                	push   $0x0
  pushl $162
80106820:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106825:	e9 53 f5 ff ff       	jmp    80105d7d <alltraps>
...
8010682a:	6a 00                	push   $0x0
  pushl $163
8010682c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106831:	e9 47 f5 ff ff       	jmp    80105d7d <alltraps>
...
80106836:	6a 00                	push   $0x0
  pushl $164
80106838:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010683d:	e9 3b f5 ff ff       	jmp    80105d7d <alltraps>
...
80106842:	6a 00                	push   $0x0
  pushl $165
80106844:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106849:	e9 2f f5 ff ff       	jmp    80105d7d <alltraps>
...
8010684e:	6a 00                	push   $0x0
  pushl $166
80106850:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106855:	e9 23 f5 ff ff       	jmp    80105d7d <alltraps>
...
8010685a:	6a 00                	push   $0x0
  pushl $167
8010685c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106861:	e9 17 f5 ff ff       	jmp    80105d7d <alltraps>
...
80106866:	6a 00                	push   $0x0
  pushl $168
80106868:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010686d:	e9 0b f5 ff ff       	jmp    80105d7d <alltraps>
...
80106874:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106879:	e9 ff f4 ff ff       	jmp    80105d7d <alltraps>
...
8010687e:	6a 00                	push   $0x0
  pushl $170
80106880:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106885:	e9 f3 f4 ff ff       	jmp    80105d7d <alltraps>
...
8010688a:	6a 00                	push   $0x0
  pushl $171
8010688c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106891:	e9 e7 f4 ff ff       	jmp    80105d7d <alltraps>
...
80106896:	6a 00                	push   $0x0
  pushl $172
80106898:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010689d:	e9 db f4 ff ff       	jmp    80105d7d <alltraps>
...
801068a2:	6a 00                	push   $0x0
  pushl $173
801068a4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801068a9:	e9 cf f4 ff ff       	jmp    80105d7d <alltraps>
...
801068ae:	6a 00                	push   $0x0
  pushl $174
801068b0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801068b5:	e9 c3 f4 ff ff       	jmp    80105d7d <alltraps>
...
801068ba:	6a 00                	push   $0x0
  pushl $175
801068bc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801068c1:	e9 b7 f4 ff ff       	jmp    80105d7d <alltraps>
...
801068c6:	6a 00                	push   $0x0
  pushl $176
801068c8:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801068cd:	e9 ab f4 ff ff       	jmp    80105d7d <alltraps>
...
801068d2:	6a 00                	push   $0x0
  pushl $177
801068d4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801068d9:	e9 9f f4 ff ff       	jmp    80105d7d <alltraps>
...
801068de:	6a 00                	push   $0x0
  pushl $178
801068e0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801068e5:	e9 93 f4 ff ff       	jmp    80105d7d <alltraps>
...
801068ea:	6a 00                	push   $0x0
  pushl $179
801068ec:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801068f1:	e9 87 f4 ff ff       	jmp    80105d7d <alltraps>
...
801068f6:	6a 00                	push   $0x0
  pushl $180
801068f8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801068fd:	e9 7b f4 ff ff       	jmp    80105d7d <alltraps>
...
80106902:	6a 00                	push   $0x0
  pushl $181
80106904:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106909:	e9 6f f4 ff ff       	jmp    80105d7d <alltraps>
...
8010690e:	6a 00                	push   $0x0
  pushl $182
80106910:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106915:	e9 63 f4 ff ff       	jmp    80105d7d <alltraps>
...
8010691a:	6a 00                	push   $0x0
  pushl $183
8010691c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106921:	e9 57 f4 ff ff       	jmp    80105d7d <alltraps>
...
80106926:	6a 00                	push   $0x0
  pushl $184
80106928:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010692d:	e9 4b f4 ff ff       	jmp    80105d7d <alltraps>
...
80106932:	6a 00                	push   $0x0
  pushl $185
80106934:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106939:	e9 3f f4 ff ff       	jmp    80105d7d <alltraps>
...
8010693e:	6a 00                	push   $0x0
  pushl $186
80106940:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106945:	e9 33 f4 ff ff       	jmp    80105d7d <alltraps>
...
8010694a:	6a 00                	push   $0x0
  pushl $187
8010694c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106951:	e9 27 f4 ff ff       	jmp    80105d7d <alltraps>
...
80106956:	6a 00                	push   $0x0
  pushl $188
80106958:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010695d:	e9 1b f4 ff ff       	jmp    80105d7d <alltraps>
...
80106962:	6a 00                	push   $0x0
  pushl $189
80106964:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106969:	e9 0f f4 ff ff       	jmp    80105d7d <alltraps>
...
8010696e:	6a 00                	push   $0x0
  pushl $190
80106970:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106975:	e9 03 f4 ff ff       	jmp    80105d7d <alltraps>
...
8010697a:	6a 00                	push   $0x0
  pushl $191
8010697c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106981:	e9 f7 f3 ff ff       	jmp    80105d7d <alltraps>
...
80106986:	6a 00                	push   $0x0
  pushl $192
80106988:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010698d:	e9 eb f3 ff ff       	jmp    80105d7d <alltraps>
...
80106992:	6a 00                	push   $0x0
  pushl $193
80106994:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106999:	e9 df f3 ff ff       	jmp    80105d7d <alltraps>
...
8010699e:	6a 00                	push   $0x0
  pushl $194
801069a0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801069a5:	e9 d3 f3 ff ff       	jmp    80105d7d <alltraps>
...
801069aa:	6a 00                	push   $0x0
  pushl $195
801069ac:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801069b1:	e9 c7 f3 ff ff       	jmp    80105d7d <alltraps>
...
801069b6:	6a 00                	push   $0x0
  pushl $196
801069b8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801069bd:	e9 bb f3 ff ff       	jmp    80105d7d <alltraps>
...
801069c2:	6a 00                	push   $0x0
  pushl $197
801069c4:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801069c9:	e9 af f3 ff ff       	jmp    80105d7d <alltraps>
...
801069ce:	6a 00                	push   $0x0
  pushl $198
801069d0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801069d5:	e9 a3 f3 ff ff       	jmp    80105d7d <alltraps>
...
801069da:	6a 00                	push   $0x0
  pushl $199
801069dc:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801069e1:	e9 97 f3 ff ff       	jmp    80105d7d <alltraps>
...
801069e6:	6a 00                	push   $0x0
  pushl $200
801069e8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801069ed:	e9 8b f3 ff ff       	jmp    80105d7d <alltraps>
...
801069f2:	6a 00                	push   $0x0
  pushl $201
801069f4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801069f9:	e9 7f f3 ff ff       	jmp    80105d7d <alltraps>
...
801069fe:	6a 00                	push   $0x0
  pushl $202
80106a00:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106a05:	e9 73 f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a0a:	6a 00                	push   $0x0
  pushl $203
80106a0c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106a11:	e9 67 f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a16:	6a 00                	push   $0x0
  pushl $204
80106a18:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106a1d:	e9 5b f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a22:	6a 00                	push   $0x0
  pushl $205
80106a24:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106a29:	e9 4f f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a2e:	6a 00                	push   $0x0
  pushl $206
80106a30:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106a35:	e9 43 f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a3a:	6a 00                	push   $0x0
  pushl $207
80106a3c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106a41:	e9 37 f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a46:	6a 00                	push   $0x0
  pushl $208
80106a48:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106a4d:	e9 2b f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a52:	6a 00                	push   $0x0
  pushl $209
80106a54:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106a59:	e9 1f f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a5e:	6a 00                	push   $0x0
  pushl $210
80106a60:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106a65:	e9 13 f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a6a:	6a 00                	push   $0x0
  pushl $211
80106a6c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106a71:	e9 07 f3 ff ff       	jmp    80105d7d <alltraps>
...
80106a76:	6a 00                	push   $0x0
  pushl $212
80106a78:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106a7d:	e9 fb f2 ff ff       	jmp    80105d7d <alltraps>
...
80106a82:	6a 00                	push   $0x0
  pushl $213
80106a84:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106a89:	e9 ef f2 ff ff       	jmp    80105d7d <alltraps>
...
80106a8e:	6a 00                	push   $0x0
  pushl $214
80106a90:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106a95:	e9 e3 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106a9a:	6a 00                	push   $0x0
  pushl $215
80106a9c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106aa1:	e9 d7 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106aa6:	6a 00                	push   $0x0
  pushl $216
80106aa8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106aad:	e9 cb f2 ff ff       	jmp    80105d7d <alltraps>
...
80106ab2:	6a 00                	push   $0x0
  pushl $217
80106ab4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106ab9:	e9 bf f2 ff ff       	jmp    80105d7d <alltraps>
...
80106abe:	6a 00                	push   $0x0
  pushl $218
80106ac0:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106ac5:	e9 b3 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106aca:	6a 00                	push   $0x0
  pushl $219
80106acc:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106ad1:	e9 a7 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106ad6:	6a 00                	push   $0x0
  pushl $220
80106ad8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106add:	e9 9b f2 ff ff       	jmp    80105d7d <alltraps>
...
80106ae2:	6a 00                	push   $0x0
  pushl $221
80106ae4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106ae9:	e9 8f f2 ff ff       	jmp    80105d7d <alltraps>
...
80106aee:	6a 00                	push   $0x0
  pushl $222
80106af0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106af5:	e9 83 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106afa:	6a 00                	push   $0x0
  pushl $223
80106afc:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106b01:	e9 77 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b06:	6a 00                	push   $0x0
  pushl $224
80106b08:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106b0d:	e9 6b f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b12:	6a 00                	push   $0x0
  pushl $225
80106b14:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106b19:	e9 5f f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b1e:	6a 00                	push   $0x0
  pushl $226
80106b20:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106b25:	e9 53 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b2a:	6a 00                	push   $0x0
  pushl $227
80106b2c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106b31:	e9 47 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b36:	6a 00                	push   $0x0
  pushl $228
80106b38:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106b3d:	e9 3b f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b42:	6a 00                	push   $0x0
  pushl $229
80106b44:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106b49:	e9 2f f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b4e:	6a 00                	push   $0x0
  pushl $230
80106b50:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106b55:	e9 23 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b5a:	6a 00                	push   $0x0
  pushl $231
80106b5c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106b61:	e9 17 f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b66:	6a 00                	push   $0x0
  pushl $232
80106b68:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106b6d:	e9 0b f2 ff ff       	jmp    80105d7d <alltraps>
...
80106b72:	6a 00                	push   $0x0
  pushl $233
80106b74:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106b79:	e9 ff f1 ff ff       	jmp    80105d7d <alltraps>
...
80106b7e:	6a 00                	push   $0x0
  pushl $234
80106b80:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106b85:	e9 f3 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106b8a:	6a 00                	push   $0x0
  pushl $235
80106b8c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106b91:	e9 e7 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106b96:	6a 00                	push   $0x0
  pushl $236
80106b98:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106b9d:	e9 db f1 ff ff       	jmp    80105d7d <alltraps>
...
80106ba2:	6a 00                	push   $0x0
  pushl $237
80106ba4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106ba9:	e9 cf f1 ff ff       	jmp    80105d7d <alltraps>
...
80106bae:	6a 00                	push   $0x0
  pushl $238
80106bb0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106bb5:	e9 c3 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106bba:	6a 00                	push   $0x0
  pushl $239
80106bbc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106bc1:	e9 b7 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106bc6:	6a 00                	push   $0x0
  pushl $240
80106bc8:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106bcd:	e9 ab f1 ff ff       	jmp    80105d7d <alltraps>
...
80106bd2:	6a 00                	push   $0x0
  pushl $241
80106bd4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106bd9:	e9 9f f1 ff ff       	jmp    80105d7d <alltraps>
...
80106bde:	6a 00                	push   $0x0
  pushl $242
80106be0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106be5:	e9 93 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106bea:	6a 00                	push   $0x0
  pushl $243
80106bec:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106bf1:	e9 87 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106bf6:	6a 00                	push   $0x0
  pushl $244
80106bf8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106bfd:	e9 7b f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c02:	6a 00                	push   $0x0
  pushl $245
80106c04:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106c09:	e9 6f f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c0e:	6a 00                	push   $0x0
  pushl $246
80106c10:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106c15:	e9 63 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c1a:	6a 00                	push   $0x0
  pushl $247
80106c1c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106c21:	e9 57 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c26:	6a 00                	push   $0x0
  pushl $248
80106c28:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106c2d:	e9 4b f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c32:	6a 00                	push   $0x0
  pushl $249
80106c34:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106c39:	e9 3f f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c3e:	6a 00                	push   $0x0
  pushl $250
80106c40:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106c45:	e9 33 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c4a:	6a 00                	push   $0x0
  pushl $251
80106c4c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106c51:	e9 27 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c56:	6a 00                	push   $0x0
  pushl $252
80106c58:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106c5d:	e9 1b f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c62:	6a 00                	push   $0x0
  pushl $253
80106c64:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106c69:	e9 0f f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c6e:	6a 00                	push   $0x0
  pushl $254
80106c70:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106c75:	e9 03 f1 ff ff       	jmp    80105d7d <alltraps>
...
80106c7a:	6a 00                	push   $0x0
  pushl $255
80106c7c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106c81:	e9 f7 f0 ff ff       	jmp    80105d7d <alltraps>
80106c86:	66 90                	xchg   %ax,%ax
80106c88:	66 90                	xchg   %ax,%ax
...
80106cae:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80106cb4:	c1 ee 0a             	shr    $0xa,%esi
}
80106cb7:	83 c4 1c             	add    $0x1c,%esp
    // The permissions here are overly generous, but they can
    // be further restricted by tlayhe permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106cd2:	74 34                	je     80106d08 <walkpgdir+0x78>
80106cd4:	e8 47 b8 ff ff       	call   80102520 <kalloc>
80106cd9:	85 c0                	test   %eax,%eax
80106cdb:	89 c3                	mov    %eax,%ebx
80106cdd:	74 29                	je     80106d08 <walkpgdir+0x78>
      return 0;
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80106cdf:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106ce6:	00 
80106ce7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106cee:	00 
80106cef:	89 04 24             	mov    %eax,(%esp)
80106cf2:	e8 09 d6 ff ff       	call   80104300 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by tlayhe permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106cf7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106cfd:	83 c8 07             	or     $0x7,%eax
80106d00:	89 07                	mov    %eax,(%edi)
80106d02:	eb b0                	jmp    80106cb4 <walkpgdir+0x24>
...
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
80106d28:	83 ec 1c             	sub    $0x1c,%esp
80106d2b:	8b 7d 08             	mov    0x8(%ebp),%edi
  char *a, *last;
  pte_t *pte;
...
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
80106d34:	89 45 e0             	mov    %eax,-0x20(%ebp)
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106d37:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80106d3b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106d3e:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
{
  char *a, *last;
  pte_t *pte;
  ...
  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106d42:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
80106d49:	29 df                	sub    %ebx,%edi
80106d4b:	eb 18                	jmp    80106d65 <mappages+0x45>
80106d4d:	8d 76 00             	lea    0x0(%esi),%esi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
80106d50:	f6 00 01             	testb  $0x1,(%eax)
80106d53:	75 3d                	jne    80106d92 <mappages+0x72>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106d55:	0b 75 0c             	or     0xc(%ebp),%esi
    if(a == last)
80106d58:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106d5b:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106d5d:	74 29                	je     80106d88 <mappages+0x68>
      break;
    a += PGSIZE;
80106d5f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  pte_t *pte;
...
80106d68:	b9 01 00 00 00       	mov    $0x1,%ecx
80106d6d:	89 da                	mov    %ebx,%edx
80106d6f:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
80106d72:	e8 19 ff ff ff       	call   80106c90 <walkpgdir>
80106d77:	85 c0                	test   %eax,%eax
80106d79:	75 d5                	jne    80106d50 <mappages+0x30>
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
...
80106d7b:	83 c4 1c             	add    $0x1c,%esp
...
80106d86:	5d                   	pop    %ebp
80106d87:	c3                   	ret    
80106d88:	83 c4 1c             	add    $0x1c,%esp
    if(a == last)
      break;
    a += PGSIZE;
    pa += PGSIZE;
...
80106d91:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106d92:	c7 04 24 40 80 10 80 	movl   $0x80108040,(%esp)
...
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106db0:	83 ec 1c             	sub    $0x1c,%esp
  uint a, pa;
  ...
  a = PGROUNDUP(newsz);
80106db3:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
...
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106dbb:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106dbe:	72 3b                	jb     80106dfb <deallocuvm.part.0+0x5b>
80106dc0:	eb 5e                	jmp    80106e20 <deallocuvm.part.0+0x80>
...
80106dcd:	74 22                	je     80106df1 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106dcf:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106dd5:	74 54                	je     80106e2b <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80106dd7:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
80106ddd:	89 14 24             	mov    %edx,(%esp)
80106de0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106de3:	e8 88 b5 ff ff       	call   80102370 <kfree>
      *pte = 0;
80106de8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106deb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106df1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106df7:	39 f3                	cmp    %esi,%ebx
80106df9:	73 25                	jae    80106e20 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106dfb:	31 c9                	xor    %ecx,%ecx
80106dfd:	89 da                	mov    %ebx,%edx
80106dff:	89 f8                	mov    %edi,%eax
80106e01:	e8 8a fe ff ff       	call   80106c90 <walkpgdir>
    if(!pte)
80106e06:	85 c0                	test   %eax,%eax
80106e08:	75 be                	jne    80106dc8 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106e0a:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106e10:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106e16:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106e1c:	39 f3                	cmp    %esi,%ebx
80106e1e:	72 db                	jb     80106dfb <deallocuvm.part.0+0x5b>
      kfree(v);
      *pte = 0;
    }
  }
...
80106e23:	83 c4 1c             	add    $0x1c,%esp
80106e26:	5b                   	pop    %ebx
80106e27:	5e                   	pop    %esi
80106e28:	5f                   	pop    %edi
80106e29:	5d                   	pop    %ebp
80106e2a:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
80106e2b:	c7 04 24 06 78 10 80 	movl   $0x80107806,(%esp)
80106e32:	e8 29 95 ff ff       	call   80100360 <panic>
...
80106e43:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106e46:	e8 b5 c8 ff ff       	call   80103700 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106e4b:	31 c9                	xor    %ecx,%ecx
80106e4d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
80106e52:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106e58:	05 80 37 11 80       	add    $0x80113780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106e5d:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e61:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
  lgdt(c->gdt, sizeof(c->gdt));
80106e66:	83 c0 70             	add    $0x70,%eax
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106e69:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e6d:	31 c9                	xor    %ecx,%ecx
80106e6f:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e73:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e78:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e7c:	31 c9                	xor    %ecx,%ecx
80106e7e:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106e82:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e87:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106e8b:	31 c9                	xor    %ecx,%ecx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106e8d:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
80106e91:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e95:	c6 40 15 92          	movb   $0x92,0x15(%eax)
80106e99:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e9d:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
80106ea1:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106ea5:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
80106ea9:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
80106ead:	66 89 50 20          	mov    %dx,0x20(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80106eb1:	ba 2f 00 00 00       	mov    $0x2f,%edx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106eb6:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
80106eba:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106ebe:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106ec2:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106ec6:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
80106eca:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106ece:	66 89 48 22          	mov    %cx,0x22(%eax)
80106ed2:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106ed6:	c6 40 27 00          	movb   $0x0,0x27(%eax)
80106eda:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
80106ede:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106ee2:	c1 e8 10             	shr    $0x10,%eax
80106ee5:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106ee9:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106eec:	0f 01 10             	lgdtl  (%eax)
  lgdt(c->gdt, sizeof(c->gdt));
}
80106eef:	c9                   	leave  
80106ef0:	c3                   	ret    
80106ef1:	eb 0d                	jmp    80106f00 <switchkvm>
80106ef3:	90                   	nop
80106ef4:	90                   	nop
80106ef5:	90                   	nop
80106ef6:	90                   	nop
...
80106f00:	a1 04 6e 11 80       	mov    0x80116e04,%eax
...
80106f2e:	0f 84 cd 00 00 00    	je     80107001 <switchuvm+0xe1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106f34:	8b 46 08             	mov    0x8(%esi),%eax
80106f37:	85 c0                	test   %eax,%eax
80106f39:	0f 84 da 00 00 00    	je     80107019 <switchuvm+0xf9>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106f3f:	8b 7e 04             	mov    0x4(%esi),%edi
80106f42:	85 ff                	test   %edi,%edi
80106f44:	0f 84 c3 00 00 00    	je     8010700d <switchuvm+0xed>
    panic("switchuvm: no pgdir");

  pushcli();
80106f4a:	e8 31 d2 ff ff       	call   80104180 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106f4f:	e8 2c c7 ff ff       	call   80103680 <mycpu>
80106f54:	89 c3                	mov    %eax,%ebx
80106f56:	e8 25 c7 ff ff       	call   80103680 <mycpu>
80106f5b:	89 c7                	mov    %eax,%edi
80106f5d:	e8 1e c7 ff ff       	call   80103680 <mycpu>
80106f62:	83 c7 08             	add    $0x8,%edi
80106f65:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106f68:	e8 13 c7 ff ff       	call   80103680 <mycpu>
80106f6d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106f70:	ba 67 00 00 00       	mov    $0x67,%edx
80106f75:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
80106f7c:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106f83:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
80106f8a:	83 c1 08             	add    $0x8,%ecx
80106f8d:	c1 e9 10             	shr    $0x10,%ecx
80106f90:	83 c0 08             	add    $0x8,%eax
80106f93:	c1 e8 18             	shr    $0x18,%eax
80106f96:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106f9c:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106fa3:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
...
80106fa9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    panic("switchuvm: no pgdir");
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106fae:	e8 cd c6 ff ff       	call   80103680 <mycpu>
80106fb3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106fba:	e8 c1 c6 ff ff       	call   80103680 <mycpu>
80106fbf:	b9 10 00 00 00       	mov    $0x10,%ecx
80106fc4:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106fc8:	e8 b3 c6 ff ff       	call   80103680 <mycpu>
80106fcd:	8b 56 08             	mov    0x8(%esi),%edx
80106fd0:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106fd6:	89 48 0c             	mov    %ecx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106fd9:	e8 a2 c6 ff ff       	call   80103680 <mycpu>
80106fde:	66 89 58 6e          	mov    %bx,0x6e(%eax)
}
...
80106fe2:	b8 28 00 00 00       	mov    $0x28,%eax
80106fe7:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106fea:	8b 46 04             	mov    0x4(%esi),%eax
...
80106ffb:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106ffc:	e9 3f d2 ff ff       	jmp    80104240 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80107001:	c7 04 24 46 80 10 80 	movl   $0x80108046,(%esp)
80107008:	e8 53 93 ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010700d:	c7 04 24 71 80 10 80 	movl   $0x80108071,(%esp)
80107014:	e8 47 93 ff ff       	call   80100360 <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80107019:	c7 04 24 5c 80 10 80 	movl   $0x8010805c,(%esp)
80107020:	e8 3b 93 ff ff       	call   80100360 <panic>
80107025:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
8010703f:	8b 7d 0c             	mov    0xc(%ebp),%edi
  char *mem;

  if(sz >= PGSIZE)
80107042:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
...
80107048:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  if(sz >= PGSIZE)
8010704b:	77 54                	ja     801070a1 <inituvm+0x71>
    panic("inituvm: more than a page");
  mem = kalloc();
8010704d:	e8 ce b4 ff ff       	call   80102520 <kalloc>
  memset(mem, 0, PGSIZE);
80107052:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107059:	00 
8010705a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107061:	00 
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
80107062:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80107064:	89 04 24             	mov    %eax,(%esp)
80107067:	e8 94 d2 ff ff       	call   80104300 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
8010706c:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80107072:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107077:	89 04 24             	mov    %eax,(%esp)
8010707a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010707d:	31 d2                	xor    %edx,%edx
8010707f:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80107086:	00 
80107087:	e8 94 fc ff ff       	call   80106d20 <mappages>
  memmove(mem, init, sz);
8010708c:	89 75 10             	mov    %esi,0x10(%ebp)
8010708f:	89 7d 0c             	mov    %edi,0xc(%ebp)
80107092:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80107095:	83 c4 1c             	add    $0x1c,%esp
80107098:	5b                   	pop    %ebx
80107099:	5e                   	pop    %esi
8010709a:	5f                   	pop    %edi
8010709b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010709c:	e9 ff d2 ff ff       	jmp    801043a0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
801070a1:	c7 04 24 85 80 10 80 	movl   $0x80108085,(%esp)
801070a8:	e8 b3 92 ff ff       	call   80100360 <panic>
...
801070b9:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
801070c0:	0f 85 98 00 00 00    	jne    8010715e <loaduvm+0xae>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801070c6:	8b 75 18             	mov    0x18(%ebp),%esi
801070c9:	31 db                	xor    %ebx,%ebx
801070cb:	85 f6                	test   %esi,%esi
801070cd:	75 1a                	jne    801070e9 <loaduvm+0x39>
801070cf:	eb 77                	jmp    80107148 <loaduvm+0x98>
801070d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801070d8:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801070de:	81 ee 00 10 00 00    	sub    $0x1000,%esi
801070e4:	39 5d 18             	cmp    %ebx,0x18(%ebp)
801070e7:	76 5f                	jbe    80107148 <loaduvm+0x98>
801070e9:	8b 55 0c             	mov    0xc(%ebp),%edx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801070ec:	31 c9                	xor    %ecx,%ecx
801070ee:	8b 45 08             	mov    0x8(%ebp),%eax
801070f1:	01 da                	add    %ebx,%edx
801070f3:	e8 98 fb ff ff       	call   80106c90 <walkpgdir>
801070f8:	85 c0                	test   %eax,%eax
801070fa:	74 56                	je     80107152 <loaduvm+0xa2>
...
80107103:	8b 4d 14             	mov    0x14(%ebp),%ecx
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
    pa = PTE_ADDR(*pte);
80107106:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
8010710b:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
80107111:	0f 42 fe             	cmovb  %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107114:	05 00 00 00 80       	add    $0x80000000,%eax
80107119:	89 44 24 04          	mov    %eax,0x4(%esp)
8010711d:	8b 45 10             	mov    0x10(%ebp),%eax
80107120:	01 d9                	add    %ebx,%ecx
80107122:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80107126:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010712a:	89 04 24             	mov    %eax,(%esp)
8010712d:	e8 ae a8 ff ff       	call   801019e0 <readi>
80107132:	39 f8                	cmp    %edi,%eax
80107134:	74 a2                	je     801070d8 <loaduvm+0x28>
      return -1;
  }
  return 0;
}
80107136:	83 c4 1c             	add    $0x1c,%esp
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
80107148:	83 c4 1c             	add    $0x1c,%esp
    else
      n = PGSIZE;
    if(readi(ip, P2V(pa), offset+i, n) != n)
      return -1;
...
80107151:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80107152:	c7 04 24 9f 80 10 80 	movl   $0x8010809f,(%esp)
80107159:	e8 02 92 ff ff       	call   80100360 <panic>
{
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
8010715e:	c7 04 24 40 81 10 80 	movl   $0x80108140,(%esp)
80107165:	e8 f6 91 ff ff       	call   80100360 <panic>
...
80107179:	8b 7d 10             	mov    0x10(%ebp),%edi
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
8010717c:	85 ff                	test   %edi,%edi
8010717e:	0f 88 7e 00 00 00    	js     80107202 <allocuvm+0x92>
    return 0;
  if(newsz < oldsz)
80107184:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80107187:	8b 45 0c             	mov    0xc(%ebp),%eax
  char *mem;
  uint a;
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
8010718a:	72 78                	jb     80107204 <allocuvm+0x94>
    return oldsz;

  a = PGROUNDUP(oldsz);
8010718c:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80107192:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80107198:	39 df                	cmp    %ebx,%edi
8010719a:	77 4a                	ja     801071e6 <allocuvm+0x76>
8010719c:	eb 72                	jmp    80107210 <allocuvm+0xa0>
8010719e:	66 90                	xchg   %ax,%ax
    ...
    memset(mem, 0, PGSIZE);
801071a0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801071a7:	00 
801071a8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801071af:	00 
801071b0:	89 04 24             	mov    %eax,(%esp)
801071b3:	e8 48 d1 ff ff       	call   80104300 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801071b8:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801071be:	b9 00 10 00 00       	mov    $0x1000,%ecx
801071c3:	89 04 24             	mov    %eax,(%esp)
801071c6:	8b 45 08             	mov    0x8(%ebp),%eax
801071c9:	89 da                	mov    %ebx,%edx
801071cb:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
801071d2:	00 
801071d3:	e8 48 fb ff ff       	call   80106d20 <mappages>
801071d8:	85 c0                	test   %eax,%eax
801071da:	78 44                	js     80107220 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
801071dc:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801071e2:	39 df                	cmp    %ebx,%edi
801071e4:	76 2a                	jbe    80107210 <allocuvm+0xa0>
    mem = kalloc();
801071e6:	e8 35 b3 ff ff       	call   80102520 <kalloc>
    if(mem == 0){
801071eb:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
801071ed:	89 c6                	mov    %eax,%esi
    if(mem == 0){
801071ef:	75 af                	jne    801071a0 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
801071f1:	c7 04 24 bd 80 10 80 	movl   $0x801080bd,(%esp)
801071f8:	e8 53 94 ff ff       	call   80100650 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
801071fd:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80107200:	77 48                	ja     8010724a <allocuvm+0xda>
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      ...
      kfree(mem);
      return 0;
80107202:	31 c0                	xor    %eax,%eax
    }
  }
  return newsz;
}
80107204:	83 c4 1c             	add    $0x1c,%esp
80107207:	5b                   	pop    %ebx
80107208:	5e                   	pop    %esi
80107209:	5f                   	pop    %edi
8010720a:	5d                   	pop    %ebp
...
80107210:	83 c4 1c             	add    $0x1c,%esp
...
8010721a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80107220:	c7 04 24 d5 80 10 80 	movl   $0x801080d5,(%esp)
80107227:	e8 24 94 ff ff       	call   80100650 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
8010722c:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010722f:	76 0d                	jbe    8010723e <allocuvm+0xce>
80107231:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107234:	89 fa                	mov    %edi,%edx
80107236:	8b 45 08             	mov    0x8(%ebp),%eax
80107239:	e8 62 fb ff ff       	call   80106da0 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
      deallocuvm(pgdir, newsz, oldsz);
      kfree(mem);
8010723e:	89 34 24             	mov    %esi,(%esp)
80107241:	e8 2a b1 ff ff       	call   80102370 <kfree>
      return 0;
80107246:	31 c0                	xor    %eax,%eax
80107248:	eb ba                	jmp    80107204 <allocuvm+0x94>
8010724a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010724d:	89 fa                	mov    %edi,%edx
8010724f:	8b 45 08             	mov    0x8(%ebp),%eax
80107252:	e8 49 fb ff ff       	call   80106da0 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80107259:	eb a9                	jmp    80107204 <allocuvm+0x94>
8010725b:	90                   	nop
...
8010726e:	73 08                	jae    80107278 <deallocuvm+0x18>
      kfree(v);
      *pte = 0;
    }
  }
...
80107270:	5d                   	pop    %ebp
80107271:	e9 2a fb ff ff       	jmp    80106da0 <deallocuvm.part.0>
80107276:	66 90                	xchg   %ax,%ax
80107278:	89 d0                	mov    %edx,%eax
8010727a:	5d                   	pop    %ebp
8010727b:	c3                   	ret    
...
80107285:	83 ec 10             	sub    $0x10,%esp
80107288:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
8010728b:	85 f6                	test   %esi,%esi
8010728d:	74 59                	je     801072e8 <freevm+0x68>
8010728f:	31 c9                	xor    %ecx,%ecx
80107291:	ba 00 00 00 80       	mov    $0x80000000,%edx
80107296:	89 f0                	mov    %esi,%eax
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107298:	31 db                	xor    %ebx,%ebx
8010729a:	e8 01 fb ff ff       	call   80106da0 <deallocuvm.part.0>
8010729f:	eb 12                	jmp    801072b3 <freevm+0x33>
801072a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801072a8:	83 c3 01             	add    $0x1,%ebx
801072ab:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
801072b1:	74 27                	je     801072da <freevm+0x5a>
    if(pgdir[i] & PTE_P){
801072b3:	8b 14 9e             	mov    (%esi,%ebx,4),%edx
801072b6:	f6 c2 01             	test   $0x1,%dl
801072b9:	74 ed                	je     801072a8 <freevm+0x28>
      char * v = P2V(PTE_ADDR(pgdir[i]));
801072bb:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801072c1:	83 c3 01             	add    $0x1,%ebx
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
801072c4:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
801072ca:	89 14 24             	mov    %edx,(%esp)
801072cd:	e8 9e b0 ff ff       	call   80102370 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801072d2:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
801072d8:	75 d9                	jne    801072b3 <freevm+0x33>
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801072e2:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
801072e3:	e9 88 b0 ff ff       	jmp    80102370 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
801072e8:	c7 04 24 f1 80 10 80 	movl   $0x801080f1,(%esp)
801072ef:	e8 6c 90 ff ff       	call   80100360 <panic>
...
80107305:	83 ec 10             	sub    $0x10,%esp
  pde_t *pgdir;
  struct kmap *k;
...
80107311:	74 6d                	je     80107380 <setupkvm+0x80>
    return 0;
  memset(pgdir, 0, PGSIZE);
80107313:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010731a:	00 
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010731b:	bb 20 b4 10 80       	mov    $0x8010b420,%ebx
  pde_t *pgdir;
  struct kmap *k;
...
8010732b:	e8 d0 cf ff ff       	call   80104300 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80107330:	8b 53 0c             	mov    0xc(%ebx),%edx
80107333:	8b 43 04             	mov    0x4(%ebx),%eax
80107336:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107339:	89 54 24 04          	mov    %edx,0x4(%esp)
8010733d:	8b 13                	mov    (%ebx),%edx
8010733f:	89 04 24             	mov    %eax,(%esp)
80107342:	29 c1                	sub    %eax,%ecx
80107344:	89 f0                	mov    %esi,%eax
80107346:	e8 d5 f9 ff ff       	call   80106d20 <mappages>
8010734b:	85 c0                	test   %eax,%eax
8010734d:	78 19                	js     80107368 <setupkvm+0x68>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010734f:	83 c3 10             	add    $0x10,%ebx
80107352:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
80107358:	72 d6                	jb     80107330 <setupkvm+0x30>
8010735a:	89 f0                	mov    %esi,%eax
...
80107364:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80107368:	89 34 24             	mov    %esi,(%esp)
8010736b:	e8 10 ff ff ff       	call   80107280 <freevm>
      return 0;
    }
  return pgdir;
}
...
80107382:	eb d8                	jmp    8010735c <setupkvm+0x5c>
...
80107393:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107396:	e8 65 ff ff ff       	call   80107300 <setupkvm>
8010739b:	a3 04 6e 11 80       	mov    %eax,0x80116e04
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
801073be:	e8 cd f8 ff ff       	call   80106c90 <walkpgdir>
  if(pte == 0)
...
801073cb:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
801073cc:	c7 04 24 02 81 10 80 	movl   $0x80108102,(%esp)
801073d3:	e8 88 8f ff ff       	call   80100360 <panic>
801073d8:	90                   	nop
...
801073e6:	83 ec 2c             	sub    $0x2c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
...
80107408:	81 c7 00 00 00 80    	add    $0x80000000,%edi
8010740e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107415:	00 
80107416:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010741a:	89 04 24             	mov    %eax,(%esp)
8010741d:	e8 7e cf ff ff       	call   801043a0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80107422:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107425:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
8010742b:	89 14 24             	mov    %edx,(%esp)
8010742e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107433:	89 da                	mov    %ebx,%edx
80107435:	89 44 24 04          	mov    %eax,0x4(%esp)
80107439:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010743c:	e8 df f8 ff ff       	call   80106d20 <mappages>
80107441:	85 c0                	test   %eax,%eax
80107443:	78 41                	js     80107486 <copyuvm+0xa6>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107445:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010744b:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
8010744e:	76 50                	jbe    801074a0 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107450:	8b 45 08             	mov    0x8(%ebp),%eax
80107453:	31 c9                	xor    %ecx,%ecx
80107455:	89 da                	mov    %ebx,%edx
80107457:	e8 34 f8 ff ff       	call   80106c90 <walkpgdir>
8010745c:	85 c0                	test   %eax,%eax
8010745e:	74 5b                	je     801074bb <copyuvm+0xdb>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80107460:	8b 30                	mov    (%eax),%esi
80107462:	f7 c6 01 00 00 00    	test   $0x1,%esi
80107468:	74 45                	je     801074af <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
8010746a:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
8010746c:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80107472:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107475:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
8010747b:	e8 a0 b0 ff ff       	call   80102520 <kalloc>
80107480:	85 c0                	test   %eax,%eax
80107482:	89 c6                	mov    %eax,%esi
80107484:	75 82                	jne    80107408 <copyuvm+0x28>
      goto bad;
  }
  return d;
...
80107489:	89 04 24             	mov    %eax,(%esp)
8010748c:	e8 ef fd ff ff       	call   80107280 <freevm>
  return 0;
...
801074a3:	83 c4 2c             	add    $0x2c,%esp
801074a6:	5b                   	pop    %ebx
801074a7:	5e                   	pop    %esi
801074a8:	5f                   	pop    %edi
801074a9:	5d                   	pop    %ebp
...
801074ad:	eb e4                	jmp    80107493 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
801074af:	c7 04 24 26 81 10 80 	movl   $0x80108126,(%esp)
801074b6:	e8 a5 8e ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
801074bb:	c7 04 24 0c 81 10 80 	movl   $0x8010810c,(%esp)
801074c2:	e8 99 8e ff ff       	call   80100360 <panic>
...
801074de:	e8 ad f7 ff ff       	call   80106c90 <walkpgdir>
  if((*pte & PTE_P) == 0)
801074e3:	8b 00                	mov    (%eax),%eax
801074e5:	89 c2                	mov    %eax,%edx
801074e7:	83 e2 05             	and    $0x5,%edx
    return 0;
  if((*pte & PTE_U) == 0)
801074ea:	83 fa 05             	cmp    $0x5,%edx
801074ed:	75 11                	jne    80107500 <uva2ka+0x30>
    return 0;
...
8010751c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
80107524:	75 3a                	jne    80107560 <copyout+0x50>
80107526:	eb 68                	jmp    80107590 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80107528:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010752b:	89 f2                	mov    %esi,%edx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
8010752d:	89 7c 24 04          	mov    %edi,0x4(%esp)
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80107531:	29 ca                	sub    %ecx,%edx
80107533:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107539:	39 da                	cmp    %ebx,%edx
8010753b:	0f 47 d3             	cmova  %ebx,%edx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
8010753e:	29 f1                	sub    %esi,%ecx
80107540:	01 c8                	add    %ecx,%eax
80107542:	89 54 24 08          	mov    %edx,0x8(%esp)
80107546:	89 04 24             	mov    %eax,(%esp)
80107549:	89 55 e4             	mov    %edx,-0x1c(%ebp)
8010754c:	e8 4f ce ff ff       	call   801043a0 <memmove>
    len -= n;
    buf += n;
80107551:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    va = va0 + PGSIZE;
80107554:	8d 8e 00 10 00 00    	lea    0x1000(%esi),%ecx
    n = PGSIZE - (va - va0);
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
...
8010755e:	74 30                	je     80107590 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
80107560:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
80107563:	89 ce                	mov    %ecx,%esi
80107565:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
8010756b:	89 74 24 04          	mov    %esi,0x4(%esp)
  char *buf, *pa0;
  uint n, va0;
  ...
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
8010756f:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80107572:	89 04 24             	mov    %eax,(%esp)
80107575:	e8 56 ff ff ff       	call   801074d0 <uva2ka>
    if(pa0 == 0)
8010757a:	85 c0                	test   %eax,%eax
8010757c:	75 aa                	jne    80107528 <copyout+0x18>
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
  }
...
8010757e:	83 c4 1c             	add    $0x1c,%esp
  buf = (char*)p;
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
80107581:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
  }
...
80107590:	83 c4 1c             	add    $0x1c,%esp
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
