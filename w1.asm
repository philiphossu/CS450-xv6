...
free(void *ap)
{
 ...
 571:	a1 68 09 00 00       	mov    0x968,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5b7:	89 10                	mov    %edx,(%eax)
  freep = p;
 5b9:	a3 68 09 00 00       	mov    %eax,0x968
}
 5be:	5b                   	pop    %ebx
 5bf:	5e                   	pop    %esi
 5c0:	5f                   	pop    %edi
 ...
 5df:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 5e2:	a3 68 09 00 00       	mov    %eax,0x968
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 1d 68 09 00 00    	mov    0x968,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 649:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 64b:	3b 15 68 09 00 00    	cmp    0x968,%edx
...
morecore(uint nu)
{
 ...
 67d:	e8 ee fe ff ff       	call   570 <free>
  return freep;
 682:	8b 15 68 09 00 00    	mov    0x968,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6a4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6a7:	89 15 68 09 00 00    	mov    %edx,0x968
      return (void*)(p + 1);
 ...
 6bc:	eb e9                	jmp    6a7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6be:	c7 05 68 09 00 00 6c 	movl   $0x96c,0x968
 6c5:	09 00 00 
    base.s.size = 0;
 6c8:	ba 6c 09 00 00       	mov    $0x96c,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6cd:	c7 05 6c 09 00 00 6c 	movl   $0x96c,0x96c
 6d4:	09 00 00 
    base.s.size = 0;
 6d7:	c7 05 70 09 00 00 00 	movl   $0x0,0x970
 6de:	00 00 00 
