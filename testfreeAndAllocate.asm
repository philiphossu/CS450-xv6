...
int main(int argc, char **argv){
   ...
   7:	83 ec 10             	sub    $0x10,%esp
	// Part 1
	printf(1,"Begin Test\n");
   a:	c7 44 24 04 38 08 00 	movl   $0x838,0x4(%esp)
  11:	00 
  ...
  23:	c7 44 24 04 44 08 00 	movl   $0x844,0x4(%esp)
  2a:	00 
  ...
  43:	e8 ba 03 00 00       	call   402 <myMemory>
	printf(1,"sbrk'ing -8192 (2 pages)\n");
  48:	c7 44 24 04 5d 08 00 	movl   $0x85d,0x4(%esp)
  4f:	00 
  ...
  6d:	c7 44 24 04 78 08 00 	movl   $0x878,0x4(%esp)
  74:	00 
  ...
  88:	e8 c3 06 00 00       	call   750 <malloc>
  ...
  ab:	e8 10 06 00 00       	call   6c0 <free>
    myMemory();
  ...
  da:	c7 44 24 04 f8 08 00 	movl   $0x8f8,0x4(%esp)
  e1:	00 
  e2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e9:	e8 e2 03 00 00       	call   4d0 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 469:	0f b6 92 3b 09 00 00 	movzbl 0x93b(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5ff:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 601:	b8 34 09 00 00       	mov    $0x934,%eax
...
free(void *ap)
{
 ...
 707:	89 10                	mov    %edx,(%eax)
  freep = p;
 709:	a3 b0 0b 00 00       	mov    %eax,0xbb0
}
 70e:	5b                   	pop    %ebx
 70f:	5e                   	pop    %esi
 710:	5f                   	pop    %edi
 ...
 72f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 732:	a3 b0 0b 00 00       	mov    %eax,0xbb0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 1d b0 0b 00 00    	mov    0xbb0,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 799:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 79b:	3b 15 b0 0b 00 00    	cmp    0xbb0,%edx
...
morecore(uint nu)
{
 ...
 7cd:	e8 ee fe ff ff       	call   6c0 <free>
  return freep;
 7d2:	8b 15 b0 0b 00 00    	mov    0xbb0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7f4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 7f7:	89 15 b0 0b 00 00    	mov    %edx,0xbb0
      return (void*)(p + 1);
 ...
 80c:	eb e9                	jmp    7f7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 80e:	c7 05 b0 0b 00 00 b4 	movl   $0xbb4,0xbb0
 815:	0b 00 00 
    base.s.size = 0;
 818:	ba b4 0b 00 00       	mov    $0xbb4,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 81d:	c7 05 b4 0b 00 00 b4 	movl   $0xbb4,0xbb4
 824:	0b 00 00 
    base.s.size = 0;
 827:	c7 05 b8 0b 00 00 00 	movl   $0x0,0xbb8
 82e:	00 00 00 
