...
// test how much code is in the program
// test heap
...
int main(int argc, char **argv){
   ...
   6:	83 ec 10             	sub    $0x10,%esp
	...
	printf(1,"Begin Test\n");
   9:	c7 44 24 04 56 07 00 	movl   $0x756,0x4(%esp)
  10:	00 
  11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  18:	e8 d3 03 00 00       	call   3f0 <printf>
	myMemory();
  1d:	e8 20 03 00 00       	call   342 <myMemory>
	printf(1,"Adding 4096 bytes to memory.\n");
  22:	c7 44 24 04 62 07 00 	movl   $0x762,0x4(%esp)
  29:	00 
  2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  31:	e8 ba 03 00 00       	call   3f0 <printf>
	sbrk(4096);
  36:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  3d:	e8 e8 02 00 00       	call   32a <sbrk>
	myMemory();
  42:	e8 fb 02 00 00       	call   342 <myMemory>
	printf(1,"Adding 4097 bytes to memory.\n");
  47:	c7 44 24 04 80 07 00 	movl   $0x780,0x4(%esp)
  4e:	00 
  4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  56:	e8 95 03 00 00       	call   3f0 <printf>
	sbrk(4097);
  5b:	c7 04 24 01 10 00 00 	movl   $0x1001,(%esp)
  62:	e8 c3 02 00 00       	call   32a <sbrk>
	myMemory();
  67:	e8 d6 02 00 00       	call   342 <myMemory>

	exit();
  6c:	e8 31 02 00 00       	call   2a2 <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 389:	0f b6 92 a5 07 00 00 	movzbl 0x7a5(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 9e 07 00 00       	mov    $0x79e,%eax
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 1d 1c 0a 00 00    	mov    0xa1c,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6b9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6bb:	3b 15 1c 0a 00 00    	cmp    0xa1c,%edx
...
morecore(uint nu)
{
 ...
 6ed:	e8 ee fe ff ff       	call   5e0 <free>
  return freep;
 6f2:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 72c:	eb e9                	jmp    717 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 72e:	c7 05 1c 0a 00 00 20 	movl   $0xa20,0xa1c
 735:	0a 00 00 
    base.s.size = 0;
 738:	ba 20 0a 00 00       	mov    $0xa20,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 73d:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 744:	0a 00 00 
    base.s.size = 0;
 747:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 74e:	00 00 00 
