...
//	directoryWalker(".");
	compareWalkers();
   a:	e8 53 03 00 00       	call   362 <compareWalkers>

	mkdir("foo");
   f:	c7 04 24 88 07 00 00 	movl   $0x788,(%esp)
  16:	e8 ef 02 00 00       	call   30a <mkdir>
	int fd;
	fd = open("/foo/smallTestFile", O_CREATE | O_RDWR);
  1b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
  22:	00 
  23:	c7 04 24 8c 07 00 00 	movl   $0x78c,(%esp)
  2a:	e8 b3 02 00 00       	call   2e2 <open>
	if(fd >= 0){
...
//	directoryWalker(".");
  ...
  31:	89 c3                	mov    %eax,%ebx
	if(fd >= 0){
  33:	78 14                	js     49 <main+0x49>
		printf(1, "\n----> File creation successful.\n");
  35:	c7 44 24 04 a4 07 00 	movl   $0x7a4,0x4(%esp)
  3c:	00 
  3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  44:	e8 d7 03 00 00       	call   420 <printf>
	}
	write(fd, "22", 2);
  49:	c7 44 24 08 02 00 00 	movl   $0x2,0x8(%esp)
  50:	00 
  51:	c7 44 24 04 9f 07 00 	movl   $0x79f,0x4(%esp)
  58:	00 
  59:	89 1c 24             	mov    %ebx,(%esp)
  5c:	e8 61 02 00 00       	call   2c2 <write>
	close(fd);
  61:	89 1c 24             	mov    %ebx,(%esp)
  64:	e8 61 02 00 00       	call   2ca <close>
	deleteIData(24);
  69:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
  70:	e8 dd 02 00 00       	call   352 <deleteIData>

	compareWalkers();
  75:	e8 e8 02 00 00       	call   362 <compareWalkers>
//	directoryWalker(".");
//	inodeTBWalker();
	exit();
  7a:	e8 23 02 00 00       	call   2a2 <exit>
  7f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 cf 07 00 00 	movzbl 0x7cf(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 54f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 551:	b8 c8 07 00 00       	mov    $0x7c8,%eax
